...
<commerce-ui:header
	bean="<%= commerceOrderContentDisplayContext.getCommerceOrder() %>"
	dropdownItems="<%= commerceOrderContentDisplayContext.getDropdownItems() %>"
	headerActions="<%= commerceOrderContentDisplayContext.getHeaderActionModels() %>"
	model="<%= CommerceOrder.class %>"
	title='<%= LanguageUtil.format(request, "order-x", commerceOrderContentDisplayContext.getCommerceOrderId()) %>'
/>

...
@Component(
	immediate = true,
	property = {
		"commerce.order.detail.renderer.key=" + PendingCommerceOrderDetailRendererImpl.KEY,
		"commerce.order.detail.renderer.order=" + Integer.MIN_VALUE,
		"commerce.order.detail.renderer.status=" + CommerceOrderDetailConstants.ORDER_DETAIL_STATUS_PENDING
	},
	service = CommerceOrderDetailRenderer.class
)
public class PendingCommerceOrderDetailRendererImpl
	...
	public void render(
		...
		if (commerceOrder.isOpen()) {
			_jspRenderer.renderJSP(
				...
				"/order_detail/render/pending/view.jsp");
		}
	}

...
import com.liferay.data.integration.service.ProcessTypeService;
...
/**
 * Provides the base implementation for the process type remote service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.liferay.data.integration.service.impl.ProcessTypeServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see com.liferay.data.integration.service.impl.ProcessTypeServiceImpl
 * @see com.liferay.data.integration.service.ProcessTypeServiceUtil
 * @generated
 */
public abstract class ProcessTypeServiceBaseImpl extends BaseServiceImpl
	implements ProcessTypeService, IdentifiableOSGiService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link com.liferay.data.integration.service.ProcessTypeServiceUtil} to access the process type remote service.
	 */
	 ...
	 */
	public com.liferay.data.integration.service.HistoryService getHistoryService() {
	...
	public void setHistoryService(
		com.liferay.data.integration.service.HistoryService historyService) {
	 ...
	 */
	public com.liferay.data.integration.service.ProcessService getProcessService() {
	...
	public void setProcessService(
		com.liferay.data.integration.service.ProcessService processService) {
	 ...
	 */
	public com.liferay.data.integration.service.ProcessTypeLocalService getProcessTypeLocalService() {
	...
	public void setProcessTypeLocalService(
		com.liferay.data.integration.service.ProcessTypeLocalService processTypeLocalService) {
		this.processTypeLocalService = processTypeLocalService;
	}

	/**
	 * Returns the process type remote service.
	 *
	 * @return the process type remote service
	 */
	...
	/**
	 * Sets the process type remote service.
	 *
	 * @param processTypeService the process type remote service
	 */
	 ...
	 */
	public com.liferay.data.integration.service.ScheduledTaskService getScheduledTaskService() {
	...
	public void setScheduledTaskService(
		com.liferay.data.integration.service.ScheduledTaskService scheduledTaskService) {
	...
	public String getOSGiServiceIdentifier() {
		return ProcessTypeService.class.getName();
	}
	...
	@BeanReference(type = com.liferay.data.integration.service.HistoryService.class)
	protected com.liferay.data.integration.service.HistoryService historyService;
	...
	@BeanReference(type = com.liferay.data.integration.service.ProcessService.class)
	protected com.liferay.data.integration.service.ProcessService processService;
	@BeanReference(type = ProcessPersistence.class)
	protected ProcessPersistence processPersistence;
	@BeanReference(type = com.liferay.data.integration.service.ProcessTypeLocalService.class)
	protected com.liferay.data.integration.service.ProcessTypeLocalService processTypeLocalService;
	@BeanReference(type = ProcessTypeService.class)
	...
	@BeanReference(type = com.liferay.data.integration.service.ScheduledTaskService.class)
	protected com.liferay.data.integration.service.ScheduledTaskService scheduledTaskService;

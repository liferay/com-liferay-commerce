...
public class CommerceUserSegmentEntryPersistenceTest {
	...
	public void tearDown() throws Exception {
		Iterator<CommerceUserSegmentEntry> iterator =
			_commerceUserSegmentEntries.iterator();
	...
	public void testCreate() throws Exception {
		...
		CommerceUserSegmentEntry commerceUserSegmentEntry = _persistence.create(
			pk);
	...
	public void testRemove() throws Exception {
		CommerceUserSegmentEntry newCommerceUserSegmentEntry =
			addCommerceUserSegmentEntry();

		_persistence.remove(newCommerceUserSegmentEntry);

		CommerceUserSegmentEntry existingCommerceUserSegmentEntry =
	...
	public void testUpdateExisting() throws Exception {
		...
		_commerceUserSegmentEntries.add(
			_persistence.update(newCommerceUserSegmentEntry));
		...
		Assert.assertEquals(
			existingCommerceUserSegmentEntry.getCommerceUserSegmentEntryId(),
		...
		Assert.assertEquals(
			existingCommerceUserSegmentEntry.getCompanyId(),
			newCommerceUserSegmentEntry.getCompanyId());
		Assert.assertEquals(
			existingCommerceUserSegmentEntry.getUserId(),
			newCommerceUserSegmentEntry.getUserId());
		Assert.assertEquals(
			existingCommerceUserSegmentEntry.getUserName(),
			newCommerceUserSegmentEntry.getUserName());
		Assert.assertEquals(
			Time.getShortTimestamp(
				existingCommerceUserSegmentEntry.getCreateDate()),
			Time.getShortTimestamp(
				newCommerceUserSegmentEntry.getCreateDate()));
		Assert.assertEquals(
			Time.getShortTimestamp(
	...
	public void testFindByPrimaryKeyExisting() throws Exception {
		...
		Assert.assertEquals(
			existingCommerceUserSegmentEntry, newCommerceUserSegmentEntry);
	}
	...
	protected OrderByComparator<CommerceUserSegmentEntry>
		getOrderByComparator() {

		return OrderByComparatorFactoryUtil.create(
			"CommerceUserSegmentEntry", "commerceUserSegmentEntryId", true,
			"groupId", true, "companyId", true, "userId", true, "userName",
			true, "createDate", true, "modifiedDate", true, "name", true, "key",
			true, "active", true, "system", true, "priority", true);
	}
	...
	public void testFetchByPrimaryKeyMissing() throws Exception {
		...
		CommerceUserSegmentEntry missingCommerceUserSegmentEntry =
	...
	public void testFetchByPrimaryKeysWithMultiplePrimaryKeysWhereAllPrimaryKeysExist()
		...
		CommerceUserSegmentEntry newCommerceUserSegmentEntry1 =
			addCommerceUserSegmentEntry();
		CommerceUserSegmentEntry newCommerceUserSegmentEntry2 =
			addCommerceUserSegmentEntry();
	...
	public void testDynamicQueryByPrimaryKeyExisting() throws Exception {
		...
		DynamicQuery dynamicQuery = DynamicQueryFactoryUtil.forClass(
			CommerceUserSegmentEntry.class, _dynamicQueryClassLoader);
		...
		List<CommerceUserSegmentEntry> result =
			_persistence.findWithDynamicQuery(dynamicQuery);

		Assert.assertEquals(1, result.size());

		CommerceUserSegmentEntry existingCommerceUserSegmentEntry = result.get(
			0);
	...
	public void testDynamicQueryByProjectionExisting() throws Exception {
		...
		dynamicQuery.setProjection(
			ProjectionFactoryUtil.property("commerceUserSegmentEntryId"));

		Object newCommerceUserSegmentEntryId =
			newCommerceUserSegmentEntry.getCommerceUserSegmentEntryId();
		...
		Assert.assertEquals(
			existingCommerceUserSegmentEntryId, newCommerceUserSegmentEntryId);
	}
	...
	public void testResetOriginalValues() throws Exception {
		...
		Assert.assertEquals(
			Long.valueOf(existingCommerceUserSegmentEntry.getGroupId()),
			ReflectionTestUtil.<Long>invoke(
				existingCommerceUserSegmentEntry, "getOriginalGroupId",
				new Class<?>[0]));
		Assert.assertTrue(
			Objects.equals(
				existingCommerceUserSegmentEntry.getKey(),
				ReflectionTestUtil.invoke(
					existingCommerceUserSegmentEntry, "getOriginalKey",
					new Class<?>[0])));
	}
	...
	protected CommerceUserSegmentEntry addCommerceUserSegmentEntry()
		...
		_commerceUserSegmentEntries.add(
			_persistence.update(commerceUserSegmentEntry));

		return commerceUserSegmentEntry;
	}

	private List<CommerceUserSegmentEntry> _commerceUserSegmentEntries =
		new ArrayList<CommerceUserSegmentEntry>();

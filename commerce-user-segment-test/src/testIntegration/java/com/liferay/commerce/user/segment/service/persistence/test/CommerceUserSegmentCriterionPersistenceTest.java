...
public class CommerceUserSegmentCriterionPersistenceTest {
	...
	public void tearDown() throws Exception {
		Iterator<CommerceUserSegmentCriterion> iterator =
			_commerceUserSegmentCriterions.iterator();
	...
	public void testRemove() throws Exception {
		CommerceUserSegmentCriterion newCommerceUserSegmentCriterion =
			addCommerceUserSegmentCriterion();

		_persistence.remove(newCommerceUserSegmentCriterion);

		CommerceUserSegmentCriterion existingCommerceUserSegmentCriterion =
	...
	public void testUpdateExisting() throws Exception {
		...
		newCommerceUserSegmentCriterion.setUserName(
			RandomTestUtil.randomString());

		newCommerceUserSegmentCriterion.setCreateDate(
			RandomTestUtil.nextDate());

		newCommerceUserSegmentCriterion.setModifiedDate(
			RandomTestUtil.nextDate());

		newCommerceUserSegmentCriterion.setCommerceUserSegmentEntryId(
			RandomTestUtil.nextLong());

		newCommerceUserSegmentCriterion.setType(RandomTestUtil.randomString());

		newCommerceUserSegmentCriterion.setTypeSettings(
			RandomTestUtil.randomString());

		newCommerceUserSegmentCriterion.setPriority(
			RandomTestUtil.nextDouble());

		_commerceUserSegmentCriterions.add(
			_persistence.update(newCommerceUserSegmentCriterion));
		...
		Assert.assertEquals(
			existingCommerceUserSegmentCriterion.
				getCommerceUserSegmentCriterionId(),
			newCommerceUserSegmentCriterion.
				getCommerceUserSegmentCriterionId());
		Assert.assertEquals(
			existingCommerceUserSegmentCriterion.getGroupId(),
			newCommerceUserSegmentCriterion.getGroupId());
		Assert.assertEquals(
			existingCommerceUserSegmentCriterion.getCompanyId(),
			newCommerceUserSegmentCriterion.getCompanyId());
		Assert.assertEquals(
			existingCommerceUserSegmentCriterion.getUserId(),
			newCommerceUserSegmentCriterion.getUserId());
		Assert.assertEquals(
			existingCommerceUserSegmentCriterion.getUserName(),
		...
		Assert.assertEquals(
			existingCommerceUserSegmentCriterion.getType(),
			newCommerceUserSegmentCriterion.getType());
		Assert.assertEquals(
			existingCommerceUserSegmentCriterion.getTypeSettings(),
			newCommerceUserSegmentCriterion.getTypeSettings());
		AssertUtils.assertEquals(
			existingCommerceUserSegmentCriterion.getPriority(),
	...
	protected OrderByComparator<CommerceUserSegmentCriterion>
		getOrderByComparator() {

		return OrderByComparatorFactoryUtil.create(
			"CommerceUserSegmentCriterion", "commerceUserSegmentCriterionId",
			true, "groupId", true, "companyId", true, "userId", true,
			"userName", true, "createDate", true, "modifiedDate", true,
			"commerceUserSegmentEntryId", true, "type", true, "priority", true);
	}
	...
	public void testFetchByPrimaryKeyMissing() throws Exception {
		...
		CommerceUserSegmentCriterion missingCommerceUserSegmentCriterion =
	...
	public void testFetchByPrimaryKeysWithMultiplePrimaryKeysWhereAllPrimaryKeysExist()
		...
		CommerceUserSegmentCriterion newCommerceUserSegmentCriterion1 =
			addCommerceUserSegmentCriterion();
		CommerceUserSegmentCriterion newCommerceUserSegmentCriterion2 =
			addCommerceUserSegmentCriterion();
		...
		Map<Serializable, CommerceUserSegmentCriterion>
			commerceUserSegmentCriterions = _persistence.fetchByPrimaryKeys(
				primaryKeys);

		Assert.assertEquals(2, commerceUserSegmentCriterions.size());
		Assert.assertEquals(
			newCommerceUserSegmentCriterion1,
			commerceUserSegmentCriterions.get(
				newCommerceUserSegmentCriterion1.getPrimaryKey()));
		Assert.assertEquals(
			newCommerceUserSegmentCriterion2,
			commerceUserSegmentCriterions.get(
	...
	public void testDynamicQueryByPrimaryKeyExisting() throws Exception {
		...
		DynamicQuery dynamicQuery = DynamicQueryFactoryUtil.forClass(
			CommerceUserSegmentCriterion.class, _dynamicQueryClassLoader);
		...
		List<CommerceUserSegmentCriterion> result =
	...
	public void testDynamicQueryByProjectionExisting() throws Exception {
		...
		dynamicQuery.setProjection(
			ProjectionFactoryUtil.property("commerceUserSegmentCriterionId"));

		Object newCommerceUserSegmentCriterionId =
		...
		Assert.assertEquals(
			existingCommerceUserSegmentCriterionId,
	...
	protected CommerceUserSegmentCriterion addCommerceUserSegmentCriterion()
		...
		_commerceUserSegmentCriterions.add(
			_persistence.update(commerceUserSegmentCriterion));

		return commerceUserSegmentCriterion;
	}

	private List<CommerceUserSegmentCriterion> _commerceUserSegmentCriterions =
		new ArrayList<CommerceUserSegmentCriterion>();

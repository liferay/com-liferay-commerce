...
public class NoSuchUserExceptionMapper
	extends BaseExceptionMapper<NoSuchUserException> {

	@Override
	public int getErrorCode() {
		return RESTError.NO_SUCH_USER.getErrorCode();
	}

	@Override
	public String getErrorDescription() {
		return RESTError.NO_SUCH_USER.getErrorDescription();
	}

	@Override
	public Response.Status getStatus() {
		return RESTError.NO_SUCH_USER.getStatus();
	}

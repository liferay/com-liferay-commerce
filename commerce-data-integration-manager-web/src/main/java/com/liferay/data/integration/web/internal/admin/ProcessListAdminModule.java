...
package com.liferay.data.integration.web.internal.admin;
...
import com.liferay.data.integration.web.internal.display.context.DataIntegrationProcessListDisplayContext;
...
@Component(
	immediate = true,
	property = "data.integration.admin.module.key=" + ProcessListAdminModule.KEY,
	service = DataIntegrationAdminModule.class
)
public class ProcessListAdminModule implements DataIntegrationAdminModule {

	public static final String KEY = "processes";
	...
	public String getLabel(Locale locale) {
		...
		return LanguageUtil.get(resourceBundle, "processes-admin");
	}

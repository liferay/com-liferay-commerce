...
public class CommerceDiscountPersistenceImpl extends BasePersistenceImpl<CommerceDiscount>
	...
	public static final FinderPath FINDER_PATH_WITHOUT_PAGINATION_FIND_BY_COMPANYID =
		new FinderPath(CommerceDiscountModelImpl.ENTITY_CACHE_ENABLED,
			...
			CommerceDiscountModelImpl.COMPANYID_COLUMN_BITMASK |
			CommerceDiscountModelImpl.CREATEDATE_COLUMN_BITMASK);
	public static final FinderPath FINDER_PATH_COUNT_BY_COMPANYID = new FinderPath(CommerceDiscountModelImpl.ENTITY_CACHE_ENABLED,
			CommerceDiscountModelImpl.FINDER_CACHE_ENABLED, Long.class,
	 ...
	 */
	@Override
	public List<CommerceDiscount> findByCompanyId(long companyId, int start,
		int end) {
	 ...
	 */
	@Override
	public CommerceDiscount findByCompanyId_First(long companyId,
		OrderByComparator<CommerceDiscount> orderByComparator)
		throws NoSuchDiscountException {
		CommerceDiscount commerceDiscount = fetchByCompanyId_First(companyId,
				orderByComparator);
	 ...
	 */
	@Override
	public CommerceDiscount fetchByCompanyId_First(long companyId,
		OrderByComparator<CommerceDiscount> orderByComparator) {
		List<CommerceDiscount> list = findByCompanyId(companyId, 0, 1,
				orderByComparator);
	 ...
	 */
	@Override
	public CommerceDiscount findByCompanyId_Last(long companyId,
		OrderByComparator<CommerceDiscount> orderByComparator)
		throws NoSuchDiscountException {
		CommerceDiscount commerceDiscount = fetchByCompanyId_Last(companyId,
				orderByComparator);
	 ...
	 */
	@Override
	public CommerceDiscount fetchByCompanyId_Last(long companyId,
		OrderByComparator<CommerceDiscount> orderByComparator) {
		...
		List<CommerceDiscount> list = findByCompanyId(companyId, count - 1,
				count, orderByComparator);
	...
	public CommerceDiscount[] findByCompanyId_PrevAndNext(
		...
		try {
			...
			array[0] = getByCompanyId_PrevAndNext(session, commerceDiscount,
					companyId, orderByComparator, true);

			array[1] = commerceDiscount;

			array[2] = getByCompanyId_PrevAndNext(session, commerceDiscount,
					companyId, orderByComparator, false);
	...
	protected CommerceDiscount getByCompanyId_PrevAndNext(Session session,
		CommerceDiscount commerceDiscount, long companyId,
		OrderByComparator<CommerceDiscount> orderByComparator, boolean previous) {
		StringBundler query = null;
	...
	public void removeByCompanyId(long companyId) {
		for (CommerceDiscount commerceDiscount : findByCompanyId(companyId,
				QueryUtil.ALL_POS, QueryUtil.ALL_POS, null)) {
			remove(commerceDiscount);
		}
	}
	...
	public static final FinderPath FINDER_PATH_WITHOUT_PAGINATION_FIND_BY_C_C = new FinderPath(CommerceDiscountModelImpl.ENTITY_CACHE_ENABLED,
			CommerceDiscountModelImpl.FINDER_CACHE_ENABLED,
			CommerceDiscountImpl.class,
			...
			CommerceDiscountModelImpl.CREATEDATE_COLUMN_BITMASK);
	public static final FinderPath FINDER_PATH_COUNT_BY_C_C = new FinderPath(CommerceDiscountModelImpl.ENTITY_CACHE_ENABLED,
			CommerceDiscountModelImpl.FINDER_CACHE_ENABLED, Long.class,
	...
	public List<CommerceDiscount> findByC_C(long companyId, String couponCode) {
		return findByC_C(companyId, couponCode, QueryUtil.ALL_POS,
			QueryUtil.ALL_POS, null);
	}
	...
	public List<CommerceDiscount> findByC_C(long companyId, String couponCode,
		int start, int end,
		OrderByComparator<CommerceDiscount> orderByComparator) {
		return findByC_C(companyId, couponCode, start, end, orderByComparator,
			true);
	}
	 ...
	 */
	@Override
	public CommerceDiscount findByC_C_First(long companyId, String couponCode,
		OrderByComparator<CommerceDiscount> orderByComparator)
		throws NoSuchDiscountException {
		CommerceDiscount commerceDiscount = fetchByC_C_First(companyId,
	 ...
	 */
	@Override
	public CommerceDiscount fetchByC_C_First(long companyId, String couponCode,
		OrderByComparator<CommerceDiscount> orderByComparator) {
		List<CommerceDiscount> list = findByC_C(companyId, couponCode, 0, 1,
				orderByComparator);
	 ...
	 */
	@Override
	public CommerceDiscount findByC_C_Last(long companyId, String couponCode,
		OrderByComparator<CommerceDiscount> orderByComparator)
		throws NoSuchDiscountException {
		CommerceDiscount commerceDiscount = fetchByC_C_Last(companyId,
				couponCode, orderByComparator);
	 ...
	 */
	@Override
	public CommerceDiscount fetchByC_C_Last(long companyId, String couponCode,
		OrderByComparator<CommerceDiscount> orderByComparator) {
		...
		List<CommerceDiscount> list = findByC_C(companyId, couponCode,
	 ...
	 */
	@Override
	public CommerceDiscount[] findByC_C_PrevAndNext(long commerceDiscountId,
		...
		try {
			...
			array[0] = getByC_C_PrevAndNext(session, commerceDiscount,
					companyId, couponCode, orderByComparator, true);

			array[1] = commerceDiscount;

			array[2] = getByC_C_PrevAndNext(session, commerceDiscount,
	...
	protected CommerceDiscount getByC_C_PrevAndNext(Session session,
	...
	public void removeByC_C(long companyId, String couponCode) {
		for (CommerceDiscount commerceDiscount : findByC_C(companyId,
				couponCode, QueryUtil.ALL_POS, QueryUtil.ALL_POS, null)) {
			remove(commerceDiscount);
		}
	}
	...
	private static final String _FINDER_COLUMN_C_C_COUPONCODE_1 = "commerceDiscount.couponCode IS NULL";

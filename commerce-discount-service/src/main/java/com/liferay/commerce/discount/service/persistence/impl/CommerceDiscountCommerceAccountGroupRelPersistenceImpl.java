 ...
 * @see com.liferay.commerce.discount.service.persistence.CommerceDiscountCommerceAccountGroupRelUtil
 * @generated
 */
@ProviderType
public class CommerceDiscountCommerceAccountGroupRelPersistenceImpl
	 ...
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link CommerceDiscountCommerceAccountGroupRelUtil} to access the commerce discount commerce account group rel persistence. Modify <code>service.xml</code> and rerun ServiceBuilder to regenerate this class.
	 */
	...
	public static final String FINDER_CLASS_NAME_LIST_WITHOUT_PAGINATION = FINDER_CLASS_NAME_ENTITY +
		".List2";
	public static final FinderPath FINDER_PATH_WITH_PAGINATION_FIND_ALL = new FinderPath(CommerceDiscountCommerceAccountGroupRelModelImpl.ENTITY_CACHE_ENABLED,
			CommerceDiscountCommerceAccountGroupRelModelImpl.FINDER_CACHE_ENABLED,
			CommerceDiscountCommerceAccountGroupRelImpl.class,
			FINDER_CLASS_NAME_LIST_WITH_PAGINATION, "findAll", new String[0]);
	public static final FinderPath FINDER_PATH_WITHOUT_PAGINATION_FIND_ALL = new FinderPath(CommerceDiscountCommerceAccountGroupRelModelImpl.ENTITY_CACHE_ENABLED,
			CommerceDiscountCommerceAccountGroupRelModelImpl.FINDER_CACHE_ENABLED,
			CommerceDiscountCommerceAccountGroupRelImpl.class,
			FINDER_CLASS_NAME_LIST_WITHOUT_PAGINATION, "findAll", new String[0]);
	public static final FinderPath FINDER_PATH_COUNT_ALL = new FinderPath(CommerceDiscountCommerceAccountGroupRelModelImpl.ENTITY_CACHE_ENABLED,
			CommerceDiscountCommerceAccountGroupRelModelImpl.FINDER_CACHE_ENABLED,
			Long.class, FINDER_CLASS_NAME_LIST_WITHOUT_PAGINATION, "countAll",
			new String[0]);
	public static final FinderPath FINDER_PATH_WITH_PAGINATION_FIND_BY_COMMERCEDISCOUNTID =
		new FinderPath(CommerceDiscountCommerceAccountGroupRelModelImpl.ENTITY_CACHE_ENABLED,
			CommerceDiscountCommerceAccountGroupRelModelImpl.FINDER_CACHE_ENABLED,
			CommerceDiscountCommerceAccountGroupRelImpl.class,
	...
	public static final FinderPath FINDER_PATH_WITHOUT_PAGINATION_FIND_BY_COMMERCEDISCOUNTID =
		new FinderPath(CommerceDiscountCommerceAccountGroupRelModelImpl.ENTITY_CACHE_ENABLED,
			...
			CommerceDiscountCommerceAccountGroupRelModelImpl.COMMERCEDISCOUNTID_COLUMN_BITMASK |
			CommerceDiscountCommerceAccountGroupRelModelImpl.CREATEDATE_COLUMN_BITMASK);
	public static final FinderPath FINDER_PATH_COUNT_BY_COMMERCEDISCOUNTID = new FinderPath(CommerceDiscountCommerceAccountGroupRelModelImpl.ENTITY_CACHE_ENABLED,
			CommerceDiscountCommerceAccountGroupRelModelImpl.FINDER_CACHE_ENABLED,
	 ...
	 */
	@Override
	public List<CommerceDiscountCommerceAccountGroupRel> findByCommerceDiscountId(
	...
	public List<CommerceDiscountCommerceAccountGroupRel> findByCommerceDiscountId(
		long commerceDiscountId, int start, int end,
		OrderByComparator<CommerceDiscountCommerceAccountGroupRel> orderByComparator) {
	...
	public List<CommerceDiscountCommerceAccountGroupRel> findByCommerceDiscountId(
		...
		if (retrieveFromCache) {
			list = (List<CommerceDiscountCommerceAccountGroupRel>)finderCache.getResult(finderPath,
					finderArgs, this);

			if ((list != null) && !list.isEmpty()) {
				for (CommerceDiscountCommerceAccountGroupRel commerceDiscountCommerceAccountGroupRel : list) {
					if ((commerceDiscountId != commerceDiscountCommerceAccountGroupRel.getCommerceDiscountId())) {
						list = null;
		...
		if (list == null) {
			...
			if (orderByComparator != null) {
			 ...
			 if (pagination) {
				query.append(CommerceDiscountCommerceAccountGroupRelModelImpl.ORDER_BY_JPQL);
			}
			...
			try {
				...
				if (!pagination) {
					list = (List<CommerceDiscountCommerceAccountGroupRel>)QueryUtil.list(q,
	 ...
	 */
	@Override
	public CommerceDiscountCommerceAccountGroupRel findByCommerceDiscountId_First(
		long commerceDiscountId,
		OrderByComparator<CommerceDiscountCommerceAccountGroupRel> orderByComparator)
		...
		throw new NoSuchDiscountCommerceAccountGroupRelException(msg.toString());
	}
	 ...
	 */
	@Override
	public CommerceDiscountCommerceAccountGroupRel fetchByCommerceDiscountId_First(
		long commerceDiscountId,
		OrderByComparator<CommerceDiscountCommerceAccountGroupRel> orderByComparator) {
		List<CommerceDiscountCommerceAccountGroupRel> list = findByCommerceDiscountId(commerceDiscountId,
	 ...
	 */
	@Override
	public CommerceDiscountCommerceAccountGroupRel findByCommerceDiscountId_Last(
		long commerceDiscountId,
		OrderByComparator<CommerceDiscountCommerceAccountGroupRel> orderByComparator)
		throws NoSuchDiscountCommerceAccountGroupRelException {
		CommerceDiscountCommerceAccountGroupRel commerceDiscountCommerceAccountGroupRel =
	 ...
	 */
	@Override
	public CommerceDiscountCommerceAccountGroupRel fetchByCommerceDiscountId_Last(
		long commerceDiscountId,
		OrderByComparator<CommerceDiscountCommerceAccountGroupRel> orderByComparator) {
	 ...
	 */
	@Override
	public CommerceDiscountCommerceAccountGroupRel[] findByCommerceDiscountId_PrevAndNext(
		...
		try {
			...
			CommerceDiscountCommerceAccountGroupRel[] array = new CommerceDiscountCommerceAccountGroupRelImpl[3];
	...
	protected CommerceDiscountCommerceAccountGroupRel getByCommerceDiscountId_PrevAndNext(
		Session session,
		CommerceDiscountCommerceAccountGroupRel commerceDiscountCommerceAccountGroupRel,
		long commerceDiscountId,
		OrderByComparator<CommerceDiscountCommerceAccountGroupRel> orderByComparator,
		...
		if (orderByComparator != null) {
			Object[] values = orderByComparator.getOrderByConditionValues(commerceDiscountCommerceAccountGroupRel);
	...
	public void removeByCommerceDiscountId(long commerceDiscountId) {
		for (CommerceDiscountCommerceAccountGroupRel commerceDiscountCommerceAccountGroupRel : findByCommerceDiscountId(
	...
	public int countByCommerceDiscountId(long commerceDiscountId) {
		...
		if (count == null) {
			...
			query.append(_SQL_COUNT_COMMERCEDISCOUNTCOMMERCEACCOUNTGROUPREL_WHERE);
	...
	public static final FinderPath FINDER_PATH_WITHOUT_PAGINATION_FIND_BY_COMMERCEACCOUNTGROUPID =
		new FinderPath(CommerceDiscountCommerceAccountGroupRelModelImpl.ENTITY_CACHE_ENABLED,
			...
			CommerceDiscountCommerceAccountGroupRelModelImpl.COMMERCEACCOUNTGROUPID_COLUMN_BITMASK |
			CommerceDiscountCommerceAccountGroupRelModelImpl.CREATEDATE_COLUMN_BITMASK);
	public static final FinderPath FINDER_PATH_COUNT_BY_COMMERCEACCOUNTGROUPID = new FinderPath(CommerceDiscountCommerceAccountGroupRelModelImpl.ENTITY_CACHE_ENABLED,
			CommerceDiscountCommerceAccountGroupRelModelImpl.FINDER_CACHE_ENABLED,
			Long.class, FINDER_CLASS_NAME_LIST_WITHOUT_PAGINATION,
	 ...
	 */
	@Override
	public List<CommerceDiscountCommerceAccountGroupRel> findByCommerceAccountGroupId(
	...
	public List<CommerceDiscountCommerceAccountGroupRel> findByCommerceAccountGroupId(
		...
		if (retrieveFromCache) {
			...
			if ((list != null) && !list.isEmpty()) {
				for (CommerceDiscountCommerceAccountGroupRel commerceDiscountCommerceAccountGroupRel : list) {
					if ((commerceAccountGroupId != commerceDiscountCommerceAccountGroupRel.getCommerceAccountGroupId())) {
						list = null;
	 ...
	 */
	@Override
	public CommerceDiscountCommerceAccountGroupRel findByCommerceAccountGroupId_First(
		long commerceAccountGroupId,
		OrderByComparator<CommerceDiscountCommerceAccountGroupRel> orderByComparator)
		throws NoSuchDiscountCommerceAccountGroupRelException {
		CommerceDiscountCommerceAccountGroupRel commerceDiscountCommerceAccountGroupRel =
	 ...
	 */
	@Override
	public CommerceDiscountCommerceAccountGroupRel fetchByCommerceAccountGroupId_First(
		long commerceAccountGroupId,
		OrderByComparator<CommerceDiscountCommerceAccountGroupRel> orderByComparator) {
		List<CommerceDiscountCommerceAccountGroupRel> list = findByCommerceAccountGroupId(commerceAccountGroupId,
				0, 1, orderByComparator);
	 ...
	 */
	@Override
	public CommerceDiscountCommerceAccountGroupRel findByCommerceAccountGroupId_Last(
		long commerceAccountGroupId,
		OrderByComparator<CommerceDiscountCommerceAccountGroupRel> orderByComparator)
		throws NoSuchDiscountCommerceAccountGroupRelException {
		CommerceDiscountCommerceAccountGroupRel commerceDiscountCommerceAccountGroupRel =
	 ...
	 */
	@Override
	public CommerceDiscountCommerceAccountGroupRel fetchByCommerceAccountGroupId_Last(
		long commerceAccountGroupId,
		OrderByComparator<CommerceDiscountCommerceAccountGroupRel> orderByComparator) {
	 ...
	 */
	@Override
	public CommerceDiscountCommerceAccountGroupRel[] findByCommerceAccountGroupId_PrevAndNext(
		long commerceDiscountCommerceAccountGroupRelId,
		long commerceAccountGroupId,
		OrderByComparator<CommerceDiscountCommerceAccountGroupRel> orderByComparator)
		throws NoSuchDiscountCommerceAccountGroupRelException {
	...
	protected CommerceDiscountCommerceAccountGroupRel getByCommerceAccountGroupId_PrevAndNext(
		Session session,
		CommerceDiscountCommerceAccountGroupRel commerceDiscountCommerceAccountGroupRel,
		long commerceAccountGroupId,
		OrderByComparator<CommerceDiscountCommerceAccountGroupRel> orderByComparator,
	...
	public void removeByCommerceAccountGroupId(long commerceAccountGroupId) {
		for (CommerceDiscountCommerceAccountGroupRel commerceDiscountCommerceAccountGroupRel : findByCommerceAccountGroupId(
	...
	public CommerceDiscountCommerceAccountGroupRelPersistenceImpl() {
		...
		try {
			...
			dbColumnNames.put("commerceDiscountCommerceAccountGroupRelId",
	...
	public void cacheResult(
		CommerceDiscountCommerceAccountGroupRel commerceDiscountCommerceAccountGroupRel) {
		entityCache.putResult(CommerceDiscountCommerceAccountGroupRelModelImpl.ENTITY_CACHE_ENABLED,
			CommerceDiscountCommerceAccountGroupRelImpl.class,
	...
	@Override
	public void cacheResult(
		List<CommerceDiscountCommerceAccountGroupRel> commerceDiscountCommerceAccountGroupRels) {
		for (CommerceDiscountCommerceAccountGroupRel commerceDiscountCommerceAccountGroupRel : commerceDiscountCommerceAccountGroupRels) {
			if (entityCache.getResult(
						CommerceDiscountCommerceAccountGroupRelModelImpl.ENTITY_CACHE_ENABLED,
						CommerceDiscountCommerceAccountGroupRelImpl.class,
						commerceDiscountCommerceAccountGroupRel.getPrimaryKey()) == null) {
	...
	public void clearCache() {
		entityCache.clearCache(CommerceDiscountCommerceAccountGroupRelImpl.class);
	...
	public void clearCache(
		CommerceDiscountCommerceAccountGroupRel commerceDiscountCommerceAccountGroupRel) {
		entityCache.removeResult(CommerceDiscountCommerceAccountGroupRelModelImpl.ENTITY_CACHE_ENABLED,
			CommerceDiscountCommerceAccountGroupRelImpl.class,
			commerceDiscountCommerceAccountGroupRel.getPrimaryKey());
	...
	public CommerceDiscountCommerceAccountGroupRel create(
		...
		commerceDiscountCommerceAccountGroupRel.setPrimaryKey(commerceDiscountCommerceAccountGroupRelId);

		commerceDiscountCommerceAccountGroupRel.setCompanyId(companyProvider.getCompanyId());
	...
	public CommerceDiscountCommerceAccountGroupRel remove(
		...
		try {
			...
			CommerceDiscountCommerceAccountGroupRel commerceDiscountCommerceAccountGroupRel =
				(CommerceDiscountCommerceAccountGroupRel)session.get(CommerceDiscountCommerceAccountGroupRelImpl.class,
					primaryKey);
			...
			if (commerceDiscountCommerceAccountGroupRel == null) {
				...
				throw new NoSuchDiscountCommerceAccountGroupRelException(_NO_SUCH_ENTITY_WITH_PRIMARY_KEY +
					primaryKey);
			}
	...
	protected CommerceDiscountCommerceAccountGroupRel removeImpl(
		...
		try {
			...
			if (!session.contains(commerceDiscountCommerceAccountGroupRel)) {
				commerceDiscountCommerceAccountGroupRel = (CommerceDiscountCommerceAccountGroupRel)session.get(CommerceDiscountCommerceAccountGroupRelImpl.class,
	...
	public CommerceDiscountCommerceAccountGroupRel updateImpl(
		...
		if (!(commerceDiscountCommerceAccountGroupRel instanceof CommerceDiscountCommerceAccountGroupRelModelImpl)) {
			...
			if (ProxyUtil.isProxyClass(
				...
				invocationHandler = ProxyUtil.getInvocationHandler(commerceDiscountCommerceAccountGroupRel);
		...
		CommerceDiscountCommerceAccountGroupRelModelImpl commerceDiscountCommerceAccountGroupRelModelImpl =
			(CommerceDiscountCommerceAccountGroupRelModelImpl)commerceDiscountCommerceAccountGroupRel;
		...
		if (isNew &&
			...
			if (serviceContext == null) {
				...
				commerceDiscountCommerceAccountGroupRel.setCreateDate(serviceContext.getCreateDate(
						now));
			}
		}
		...
		if (!commerceDiscountCommerceAccountGroupRelModelImpl.hasSetModifiedDate()) {
			if (serviceContext == null) {
				...
				commerceDiscountCommerceAccountGroupRel.setModifiedDate(serviceContext.getModifiedDate(
						now));
			}
		}
		...
		try {
			...
			if (commerceDiscountCommerceAccountGroupRel.isNew()) {
				...
				commerceDiscountCommerceAccountGroupRel = (CommerceDiscountCommerceAccountGroupRel)session.merge(commerceDiscountCommerceAccountGroupRel);
			}
		}
		catch (Exception e) {
			throw processException(e);
		...
		if (!CommerceDiscountCommerceAccountGroupRelModelImpl.COLUMN_BITMASK_ENABLED) {
			finderCache.clearCache(FINDER_CLASS_NAME_LIST_WITHOUT_PAGINATION);
		}
		else
		 if (isNew) {
			Object[] args = new Object[] {
					commerceDiscountCommerceAccountGroupRelModelImpl.getCommerceDiscountId()
				};
			...
			args = new Object[] {
					commerceDiscountCommerceAccountGroupRelModelImpl.getCommerceAccountGroupId()
				};
			...
			if ((commerceDiscountCommerceAccountGroupRelModelImpl.getColumnBitmask() &
					FINDER_PATH_WITHOUT_PAGINATION_FIND_BY_COMMERCEDISCOUNTID.getColumnBitmask()) != 0) {
				Object[] args = new Object[] {
						commerceDiscountCommerceAccountGroupRelModelImpl.getOriginalCommerceDiscountId()
					};
			...
			if ((commerceDiscountCommerceAccountGroupRelModelImpl.getColumnBitmask() &
				...
				Object[] args = new Object[] {
						commerceDiscountCommerceAccountGroupRelModelImpl.getOriginalCommerceAccountGroupId()
					};
	...
	/**
	 * Returns the commerce discount commerce account group rel with the primary key or throws a {@link com.liferay.portal.kernel.exception.NoSuchModelException} if it could not be found.
	 *
	 * @param primaryKey the primary key of the commerce discount commerce account group rel
	...
	/**
	 * Returns the commerce discount commerce account group rel with the primary key or throws a {@link NoSuchDiscountCommerceAccountGroupRelException} if it could not be found.
	 *
	 * @param commerceDiscountCommerceAccountGroupRelId the primary key of the commerce discount commerce account group rel
	 * @return the commerce discount commerce account group rel
	 * @throws NoSuchDiscountCommerceAccountGroupRelException if a commerce discount commerce account group rel with the primary key could not be found
	...
	public CommerceDiscountCommerceAccountGroupRel findByPrimaryKey(
		long commerceDiscountCommerceAccountGroupRelId)
		throws NoSuchDiscountCommerceAccountGroupRelException {
		return findByPrimaryKey((Serializable)commerceDiscountCommerceAccountGroupRelId);
	}
	...
	public CommerceDiscountCommerceAccountGroupRel fetchByPrimaryKey(
		Serializable primaryKey) {
		Serializable serializable = entityCache.getResult(CommerceDiscountCommerceAccountGroupRelModelImpl.ENTITY_CACHE_ENABLED,
	...
	public CommerceDiscountCommerceAccountGroupRel fetchByPrimaryKey(
		long commerceDiscountCommerceAccountGroupRelId) {
		return fetchByPrimaryKey((Serializable)commerceDiscountCommerceAccountGroupRelId);
	}

	@Override
	public Map<Serializable, CommerceDiscountCommerceAccountGroupRel> fetchByPrimaryKeys(
		Set<Serializable> primaryKeys) {
		if (primaryKeys.isEmpty()) {
			return Collections.emptyMap();
		}

		Map<Serializable, CommerceDiscountCommerceAccountGroupRel> map = new HashMap<Serializable, CommerceDiscountCommerceAccountGroupRel>();
		...
		query.append(_SQL_SELECT_COMMERCEDISCOUNTCOMMERCEACCOUNTGROUPREL_WHERE_PKS_IN);
		...
		try {
			...
			for (CommerceDiscountCommerceAccountGroupRel commerceDiscountCommerceAccountGroupRel : (List<CommerceDiscountCommerceAccountGroupRel>)q.list()) {
				map.put(commerceDiscountCommerceAccountGroupRel.getPrimaryKeyObj(),
					commerceDiscountCommerceAccountGroupRel);

				cacheResult(commerceDiscountCommerceAccountGroupRel);

				uncachedPrimaryKeys.remove(commerceDiscountCommerceAccountGroupRel.getPrimaryKeyObj());
			}
	 ...
	 */
	@Override
	public List<CommerceDiscountCommerceAccountGroupRel> findAll(int start,
		int end) {
	...
	public List<CommerceDiscountCommerceAccountGroupRel> findAll(int start,
		...
		if (list == null) {
			...
			if (orderByComparator != null) {
				...
				query.append(_SQL_SELECT_COMMERCEDISCOUNTCOMMERCEACCOUNTGROUPREL);
				...
				if (pagination) {
					sql = sql.concat(CommerceDiscountCommerceAccountGroupRelModelImpl.ORDER_BY_JPQL);
				}
			}
	...
	public void removeAll() {
		for (CommerceDiscountCommerceAccountGroupRel commerceDiscountCommerceAccountGroupRel : findAll()) {
			remove(commerceDiscountCommerceAccountGroupRel);
		}
	}
	...
	public int countAll() {
		...
		if (count == null) {
			...
			try {
				...
				Query q = session.createQuery(_SQL_COUNT_COMMERCEDISCOUNTCOMMERCEACCOUNTGROUPREL);
	...
	public void destroy() {
		entityCache.removeCache(CommerceDiscountCommerceAccountGroupRelImpl.class.getName());
	...
	private static final String _SQL_SELECT_COMMERCEDISCOUNTCOMMERCEACCOUNTGROUPREL =
	...
	private static final String _SQL_SELECT_COMMERCEDISCOUNTCOMMERCEACCOUNTGROUPREL_WHERE_PKS_IN =
	...
	private static final String _SQL_SELECT_COMMERCEDISCOUNTCOMMERCEACCOUNTGROUPREL_WHERE =
	...
	private static final String _SQL_COUNT_COMMERCEDISCOUNTCOMMERCEACCOUNTGROUPREL =
	...
	private static final String _SQL_COUNT_COMMERCEDISCOUNTCOMMERCEACCOUNTGROUPREL_WHERE =

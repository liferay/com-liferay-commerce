...
public class CommerceDiscountCommerceAccountGroupRelCacheModel
	...
	public boolean equals(Object obj) {
		...
		if (!(obj instanceof CommerceDiscountCommerceAccountGroupRelCacheModel)) {
			return false;
		}

		CommerceDiscountCommerceAccountGroupRelCacheModel commerceDiscountCommerceAccountGroupRelCacheModel =
			(CommerceDiscountCommerceAccountGroupRelCacheModel)obj;

		if (commerceDiscountCommerceAccountGroupRelId == commerceDiscountCommerceAccountGroupRelCacheModel.commerceDiscountCommerceAccountGroupRelId) {
			return true;
		}
	...
	public CommerceDiscountCommerceAccountGroupRel toEntityModel() {
		CommerceDiscountCommerceAccountGroupRelImpl commerceDiscountCommerceAccountGroupRelImpl =
			new CommerceDiscountCommerceAccountGroupRelImpl();

		commerceDiscountCommerceAccountGroupRelImpl.setCommerceDiscountCommerceAccountGroupRelId(commerceDiscountCommerceAccountGroupRelId);
		commerceDiscountCommerceAccountGroupRelImpl.setGroupId(groupId);
		...
		if (createDate == Long.MIN_VALUE) {
			...
			commerceDiscountCommerceAccountGroupRelImpl.setCreateDate(new Date(
					createDate));
		}
		...
		if (modifiedDate == Long.MIN_VALUE) {
			...
			commerceDiscountCommerceAccountGroupRelImpl.setModifiedDate(new Date(
					modifiedDate));
		}

		commerceDiscountCommerceAccountGroupRelImpl.setCommerceDiscountId(commerceDiscountId);
		commerceDiscountCommerceAccountGroupRelImpl.setCommerceAccountGroupId(commerceAccountGroupId);

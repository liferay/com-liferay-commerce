...
public interface CommerceVirtualOrderItemPersistence extends BasePersistence<CommerceVirtualOrderItem> {
	...
	*/
	public java.util.List<CommerceVirtualOrderItem> findByUuid(String uuid,
		int start, int end,
		com.liferay.portal.kernel.util.OrderByComparator<CommerceVirtualOrderItem> orderByComparator);
	...
	* @return the matching commerce virtual order items
	*/
	public java.util.List<CommerceVirtualOrderItem> findByUuid_C(String uuid,
		long companyId);
	...
	*/
	...
	@Override
	public java.util.Map<java.io.Serializable, CommerceVirtualOrderItem> fetchByPrimaryKeys(

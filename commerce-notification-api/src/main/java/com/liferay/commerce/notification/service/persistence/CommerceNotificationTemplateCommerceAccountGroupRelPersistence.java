...
public interface CommerceNotificationTemplateCommerceAccountGroupRelPersistence
	extends BasePersistence<CommerceNotificationTemplateCommerceAccountGroupRel> {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	...
	*/
	public java.util.List<CommerceNotificationTemplateCommerceAccountGroupRel> findByCommerceAccountGroupId(
	...
	* @return the matching commerce notification template commerce account group rels
	*/
	public java.util.List<CommerceNotificationTemplateCommerceAccountGroupRel> findByCommerceNotificationTemplateId(
	...
	*/
	public void cacheResult(
		java.util.List<CommerceNotificationTemplateCommerceAccountGroupRel> commerceNotificationTemplateCommerceAccountGroupRels);
	...
	*/
	...
	@Override
	public java.util.Map<java.io.Serializable, CommerceNotificationTemplateCommerceAccountGroupRel> fetchByPrimaryKeys(
	...
	*/
	public java.util.List<CommerceNotificationTemplateCommerceAccountGroupRel> findAll();

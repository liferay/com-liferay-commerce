...
public interface CommerceNotificationTemplateUserSegmentRelLocalService
	 ...
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link CommerceNotificationTemplateUserSegmentRelLocalServiceUtil} to access the commerce notification template user segment rel local service. Add custom service methods to <code>com.liferay.commerce.notification.service.impl.CommerceNotificationTemplateUserSegmentRelLocalServiceImpl</code> and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */

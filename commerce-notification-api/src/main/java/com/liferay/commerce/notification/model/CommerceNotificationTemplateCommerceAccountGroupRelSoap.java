 ...
 * @see com.liferay.commerce.notification.service.http.CommerceNotificationTemplateCommerceAccountGroupRelServiceSoap
 * @generated
 */
@ProviderType
public class CommerceNotificationTemplateCommerceAccountGroupRelSoap
	implements Serializable {
	public static CommerceNotificationTemplateCommerceAccountGroupRelSoap toSoapModel(
		CommerceNotificationTemplateCommerceAccountGroupRel model) {
		CommerceNotificationTemplateCommerceAccountGroupRelSoap soapModel = new CommerceNotificationTemplateCommerceAccountGroupRelSoap();

		soapModel.setCommerceNotificationTemplateCommerceAccountGroupRelId(model.getCommerceNotificationTemplateCommerceAccountGroupRelId());
	...
	public static CommerceNotificationTemplateCommerceAccountGroupRelSoap[] toSoapModels(
		CommerceNotificationTemplateCommerceAccountGroupRel[] models) {
		CommerceNotificationTemplateCommerceAccountGroupRelSoap[] soapModels = new CommerceNotificationTemplateCommerceAccountGroupRelSoap[models.length];
	...
	public static CommerceNotificationTemplateCommerceAccountGroupRelSoap[][] toSoapModels(
		CommerceNotificationTemplateCommerceAccountGroupRel[][] models) {
		CommerceNotificationTemplateCommerceAccountGroupRelSoap[][] soapModels = null;

		if (models.length > 0) {
			soapModels = new CommerceNotificationTemplateCommerceAccountGroupRelSoap[models.length][models[0].length];
		}
		else {
			soapModels = new CommerceNotificationTemplateCommerceAccountGroupRelSoap[0][0];
		}
	...
	public static CommerceNotificationTemplateCommerceAccountGroupRelSoap[] toSoapModels(
		...
		List<CommerceNotificationTemplateCommerceAccountGroupRelSoap> soapModels =
			new ArrayList<CommerceNotificationTemplateCommerceAccountGroupRelSoap>(models.size());

		for (CommerceNotificationTemplateCommerceAccountGroupRel model : models) {
			soapModels.add(toSoapModel(model));
		}

		return soapModels.toArray(new CommerceNotificationTemplateCommerceAccountGroupRelSoap[soapModels.size()]);
	}

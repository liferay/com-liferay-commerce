...
public interface CommerceNotificationQueueEntryPersistence
	...
	* @return the matching commerce notification queue entries
	*/
	public java.util.List<CommerceNotificationQueueEntry> findByCommerceNotificationTemplateId(
	...
	*/
	public void cacheResult(
		java.util.List<CommerceNotificationQueueEntry> commerceNotificationQueueEntries);
	...
	*/
	...
	@Override
	public java.util.Map<java.io.Serializable, CommerceNotificationQueueEntry> fetchByPrimaryKeys(
	...
	*/
	public java.util.List<CommerceNotificationQueueEntry> findAll(int start,
		int end);

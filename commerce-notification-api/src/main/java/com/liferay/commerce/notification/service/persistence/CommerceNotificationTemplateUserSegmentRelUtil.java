...
/**
 * The persistence utility for the commerce notification template user segment rel service. This utility wraps <code>com.liferay.commerce.notification.service.persistence.impl.CommerceNotificationTemplateUserSegmentRelPersistenceImpl</code> and provides direct access to the database for CRUD operations. This utility should only be used by the service layer, as it must operate within a transaction. Never access this utility in a JSP, controller, model, or other front-end class.
 *
 * <p>
...
public class CommerceNotificationTemplateUserSegmentRelUtil {
	 ...
	 */
	public static Map<Serializable, CommerceNotificationTemplateUserSegmentRel>
	...
	public static CommerceNotificationTemplateUserSegmentRel update(
		...
		return getPersistence().update(
			commerceNotificationTemplateUserSegmentRel, serviceContext);
	}
	 ...
	 */
	public static CommerceNotificationTemplateUserSegmentRel
			findByCommerceUserSegmentEntryId_First(
				long commerceUserSegmentEntryId,
				OrderByComparator<CommerceNotificationTemplateUserSegmentRel>
					orderByComparator)
		throws com.liferay.commerce.notification.exception.
			NoSuchNotificationTemplateUserSegmentRelException {
	...
	public static CommerceNotificationTemplateUserSegmentRelPersistence
		getPersistence() {
	...
	private static ServiceTracker
		<CommerceNotificationTemplateUserSegmentRelPersistence,
		 CommerceNotificationTemplateUserSegmentRelPersistence> _serviceTracker;

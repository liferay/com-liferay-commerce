 ...
 * {@link com.liferay.commerce.notification.service.impl.CommerceNotificationAttachmentLocalServiceImpl} and is the
 ...
 * @see com.liferay.commerce.notification.service.base.CommerceNotificationAttachmentLocalServiceBaseImpl
...
public class CommerceNotificationAttachmentLocalServiceUtil {
	 ...
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this class directly. Add custom service methods to {@link com.liferay.commerce.notification.service.impl.CommerceNotificationAttachmentLocalServiceImpl} and rerun ServiceBuilder to regenerate this class.
	 */
	...
	*/
	public static com.liferay.commerce.notification.model.CommerceNotificationAttachment addCommerceNotificationAttachment(
	...
	public static com.liferay.commerce.notification.model.CommerceNotificationAttachment addCommerceNotificationAttachment(
		...
		return getService()
				   .addCommerceNotificationAttachment(commerceNotificationQueueEntryId,
	...
	*/
	public static com.liferay.commerce.notification.model.CommerceNotificationAttachment createCommerceNotificationAttachment(
		long commerceNotificationAttachmentId) {
		return getService()
				   .createCommerceNotificationAttachment(commerceNotificationAttachmentId);
	}
	...
	*/
	public static com.liferay.commerce.notification.model.CommerceNotificationAttachment deleteCommerceNotificationAttachment(
		com.liferay.commerce.notification.model.CommerceNotificationAttachment commerceNotificationAttachment) {
		return getService()
				   .deleteCommerceNotificationAttachment(commerceNotificationAttachment);
	}
	...
	*/
	public static com.liferay.commerce.notification.model.CommerceNotificationAttachment deleteCommerceNotificationAttachment(
		...
		throws com.liferay.portal.kernel.exception.PortalException {
		return getService()
				   .deleteCommerceNotificationAttachment(commerceNotificationAttachmentId);
	}

	public static void deleteCommerceNotificationAttachments(
		long commerceNotificationQueueEntryId) {
		getService()
			.deleteCommerceNotificationAttachments(commerceNotificationQueueEntryId);
	}
	...
	*/
	...
	public static com.liferay.commerce.notification.model.CommerceNotificationAttachment fetchCommerceNotificationAttachment(
		long commerceNotificationAttachmentId) {
		return getService()
				   .fetchCommerceNotificationAttachment(commerceNotificationAttachmentId);
	}
	...
	*/
	public static com.liferay.commerce.notification.model.CommerceNotificationAttachment fetchCommerceNotificationAttachmentByUuidAndGroupId(
		String uuid, long groupId) {
		return getService()
				   .fetchCommerceNotificationAttachmentByUuidAndGroupId(uuid,
			groupId);
	}
	...
	* @throws PortalException if a commerce notification attachment with the primary key could not be found
	*/
	public static com.liferay.commerce.notification.model.CommerceNotificationAttachment getCommerceNotificationAttachment(
		long commerceNotificationAttachmentId)
		throws com.liferay.portal.kernel.exception.PortalException {
		return getService()
	...
	*/
	public static com.liferay.commerce.notification.model.CommerceNotificationAttachment getCommerceNotificationAttachmentByUuidAndGroupId(
		String uuid, long groupId)
		throws com.liferay.portal.kernel.exception.PortalException {
		return getService()
				   .getCommerceNotificationAttachmentByUuidAndGroupId(uuid,
			groupId);
	}
	...
	*/
	public static java.util.List<com.liferay.commerce.notification.model.CommerceNotificationAttachment> getCommerceNotificationAttachments(
		int start, int end) {
	...
	public static java.util.List<com.liferay.commerce.notification.model.CommerceNotificationAttachment> getCommerceNotificationAttachments(
		...
		return getService()
				   .getCommerceNotificationAttachments(commerceNotificationQueueEntryId,
	...
	*/
	public static java.util.List<com.liferay.commerce.notification.model.CommerceNotificationAttachment> getCommerceNotificationAttachmentsByUuidAndCompanyId(
		String uuid, long companyId) {
		return getService()
				   .getCommerceNotificationAttachmentsByUuidAndCompanyId(uuid,
			companyId);
	}
	...
	*/
	public static com.liferay.commerce.notification.model.CommerceNotificationAttachment updateCommerceNotificationAttachment(
		com.liferay.commerce.notification.model.CommerceNotificationAttachment commerceNotificationAttachment) {
		return getService()
	...
	private static ServiceTracker<CommerceNotificationAttachmentLocalService, CommerceNotificationAttachmentLocalService> _serviceTracker;

	static {
		Bundle bundle = FrameworkUtil.getBundle(CommerceNotificationAttachmentLocalService.class);

		ServiceTracker<CommerceNotificationAttachmentLocalService, CommerceNotificationAttachmentLocalService> serviceTracker =
			new ServiceTracker<CommerceNotificationAttachmentLocalService, CommerceNotificationAttachmentLocalService>(bundle.getBundleContext(),
				CommerceNotificationAttachmentLocalService.class, null);

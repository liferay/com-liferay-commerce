...
public class QuantitySelectorItemRenderer implements InfoItemRenderer<CPCatalogEntry> {
    ...
    private static final Log _log = LogFactoryUtil.getLog(QuantitySelectorItemRenderer.class);
}

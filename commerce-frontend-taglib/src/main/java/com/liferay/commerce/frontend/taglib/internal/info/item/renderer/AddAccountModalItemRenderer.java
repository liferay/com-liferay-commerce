...
public class AddAccountModalItemRenderer implements InfoItemRenderer<CPCatalogEntry> {
    ...
    private static final Log _log = LogFactoryUtil.getLog(AddAccountModalItemRenderer.class);
}

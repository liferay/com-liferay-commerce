...
public class SearchBarItemRenderer implements InfoItemRenderer<CPCatalogEntry> {
    ...
    private static final Log _log = LogFactoryUtil.getLog(SearchBarItemRenderer.class);
}

 ...
 */
@Component(
	immediate = true, service = UserInvitationModalItemRendererUtil.class
)
public class UserInvitationModalItemRendererUtil {
	...
	@Reference(unbind = "-")
	protected void setUserInvitationModalItemRenderer(
		UserInvitationModalItemRenderer userInvitationModalItemRenderer) {
	...
	private static UserInvitationModalItemRendererUtil
		_userInvitationModalItemRendererUtil;

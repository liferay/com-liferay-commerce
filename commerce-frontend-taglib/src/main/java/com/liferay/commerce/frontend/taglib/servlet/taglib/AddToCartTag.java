...
public class AddToCartTag extends IncludeTag {
	...
	public int doStartTag() throws JspException {
		...
		_addToCartItemRenderer = ServletContextUtil.getAddToCartItemRenderer();
	...
	public void setId(String id) {
		_fakeContext.put("id", id);
	}

	public void setCPInstanceId(long productId) {
		// TODO Remove, just to test
		_fakeContext.put("productId", productId);
	}

	private Map<String, Object> _fakeContext = new HashMap<>();

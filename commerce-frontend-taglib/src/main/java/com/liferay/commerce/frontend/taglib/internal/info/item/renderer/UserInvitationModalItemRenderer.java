...
public class UserInvitationModalItemRenderer implements InfoItemRenderer<CPCatalogEntry> {
    ...
    private static final Log _log = LogFactoryUtil.getLog(UserInvitationModalItemRenderer.class);
}

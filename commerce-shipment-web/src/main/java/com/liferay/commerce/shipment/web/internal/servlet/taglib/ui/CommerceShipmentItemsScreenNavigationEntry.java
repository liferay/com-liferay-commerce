...
public class CommerceShipmentItemsScreenNavigationEntry
	implements ScreenNavigationCategory,
			   ScreenNavigationEntry<CommerceShipment> {

	@Override
	public String getCategoryKey() {
		return CommerceShipmentScreenNavigationConstants.CATEGORY_KEY_ITEMS;
	}
	...
	public String getLabel(Locale locale) {
		return LanguageUtil.get(locale, "items");
	}

 ...
 */
@ProviderType
public class CommerceInventoryWarehouseItemQuantityException extends PortalException {
	...
	public CommerceInventoryWarehouseItemQuantityException(String msg, Throwable cause) {
		super(msg, cause);
	}

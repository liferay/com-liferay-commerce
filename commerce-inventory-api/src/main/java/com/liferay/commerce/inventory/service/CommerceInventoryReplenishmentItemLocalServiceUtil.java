 ...
 * {@link com.liferay.commerce.inventory.service.impl.CommerceInventoryReplenishmentItemLocalServiceImpl} and is the
 ...
 * @see com.liferay.commerce.inventory.service.base.CommerceInventoryReplenishmentItemLocalServiceBaseImpl
...
public class CommerceInventoryReplenishmentItemLocalServiceUtil {
	 ...
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this class directly. Add custom service methods to {@link com.liferay.commerce.inventory.service.impl.CommerceInventoryReplenishmentItemLocalServiceImpl} and rerun ServiceBuilder to regenerate this class.
	 */
	...
	*/
	public static com.liferay.commerce.inventory.model.CommerceInventoryReplenishmentItem addCommerceInventoryReplenishmentItem(
	...
	*/
	public static com.liferay.commerce.inventory.model.CommerceInventoryReplenishmentItem createCommerceInventoryReplenishmentItem(
		long commerceInventoryReplenishmentItemId) {
		return getService()
				   .createCommerceInventoryReplenishmentItem(commerceInventoryReplenishmentItemId);
	}
	...
	*/
	public static com.liferay.commerce.inventory.model.CommerceInventoryReplenishmentItem deleteCommerceInventoryReplenishmentItem(
		com.liferay.commerce.inventory.model.CommerceInventoryReplenishmentItem commerceInventoryReplenishmentItem) {
		return getService()
				   .deleteCommerceInventoryReplenishmentItem(commerceInventoryReplenishmentItem);
	}
	...
	*/
	public static com.liferay.commerce.inventory.model.CommerceInventoryReplenishmentItem deleteCommerceInventoryReplenishmentItem(
		...
		throws com.liferay.portal.kernel.exception.PortalException {
		return getService()
				   .deleteCommerceInventoryReplenishmentItem(commerceInventoryReplenishmentItemId);
	}
	...
	*/
	...
	public static com.liferay.commerce.inventory.model.CommerceInventoryReplenishmentItem fetchCommerceInventoryReplenishmentItem(
		long commerceInventoryReplenishmentItemId) {
		return getService()
				   .fetchCommerceInventoryReplenishmentItem(commerceInventoryReplenishmentItemId);
	}
	...
	* @throws PortalException if a commerce inventory replenishment item with the primary key could not be found
	*/
	public static com.liferay.commerce.inventory.model.CommerceInventoryReplenishmentItem getCommerceInventoryReplenishmentItem(
		long commerceInventoryReplenishmentItemId)
		throws com.liferay.portal.kernel.exception.PortalException {
		return getService()
				   .getCommerceInventoryReplenishmentItem(commerceInventoryReplenishmentItemId);
	}
	...
	*/
	public static java.util.List<com.liferay.commerce.inventory.model.CommerceInventoryReplenishmentItem> getCommerceInventoryReplenishmentItems(
		int start, int end) {
	...
	*/
	public static com.liferay.commerce.inventory.model.CommerceInventoryReplenishmentItem updateCommerceInventoryReplenishmentItem(
		com.liferay.commerce.inventory.model.CommerceInventoryReplenishmentItem commerceInventoryReplenishmentItem) {
		return getService()
				   .updateCommerceInventoryReplenishmentItem(commerceInventoryReplenishmentItem);
	}
	...
	private static ServiceTracker<CommerceInventoryReplenishmentItemLocalService, CommerceInventoryReplenishmentItemLocalService> _serviceTracker;

	static {
		Bundle bundle = FrameworkUtil.getBundle(CommerceInventoryReplenishmentItemLocalService.class);

		ServiceTracker<CommerceInventoryReplenishmentItemLocalService, CommerceInventoryReplenishmentItemLocalService> serviceTracker =
			new ServiceTracker<CommerceInventoryReplenishmentItemLocalService, CommerceInventoryReplenishmentItemLocalService>(bundle.getBundleContext(),
				CommerceInventoryReplenishmentItemLocalService.class, null);

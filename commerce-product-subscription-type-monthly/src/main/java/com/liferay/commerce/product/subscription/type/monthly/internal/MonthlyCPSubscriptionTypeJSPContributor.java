...
package com.liferay.commerce.product.subscription.type.monthly.internal;

import com.liferay.commerce.product.subscription.type.monthly.internal.display.context.MonthlyCPSubscriptionTypeDisplayContext;
...
@Component(
	immediate = true,
	property = "commerce.product.subscription.type.jsp.contributor.key=" + MonthlyCPSubscriptionTypeImpl.NAME,
...
public class MonthlyCPSubscriptionTypeJSPContributor
	...
	@Reference(
		target = "(osgi.web.symbolicname=com.liferay.commerce.product.subscription.type.monthly)"
	)

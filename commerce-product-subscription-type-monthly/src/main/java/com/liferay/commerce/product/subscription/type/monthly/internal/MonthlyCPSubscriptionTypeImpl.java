...
import com.liferay.commerce.product.subscription.type.monthly.internal.constants.MonthlyCPSubscriptionTypeConstants;
...
@Component(
	immediate = true,
	property = {
		"commerce.product.subscription.type.name=" + MonthlyCPSubscriptionTypeImpl.NAME,
...
public class MonthlyCPSubscriptionTypeImpl implements CPSubscriptionType {
	...
	public Date getSubscriptionNextIterationDate(
		...
		if (monthlyMode ==
				MonthlyCPSubscriptionTypeConstants.MODE_EXACT_DAY_OF_MONTH) {
	...
	public Date getSubscriptionStartDate(
		...
		if (monthlyMode ==
			...
			calendar.set(Calendar.DAY_OF_MONTH, monthDay);
					...
					MonthlyCPSubscriptionTypeConstants.MODE_LAST_DAY_OF_MONTH) {

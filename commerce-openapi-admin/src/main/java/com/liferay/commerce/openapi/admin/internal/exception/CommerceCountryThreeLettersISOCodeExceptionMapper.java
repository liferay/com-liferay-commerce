...
@Provider
public class CommerceCountryThreeLettersISOCodeExceptionMapper
	extends BaseExceptionMapper<CommerceCountryThreeLettersISOCodeException> {

	@Override
	public int getErrorCode() {
		return RESTError.THREE_LETTERS_COUNTRY_ISO_CODE_ERROR.getErrorCode();
	}

	@Override
	public String getErrorDescription() {
		return RESTError.THREE_LETTERS_COUNTRY_ISO_CODE_ERROR.
			getErrorDescription();
	}

	@Override
	public Response.Status getStatus() {
		return RESTError.THREE_LETTERS_COUNTRY_ISO_CODE_ERROR.getStatus();
	}

...
@Provider
public class SearchExceptionMapper
	extends BaseExceptionMapper<SearchException> {

	@Override
	public int getErrorCode() {
		return RESTError.SEARCH_ERROR.getErrorCode();
	}

	@Override
	public String getErrorDescription() {
		return RESTError.SEARCH_ERROR.getErrorDescription();
	}

	@Override
	public Response.Status getStatus() {
		return RESTError.SEARCH_ERROR.getStatus();
	}

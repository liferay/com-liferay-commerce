...
@Provider
public class CommerceCountryTwoLettersISOCodeExceptionMapper
	extends BaseExceptionMapper<CommerceCountryTwoLettersISOCodeException> {

	@Override
	public int getErrorCode() {
		return RESTError.TWO_LETTERS_COUNTRY_ISO_CODE_ERROR.getErrorCode();
	}
	...
	public Response.Status getStatus() {
		return RESTError.TWO_LETTERS_COUNTRY_ISO_CODE_ERROR.getStatus();
	}

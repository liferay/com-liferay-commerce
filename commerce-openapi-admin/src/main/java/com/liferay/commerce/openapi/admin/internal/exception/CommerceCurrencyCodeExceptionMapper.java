...
@Provider
public class CommerceCurrencyCodeExceptionMapper
	extends BaseExceptionMapper<CommerceCurrencyCodeException> {

	@Override
	public int getErrorCode() {
		return RESTError.CURRENCY_CODE_ERROR.getErrorCode();
	}

	@Override
	public String getErrorDescription() {
		return RESTError.CURRENCY_CODE_ERROR.getErrorDescription();
	}

	@Override
	public Response.Status getStatus() {
		return RESTError.CURRENCY_CODE_ERROR.getStatus();
	}

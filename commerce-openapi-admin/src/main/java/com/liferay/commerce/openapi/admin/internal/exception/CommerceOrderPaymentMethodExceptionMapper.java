...
@Provider
public class CommerceOrderPaymentMethodExceptionMapper
	extends BaseExceptionMapper<CommerceOrderPaymentMethodException> {

	@Override
	public int getErrorCode() {
		return RESTError.ORDER_PAYMENT_METHOD_ERROR.getErrorCode();
	}

	@Override
	public String getErrorDescription() {
		return RESTError.ORDER_PAYMENT_METHOD_ERROR.getErrorDescription();
	}

	@Override
	public Response.Status getStatus() {
		return RESTError.ORDER_PAYMENT_METHOD_ERROR.getStatus();
	}

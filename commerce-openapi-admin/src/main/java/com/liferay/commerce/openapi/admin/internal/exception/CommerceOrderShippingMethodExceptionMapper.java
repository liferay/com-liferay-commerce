...
public class CommerceOrderShippingMethodExceptionMapper
	...
	public int getErrorCode() {
		return RESTError.ORDER_SHIPPING_METHOD_ERROR.getErrorCode();
	}

	@Override
	public String getErrorDescription() {
		return RESTError.ORDER_SHIPPING_METHOD_ERROR.getErrorDescription();
	}

	@Override
	public Response.Status getStatus() {
		return RESTError.ORDER_SHIPPING_METHOD_ERROR.getStatus();
	}

...
public class NoSuchCPOptionExceptionMapper
	...
	public int getErrorCode() {
		return RESTError.NO_SUCH_PRODUCT_OPTION.getErrorCode();
	}

	@Override
	public String getErrorDescription() {
		return RESTError.NO_SUCH_PRODUCT_OPTION.getErrorDescription();
	}

	@Override
	public Response.Status getStatus() {
		return RESTError.NO_SUCH_PRODUCT_OPTION.getStatus();
	}

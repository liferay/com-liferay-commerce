...
@Provider
public class CommerceCurrencyNameExceptionMapper
	extends BaseExceptionMapper<CommerceCurrencyNameException> {

	@Override
	public int getErrorCode() {
		return RESTError.CURRENCY_NAME_ERROR.getErrorCode();
	}

	@Override
	public String getErrorDescription() {
		return RESTError.CURRENCY_NAME_ERROR.getErrorDescription();
	}

	@Override
	public Response.Status getStatus() {
		return RESTError.CURRENCY_NAME_ERROR.getStatus();
	}

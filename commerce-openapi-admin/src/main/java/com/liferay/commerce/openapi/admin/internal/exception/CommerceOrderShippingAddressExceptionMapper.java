...
public class CommerceOrderShippingAddressExceptionMapper
	...
	public int getErrorCode() {
		return RESTError.ORDER_SHIPPING_ADDRESS_ERROR.getErrorCode();
	}

	@Override
	public String getErrorDescription() {
		return RESTError.ORDER_SHIPPING_ADDRESS_ERROR.getErrorDescription();
	}

	@Override
	public Response.Status getStatus() {
		return RESTError.ORDER_SHIPPING_ADDRESS_ERROR.getStatus();
	}

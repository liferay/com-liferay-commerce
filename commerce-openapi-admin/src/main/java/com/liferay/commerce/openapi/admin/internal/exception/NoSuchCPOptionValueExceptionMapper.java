...
@Provider
public class NoSuchCPOptionValueExceptionMapper
	extends BaseExceptionMapper<NoSuchCPOptionValueException> {

	@Override
	public int getErrorCode() {
		return RESTError.NO_SUCH_PRODUCT_OPTION_VALUE.getErrorCode();
	}

	@Override
	public String getErrorDescription() {
		return RESTError.NO_SUCH_PRODUCT_OPTION_VALUE.getErrorDescription();
	}

	@Override
	public Response.Status getStatus() {
		return RESTError.NO_SUCH_PRODUCT_OPTION_VALUE.getStatus();
	}

...
@Provider
public class DuplicateCommerceAccountExceptionMapper
	extends BaseExceptionMapper<DuplicateCommerceAccountException> {

	@Override
	public int getErrorCode() {
		return RESTError.DUPLICATE_ACCOUNT.getErrorCode();
	}

	@Override
	public String getErrorDescription() {
		return RESTError.DUPLICATE_ACCOUNT.getErrorDescription();
	}

	@Override
	public Response.Status getStatus() {
		return RESTError.DUPLICATE_ACCOUNT.getStatus();
	}

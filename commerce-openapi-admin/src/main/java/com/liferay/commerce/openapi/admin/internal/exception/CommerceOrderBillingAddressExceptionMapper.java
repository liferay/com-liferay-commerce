...
public class CommerceOrderBillingAddressExceptionMapper
	...
	public int getErrorCode() {
		return RESTError.ORDER_BILLING_ADDRESS_ERROR.getErrorCode();
	}

	@Override
	public String getErrorDescription() {
		return RESTError.ORDER_BILLING_ADDRESS_ERROR.getErrorDescription();
	}

	@Override
	public Response.Status getStatus() {
		return RESTError.ORDER_BILLING_ADDRESS_ERROR.getStatus();
	}

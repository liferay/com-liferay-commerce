...
public class CommerceAddressCountryExceptionMapper
	...
	public int getErrorCode() {
		return RESTError.ADDRESS_COUNTRY_ERROR.getErrorCode();
	}

	@Override
	public String getErrorDescription() {
		return RESTError.ADDRESS_COUNTRY_ERROR.getErrorDescription();
	}

	@Override
	public Response.Status getStatus() {
		return RESTError.ADDRESS_COUNTRY_ERROR.getStatus();
	}

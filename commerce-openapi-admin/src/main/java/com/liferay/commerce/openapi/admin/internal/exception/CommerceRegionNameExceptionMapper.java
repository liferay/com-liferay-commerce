...
@Provider
public class CommerceRegionNameExceptionMapper
	extends BaseExceptionMapper<CommerceRegionNameException> {

	@Override
	public int getErrorCode() {
		return RESTError.REGION_NAME_ERROR.getErrorCode();
	}

	@Override
	public String getErrorDescription() {
		return RESTError.REGION_NAME_ERROR.getErrorDescription();
	}

	@Override
	public Response.Status getStatus() {
		return RESTError.REGION_NAME_ERROR.getStatus();
	}

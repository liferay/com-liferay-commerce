...
public class CPOptionValueKeyExceptionMapper
	...
	public int getErrorCode() {
		return RESTError.DUPLICATE_PRODUCT_OPTION_VALUE_KEY.getErrorCode();
	}

	@Override
	public String getErrorDescription() {
		return RESTError.DUPLICATE_PRODUCT_OPTION_VALUE_KEY.
			getErrorDescription();
	}

	@Override
	public Response.Status getStatus() {
		return RESTError.DUPLICATE_PRODUCT_OPTION_VALUE_KEY.getStatus();
	}

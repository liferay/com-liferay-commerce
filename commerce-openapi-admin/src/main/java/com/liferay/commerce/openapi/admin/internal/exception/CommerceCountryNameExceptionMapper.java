...
@Provider
public class CommerceCountryNameExceptionMapper
	extends BaseExceptionMapper<CommerceCountryNameException> {

	@Override
	public int getErrorCode() {
		return RESTError.COUNTRY_NAME_ERROR.getErrorCode();
	}

	@Override
	public String getErrorDescription() {
		return RESTError.COUNTRY_NAME_ERROR.getErrorDescription();
	}

	@Override
	public Response.Status getStatus() {
		return RESTError.COUNTRY_NAME_ERROR.getStatus();
	}

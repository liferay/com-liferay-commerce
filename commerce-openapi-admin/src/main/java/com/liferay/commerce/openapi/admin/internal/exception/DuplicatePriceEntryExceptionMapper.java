...
public class DuplicatePriceEntryExceptionMapper
	...
	public int getErrorCode() {
		return RESTError.DUPLICATE_PRICE_ENTRY.getErrorCode();
	}

	@Override
	public String getErrorDescription() {
		return RESTError.DUPLICATE_PRICE_ENTRY.getErrorDescription();
	}

	@Override
	public Response.Status getStatus() {
		return RESTError.DUPLICATE_PRICE_ENTRY.getStatus();
	}

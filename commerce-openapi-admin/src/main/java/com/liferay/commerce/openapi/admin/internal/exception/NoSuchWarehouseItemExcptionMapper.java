...
public class NoSuchWarehouseItemExcptionMapper
	extends BaseExceptionMapper<NoSuchWarehouseItemException> {

	@Override
	public int getErrorCode() {
		return RESTError.NO_SUCH_WAREHOUSE_ITEM_VALUE.getErrorCode();
	}

	@Override
	public String getErrorDescription() {
		return RESTError.NO_SUCH_WAREHOUSE_ITEM_VALUE.getErrorDescription();
	}

	@Override
	public Response.Status getStatus() {
		return RESTError.NO_SUCH_WAREHOUSE_ITEM_VALUE.getStatus();
	}

...
public interface CommerceChannelRelLocalService extends BaseLocalService,
	PersistedModelLocalService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link CommerceChannelRelLocalServiceUtil} to access the commerce channel rel local service. Add custom service methods to {@link com.liferay.commerce.product.service.impl.CommerceChannelRelLocalServiceImpl} and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
	...
	*/
	...
	public CommerceChannelRel addCommerceChannelRel(String className,
		long classPK, long commerceChannelId, ServiceContext serviceContext)
	...
	*/
	@Indexable(type = IndexableType.DELETE)
	public CommerceChannelRel deleteCommerceChannelRel(
		long commerceChannelRelId) throws PortalException;
	...
	*/
	...
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public List<CommerceChannelRel> getCommerceChannelRels(String className,

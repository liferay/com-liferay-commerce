...
/**
 * The persistence utility for the cp rule service. This utility wraps <code>com.liferay.commerce.product.service.persistence.impl.CPRulePersistenceImpl</code> and provides direct access to the database for CRUD operations. This utility should only be used by the service layer, as it must operate within a transaction. Never access this utility in a JSP, controller, model, or other front-end class.
 *
 * <p>
...
public class CPRuleUtil {
	 ...
	 */
	public static Map<Serializable, CPRule> fetchByPrimaryKeys(
	 ...
	 */
	public static List<CPRule> findWithDynamicQuery(
	 ...
	 */
	public static List<CPRule> findByGroupId(
	 ...
	 */
	public static CPRule findByGroupId_First(
	 ...
	 */
	public static CPRule fetchByGroupId_First(
		long groupId, OrderByComparator<CPRule> orderByComparator) {
	 ...
	 * @throws NoSuchCPRuleException if a matching cp rule could not be found
	 */
	public static CPRule findByGroupId_Last(
			long groupId, OrderByComparator<CPRule> orderByComparator)
		throws com.liferay.commerce.product.exception.NoSuchCPRuleException {
	 ...
	 */
	public static CPRule fetchByGroupId_Last(
		long groupId, OrderByComparator<CPRule> orderByComparator) {
	 ...
	 */
	public static CPRule[] findByGroupId_PrevAndNext(
	 ...
	 */
	public static List<CPRule> filterFindByGroupId(
		long groupId, int start, int end) {
	 ...
	 * @throws NoSuchCPRuleException if a cp rule with the primary key could not be found
	 */
	public static CPRule[] filterFindByGroupId_PrevAndNext(
			long CPRuleId, long groupId,
			OrderByComparator<CPRule> orderByComparator)
		throws com.liferay.commerce.product.exception.NoSuchCPRuleException {
	...
	private static ServiceTracker<CPRulePersistence, CPRulePersistence>
		_serviceTracker;

	static {
		Bundle bundle = FrameworkUtil.getBundle(CPRulePersistence.class);

		ServiceTracker<CPRulePersistence, CPRulePersistence> serviceTracker =
			new ServiceTracker<CPRulePersistence, CPRulePersistence>(
				bundle.getBundleContext(), CPRulePersistence.class, null);

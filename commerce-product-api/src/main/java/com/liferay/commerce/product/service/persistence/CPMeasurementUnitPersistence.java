...
public interface CPMeasurementUnitPersistence extends BasePersistence<CPMeasurementUnit> {
	...
	* @return the matching cp measurement units
	*/
	public java.util.List<CPMeasurementUnit> findByC_T(long companyId, int type);
	...
	* @return the range of matching cp measurement units
	*/
	public java.util.List<CPMeasurementUnit> findByC_T(long companyId,
	...
	* @return the matching cp measurement units
	*/
	public java.util.List<CPMeasurementUnit> findByC_P_T(long companyId,

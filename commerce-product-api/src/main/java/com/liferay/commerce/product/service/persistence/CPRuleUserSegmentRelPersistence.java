 ...
 */
@ProviderType
public interface CPRuleUserSegmentRelPersistence
	extends BasePersistence<CPRuleUserSegmentRel> {
	 ...
	 */
	public java.util.List<CPRuleUserSegmentRel> findByCPRuleId(
	...
	public java.util.List<CPRuleUserSegmentRel> findByCPRuleId(
		long CPRuleId, int start, int end,
		com.liferay.portal.kernel.util.OrderByComparator<CPRuleUserSegmentRel>
			orderByComparator);
	 ...
	 * @return the matching cp rule user segment rels
	 */
	public java.util.List<CPRuleUserSegmentRel>

...
public class CPDefinitionOptionValueRelUtil {
	...
	private static ServiceTracker
		<CPDefinitionOptionValueRelPersistence,
		 CPDefinitionOptionValueRelPersistence> _serviceTracker;

	static {
		Bundle bundle = FrameworkUtil.getBundle(
			CPDefinitionOptionValueRelPersistence.class);

		ServiceTracker
			<CPDefinitionOptionValueRelPersistence,
			 CPDefinitionOptionValueRelPersistence> serviceTracker =
				new ServiceTracker
					<CPDefinitionOptionValueRelPersistence,
					 CPDefinitionOptionValueRelPersistence>(

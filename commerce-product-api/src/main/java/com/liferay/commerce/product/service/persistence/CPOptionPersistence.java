...
public interface CPOptionPersistence extends BasePersistence<CPOption> {
	...
	*/
	public java.util.List<CPOption> filterFindByUuid(String uuid, int start,
		int end);
	...
	* @return the matching cp options that the user has permission to view
	*/
	public java.util.List<CPOption> filterFindByUuid_C(String uuid,
		long companyId);
	...
	* @return the range of matching cp options
	*/
	public java.util.List<CPOption> findByCompanyId(long companyId, int start,
		int end);

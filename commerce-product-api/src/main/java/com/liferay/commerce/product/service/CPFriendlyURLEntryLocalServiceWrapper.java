...
public class CPFriendlyURLEntryLocalServiceWrapper
	...
	public void addCPFriendlyURLEntries(
		...
		_cpFriendlyURLEntryLocalService.addCPFriendlyURLEntries(
			groupId, companyId, clazz, classPK, urlTitleMap);
	}
	 ...
	 */
	@Override
	public com.liferay.commerce.product.model.CPFriendlyURLEntry
		addCPFriendlyURLEntry(
			com.liferay.commerce.product.model.CPFriendlyURLEntry
				cpFriendlyURLEntry) {

		return _cpFriendlyURLEntryLocalService.addCPFriendlyURLEntry(
			cpFriendlyURLEntry);
	}
	...
	public String buildUrlTitle(
		...
		return _cpFriendlyURLEntryLocalService.buildUrlTitle(
			groupId, classNameId, classPK, languageId, title);
	}
	...
	@Override
	public com.liferay.commerce.product.model.CPFriendlyURLEntry
		createCPFriendlyURLEntry(long CPFriendlyURLEntryId) {

		return _cpFriendlyURLEntryLocalService.createCPFriendlyURLEntry(
	...
	public com.liferay.commerce.product.model.CPFriendlyURLEntry
		...
		return _cpFriendlyURLEntryLocalService.deleteCPFriendlyURLEntry(
			cpFriendlyURLEntry);
	}
	...
	@Override
	public com.liferay.commerce.product.model.CPFriendlyURLEntry
			deleteCPFriendlyURLEntry(long CPFriendlyURLEntryId)
		throws com.liferay.portal.kernel.exception.PortalException {
	...
	public com.liferay.portal.kernel.model.PersistedModel deletePersistedModel(
		...
		return _cpFriendlyURLEntryLocalService.deletePersistedModel(
			persistedModel);
	}
	...
	public long dynamicQueryCount(
		...
		return _cpFriendlyURLEntryLocalService.dynamicQueryCount(
			dynamicQuery, projection);
	}

	@Override
	public com.liferay.commerce.product.model.CPFriendlyURLEntry
		fetchCPFriendlyURLEntry(long CPFriendlyURLEntryId) {

		return _cpFriendlyURLEntryLocalService.fetchCPFriendlyURLEntry(
			CPFriendlyURLEntryId);
	}

	@Override
	public com.liferay.commerce.product.model.CPFriendlyURLEntry
		fetchCPFriendlyURLEntry(
			long groupId, long classNameId, long classPK, String languageId,
			boolean main) {
	...
	@Override
	public com.liferay.commerce.product.model.CPFriendlyURLEntry
		fetchCPFriendlyURLEntryByUuidAndGroupId(String uuid, long groupId) {
	...
	public java.util.List<com.liferay.commerce.product.model.CPFriendlyURLEntry>
		getCPFriendlyURLEntries(int start, int end) {
	...
	@Override
	public java.util.List<com.liferay.commerce.product.model.CPFriendlyURLEntry>
		getCPFriendlyURLEntries(long groupId, long classNameId, long classPK) {
	...
	@Override
	public java.util.List<com.liferay.commerce.product.model.CPFriendlyURLEntry>
		getCPFriendlyURLEntriesByUuidAndCompanyId(String uuid, long companyId) {
	...
	@Override
	public com.liferay.commerce.product.model.CPFriendlyURLEntry
			getCPFriendlyURLEntry(long CPFriendlyURLEntryId)
		throws com.liferay.portal.kernel.exception.PortalException {

		return _cpFriendlyURLEntryLocalService.getCPFriendlyURLEntry(
			CPFriendlyURLEntryId);
	}
	...
	@Override
	public com.liferay.commerce.product.model.CPFriendlyURLEntry
			getCPFriendlyURLEntryByUuidAndGroupId(String uuid, long groupId)
		throws com.liferay.portal.kernel.exception.PortalException {

		return _cpFriendlyURLEntryLocalService.
			getCPFriendlyURLEntryByUuidAndGroupId(uuid, groupId);
	}
	...
	public com.liferay.portal.kernel.dao.orm.ExportActionableDynamicQuery
		...
		return _cpFriendlyURLEntryLocalService.getExportActionableDynamicQuery(
			portletDataContext);
	}
	...
	public java.util.Map<String, String> getLanguageIdToUrlTitleMap(
		...
		return _cpFriendlyURLEntryLocalService.getLanguageIdToUrlTitleMap(
			groupId, classNameId, classPK);
	}
	...
	public java.util.Map<java.util.Locale, String> getUrlTitleMap(
		...
		return _cpFriendlyURLEntryLocalService.getUrlTitleMap(
			groupId, classNameId, classPK);
	}
	...
	public String getUrlTitleMapAsXML(
		...
		return _cpFriendlyURLEntryLocalService.getUrlTitleMapAsXML(
	...
	@Override
	public com.liferay.commerce.product.model.CPFriendlyURLEntry
		updateCPFriendlyURLEntry(
			com.liferay.commerce.product.model.CPFriendlyURLEntry
				cpFriendlyURLEntry) {

		return _cpFriendlyURLEntryLocalService.updateCPFriendlyURLEntry(
			cpFriendlyURLEntry);
	}

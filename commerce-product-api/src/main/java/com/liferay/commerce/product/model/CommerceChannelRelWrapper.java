 ...
 */
@ProviderType
public class CommerceChannelRelWrapper implements CommerceChannelRel,
	ModelWrapper<CommerceChannelRel> {
	...
	@Override
	public Object clone() {
		return new CommerceChannelRelWrapper((CommerceChannelRel)_commerceChannelRel.clone());
	}
	...
	*/
	...
	@Override
	public com.liferay.portal.kernel.model.CacheModel<CommerceChannelRel> toCacheModel() {
		return _commerceChannelRel.toCacheModel();
	}

	@Override
	public CommerceChannelRel toEscapedModel() {
		return new CommerceChannelRelWrapper(_commerceChannelRel.toEscapedModel());
	}
	...
	public CommerceChannelRel toUnescapedModel() {
		return new CommerceChannelRelWrapper(_commerceChannelRel.toUnescapedModel());
	}
	...
	public boolean equals(Object obj) {
		...
		CommerceChannelRelWrapper commerceChannelRelWrapper = (CommerceChannelRelWrapper)obj;

		if (Objects.equals(_commerceChannelRel,

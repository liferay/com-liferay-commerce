...
public class CPInstanceUtil {
	 ...
	 * @return the range of matching cp instances
	 */
	public static List<CPInstance> findByG_NotST(
		long groupId, int status, int start, int end) {
	...
	public static List<CPInstance> findByG_NotST(
		...
		return getPersistence().findByG_NotST(
			groupId, status, start, end, orderByComparator);
	}
	 ...
	 * @throws NoSuchCPInstanceException if a matching cp instance could not be found
	 */
	public static CPInstance findByG_NotST_First(
			long groupId, int status,
			OrderByComparator<CPInstance> orderByComparator)
		throws com.liferay.commerce.product.exception.
			NoSuchCPInstanceException {

		return getPersistence().findByG_NotST_First(
			groupId, status, orderByComparator);
	}
	 ...
	 * @return the first matching cp instance, or <code>null</code> if a matching cp instance could not be found
	 */
	public static CPInstance fetchByG_NotST_First(
		long groupId, int status,
		OrderByComparator<CPInstance> orderByComparator) {

		return getPersistence().fetchByG_NotST_First(
			groupId, status, orderByComparator);
	}
	 ...
	 * @throws NoSuchCPInstanceException if a matching cp instance could not be found
	 */
	public static CPInstance findByG_NotST_Last(
			long groupId, int status,
			OrderByComparator<CPInstance> orderByComparator)
		throws com.liferay.commerce.product.exception.
			NoSuchCPInstanceException {

		return getPersistence().findByG_NotST_Last(
			groupId, status, orderByComparator);
	}
	 ...
	 * @return the last matching cp instance, or <code>null</code> if a matching cp instance could not be found
	 */
	public static CPInstance fetchByG_NotST_Last(
		long groupId, int status,
		OrderByComparator<CPInstance> orderByComparator) {

		return getPersistence().fetchByG_NotST_Last(
			groupId, status, orderByComparator);
	}
	 ...
	 * @throws NoSuchCPInstanceException if a cp instance with the primary key could not be found
	 */
	public static CPInstance[] findByG_NotST_PrevAndNext(
			long CPInstanceId, long groupId, int status,
			OrderByComparator<CPInstance> orderByComparator)
		throws com.liferay.commerce.product.exception.
			NoSuchCPInstanceException {

		return getPersistence().findByG_NotST_PrevAndNext(
			CPInstanceId, groupId, status, orderByComparator);
	}
	...
	public static CPInstance fetchByC_C(
		...
		return getPersistence().fetchByC_C(
			CPDefinitionId, CPInstanceUuid, retrieveFromCache);
	}
	...
	public static CPInstance fetchByC_S(
		...
		return getPersistence().fetchByC_S(
			CPDefinitionId, sku, retrieveFromCache);
	}
	 ...
	 * @return the matching cp instances
	 */
	public static List<CPInstance> findByC_NotST(
		long CPDefinitionId, int status) {
	 ...
	 * @throws NoSuchCPInstanceException if a matching cp instance could not be found
	 */
	public static CPInstance findByC_NotST_First(
			long CPDefinitionId, int status,
			OrderByComparator<CPInstance> orderByComparator)
		throws com.liferay.commerce.product.exception.
			NoSuchCPInstanceException {
	 ...
	 * @return the first matching cp instance, or <code>null</code> if a matching cp instance could not be found
	 */
	public static CPInstance fetchByC_NotST_First(
		long CPDefinitionId, int status,
		OrderByComparator<CPInstance> orderByComparator) {
	 ...
	 * @throws NoSuchCPInstanceException if a matching cp instance could not be found
	 */
	public static CPInstance findByC_NotST_Last(
			long CPDefinitionId, int status,
			OrderByComparator<CPInstance> orderByComparator)
		throws com.liferay.commerce.product.exception.
			NoSuchCPInstanceException {
	 ...
	 * @return the last matching cp instance, or <code>null</code> if a matching cp instance could not be found
	 */
	public static CPInstance fetchByC_NotST_Last(
		long CPDefinitionId, int status,
		OrderByComparator<CPInstance> orderByComparator) {
	 ...
	 * @throws NoSuchCPInstanceException if a cp instance with the primary key could not be found
	 */
	public static CPInstance[] findByC_NotST_PrevAndNext(
			long CPInstanceId, long CPDefinitionId, int status,
			OrderByComparator<CPInstance> orderByComparator)
		throws com.liferay.commerce.product.exception.
			NoSuchCPInstanceException {

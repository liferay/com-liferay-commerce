...
public class CPRuleSoap implements Serializable {
	...
	public static CPRuleSoap[] toSoapModels(CPRule[] models) {
		CPRuleSoap[] soapModels = new CPRuleSoap[models.length];
	...
	public static CPRuleSoap[][] toSoapModels(CPRule[][] models) {
		CPRuleSoap[][] soapModels = null;

		if (models.length > 0) {
			soapModels = new CPRuleSoap[models.length][models[0].length];
		}
		else {
			soapModels = new CPRuleSoap[0][0];
		}
	...
	public static CPRuleSoap[] toSoapModels(List<CPRule> models) {
		List<CPRuleSoap> soapModels = new ArrayList<CPRuleSoap>(models.size());

		for (CPRule model : models) {
			soapModels.add(toSoapModel(model));
		}

		return soapModels.toArray(new CPRuleSoap[soapModels.size()]);
	}

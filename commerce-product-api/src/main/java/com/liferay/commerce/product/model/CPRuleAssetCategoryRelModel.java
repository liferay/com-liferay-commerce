...
/**
 * The base model interface for the CPRuleAssetCategoryRel service. Represents a row in the &quot;CPRuleAssetCategoryRel&quot; database table, with each column mapped to a property of this class.
 *
 * <p>
 * This interface and its corresponding implementation <code>com.liferay.commerce.product.model.impl.CPRuleAssetCategoryRelModelImpl</code> exist only as a container for the default property accessors generated by ServiceBuilder. Helper methods and all application logic should be put in <code>com.liferay.commerce.product.model.impl.CPRuleAssetCategoryRelImpl</code>.
 * </p>
 *
 * @author Marco Leo
 ...
 */
@ProviderType
public interface CPRuleAssetCategoryRelModel
	extends BaseModel<CPRuleAssetCategoryRel>, GroupedModel, ShardedModel {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. All methods that expect a cp rule asset category rel model instance should use the {@link CPRuleAssetCategoryRel} interface instead.
	 */

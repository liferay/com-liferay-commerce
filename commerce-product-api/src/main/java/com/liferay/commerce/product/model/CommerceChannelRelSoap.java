 ...
 *
 * @author Marco Leo
 * @see com.liferay.commerce.product.service.http.CommerceChannelRelServiceSoap
 * @generated
 */
@ProviderType
public class CommerceChannelRelSoap implements Serializable {
	...
	public static CommerceChannelRelSoap[] toSoapModels(
		...
		CommerceChannelRelSoap[] soapModels = new CommerceChannelRelSoap[models.length];
	...
	public static CommerceChannelRelSoap[][] toSoapModels(
		...
		if (models.length > 0) {
			soapModels = new CommerceChannelRelSoap[models.length][models[0].length];
		}
		else {
	...
	public static CommerceChannelRelSoap[] toSoapModels(
		...
		List<CommerceChannelRelSoap> soapModels = new ArrayList<CommerceChannelRelSoap>(models.size());

		for (CommerceChannelRel model : models) {
			soapModels.add(toSoapModel(model));
		}

		return soapModels.toArray(new CommerceChannelRelSoap[soapModels.size()]);
	}

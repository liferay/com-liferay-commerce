 ...
 * {@link com.liferay.commerce.product.service.impl.CProductLocalServiceImpl} and is the
 ...
 * @see com.liferay.commerce.product.service.base.CProductLocalServiceBaseImpl
...
public class CProductLocalServiceUtil {
	 ...
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this class directly. Add custom service methods to {@link com.liferay.commerce.product.service.impl.CProductLocalServiceImpl} and rerun ServiceBuilder to regenerate this class.
	 */
	...
	*/
	...
	public static com.liferay.commerce.product.model.CProduct addCProduct(
		...
		return getService()
				   .addCProduct(groupId, userId, externalReferenceCode,
			serviceContext);
	}
	...
	* @return the matching c product, or <code>null</code> if a matching c product could not be found
	*/
	public static com.liferay.commerce.product.model.CProduct fetchCProductByUuidAndGroupId(
	...
	*/
	public static com.liferay.commerce.product.model.CProduct getCProductByUuidAndGroupId(
		String uuid, long groupId)
		throws com.liferay.portal.kernel.exception.PortalException {
	...
	*/
	public static java.util.List<com.liferay.commerce.product.model.CProduct> getCProducts(
		int start, int end) {
	...
	*/
	public static java.util.List<com.liferay.commerce.product.model.CProduct> getCProductsByUuidAndCompanyId(
	...
	*/
	public static java.util.List<com.liferay.commerce.product.model.CProduct> getCProductsByUuidAndCompanyId(
		...
		com.liferay.portal.kernel.util.OrderByComparator<com.liferay.commerce.product.model.CProduct> orderByComparator) {
		return getService()
				   .getCProductsByUuidAndCompanyId(uuid, companyId, start, end,
			orderByComparator);
	}
	...
	*/
	...
	private static ServiceTracker<CProductLocalService, CProductLocalService> _serviceTracker;

	static {
		Bundle bundle = FrameworkUtil.getBundle(CProductLocalService.class);

		ServiceTracker<CProductLocalService, CProductLocalService> serviceTracker =
			new ServiceTracker<CProductLocalService, CProductLocalService>(bundle.getBundleContext(),
				CProductLocalService.class, null);

...
public class CPOptionCategoryUtil {
	...
	*/
	public static CPOptionCategory[] filterFindByUuid_PrevAndNext(
		...
		throws com.liferay.commerce.product.exception.NoSuchCPOptionCategoryException {
		return getPersistence()
				   .filterFindByUuid_PrevAndNext(CPOptionCategoryId, uuid,
			orderByComparator);
	}
	...
	* @return the matching cp option categories that the user has permission to view
	*/
	public static List<CPOptionCategory> filterFindByUuid_C(String uuid,
		long companyId) {
	...
	*/
	public static CPOptionCategory[] filterFindByUuid_C_PrevAndNext(
		...
		throws com.liferay.commerce.product.exception.NoSuchCPOptionCategoryException {
		return getPersistence()
				   .filterFindByUuid_C_PrevAndNext(CPOptionCategoryId, uuid,
			companyId, orderByComparator);
	}
	...
	*/
	public static CPOptionCategory[] filterFindByCompanyId_PrevAndNext(
		...
		throws com.liferay.commerce.product.exception.NoSuchCPOptionCategoryException {
		return getPersistence()
				   .filterFindByCompanyId_PrevAndNext(CPOptionCategoryId,
			companyId, orderByComparator);
	}

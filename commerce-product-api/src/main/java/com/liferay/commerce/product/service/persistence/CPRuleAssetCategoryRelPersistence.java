 ...
 */
@ProviderType
public interface CPRuleAssetCategoryRelPersistence
	extends BasePersistence<CPRuleAssetCategoryRel> {
	...
	public java.util.List<CPRuleAssetCategoryRel> findByCPRuleId(
		long CPRuleId, int start, int end,
		com.liferay.portal.kernel.util.OrderByComparator<CPRuleAssetCategoryRel>
			orderByComparator);
	...
	public CPRuleAssetCategoryRel findByCPRuleId_First(
			...
			com.liferay.portal.kernel.util.OrderByComparator
				<CPRuleAssetCategoryRel> orderByComparator)

...
public class CPTaxCategoryUtil {
	 ...
	 */
	public static List<CPTaxCategory> findByGroupId(
	 ...
	 */
	public static CPTaxCategory findByGroupId_First(
	 ...
	 */
	public static CPTaxCategory fetchByGroupId_First(
		long groupId, OrderByComparator<CPTaxCategory> orderByComparator) {
	 ...
	 * @throws NoSuchCPTaxCategoryException if a matching cp tax category could not be found
	 */
	public static CPTaxCategory findByGroupId_Last(
			long groupId, OrderByComparator<CPTaxCategory> orderByComparator)
		throws com.liferay.commerce.product.exception.
			NoSuchCPTaxCategoryException {
	 ...
	 */
	public static CPTaxCategory fetchByGroupId_Last(
		long groupId, OrderByComparator<CPTaxCategory> orderByComparator) {

...
public class CPTaxCategoryUtil {
	...
	*/
	public static CPTaxCategory findByCompanyId_First(long companyId,
		OrderByComparator<CPTaxCategory> orderByComparator)
	...
	*/
	public static CPTaxCategory fetchByCompanyId_First(long companyId,
		OrderByComparator<CPTaxCategory> orderByComparator) {
		return getPersistence()
	...
	* @throws NoSuchCPTaxCategoryException if a matching cp tax category could not be found
	*/
	public static CPTaxCategory findByCompanyId_Last(long companyId,
		OrderByComparator<CPTaxCategory> orderByComparator)
		throws com.liferay.commerce.product.exception.NoSuchCPTaxCategoryException {
		return getPersistence()
	...
	*/
	public static CPTaxCategory fetchByCompanyId_Last(long companyId,
		OrderByComparator<CPTaxCategory> orderByComparator) {
		return getPersistence()
	...
	*/
	public static CPTaxCategory[] findByCompanyId_PrevAndNext(
		...
		throws com.liferay.commerce.product.exception.NoSuchCPTaxCategoryException {
		return getPersistence()
				   .findByCompanyId_PrevAndNext(CPTaxCategoryId, companyId,
			orderByComparator);
	}

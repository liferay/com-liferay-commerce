...
public class CommerceChannelUtil {
	...
	*/
	public static CommerceChannel findByCompanyId_First(long companyId,
		OrderByComparator<CommerceChannel> orderByComparator)
	...
	*/
	public static CommerceChannel fetchByCompanyId_First(long companyId,
		OrderByComparator<CommerceChannel> orderByComparator) {
		return getPersistence()
	...
	* @throws NoSuchChannelException if a matching commerce channel could not be found
	*/
	public static CommerceChannel findByCompanyId_Last(long companyId,
		OrderByComparator<CommerceChannel> orderByComparator)
		throws com.liferay.commerce.product.exception.NoSuchChannelException {
		return getPersistence()
	...
	*/
	public static CommerceChannel fetchByCompanyId_Last(long companyId,
		OrderByComparator<CommerceChannel> orderByComparator) {
		return getPersistence()
	...
	*/
	public static CommerceChannel[] findByCompanyId_PrevAndNext(
		...
		throws com.liferay.commerce.product.exception.NoSuchChannelException {
		return getPersistence()
				   .findByCompanyId_PrevAndNext(commerceChannelId, companyId,
			orderByComparator);
	}
	...
	*/
	public static CommerceChannel[] filterFindByCompanyId_PrevAndNext(
		...
		throws com.liferay.commerce.product.exception.NoSuchChannelException {
		return getPersistence()
				   .filterFindByCompanyId_PrevAndNext(commerceChannelId,
	...
	* @throws NoSuchChannelException if a matching commerce channel could not be found
	*/
	public static CommerceChannel findByC_ERC(long companyId,
	...
	* @return the matching commerce channel, or <code>null</code> if a matching commerce channel could not be found
	*/
	public static CommerceChannel fetchByC_ERC(long companyId,
		String externalReferenceCode) {
	...
	* @return the commerce channel that was removed
	*/
	public static CommerceChannel removeByC_ERC(long companyId,
		String externalReferenceCode)
		throws com.liferay.commerce.product.exception.NoSuchChannelException {

...
public class CPOptionValueLocalServiceUtil {
	...
	*/
	public static com.liferay.commerce.product.model.CPOptionValue fetchCPOptionValueByReferenceCode(
		long companyId, String externalReferenceCode) {
		return getService()
				   .fetchCPOptionValueByReferenceCode(companyId,
			externalReferenceCode);
	}
	...
	* @return the matching cp option value, or <code>null</code> if a matching cp option value could not be found
	*/
	public static com.liferay.commerce.product.model.CPOptionValue fetchCPOptionValueByUuidAndCompanyId(
		String uuid, long companyId) {
		return getService().fetchCPOptionValueByUuidAndCompanyId(uuid, companyId);
	}
	...
	*/
	public static com.liferay.commerce.product.model.CPOptionValue getCPOptionValueByUuidAndCompanyId(
		String uuid, long companyId)
		throws com.liferay.portal.kernel.exception.PortalException {

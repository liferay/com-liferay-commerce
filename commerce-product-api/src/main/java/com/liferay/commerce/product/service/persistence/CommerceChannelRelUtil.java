 ...
 * @see com.liferay.commerce.product.service.persistence.impl.CommerceChannelRelPersistenceImpl
 * @generated
 */
@ProviderType
public class CommerceChannelRelUtil {
	...
	*/
	public static CommerceChannelRel findByCommerceChannelId_First(
		long commerceChannelId,
		OrderByComparator<CommerceChannelRel> orderByComparator)
		throws com.liferay.commerce.product.exception.NoSuchChannelRelException {
		return getPersistence()
	...
	*/
	public static CommerceChannelRel[] findByCommerceChannelId_PrevAndNext(
		...
		throws com.liferay.commerce.product.exception.NoSuchChannelRelException {
		return getPersistence()
				   .findByCommerceChannelId_PrevAndNext(commerceChannelRelId,
	...
	* @return the matching commerce channel rels
	*/
	public static List<CommerceChannelRel> findByC_C(long classNameId,
		long classPK) {
	...
	* @throws NoSuchChannelRelException if a matching commerce channel rel could not be found
	*/
	public static CommerceChannelRel findByC_C_First(long classNameId,
		long classPK, OrderByComparator<CommerceChannelRel> orderByComparator)
		throws com.liferay.commerce.product.exception.NoSuchChannelRelException {
		return getPersistence()
	...
	* @return the first matching commerce channel rel, or <code>null</code> if a matching commerce channel rel could not be found
	*/
	public static CommerceChannelRel fetchByC_C_First(long classNameId,
		long classPK, OrderByComparator<CommerceChannelRel> orderByComparator) {
		return getPersistence()
	...
	* @throws NoSuchChannelRelException if a matching commerce channel rel could not be found
	*/
	public static CommerceChannelRel findByC_C_Last(long classNameId,
		long classPK, OrderByComparator<CommerceChannelRel> orderByComparator)
		throws com.liferay.commerce.product.exception.NoSuchChannelRelException {
		return getPersistence()
	...
	* @return the last matching commerce channel rel, or <code>null</code> if a matching commerce channel rel could not be found
	*/
	public static CommerceChannelRel fetchByC_C_Last(long classNameId,
		long classPK, OrderByComparator<CommerceChannelRel> orderByComparator) {
		return getPersistence()
	...
	*/
	public static CommerceChannelRel[] findByC_C_PrevAndNext(
		...
		throws com.liferay.commerce.product.exception.NoSuchChannelRelException {
		return getPersistence()
				   .findByC_C_PrevAndNext(commerceChannelRelId, classNameId,
	...
	* @throws NoSuchChannelRelException if a matching commerce channel rel could not be found
	*/
	public static CommerceChannelRel findByC_C_C(long classNameId,
		long classPK, long commerceChannelId)
		throws com.liferay.commerce.product.exception.NoSuchChannelRelException {
		return getPersistence()
				   .findByC_C_C(classNameId, classPK, commerceChannelId);
	}
	...
	*/
	public static CommerceChannelRel fetchByC_C_C(long classNameId,
		long classPK, long commerceChannelId) {
		return getPersistence()
				   .fetchByC_C_C(classNameId, classPK, commerceChannelId);
	}
	...
	*/
	public static CommerceChannelRel fetchByC_C_C(long classNameId,
		long classPK, long commerceChannelId, boolean retrieveFromCache) {
		return getPersistence()
				   .fetchByC_C_C(classNameId, classPK, commerceChannelId,
			retrieveFromCache);
	}
	...
	*/
	public static CommerceChannelRel removeByC_C_C(long classNameId,
		long classPK, long commerceChannelId)
		throws com.liferay.commerce.product.exception.NoSuchChannelRelException {
		return getPersistence()
				   .removeByC_C_C(classNameId, classPK, commerceChannelId);
	}
	...
	*/
	public static int countByC_C_C(long classNameId, long classPK,
		long commerceChannelId) {
		return getPersistence()
				   .countByC_C_C(classNameId, classPK, commerceChannelId);
	}
	...
	*/
	...
	public static java.util.Map<java.io.Serializable, CommerceChannelRel> fetchByPrimaryKeys(
	...
	*/
	...
	private static ServiceTracker<CommerceChannelRelPersistence, CommerceChannelRelPersistence> _serviceTracker;

	static {
		Bundle bundle = FrameworkUtil.getBundle(CommerceChannelRelPersistence.class);

		ServiceTracker<CommerceChannelRelPersistence, CommerceChannelRelPersistence> serviceTracker =
			new ServiceTracker<CommerceChannelRelPersistence, CommerceChannelRelPersistence>(bundle.getBundleContext(),

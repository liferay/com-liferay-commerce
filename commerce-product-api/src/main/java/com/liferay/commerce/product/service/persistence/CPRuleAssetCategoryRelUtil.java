...
/**
 * The persistence utility for the cp rule asset category rel service. This utility wraps <code>com.liferay.commerce.product.service.persistence.impl.CPRuleAssetCategoryRelPersistenceImpl</code> and provides direct access to the database for CRUD operations. This utility should only be used by the service layer, as it must operate within a transaction. Never access this utility in a JSP, controller, model, or other front-end class.
 *
 * <p>
...
public class CPRuleAssetCategoryRelUtil {
	 ...
	 */
	public static Map<Serializable, CPRuleAssetCategoryRel> fetchByPrimaryKeys(
	 ...
	 */
	public static List<CPRuleAssetCategoryRel> findByCPRuleId(
	 ...
	 */
	public static CPRuleAssetCategoryRel findByCPRuleId_First(
			long CPRuleId,
			OrderByComparator<CPRuleAssetCategoryRel> orderByComparator)
	 ...
	 */
	public static CPRuleAssetCategoryRel fetchByCPRuleId_First(
		long CPRuleId,
		OrderByComparator<CPRuleAssetCategoryRel> orderByComparator) {
	 ...
	 * @throws NoSuchCPRuleAssetCategoryRelException if a matching cp rule asset category rel could not be found
	 */
	public static CPRuleAssetCategoryRel findByCPRuleId_Last(
			long CPRuleId,
			OrderByComparator<CPRuleAssetCategoryRel> orderByComparator)
		throws com.liferay.commerce.product.exception.
			NoSuchCPRuleAssetCategoryRelException {
	 ...
	 */
	public static CPRuleAssetCategoryRel fetchByCPRuleId_Last(
		long CPRuleId,
		OrderByComparator<CPRuleAssetCategoryRel> orderByComparator) {
	...
	public static CPRuleAssetCategoryRel[] findByCPRuleId_PrevAndNext(
		...
		return getPersistence().findByCPRuleId_PrevAndNext(
			CPRuleAssetCategoryRelId, CPRuleId, orderByComparator);
	}
	...
	public static List<CPRuleAssetCategoryRel> findByAssetCategoryId(
		...
		return getPersistence().findByAssetCategoryId(
			assetCategoryId, start, end, orderByComparator, retrieveFromCache);
	}
	...
	public static CPRuleAssetCategoryRel[] findByAssetCategoryId_PrevAndNext(
		...
		return getPersistence().findByAssetCategoryId_PrevAndNext(
			CPRuleAssetCategoryRelId, assetCategoryId, orderByComparator);
	}
	...
	static {
		Bundle bundle = FrameworkUtil.getBundle(
			CPRuleAssetCategoryRelPersistence.class);

		ServiceTracker
			<CPRuleAssetCategoryRelPersistence,
			 CPRuleAssetCategoryRelPersistence> serviceTracker =
				new ServiceTracker
					<CPRuleAssetCategoryRelPersistence,
					 CPRuleAssetCategoryRelPersistence>(

...
/**
 * The persistence utility for the cp rule user segment rel service. This utility wraps <code>com.liferay.commerce.product.service.persistence.impl.CPRuleUserSegmentRelPersistenceImpl</code> and provides direct access to the database for CRUD operations. This utility should only be used by the service layer, as it must operate within a transaction. Never access this utility in a JSP, controller, model, or other front-end class.
 *
 * <p>
...
public class CPRuleUserSegmentRelUtil {
	 ...
	 */
	public static Map<Serializable, CPRuleUserSegmentRel> fetchByPrimaryKeys(
	 ...
	 */
	public static List<CPRuleUserSegmentRel> findByCPRuleId(
	...
	public static List<CPRuleUserSegmentRel> findByCPRuleId(
		...
		return getPersistence().findByCPRuleId(
	...
	public static List<CPRuleUserSegmentRel> findByCPRuleId(
		...
		return getPersistence().findByCPRuleId(
			CPRuleId, start, end, orderByComparator, retrieveFromCache);
	}
	 ...
	 */
	public static CPRuleUserSegmentRel findByCPRuleId_First(
			long CPRuleId,
			OrderByComparator<CPRuleUserSegmentRel> orderByComparator)
		throws com.liferay.commerce.product.exception.
			NoSuchCPRuleUserSegmentRelException {

		return getPersistence().findByCPRuleId_First(
	 ...
	 */
	public static CPRuleUserSegmentRel fetchByCPRuleId_First(
		long CPRuleId,
		OrderByComparator<CPRuleUserSegmentRel> orderByComparator) {

		return getPersistence().fetchByCPRuleId_First(
			CPRuleId, orderByComparator);
	}
	 ...
	 * @throws NoSuchCPRuleUserSegmentRelException if a matching cp rule user segment rel could not be found
	 */
	public static CPRuleUserSegmentRel findByCPRuleId_Last(
			long CPRuleId,
			OrderByComparator<CPRuleUserSegmentRel> orderByComparator)
		throws com.liferay.commerce.product.exception.
			NoSuchCPRuleUserSegmentRelException {

		return getPersistence().findByCPRuleId_Last(
			CPRuleId, orderByComparator);
	}
	 ...
	 */
	public static CPRuleUserSegmentRel fetchByCPRuleId_Last(
		long CPRuleId,
		OrderByComparator<CPRuleUserSegmentRel> orderByComparator) {

		return getPersistence().fetchByCPRuleId_Last(
			CPRuleId, orderByComparator);
	}
	...
	public static CPRuleUserSegmentRel[] findByCPRuleId_PrevAndNext(
		...
		return getPersistence().findByCPRuleId_PrevAndNext(
			CPRuleUserSegmentRelId, CPRuleId, orderByComparator);
	}
	...
	public static List<CPRuleUserSegmentRel> findByCommerceUserSegmentEntryId(
		...
		return getPersistence().findByCommerceUserSegmentEntryId(
	...
	public static CPRuleUserSegmentRel findByCommerceUserSegmentEntryId_First(
		...
		return getPersistence().findByCommerceUserSegmentEntryId_First(
	...
	public static CPRuleUserSegmentRel fetchByCommerceUserSegmentEntryId_First(
		...
		return getPersistence().fetchByCommerceUserSegmentEntryId_First(
			commerceUserSegmentEntryId, orderByComparator);
	}
	...
	public static CPRuleUserSegmentRel findByCommerceUserSegmentEntryId_Last(
		...
		return getPersistence().findByCommerceUserSegmentEntryId_Last(
			commerceUserSegmentEntryId, orderByComparator);
	}
	...
	public static CPRuleUserSegmentRel fetchByCommerceUserSegmentEntryId_Last(
		...
		return getPersistence().fetchByCommerceUserSegmentEntryId_Last(
			commerceUserSegmentEntryId, orderByComparator);
	}
	 ...
	 * @throws NoSuchCPRuleUserSegmentRelException if a cp rule user segment rel with the primary key could not be found
	 */
	public static CPRuleUserSegmentRel[]
		...
		return getPersistence().findByCommerceUserSegmentEntryId_PrevAndNext(
			CPRuleUserSegmentRelId, commerceUserSegmentEntryId,
			orderByComparator);
	}
	...
	public static void removeByCommerceUserSegmentEntryId(
		...
		getPersistence().removeByCommerceUserSegmentEntryId(
			commerceUserSegmentEntryId);
	}
	...
	public static int countByCommerceUserSegmentEntryId(
		...
		return getPersistence().countByCommerceUserSegmentEntryId(
			commerceUserSegmentEntryId);
	}
	...
	static {
		Bundle bundle = FrameworkUtil.getBundle(
			CPRuleUserSegmentRelPersistence.class);

		ServiceTracker
			<CPRuleUserSegmentRelPersistence, CPRuleUserSegmentRelPersistence>
				serviceTracker =
					new ServiceTracker
						<CPRuleUserSegmentRelPersistence,
						 CPRuleUserSegmentRelPersistence>(

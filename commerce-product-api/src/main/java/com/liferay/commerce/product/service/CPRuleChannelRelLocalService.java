...
/**
 * Provides the local service interface for CPRuleChannelRel. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author Marco Leo
 * @see CPRuleChannelRelLocalServiceUtil
...
public interface CPRuleChannelRelLocalService extends BaseLocalService,
	PersistedModelLocalService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link CPRuleChannelRelLocalServiceUtil} to access the cp rule channel rel local service. Add custom service methods to {@link com.liferay.commerce.product.service.impl.CPRuleChannelRelLocalServiceImpl} and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
	...
	*/
	...
	public CPRuleChannelRel addCPRuleChannelRel(
		CPRuleChannelRel cpRuleChannelRel);
	...
	*/
	...
	public CPRuleChannelRel createCPRuleChannelRel(long CPRuleChannelRelId);
	...
	*/
	...
	public CPRuleChannelRel deleteCPRuleChannelRel(
		CPRuleChannelRel cpRuleChannelRel);
	...
	*/
	@Indexable(type = IndexableType.DELETE)
	public CPRuleChannelRel deleteCPRuleChannelRel(long CPRuleChannelRelId)
	...
	*/
	...
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public CPRuleChannelRel fetchCPRuleChannelRel(long CPRuleChannelRelId);
	...
	*/
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public CPRuleChannelRel getCPRuleChannelRel(long CPRuleChannelRelId)
		throws PortalException;
	...
	*/
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public List<CPRuleChannelRel> getCPRuleChannelRels(int start, int end);
	...
	*/
	@Indexable(type = IndexableType.REINDEX)
	public CPRuleChannelRel updateCPRuleChannelRel(
		CPRuleChannelRel cpRuleChannelRel);
}
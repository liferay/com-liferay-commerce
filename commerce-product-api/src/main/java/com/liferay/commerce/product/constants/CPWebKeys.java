...
public class CPWebKeys {
	...
	public static final String CP_DEFINITION_OPTION_VALUE_RELS =
		"CP_DEFINITION_OPTION_VALUE_RELS";

	public static final String CP_DEFINITION_SPECIFICATION_OPTION_VALUE =
		"CP_DEFINITION_SPECIFICATION_OPTION_VALUE";

	public static final String CP_DEFINITION_SPECIFICATION_OPTION_VALUES =
		"CP_DEFINITION_SPECIFICATION_OPTION_VALUES";

 ...
 *
 * <p>
 * This implementation and its corresponding interface {@link CommercePaymentMethodGroupRelModel} exist only as a container for the default property accessors generated by ServiceBuilder. Helper methods and all application logic should be put in {@link CommercePaymentMethodGroupRelImpl}.
 * </p>
 *
...
@JSON(strict = true)
@ProviderType
public class CommercePaymentMethodGroupRelModelImpl extends BaseModelImpl<CommercePaymentMethodGroupRel>
	...
	public static final Object[][] TABLE_COLUMNS = {
			{ "CPaymentMethodGroupRelId", Types.BIGINT },
	...
	public static final String TABLE_SQL_CREATE = "create table CommercePaymentMethodGroupRel (CPaymentMethodGroupRelId LONG not null primary key,groupId LONG,companyId LONG,userId LONG,userName VARCHAR(75) null,createDate DATE null,modifiedDate DATE null,name STRING null,description STRING null,imageId LONG,engineKey VARCHAR(75) null,priority DOUBLE,active_ BOOLEAN)";
	public static final String TABLE_SQL_DROP = "drop table CommercePaymentMethodGroupRel";
	public static final String ORDER_BY_JPQL = " ORDER BY commercePaymentMethodGroupRel.priority ASC";
	public static final String ORDER_BY_SQL = " ORDER BY CommercePaymentMethodGroupRel.priority ASC";
	public static final String DATA_SOURCE = "liferayDataSource";
	public static final String SESSION_FACTORY = "liferaySessionFactory";
	public static final String TX_MANAGER = "liferayTransactionManager";
	public static final boolean ENTITY_CACHE_ENABLED = GetterUtil.getBoolean(com.liferay.commerce.payment.service.util.ServiceProps.get(
				"value.object.entity.cache.enabled.com.liferay.commerce.payment.model.CommercePaymentMethodGroupRel"),
			true);
	public static final boolean FINDER_CACHE_ENABLED = GetterUtil.getBoolean(com.liferay.commerce.payment.service.util.ServiceProps.get(
				"value.object.finder.cache.enabled.com.liferay.commerce.payment.model.CommercePaymentMethodGroupRel"),
			true);
	public static final boolean COLUMN_BITMASK_ENABLED = GetterUtil.getBoolean(com.liferay.commerce.payment.service.util.ServiceProps.get(
	...
	public static CommercePaymentMethodGroupRel toModel(
		...
		CommercePaymentMethodGroupRel model = new CommercePaymentMethodGroupRelImpl();

		model.setCommercePaymentMethodGroupRelId(soapModel.getCommercePaymentMethodGroupRelId());
	...
	public static List<CommercePaymentMethodGroupRel> toModels(
		...
		List<CommercePaymentMethodGroupRel> models = new ArrayList<CommercePaymentMethodGroupRel>(soapModels.length);
	...
	public static final long LOCK_EXPIRATION_TIME = GetterUtil.getLong(com.liferay.commerce.payment.service.util.ServiceProps.get(
	...
	public void prepareLocalizedFieldsForImport() throws LocaleException {
		...
		Locale defaultImportLocale = LocalizationUtil.getDefaultImportLocale(CommercePaymentMethodGroupRel.class.getName(),
	...
	public CommercePaymentMethodGroupRel toEscapedModel() {
		if (_escapedModel == null) {
			_escapedModel = (CommercePaymentMethodGroupRel)ProxyUtil.newProxyInstance(_classLoader,
	...
	public Object clone() {
		...
		commercePaymentMethodGroupRelImpl.setCommercePaymentMethodGroupRelId(getCommercePaymentMethodGroupRelId());
	...
	public void resetOriginalValues() {
		...
		commercePaymentMethodGroupRelModelImpl._originalGroupId = commercePaymentMethodGroupRelModelImpl._groupId;
		...
		commercePaymentMethodGroupRelModelImpl._originalEngineKey = commercePaymentMethodGroupRelModelImpl._engineKey;

		commercePaymentMethodGroupRelModelImpl._originalActive = commercePaymentMethodGroupRelModelImpl._active;
	...
	public CacheModel<CommercePaymentMethodGroupRel> toCacheModel() {
		...
		commercePaymentMethodGroupRelCacheModel.commercePaymentMethodGroupRelId = getCommercePaymentMethodGroupRelId();
		...
		if (createDate != null) {
			commercePaymentMethodGroupRelCacheModel.createDate = createDate.getTime();
		}
		else {
		...
		if (modifiedDate != null) {
			commercePaymentMethodGroupRelCacheModel.modifiedDate = modifiedDate.getTime();
		}
		else {
			commercePaymentMethodGroupRelCacheModel.modifiedDate = Long.MIN_VALUE;
		}
		...
		String description = commercePaymentMethodGroupRelCacheModel.description;
	...
	public String toString() {
		...
		sb.append(getCommercePaymentMethodGroupRelId());
		sb.append(", groupId=");
	...
	public String toXmlString() {
		...
		sb.append(
			"<column><column-name>commercePaymentMethodGroupRelId</column-name><column-value><![CDATA[");
		sb.append(getCommercePaymentMethodGroupRelId());
	...
	private static final ClassLoader _classLoader = CommercePaymentMethodGroupRel.class.getClassLoader();

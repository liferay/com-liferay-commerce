...
@Component(
	immediate = true,
	property = {
		"commerce.notification.type.key=" + SubscriptionCancelledCommerceNotificationTypeImpl.KEY,
		"commerce.notification.type.order:Integer=230"
	},
	service = CommerceNotificationType.class
)
public class SubscriptionCancelledCommerceNotificationTypeImpl
	implements CommerceNotificationType {

	public static final String KEY = "subscription-cancelled";

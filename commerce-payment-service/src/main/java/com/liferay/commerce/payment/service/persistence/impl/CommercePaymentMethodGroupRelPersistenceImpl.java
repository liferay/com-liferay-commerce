 ...
 * @see com.liferay.commerce.payment.service.persistence.CommercePaymentMethodGroupRelUtil
 * @generated
 */
@ProviderType
public class CommercePaymentMethodGroupRelPersistenceImpl
	 ...
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link CommercePaymentMethodGroupRelUtil} to access the commerce payment method group rel persistence. Modify <code>service.xml</code> and rerun ServiceBuilder to regenerate this class.
	 */
	...
	public static final String FINDER_CLASS_NAME_LIST_WITHOUT_PAGINATION = FINDER_CLASS_NAME_ENTITY +
		".List2";
	public static final FinderPath FINDER_PATH_WITH_PAGINATION_FIND_ALL = new FinderPath(CommercePaymentMethodGroupRelModelImpl.ENTITY_CACHE_ENABLED,
			CommercePaymentMethodGroupRelModelImpl.FINDER_CACHE_ENABLED,
			CommercePaymentMethodGroupRelImpl.class,
			FINDER_CLASS_NAME_LIST_WITH_PAGINATION, "findAll", new String[0]);
	public static final FinderPath FINDER_PATH_WITHOUT_PAGINATION_FIND_ALL = new FinderPath(CommercePaymentMethodGroupRelModelImpl.ENTITY_CACHE_ENABLED,
			CommercePaymentMethodGroupRelModelImpl.FINDER_CACHE_ENABLED,
			CommercePaymentMethodGroupRelImpl.class,
			FINDER_CLASS_NAME_LIST_WITHOUT_PAGINATION, "findAll", new String[0]);
	public static final FinderPath FINDER_PATH_COUNT_ALL = new FinderPath(CommercePaymentMethodGroupRelModelImpl.ENTITY_CACHE_ENABLED,
			CommercePaymentMethodGroupRelModelImpl.FINDER_CACHE_ENABLED,
			Long.class, FINDER_CLASS_NAME_LIST_WITHOUT_PAGINATION, "countAll",
			new String[0]);
	public static final FinderPath FINDER_PATH_WITH_PAGINATION_FIND_BY_GROUPID = new FinderPath(CommercePaymentMethodGroupRelModelImpl.ENTITY_CACHE_ENABLED,
			CommercePaymentMethodGroupRelModelImpl.FINDER_CACHE_ENABLED,
			CommercePaymentMethodGroupRelImpl.class,
	...
	public static final FinderPath FINDER_PATH_WITHOUT_PAGINATION_FIND_BY_GROUPID =
		new FinderPath(CommercePaymentMethodGroupRelModelImpl.ENTITY_CACHE_ENABLED,
			CommercePaymentMethodGroupRelModelImpl.FINDER_CACHE_ENABLED,
			CommercePaymentMethodGroupRelImpl.class,
	...
	public static final FinderPath FINDER_PATH_COUNT_BY_GROUPID = new FinderPath(CommercePaymentMethodGroupRelModelImpl.ENTITY_CACHE_ENABLED,
			CommercePaymentMethodGroupRelModelImpl.FINDER_CACHE_ENABLED,
	...
	public List<CommercePaymentMethodGroupRel> findByGroupId(long groupId,
		...
		if (retrieveFromCache) {
			list = (List<CommercePaymentMethodGroupRel>)finderCache.getResult(finderPath,
					finderArgs, this);
		...
		if (list == null) {
			...
			try {
				...
				if (!pagination) {
					list = (List<CommercePaymentMethodGroupRel>)QueryUtil.list(q,
	 ...
	 */
	@Override
	public CommercePaymentMethodGroupRel findByGroupId_First(long groupId,
		OrderByComparator<CommercePaymentMethodGroupRel> orderByComparator)
		throws NoSuchPaymentMethodGroupRelException {
		CommercePaymentMethodGroupRel commercePaymentMethodGroupRel = fetchByGroupId_First(groupId,
				orderByComparator);
	 ...
	 */
	@Override
	public CommercePaymentMethodGroupRel fetchByGroupId_First(long groupId,
		OrderByComparator<CommercePaymentMethodGroupRel> orderByComparator) {
		List<CommercePaymentMethodGroupRel> list = findByGroupId(groupId, 0, 1,
				orderByComparator);
	 ...
	 */
	@Override
	public CommercePaymentMethodGroupRel fetchByGroupId_Last(long groupId,
		OrderByComparator<CommercePaymentMethodGroupRel> orderByComparator) {
		...
		List<CommercePaymentMethodGroupRel> list = findByGroupId(groupId,
	...
	public CommercePaymentMethodGroupRel[] findByGroupId_PrevAndNext(
		...
		OrderByComparator<CommercePaymentMethodGroupRel> orderByComparator)
		throws NoSuchPaymentMethodGroupRelException {
		CommercePaymentMethodGroupRel commercePaymentMethodGroupRel = findByPrimaryKey(commercePaymentMethodGroupRelId);
		...
		try {
			...
			CommercePaymentMethodGroupRel[] array = new CommercePaymentMethodGroupRelImpl[3];

			array[0] = getByGroupId_PrevAndNext(session,
					commercePaymentMethodGroupRel, groupId, orderByComparator,
					true);
	...
	protected CommercePaymentMethodGroupRel getByGroupId_PrevAndNext(
		...
		if (orderByComparator != null) {
			Object[] values = orderByComparator.getOrderByConditionValues(commercePaymentMethodGroupRel);
	...
	public void removeByGroupId(long groupId) {
		for (CommercePaymentMethodGroupRel commercePaymentMethodGroupRel : findByGroupId(
	...
	public static final FinderPath FINDER_PATH_FETCH_BY_G_E = new FinderPath(CommercePaymentMethodGroupRelModelImpl.ENTITY_CACHE_ENABLED,
			CommercePaymentMethodGroupRelModelImpl.FINDER_CACHE_ENABLED,
	...
	public static final FinderPath FINDER_PATH_COUNT_BY_G_E = new FinderPath(CommercePaymentMethodGroupRelModelImpl.ENTITY_CACHE_ENABLED,
			CommercePaymentMethodGroupRelModelImpl.FINDER_CACHE_ENABLED,
			Long.class, FINDER_CLASS_NAME_LIST_WITHOUT_PAGINATION,
			"countByG_E",
			new String[] { Long.class.getName(), String.class.getName() });
	...
	/**
	 * Returns the commerce payment method group rel where groupId = &#63; and engineKey = &#63; or throws a {@link NoSuchPaymentMethodGroupRelException} if it could not be found.
	 *
	 * @param groupId the group ID
	 ...
	 */
	@Override
	public CommercePaymentMethodGroupRel findByG_E(long groupId,
		String engineKey) throws NoSuchPaymentMethodGroupRelException {
		CommercePaymentMethodGroupRel commercePaymentMethodGroupRel = fetchByG_E(groupId,
				engineKey);
	...
	public CommercePaymentMethodGroupRel fetchByG_E(long groupId,
		...
		if (result instanceof CommercePaymentMethodGroupRel) {
			CommercePaymentMethodGroupRel commercePaymentMethodGroupRel = (CommercePaymentMethodGroupRel)result;
		...
		if (result == null) {
			...
			try {
				...
				if (list.isEmpty()) {
					...
					CommercePaymentMethodGroupRel commercePaymentMethodGroupRel = list.get(0);
	 ...
	 */
	@Override
	public CommercePaymentMethodGroupRel removeByG_E(long groupId,
		String engineKey) throws NoSuchPaymentMethodGroupRelException {
		CommercePaymentMethodGroupRel commercePaymentMethodGroupRel = findByG_E(groupId,
				engineKey);
	...
	private static final String _FINDER_COLUMN_G_E_ENGINEKEY_1 = "commercePaymentMethodGroupRel.engineKey IS NULL";
	...
	public static final FinderPath FINDER_PATH_WITH_PAGINATION_FIND_BY_G_A = new FinderPath(CommercePaymentMethodGroupRelModelImpl.ENTITY_CACHE_ENABLED,
			CommercePaymentMethodGroupRelModelImpl.FINDER_CACHE_ENABLED,
			CommercePaymentMethodGroupRelImpl.class,
	...
	public static final FinderPath FINDER_PATH_WITHOUT_PAGINATION_FIND_BY_G_A = new FinderPath(CommercePaymentMethodGroupRelModelImpl.ENTITY_CACHE_ENABLED,
			CommercePaymentMethodGroupRelModelImpl.FINDER_CACHE_ENABLED,
			CommercePaymentMethodGroupRelImpl.class,
			...
			CommercePaymentMethodGroupRelModelImpl.PRIORITY_COLUMN_BITMASK);
	public static final FinderPath FINDER_PATH_COUNT_BY_G_A = new FinderPath(CommercePaymentMethodGroupRelModelImpl.ENTITY_CACHE_ENABLED,
			CommercePaymentMethodGroupRelModelImpl.FINDER_CACHE_ENABLED,
			Long.class, FINDER_CLASS_NAME_LIST_WITHOUT_PAGINATION,
			"countByG_A",
			new String[] { Long.class.getName(), Boolean.class.getName() });
	 ...
	 */
	@Override
	public List<CommercePaymentMethodGroupRel> findByG_A(long groupId,
		boolean active) {
	 ...
	 */
	@Override
	public CommercePaymentMethodGroupRel findByG_A_First(long groupId,
		boolean active,
		OrderByComparator<CommercePaymentMethodGroupRel> orderByComparator)
		throws NoSuchPaymentMethodGroupRelException {
		CommercePaymentMethodGroupRel commercePaymentMethodGroupRel = fetchByG_A_First(groupId,
	 ...
	 */
	@Override
	public CommercePaymentMethodGroupRel fetchByG_A_First(long groupId,
		boolean active,
		OrderByComparator<CommercePaymentMethodGroupRel> orderByComparator) {
		List<CommercePaymentMethodGroupRel> list = findByG_A(groupId, active,
	 ...
	 */
	@Override
	public CommercePaymentMethodGroupRel findByG_A_Last(long groupId,
		boolean active,
		OrderByComparator<CommercePaymentMethodGroupRel> orderByComparator)
		throws NoSuchPaymentMethodGroupRelException {
		CommercePaymentMethodGroupRel commercePaymentMethodGroupRel = fetchByG_A_Last(groupId,
				active, orderByComparator);
	 ...
	 */
	@Override
	public CommercePaymentMethodGroupRel fetchByG_A_Last(long groupId,
		boolean active,
		OrderByComparator<CommercePaymentMethodGroupRel> orderByComparator) {
	...
	public CommercePaymentMethodGroupRel[] findByG_A_PrevAndNext(
		...
		try {
			...
			array[0] = getByG_A_PrevAndNext(session,
					commercePaymentMethodGroupRel, groupId, active,
					orderByComparator, true);

			array[1] = commercePaymentMethodGroupRel;

			array[2] = getByG_A_PrevAndNext(session,
					commercePaymentMethodGroupRel, groupId, active,
	...
	public CommercePaymentMethodGroupRelPersistenceImpl() {
		...
		try {
			...
			dbColumnNames.put("commercePaymentMethodGroupRelId",
	...
	public void cacheResult(
		CommercePaymentMethodGroupRel commercePaymentMethodGroupRel) {
		entityCache.putResult(CommercePaymentMethodGroupRelModelImpl.ENTITY_CACHE_ENABLED,
			CommercePaymentMethodGroupRelImpl.class,
	...
	public void clearCache(
		...
		clearUniqueFindersCache((CommercePaymentMethodGroupRelModelImpl)commercePaymentMethodGroupRel,
			true);
	}
	...
	protected void cacheUniqueFindersCache(
		CommercePaymentMethodGroupRelModelImpl commercePaymentMethodGroupRelModelImpl) {
		...
		finderCache.putResult(FINDER_PATH_FETCH_BY_G_E, args,
			commercePaymentMethodGroupRelModelImpl, false);
	}
	...
	public CommercePaymentMethodGroupRel create(
		...
		CommercePaymentMethodGroupRel commercePaymentMethodGroupRel = new CommercePaymentMethodGroupRelImpl();

		commercePaymentMethodGroupRel.setNew(true);
		commercePaymentMethodGroupRel.setPrimaryKey(commercePaymentMethodGroupRelId);

		commercePaymentMethodGroupRel.setCompanyId(companyProvider.getCompanyId());
	...
	public CommercePaymentMethodGroupRel remove(Serializable primaryKey)
		...
		try {
			...
			CommercePaymentMethodGroupRel commercePaymentMethodGroupRel = (CommercePaymentMethodGroupRel)session.get(CommercePaymentMethodGroupRelImpl.class,
					primaryKey);
			...
			if (commercePaymentMethodGroupRel == null) {
				...
				throw new NoSuchPaymentMethodGroupRelException(_NO_SUCH_ENTITY_WITH_PRIMARY_KEY +
					primaryKey);
			}
	...
	protected CommercePaymentMethodGroupRel removeImpl(
		...
		try {
			...
			if (!session.contains(commercePaymentMethodGroupRel)) {
				commercePaymentMethodGroupRel = (CommercePaymentMethodGroupRel)session.get(CommercePaymentMethodGroupRelImpl.class,
	...
	public CommercePaymentMethodGroupRel updateImpl(
		...
		if (!(commercePaymentMethodGroupRel instanceof CommercePaymentMethodGroupRelModelImpl)) {
			...
			if (ProxyUtil.isProxyClass(commercePaymentMethodGroupRel.getClass())) {
				invocationHandler = ProxyUtil.getInvocationHandler(commercePaymentMethodGroupRel);
		...
		CommercePaymentMethodGroupRelModelImpl commercePaymentMethodGroupRelModelImpl =
			(CommercePaymentMethodGroupRelModelImpl)commercePaymentMethodGroupRel;
		...
		if (isNew && (commercePaymentMethodGroupRel.getCreateDate() == null)) {
			if (serviceContext == null) {
				...
				commercePaymentMethodGroupRel.setCreateDate(serviceContext.getCreateDate(
						now));
			}
		}
		...
		if (!commercePaymentMethodGroupRelModelImpl.hasSetModifiedDate()) {
			if (serviceContext == null) {
				...
				commercePaymentMethodGroupRel.setModifiedDate(serviceContext.getModifiedDate(
						now));
			}
		}
		...
		try {
			...
			if (commercePaymentMethodGroupRel.isNew()) {
				...
				commercePaymentMethodGroupRel = (CommercePaymentMethodGroupRel)session.merge(commercePaymentMethodGroupRel);
			}
		}
		catch (Exception e) {
			throw processException(e);
	...
	/**
	 * Returns the commerce payment method group rel with the primary key or throws a {@link com.liferay.portal.kernel.exception.NoSuchModelException} if it could not be found.
	 *
	 * @param primaryKey the primary key of the commerce payment method group rel
	...
	public CommercePaymentMethodGroupRel findByPrimaryKey(
		Serializable primaryKey) throws NoSuchPaymentMethodGroupRelException {
		CommercePaymentMethodGroupRel commercePaymentMethodGroupRel = fetchByPrimaryKey(primaryKey);
	...
	/**
	 * Returns the commerce payment method group rel with the primary key or throws a {@link NoSuchPaymentMethodGroupRelException} if it could not be found.
	 *
	 * @param commercePaymentMethodGroupRelId the primary key of the commerce payment method group rel
	 * @return the commerce payment method group rel
	 * @throws NoSuchPaymentMethodGroupRelException if a commerce payment method group rel with the primary key could not be found
	...
	public CommercePaymentMethodGroupRel fetchByPrimaryKey(
		...
		Serializable serializable = entityCache.getResult(CommercePaymentMethodGroupRelModelImpl.ENTITY_CACHE_ENABLED,
		...
		CommercePaymentMethodGroupRel commercePaymentMethodGroupRel = (CommercePaymentMethodGroupRel)serializable;
	...
	public Map<Serializable, CommercePaymentMethodGroupRel> fetchByPrimaryKeys(
		...
		Map<Serializable, CommercePaymentMethodGroupRel> map = new HashMap<Serializable, CommercePaymentMethodGroupRel>();
		...
		try {
			...
			for (CommercePaymentMethodGroupRel commercePaymentMethodGroupRel : (List<CommercePaymentMethodGroupRel>)q.list()) {
				map.put(commercePaymentMethodGroupRel.getPrimaryKeyObj(),
					commercePaymentMethodGroupRel);

				cacheResult(commercePaymentMethodGroupRel);

				uncachedPrimaryKeys.remove(commercePaymentMethodGroupRel.getPrimaryKeyObj());
			}
	...
	public List<CommercePaymentMethodGroupRel> findAll(int start, int end,
		...
		if (list == null) {
			...
			if (orderByComparator != null) {
				...
				if (pagination) {
					sql = sql.concat(CommercePaymentMethodGroupRelModelImpl.ORDER_BY_JPQL);
				}
			}
	...
	public void removeAll() {
		for (CommercePaymentMethodGroupRel commercePaymentMethodGroupRel : findAll()) {
			remove(commercePaymentMethodGroupRel);
		}
	}
	...
	public int countAll() {
		...
		if (count == null) {
			...
			try {
				...
				Query q = session.createQuery(_SQL_COUNT_COMMERCEPAYMENTMETHODGROUPREL);
	...
	public void destroy() {
		entityCache.removeCache(CommercePaymentMethodGroupRelImpl.class.getName());
	...
	private static final String _SQL_SELECT_COMMERCEPAYMENTMETHODGROUPREL_WHERE_PKS_IN =

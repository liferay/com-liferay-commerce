 ...
 *
 * <p>
 * This implementation and its corresponding interface {@link CommercePriceListAccountRelModel} exist only as a container for the default property accessors generated by ServiceBuilder. Helper methods and all application logic should be put in {@link CommercePriceListAccountRelImpl}.
 * </p>
 *
...
@JSON(strict = true)
@ProviderType
public class CommercePriceListAccountRelModelImpl extends BaseModelImpl<CommercePriceListAccountRel>
	...
	public static final String TABLE_SQL_CREATE = "create table CommercePriceListAccountRel (uuid_ VARCHAR(75) null,commercePriceListAccountRelId LONG not null primary key,groupId LONG,companyId LONG,userId LONG,userName VARCHAR(75) null,createDate DATE null,modifiedDate DATE null,commerceAccountId LONG,commercePriceListId LONG,order_ INTEGER,lastPublishDate DATE null)";
	public static final String TABLE_SQL_DROP = "drop table CommercePriceListAccountRel";
	public static final String ORDER_BY_JPQL = " ORDER BY commercePriceListAccountRel.order ASC";
	public static final String ORDER_BY_SQL = " ORDER BY CommercePriceListAccountRel.order_ ASC";
	...
	public static CommercePriceListAccountRel toModel(
		...
		CommercePriceListAccountRel model = new CommercePriceListAccountRelImpl();

		model.setUuid(soapModel.getUuid());
		model.setCommercePriceListAccountRelId(soapModel.getCommercePriceListAccountRelId());
	...
	public ExpandoBridge getExpandoBridge() {
		return ExpandoBridgeFactoryUtil.getExpandoBridge(getCompanyId(),
			CommercePriceListAccountRel.class.getName(), getPrimaryKey());
	}
	...
	public CommercePriceListAccountRel toEscapedModel() {
		if (_escapedModel == null) {
			_escapedModel = (CommercePriceListAccountRel)ProxyUtil.newProxyInstance(_classLoader,
	...
	public Object clone() {
		...
		commercePriceListAccountRelImpl.setCommercePriceListAccountRelId(getCommercePriceListAccountRelId());
		...
		commercePriceListAccountRelImpl.setCommerceAccountId(getCommerceAccountId());
		commercePriceListAccountRelImpl.setCommercePriceListId(getCommercePriceListId());
		commercePriceListAccountRelImpl.setOrder(getOrder());
		commercePriceListAccountRelImpl.setLastPublishDate(getLastPublishDate());
	...
	public boolean equals(Object obj) {
		...
		CommercePriceListAccountRel commercePriceListAccountRel = (CommercePriceListAccountRel)obj;
	...
	public void resetOriginalValues() {
		...
		commercePriceListAccountRelModelImpl._originalUuid = commercePriceListAccountRelModelImpl._uuid;

		commercePriceListAccountRelModelImpl._originalGroupId = commercePriceListAccountRelModelImpl._groupId;

		commercePriceListAccountRelModelImpl._setOriginalGroupId = false;

		commercePriceListAccountRelModelImpl._originalCompanyId = commercePriceListAccountRelModelImpl._companyId;
		...
		commercePriceListAccountRelModelImpl._originalCommerceAccountId = commercePriceListAccountRelModelImpl._commerceAccountId;

		commercePriceListAccountRelModelImpl._setOriginalCommerceAccountId = false;

		commercePriceListAccountRelModelImpl._originalCommercePriceListId = commercePriceListAccountRelModelImpl._commercePriceListId;

		commercePriceListAccountRelModelImpl._setOriginalCommercePriceListId = false;
	...
	public CacheModel<CommercePriceListAccountRel> toCacheModel() {
		...
		commercePriceListAccountRelCacheModel.commercePriceListAccountRelId = getCommercePriceListAccountRelId();
		...
		if (createDate != null) {
			commercePriceListAccountRelCacheModel.createDate = createDate.getTime();
		}
		else {
		...
		if (modifiedDate != null) {
			commercePriceListAccountRelCacheModel.modifiedDate = modifiedDate.getTime();
		}
		else {
			commercePriceListAccountRelCacheModel.modifiedDate = Long.MIN_VALUE;
		}

		commercePriceListAccountRelCacheModel.commerceAccountId = getCommerceAccountId();

		commercePriceListAccountRelCacheModel.commercePriceListId = getCommercePriceListId();
		...
		if (lastPublishDate != null) {
			commercePriceListAccountRelCacheModel.lastPublishDate = lastPublishDate.getTime();
		}
		else {
			commercePriceListAccountRelCacheModel.lastPublishDate = Long.MIN_VALUE;
		}
	...
	public String toString() {
		...
		sb.append(getCommercePriceListAccountRelId());
		sb.append(", groupId=");
	...
	public String toXmlString() {
		...
		sb.append(
			"<column><column-name>commercePriceListAccountRelId</column-name><column-value><![CDATA[");
		sb.append(getCommercePriceListAccountRelId());
		sb.append("]]></column-value></column>");
		sb.append(
	...
	private static final ClassLoader _classLoader = CommercePriceListAccountRel.class.getClassLoader();

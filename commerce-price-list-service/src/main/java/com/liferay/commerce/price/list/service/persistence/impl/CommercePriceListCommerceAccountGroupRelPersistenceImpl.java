 ...
 * @see com.liferay.commerce.price.list.service.persistence.CommercePriceListCommerceAccountGroupRelUtil
 * @generated
 */
@ProviderType
public class CommercePriceListCommerceAccountGroupRelPersistenceImpl
	 ...
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link CommercePriceListCommerceAccountGroupRelUtil} to access the commerce price list commerce account group rel persistence. Modify <code>service.xml</code> and rerun ServiceBuilder to regenerate this class.
	 */
	public static final String FINDER_CLASS_NAME_ENTITY = CommercePriceListCommerceAccountGroupRelImpl.class.getName();
	public static final String FINDER_CLASS_NAME_LIST_WITH_PAGINATION = FINDER_CLASS_NAME_ENTITY +
		".List1";
	public static final String FINDER_CLASS_NAME_LIST_WITHOUT_PAGINATION = FINDER_CLASS_NAME_ENTITY +
		".List2";
	public static final FinderPath FINDER_PATH_WITH_PAGINATION_FIND_ALL = new FinderPath(CommercePriceListCommerceAccountGroupRelModelImpl.ENTITY_CACHE_ENABLED,
			CommercePriceListCommerceAccountGroupRelModelImpl.FINDER_CACHE_ENABLED,
			CommercePriceListCommerceAccountGroupRelImpl.class,
			FINDER_CLASS_NAME_LIST_WITH_PAGINATION, "findAll", new String[0]);
	public static final FinderPath FINDER_PATH_WITHOUT_PAGINATION_FIND_ALL = new FinderPath(CommercePriceListCommerceAccountGroupRelModelImpl.ENTITY_CACHE_ENABLED,
			CommercePriceListCommerceAccountGroupRelModelImpl.FINDER_CACHE_ENABLED,
			CommercePriceListCommerceAccountGroupRelImpl.class,
			FINDER_CLASS_NAME_LIST_WITHOUT_PAGINATION, "findAll", new String[0]);
	public static final FinderPath FINDER_PATH_COUNT_ALL = new FinderPath(CommercePriceListCommerceAccountGroupRelModelImpl.ENTITY_CACHE_ENABLED,
			CommercePriceListCommerceAccountGroupRelModelImpl.FINDER_CACHE_ENABLED,
			Long.class, FINDER_CLASS_NAME_LIST_WITHOUT_PAGINATION, "countAll",
			new String[0]);
	public static final FinderPath FINDER_PATH_WITH_PAGINATION_FIND_BY_UUID = new FinderPath(CommercePriceListCommerceAccountGroupRelModelImpl.ENTITY_CACHE_ENABLED,
			CommercePriceListCommerceAccountGroupRelModelImpl.FINDER_CACHE_ENABLED,
			CommercePriceListCommerceAccountGroupRelImpl.class,
	...
	public static final FinderPath FINDER_PATH_WITHOUT_PAGINATION_FIND_BY_UUID = new FinderPath(CommercePriceListCommerceAccountGroupRelModelImpl.ENTITY_CACHE_ENABLED,
			CommercePriceListCommerceAccountGroupRelModelImpl.FINDER_CACHE_ENABLED,
			CommercePriceListCommerceAccountGroupRelImpl.class,
			FINDER_CLASS_NAME_LIST_WITHOUT_PAGINATION, "findByUuid",
			new String[] { String.class.getName() },
			CommercePriceListCommerceAccountGroupRelModelImpl.UUID_COLUMN_BITMASK |
			CommercePriceListCommerceAccountGroupRelModelImpl.ORDER_COLUMN_BITMASK);
	public static final FinderPath FINDER_PATH_COUNT_BY_UUID = new FinderPath(CommercePriceListCommerceAccountGroupRelModelImpl.ENTITY_CACHE_ENABLED,
			CommercePriceListCommerceAccountGroupRelModelImpl.FINDER_CACHE_ENABLED,
	...
	public List<CommercePriceListCommerceAccountGroupRel> findByUuid(
		...
		if (retrieveFromCache) {
			list = (List<CommercePriceListCommerceAccountGroupRel>)finderCache.getResult(finderPath,
					finderArgs, this);

			if ((list != null) && !list.isEmpty()) {
				for (CommercePriceListCommerceAccountGroupRel commercePriceListCommerceAccountGroupRel : list) {
		...
		if (list == null) {
			...
			query.append(_SQL_SELECT_COMMERCEPRICELISTCOMMERCEACCOUNTGROUPREL_WHERE);
			...
			if (orderByComparator != null) {
			 ...
			 if (pagination) {
				query.append(CommercePriceListCommerceAccountGroupRelModelImpl.ORDER_BY_JPQL);
			}
			...
			try {
				...
				if (!pagination) {
					list = (List<CommercePriceListCommerceAccountGroupRel>)QueryUtil.list(q,
	...
	public CommercePriceListCommerceAccountGroupRel findByUuid_First(
		...
		throw new NoSuchPriceListCommerceAccountGroupRelException(msg.toString());
	}
	...
	public CommercePriceListCommerceAccountGroupRel fetchByUuid_First(
		String uuid,
		OrderByComparator<CommercePriceListCommerceAccountGroupRel> orderByComparator) {
		List<CommercePriceListCommerceAccountGroupRel> list = findByUuid(uuid,
	...
	public CommercePriceListCommerceAccountGroupRel[] findByUuid_PrevAndNext(
		...
		try {
			...
			CommercePriceListCommerceAccountGroupRel[] array = new CommercePriceListCommerceAccountGroupRelImpl[3];
	...
	protected CommercePriceListCommerceAccountGroupRel getByUuid_PrevAndNext(
		...
		if (orderByComparator != null) {
			Object[] values = orderByComparator.getOrderByConditionValues(commercePriceListCommerceAccountGroupRel);
	...
	public void removeByUuid(String uuid) {
		for (CommercePriceListCommerceAccountGroupRel commercePriceListCommerceAccountGroupRel : findByUuid(
	...
	public int countByUuid(String uuid) {
		...
		if (count == null) {
			...
			query.append(_SQL_COUNT_COMMERCEPRICELISTCOMMERCEACCOUNTGROUPREL_WHERE);
	...
	private static final String _FINDER_COLUMN_UUID_UUID_1 = "commercePriceListCommerceAccountGroupRel.uuid IS NULL";
	private static final String _FINDER_COLUMN_UUID_UUID_2 = "commercePriceListCommerceAccountGroupRel.uuid = ?";
	private static final String _FINDER_COLUMN_UUID_UUID_3 = "(commercePriceListCommerceAccountGroupRel.uuid IS NULL OR commercePriceListCommerceAccountGroupRel.uuid = '')";
	public static final FinderPath FINDER_PATH_FETCH_BY_UUID_G = new FinderPath(CommercePriceListCommerceAccountGroupRelModelImpl.ENTITY_CACHE_ENABLED,
			CommercePriceListCommerceAccountGroupRelModelImpl.FINDER_CACHE_ENABLED,
			CommercePriceListCommerceAccountGroupRelImpl.class,
			FINDER_CLASS_NAME_ENTITY, "fetchByUUID_G",
			new String[] { String.class.getName(), Long.class.getName() },
			CommercePriceListCommerceAccountGroupRelModelImpl.UUID_COLUMN_BITMASK |
			CommercePriceListCommerceAccountGroupRelModelImpl.GROUPID_COLUMN_BITMASK);
	public static final FinderPath FINDER_PATH_COUNT_BY_UUID_G = new FinderPath(CommercePriceListCommerceAccountGroupRelModelImpl.ENTITY_CACHE_ENABLED,
			CommercePriceListCommerceAccountGroupRelModelImpl.FINDER_CACHE_ENABLED,
			Long.class, FINDER_CLASS_NAME_LIST_WITHOUT_PAGINATION,
			"countByUUID_G",
			new String[] { String.class.getName(), Long.class.getName() });
	...
	/**
	 * Returns the commerce price list commerce account group rel where uuid = &#63; and groupId = &#63; or throws a {@link NoSuchPriceListCommerceAccountGroupRelException} if it could not be found.
	 *
	 * @param uuid the uuid
	 ...
	 */
	@Override
	public CommercePriceListCommerceAccountGroupRel findByUUID_G(String uuid,
		long groupId) throws NoSuchPriceListCommerceAccountGroupRelException {
		CommercePriceListCommerceAccountGroupRel commercePriceListCommerceAccountGroupRel =
	...
	/**
	 * Returns the commerce price list commerce account group rel where uuid = &#63; and groupId = &#63; or returns <code>null</code> if it could not be found. Uses the finder cache.
	 *
	 * @param uuid the uuid
	 * @param groupId the group ID
	 ...
	 */
	@Override
	public CommercePriceListCommerceAccountGroupRel fetchByUUID_G(String uuid,
		long groupId) {
		return fetchByUUID_G(uuid, groupId, true);
	}

	/**
	 * Returns the commerce price list commerce account group rel where uuid = &#63; and groupId = &#63; or returns <code>null</code> if it could not be found, optionally using the finder cache.
	 *
	 * @param uuid the uuid
	 * @param groupId the group ID
	 * @param retrieveFromCache whether to retrieve from the finder cache
	...
	public CommercePriceListCommerceAccountGroupRel fetchByUUID_G(String uuid,
		...
		if (result instanceof CommercePriceListCommerceAccountGroupRel) {
			...
			if (!Objects.equals(uuid,
						commercePriceListCommerceAccountGroupRel.getUuid()) ||
					(groupId != commercePriceListCommerceAccountGroupRel.getGroupId())) {
				result = null;
			}
		}
	...
	/**
	 * Removes the commerce price list commerce account group rel where uuid = &#63; and groupId = &#63; from the database.
	 *
	 * @param uuid the uuid
	 * @param groupId the group ID
	 ...
	 */
	@Override
	public CommercePriceListCommerceAccountGroupRel removeByUUID_G(
	...
	/**
	 * Returns the number of commerce price list commerce account group rels where uuid = &#63; and groupId = &#63;.
	 *
	 * @param uuid the uuid
	 * @param groupId the group ID
	 * @return the number of matching commerce price list commerce account group rels
	...
	private static final String _FINDER_COLUMN_UUID_G_UUID_1 = "commercePriceListCommerceAccountGroupRel.uuid IS NULL AND ";
	private static final String _FINDER_COLUMN_UUID_G_UUID_2 = "commercePriceListCommerceAccountGroupRel.uuid = ? AND ";
	private static final String _FINDER_COLUMN_UUID_G_UUID_3 = "(commercePriceListCommerceAccountGroupRel.uuid IS NULL OR commercePriceListCommerceAccountGroupRel.uuid = '') AND ";
	private static final String _FINDER_COLUMN_UUID_G_GROUPID_2 = "commercePriceListCommerceAccountGroupRel.groupId = ?";
	public static final FinderPath FINDER_PATH_WITH_PAGINATION_FIND_BY_UUID_C = new FinderPath(CommercePriceListCommerceAccountGroupRelModelImpl.ENTITY_CACHE_ENABLED,
			CommercePriceListCommerceAccountGroupRelModelImpl.FINDER_CACHE_ENABLED,
			CommercePriceListCommerceAccountGroupRelImpl.class,
	...
	public static final FinderPath FINDER_PATH_WITHOUT_PAGINATION_FIND_BY_UUID_C =
		new FinderPath(CommercePriceListCommerceAccountGroupRelModelImpl.ENTITY_CACHE_ENABLED,
			CommercePriceListCommerceAccountGroupRelModelImpl.FINDER_CACHE_ENABLED,
			CommercePriceListCommerceAccountGroupRelImpl.class,
			FINDER_CLASS_NAME_LIST_WITHOUT_PAGINATION, "findByUuid_C",
			new String[] { String.class.getName(), Long.class.getName() },
			CommercePriceListCommerceAccountGroupRelModelImpl.UUID_COLUMN_BITMASK |
			CommercePriceListCommerceAccountGroupRelModelImpl.COMPANYID_COLUMN_BITMASK |
			CommercePriceListCommerceAccountGroupRelModelImpl.ORDER_COLUMN_BITMASK);
	public static final FinderPath FINDER_PATH_COUNT_BY_UUID_C = new FinderPath(CommercePriceListCommerceAccountGroupRelModelImpl.ENTITY_CACHE_ENABLED,
			CommercePriceListCommerceAccountGroupRelModelImpl.FINDER_CACHE_ENABLED,
			Long.class, FINDER_CLASS_NAME_LIST_WITHOUT_PAGINATION,
			"countByUuid_C",
			new String[] { String.class.getName(), Long.class.getName() });
		...
		if (retrieveFromCache) {
			...
			if ((list != null) && !list.isEmpty()) {
				for (CommercePriceListCommerceAccountGroupRel commercePriceListCommerceAccountGroupRel : list) {
					if (!Objects.equals(uuid,
								commercePriceListCommerceAccountGroupRel.getUuid()) ||
							(companyId != commercePriceListCommerceAccountGroupRel.getCompanyId())) {
						list = null;
	...
	public CommercePriceListCommerceAccountGroupRel fetchByUuid_C_First(
		String uuid, long companyId,
		OrderByComparator<CommercePriceListCommerceAccountGroupRel> orderByComparator) {
		List<CommercePriceListCommerceAccountGroupRel> list = findByUuid_C(uuid,
	...
	public CommercePriceListCommerceAccountGroupRel[] findByUuid_C_PrevAndNext(
		...
		try {
			...
			array[0] = getByUuid_C_PrevAndNext(session,
					commercePriceListCommerceAccountGroupRel, uuid, companyId,
					orderByComparator, true);
	...
	public void removeByUuid_C(String uuid, long companyId) {
		for (CommercePriceListCommerceAccountGroupRel commercePriceListCommerceAccountGroupRel : findByUuid_C(
	...
	private static final String _FINDER_COLUMN_UUID_C_UUID_1 = "commercePriceListCommerceAccountGroupRel.uuid IS NULL AND ";
	private static final String _FINDER_COLUMN_UUID_C_UUID_2 = "commercePriceListCommerceAccountGroupRel.uuid = ? AND ";
	private static final String _FINDER_COLUMN_UUID_C_UUID_3 = "(commercePriceListCommerceAccountGroupRel.uuid IS NULL OR commercePriceListCommerceAccountGroupRel.uuid = '') AND ";
	private static final String _FINDER_COLUMN_UUID_C_COMPANYID_2 = "commercePriceListCommerceAccountGroupRel.companyId = ?";
	...
	public static final FinderPath FINDER_PATH_WITHOUT_PAGINATION_FIND_BY_COMMERCEPRICELISTID =
		new FinderPath(CommercePriceListCommerceAccountGroupRelModelImpl.ENTITY_CACHE_ENABLED,
			...
			CommercePriceListCommerceAccountGroupRelModelImpl.COMMERCEPRICELISTID_COLUMN_BITMASK |
			CommercePriceListCommerceAccountGroupRelModelImpl.ORDER_COLUMN_BITMASK);
	public static final FinderPath FINDER_PATH_COUNT_BY_COMMERCEPRICELISTID = new FinderPath(CommercePriceListCommerceAccountGroupRelModelImpl.ENTITY_CACHE_ENABLED,
			CommercePriceListCommerceAccountGroupRelModelImpl.FINDER_CACHE_ENABLED,
			Long.class, FINDER_CLASS_NAME_LIST_WITHOUT_PAGINATION,
	 ...
	 */
	@Override
	public List<CommercePriceListCommerceAccountGroupRel> findByCommercePriceListId(
	...
	public List<CommercePriceListCommerceAccountGroupRel> findByCommercePriceListId(
		...
		if (retrieveFromCache) {
			...
			if ((list != null) && !list.isEmpty()) {
				for (CommercePriceListCommerceAccountGroupRel commercePriceListCommerceAccountGroupRel : list) {
					if ((commercePriceListId != commercePriceListCommerceAccountGroupRel.getCommercePriceListId())) {
						list = null;
	 ...
	 */
	@Override
	public CommercePriceListCommerceAccountGroupRel findByCommercePriceListId_First(
		long commercePriceListId,
		OrderByComparator<CommercePriceListCommerceAccountGroupRel> orderByComparator)
		throws NoSuchPriceListCommerceAccountGroupRelException {
		CommercePriceListCommerceAccountGroupRel commercePriceListCommerceAccountGroupRel =
	 ...
	 */
	@Override
	public CommercePriceListCommerceAccountGroupRel fetchByCommercePriceListId_First(
		long commercePriceListId,
		OrderByComparator<CommercePriceListCommerceAccountGroupRel> orderByComparator) {
		List<CommercePriceListCommerceAccountGroupRel> list = findByCommercePriceListId(commercePriceListId,
				0, 1, orderByComparator);
	 ...
	 */
	@Override
	public CommercePriceListCommerceAccountGroupRel findByCommercePriceListId_Last(
		long commercePriceListId,
		OrderByComparator<CommercePriceListCommerceAccountGroupRel> orderByComparator)
		throws NoSuchPriceListCommerceAccountGroupRelException {
		CommercePriceListCommerceAccountGroupRel commercePriceListCommerceAccountGroupRel =
	 ...
	 */
	@Override
	public CommercePriceListCommerceAccountGroupRel fetchByCommercePriceListId_Last(
		long commercePriceListId,
		OrderByComparator<CommercePriceListCommerceAccountGroupRel> orderByComparator) {
	 ...
	 */
	@Override
	public CommercePriceListCommerceAccountGroupRel[] findByCommercePriceListId_PrevAndNext(
	...
	protected CommercePriceListCommerceAccountGroupRel getByCommercePriceListId_PrevAndNext(
		Session session,
		CommercePriceListCommerceAccountGroupRel commercePriceListCommerceAccountGroupRel,
		long commercePriceListId,
		OrderByComparator<CommercePriceListCommerceAccountGroupRel> orderByComparator,
	...
	public void removeByCommercePriceListId(long commercePriceListId) {
		for (CommercePriceListCommerceAccountGroupRel commercePriceListCommerceAccountGroupRel : findByCommercePriceListId(
	...
	public static final FinderPath FINDER_PATH_FETCH_BY_C_C = new FinderPath(CommercePriceListCommerceAccountGroupRelModelImpl.ENTITY_CACHE_ENABLED,
			CommercePriceListCommerceAccountGroupRelModelImpl.FINDER_CACHE_ENABLED,
			CommercePriceListCommerceAccountGroupRelImpl.class,
			FINDER_CLASS_NAME_ENTITY, "fetchByC_C",
			new String[] { Long.class.getName(), Long.class.getName() },
			CommercePriceListCommerceAccountGroupRelModelImpl.COMMERCEPRICELISTID_COLUMN_BITMASK |
			CommercePriceListCommerceAccountGroupRelModelImpl.COMMERCEACCOUNTGROUPID_COLUMN_BITMASK);
	public static final FinderPath FINDER_PATH_COUNT_BY_C_C = new FinderPath(CommercePriceListCommerceAccountGroupRelModelImpl.ENTITY_CACHE_ENABLED,
			CommercePriceListCommerceAccountGroupRelModelImpl.FINDER_CACHE_ENABLED,
			Long.class, FINDER_CLASS_NAME_LIST_WITHOUT_PAGINATION,
			"countByC_C",
			new String[] { Long.class.getName(), Long.class.getName() });
	...
	/**
	 * Returns the commerce price list commerce account group rel where commercePriceListId = &#63; and commerceAccountGroupId = &#63; or throws a {@link NoSuchPriceListCommerceAccountGroupRelException} if it could not be found.
	 *
	 * @param commercePriceListId the commerce price list ID
	...
	public CommercePriceListCommerceAccountGroupRel findByC_C(
		...
		throws NoSuchPriceListCommerceAccountGroupRelException {
		CommercePriceListCommerceAccountGroupRel commercePriceListCommerceAccountGroupRel =
			fetchByC_C(commercePriceListId, commerceAccountGroupId);
	...
	public CommercePriceListCommerceAccountGroupRel fetchByC_C(
		...
		if (result instanceof CommercePriceListCommerceAccountGroupRel) {
			...
			if ((commercePriceListId != commercePriceListCommerceAccountGroupRel.getCommercePriceListId()) ||
					(commerceAccountGroupId != commercePriceListCommerceAccountGroupRel.getCommerceAccountGroupId())) {
				result = null;
			}
		}
	...
	public CommercePriceListCommerceAccountGroupRel removeByC_C(
		...
		throws NoSuchPriceListCommerceAccountGroupRelException {
		CommercePriceListCommerceAccountGroupRel commercePriceListCommerceAccountGroupRel =
			findByC_C(commercePriceListId, commerceAccountGroupId);
	 ...
	 */
	@Override
	public int countByC_C(long commercePriceListId, long commerceAccountGroupId) {
	...
	private static final String _FINDER_COLUMN_C_C_COMMERCEPRICELISTID_2 = "commercePriceListCommerceAccountGroupRel.commercePriceListId = ? AND ";
	private static final String _FINDER_COLUMN_C_C_COMMERCEACCOUNTGROUPID_2 = "commercePriceListCommerceAccountGroupRel.commerceAccountGroupId = ?";
	...
	public CommercePriceListCommerceAccountGroupRelPersistenceImpl() {
		...
		try {
			...
			dbColumnNames.put("commercePriceListCommerceAccountGroupRelId",
	...
	public void cacheResult(
		CommercePriceListCommerceAccountGroupRel commercePriceListCommerceAccountGroupRel) {
		entityCache.putResult(CommercePriceListCommerceAccountGroupRelModelImpl.ENTITY_CACHE_ENABLED,
			CommercePriceListCommerceAccountGroupRelImpl.class,
	...
	@Override
	public void cacheResult(
		List<CommercePriceListCommerceAccountGroupRel> commercePriceListCommerceAccountGroupRels) {
		for (CommercePriceListCommerceAccountGroupRel commercePriceListCommerceAccountGroupRel : commercePriceListCommerceAccountGroupRels) {
			if (entityCache.getResult(
						CommercePriceListCommerceAccountGroupRelModelImpl.ENTITY_CACHE_ENABLED,
						CommercePriceListCommerceAccountGroupRelImpl.class,
						commercePriceListCommerceAccountGroupRel.getPrimaryKey()) == null) {
				cacheResult(commercePriceListCommerceAccountGroupRel);
			}
			else {
				commercePriceListCommerceAccountGroupRel.resetOriginalValues();
	...
	public void clearCache() {
		entityCache.clearCache(CommercePriceListCommerceAccountGroupRelImpl.class);
	...
	public void clearCache(
		CommercePriceListCommerceAccountGroupRel commercePriceListCommerceAccountGroupRel) {
		entityCache.removeResult(CommercePriceListCommerceAccountGroupRelModelImpl.ENTITY_CACHE_ENABLED,
			CommercePriceListCommerceAccountGroupRelImpl.class,
			commercePriceListCommerceAccountGroupRel.getPrimaryKey());
		...
		clearUniqueFindersCache((CommercePriceListCommerceAccountGroupRelModelImpl)commercePriceListCommerceAccountGroupRel,
			true);
	}
	...
	protected void cacheUniqueFindersCache(
		...
		Object[] args = new Object[] {
				...
				commercePriceListCommerceAccountGroupRelModelImpl.getGroupId()
			};
		...
		args = new Object[] {
				commercePriceListCommerceAccountGroupRelModelImpl.getCommercePriceListId(),
				commercePriceListCommerceAccountGroupRelModelImpl.getCommerceAccountGroupId()
			};
	...
	protected void clearUniqueFindersCache(
		...
		if ((commercePriceListCommerceAccountGroupRelModelImpl.getColumnBitmask() &
				FINDER_PATH_FETCH_BY_UUID_G.getColumnBitmask()) != 0) {
			Object[] args = new Object[] {
					commercePriceListCommerceAccountGroupRelModelImpl.getOriginalUuid(),
					commercePriceListCommerceAccountGroupRelModelImpl.getOriginalGroupId()
				};
		...
		if ((commercePriceListCommerceAccountGroupRelModelImpl.getColumnBitmask() &
			...
			Object[] args = new Object[] {
					commercePriceListCommerceAccountGroupRelModelImpl.getOriginalCommercePriceListId(),
					commercePriceListCommerceAccountGroupRelModelImpl.getOriginalCommerceAccountGroupId()
				};
	...
	public CommercePriceListCommerceAccountGroupRel create(
		...
		commercePriceListCommerceAccountGroupRel.setPrimaryKey(commercePriceListCommerceAccountGroupRelId);

		String uuid = PortalUUIDUtil.generate();

		commercePriceListCommerceAccountGroupRel.setUuid(uuid);

		commercePriceListCommerceAccountGroupRel.setCompanyId(companyProvider.getCompanyId());
	...
	public CommercePriceListCommerceAccountGroupRel remove(
		...
		try {
			...
			CommercePriceListCommerceAccountGroupRel commercePriceListCommerceAccountGroupRel =
				(CommercePriceListCommerceAccountGroupRel)session.get(CommercePriceListCommerceAccountGroupRelImpl.class,
					primaryKey);
			...
			if (commercePriceListCommerceAccountGroupRel == null) {
				...
				throw new NoSuchPriceListCommerceAccountGroupRelException(_NO_SUCH_ENTITY_WITH_PRIMARY_KEY +
					primaryKey);
			}
	...
	protected CommercePriceListCommerceAccountGroupRel removeImpl(
		...
		try {
			...
			if (!session.contains(commercePriceListCommerceAccountGroupRel)) {
				commercePriceListCommerceAccountGroupRel = (CommercePriceListCommerceAccountGroupRel)session.get(CommercePriceListCommerceAccountGroupRelImpl.class,
	...
	public CommercePriceListCommerceAccountGroupRel updateImpl(
		...
		if (!(commercePriceListCommerceAccountGroupRel instanceof CommercePriceListCommerceAccountGroupRelModelImpl)) {
			InvocationHandler invocationHandler = null;

			if (ProxyUtil.isProxyClass(
						commercePriceListCommerceAccountGroupRel.getClass())) {
				invocationHandler = ProxyUtil.getInvocationHandler(commercePriceListCommerceAccountGroupRel);
		...
		CommercePriceListCommerceAccountGroupRelModelImpl commercePriceListCommerceAccountGroupRelModelImpl =
			(CommercePriceListCommerceAccountGroupRelModelImpl)commercePriceListCommerceAccountGroupRel;

		if (Validator.isNull(commercePriceListCommerceAccountGroupRel.getUuid())) {
			String uuid = PortalUUIDUtil.generate();
		...
		if (isNew &&
				(commercePriceListCommerceAccountGroupRel.getCreateDate() == null)) {
			if (serviceContext == null) {
				commercePriceListCommerceAccountGroupRel.setCreateDate(now);
			}
			else {
				commercePriceListCommerceAccountGroupRel.setCreateDate(serviceContext.getCreateDate(
						now));
			}
		}

		if (!commercePriceListCommerceAccountGroupRelModelImpl.hasSetModifiedDate()) {
			if (serviceContext == null) {
				commercePriceListCommerceAccountGroupRel.setModifiedDate(now);
			}
			else {
				commercePriceListCommerceAccountGroupRel.setModifiedDate(serviceContext.getModifiedDate(
						now));
			}
		}
		...
		try {
			...
			if (commercePriceListCommerceAccountGroupRel.isNew()) {
				...
				commercePriceListCommerceAccountGroupRel = (CommercePriceListCommerceAccountGroupRel)session.merge(commercePriceListCommerceAccountGroupRel);
			}
		}
		catch (Exception e) {
			throw processException(e);
		...
		if (!CommercePriceListCommerceAccountGroupRelModelImpl.COLUMN_BITMASK_ENABLED) {
			finderCache.clearCache(FINDER_CLASS_NAME_LIST_WITHOUT_PAGINATION);
		}
		else
		 if (isNew) {
			...
			if ((commercePriceListCommerceAccountGroupRelModelImpl.getColumnBitmask() &
				...
				Object[] args = new Object[] {
						commercePriceListCommerceAccountGroupRelModelImpl.getOriginalUuid(),
						commercePriceListCommerceAccountGroupRelModelImpl.getOriginalCompanyId()
					};
		...
		clearUniqueFindersCache(commercePriceListCommerceAccountGroupRelModelImpl,
			false);
		cacheUniqueFindersCache(commercePriceListCommerceAccountGroupRelModelImpl);
	...
	/**
	 * Returns the commerce price list commerce account group rel with the primary key or throws a {@link com.liferay.portal.kernel.exception.NoSuchModelException} if it could not be found.
	 *
	 * @param primaryKey the primary key of the commerce price list commerce account group rel
	...
	/**
	 * Returns the commerce price list commerce account group rel with the primary key or throws a {@link NoSuchPriceListCommerceAccountGroupRelException} if it could not be found.
	 *
	 * @param commercePriceListCommerceAccountGroupRelId the primary key of the commerce price list commerce account group rel
	 * @return the commerce price list commerce account group rel
	 * @throws NoSuchPriceListCommerceAccountGroupRelException if a commerce price list commerce account group rel with the primary key could not be found
	...
	public CommercePriceListCommerceAccountGroupRel findByPrimaryKey(
		long commercePriceListCommerceAccountGroupRelId)
		throws NoSuchPriceListCommerceAccountGroupRelException {
		return findByPrimaryKey((Serializable)commercePriceListCommerceAccountGroupRelId);
	}
	...
	public CommercePriceListCommerceAccountGroupRel fetchByPrimaryKey(
		Serializable primaryKey) {
		Serializable serializable = entityCache.getResult(CommercePriceListCommerceAccountGroupRelModelImpl.ENTITY_CACHE_ENABLED,
	...
	public CommercePriceListCommerceAccountGroupRel fetchByPrimaryKey(
		long commercePriceListCommerceAccountGroupRelId) {
		return fetchByPrimaryKey((Serializable)commercePriceListCommerceAccountGroupRelId);
	}

	@Override
	public Map<Serializable, CommercePriceListCommerceAccountGroupRel> fetchByPrimaryKeys(
		Set<Serializable> primaryKeys) {
		if (primaryKeys.isEmpty()) {
			return Collections.emptyMap();
		}

		Map<Serializable, CommercePriceListCommerceAccountGroupRel> map = new HashMap<Serializable, CommercePriceListCommerceAccountGroupRel>();
		...
		query.append(_SQL_SELECT_COMMERCEPRICELISTCOMMERCEACCOUNTGROUPREL_WHERE_PKS_IN);
		...
		try {
			...
			for (CommercePriceListCommerceAccountGroupRel commercePriceListCommerceAccountGroupRel : (List<CommercePriceListCommerceAccountGroupRel>)q.list()) {
				map.put(commercePriceListCommerceAccountGroupRel.getPrimaryKeyObj(),
					commercePriceListCommerceAccountGroupRel);

				cacheResult(commercePriceListCommerceAccountGroupRel);

				uncachedPrimaryKeys.remove(commercePriceListCommerceAccountGroupRel.getPrimaryKeyObj());
			}
	 ...
	 */
	@Override
	public List<CommercePriceListCommerceAccountGroupRel> findAll(int start,
		int end) {
	...
	public List<CommercePriceListCommerceAccountGroupRel> findAll(int start,
		...
		if (list == null) {
			...
			if (orderByComparator != null) {
				...
				query.append(_SQL_SELECT_COMMERCEPRICELISTCOMMERCEACCOUNTGROUPREL);
				...
				if (pagination) {
					sql = sql.concat(CommercePriceListCommerceAccountGroupRelModelImpl.ORDER_BY_JPQL);
				}
			}
	...
	public void removeAll() {
		for (CommercePriceListCommerceAccountGroupRel commercePriceListCommerceAccountGroupRel : findAll()) {
			remove(commercePriceListCommerceAccountGroupRel);
		}
	}
	...
	public int countAll() {
		...
		if (count == null) {
			...
			try {
				...
				Query q = session.createQuery(_SQL_COUNT_COMMERCEPRICELISTCOMMERCEACCOUNTGROUPREL);
	...
	protected Map<String, Integer> getTableColumnsMap() {
		return CommercePriceListCommerceAccountGroupRelModelImpl.TABLE_COLUMNS_MAP;
	}
	...
	public void destroy() {
		entityCache.removeCache(CommercePriceListCommerceAccountGroupRelImpl.class.getName());
	...
	private static final String _SQL_SELECT_COMMERCEPRICELISTCOMMERCEACCOUNTGROUPREL =
	...
	private static final String _SQL_SELECT_COMMERCEPRICELISTCOMMERCEACCOUNTGROUPREL_WHERE_PKS_IN =
	...
	private static final String _SQL_SELECT_COMMERCEPRICELISTCOMMERCEACCOUNTGROUPREL_WHERE =
	...
	private static final String _SQL_COUNT_COMMERCEPRICELISTCOMMERCEACCOUNTGROUPREL =
	...
	private static final String _SQL_COUNT_COMMERCEPRICELISTCOMMERCEACCOUNTGROUPREL_WHERE =
	...
	private static final String _ORDER_BY_ENTITY_ALIAS = "commercePriceListCommerceAccountGroupRel.";
	private static final String _NO_SUCH_ENTITY_WITH_PRIMARY_KEY = "No CommercePriceListCommerceAccountGroupRel exists with the primary key ";
	private static final String _NO_SUCH_ENTITY_WITH_KEY = "No CommercePriceListCommerceAccountGroupRel exists with the key {";
	private static final Log _log = LogFactoryUtil.getLog(CommercePriceListCommerceAccountGroupRelPersistenceImpl.class);

...
public class CommercePriceListPersistenceImpl extends BasePersistenceImpl<CommercePriceList>
	...
	public static final FinderPath FINDER_PATH_WITH_PAGINATION_FIND_BY_G_C = new FinderPath(CommercePriceListModelImpl.ENTITY_CACHE_ENABLED,
			CommercePriceListModelImpl.FINDER_CACHE_ENABLED,
			CommercePriceListImpl.class,
	...
	public static final FinderPath FINDER_PATH_WITHOUT_PAGINATION_FIND_BY_G_C = new FinderPath(CommercePriceListModelImpl.ENTITY_CACHE_ENABLED,
			CommercePriceListModelImpl.FINDER_CACHE_ENABLED,
			CommercePriceListImpl.class,
			...
			CommercePriceListModelImpl.CREATEDATE_COLUMN_BITMASK |
			CommercePriceListModelImpl.PRIORITY_COLUMN_BITMASK);
	public static final FinderPath FINDER_PATH_COUNT_BY_G_C = new FinderPath(CommercePriceListModelImpl.ENTITY_CACHE_ENABLED,
			CommercePriceListModelImpl.FINDER_CACHE_ENABLED, Long.class,
			FINDER_CLASS_NAME_LIST_WITHOUT_PAGINATION, "countByG_C",
			new String[] { Long.class.getName(), Long.class.getName() });
	public static final FinderPath FINDER_PATH_WITH_PAGINATION_COUNT_BY_G_C = new FinderPath(CommercePriceListModelImpl.ENTITY_CACHE_ENABLED,
			CommercePriceListModelImpl.FINDER_CACHE_ENABLED, Long.class,
	 ...
	 */
	@Override
	public CommercePriceList findByG_C_First(long groupId, long companyId,
		OrderByComparator<CommercePriceList> orderByComparator)
		throws NoSuchPriceListException {
		CommercePriceList commercePriceList = fetchByG_C_First(groupId,
				companyId, orderByComparator);
	 ...
	 */
	@Override
	public CommercePriceList fetchByG_C_First(long groupId, long companyId,
		OrderByComparator<CommercePriceList> orderByComparator) {
		List<CommercePriceList> list = findByG_C(groupId, companyId, 0, 1,
				orderByComparator);
	 ...
	 */
	@Override
	public CommercePriceList findByG_C_Last(long groupId, long companyId,
		OrderByComparator<CommercePriceList> orderByComparator)
		throws NoSuchPriceListException {
		CommercePriceList commercePriceList = fetchByG_C_Last(groupId,
				companyId, orderByComparator);
	 ...
	 */
	@Override
	public CommercePriceList fetchByG_C_Last(long groupId, long companyId,
		OrderByComparator<CommercePriceList> orderByComparator) {
		...
		List<CommercePriceList> list = findByG_C(groupId, companyId, count - 1,
				count, orderByComparator);
	 ...
	 */
	@Override
	public CommercePriceList[] findByG_C_PrevAndNext(long commercePriceListId,
		...
		try {
			...
			array[0] = getByG_C_PrevAndNext(session, commercePriceList,
					groupId, companyId, orderByComparator, true);

			array[1] = commercePriceList;

			array[2] = getByG_C_PrevAndNext(session, commercePriceList,
	...
	protected CommercePriceList getByG_C_PrevAndNext(Session session,
		CommercePriceList commercePriceList, long groupId, long companyId,
		OrderByComparator<CommercePriceList> orderByComparator, boolean previous) {
		StringBundler query = null;
	...
	public List<CommercePriceList> findByG_C(long[] groupIds, long companyId,
		...
		if (retrieveFromCache) {
			list = (List<CommercePriceList>)finderCache.getResult(FINDER_PATH_WITH_PAGINATION_FIND_BY_G_C,
					finderArgs, this);
	...
	public void removeByG_C(long groupId, long companyId) {
		for (CommercePriceList commercePriceList : findByG_C(groupId,
				companyId, QueryUtil.ALL_POS, QueryUtil.ALL_POS, null)) {
			remove(commercePriceList);
		}
	}
	...
	private static final String _FINDER_COLUMN_G_C_GROUPID_2 = "commercePriceList.groupId = ? AND ";
	private static final String _FINDER_COLUMN_G_C_GROUPID_7 = "commercePriceList.groupId IN (";
	private static final String _FINDER_COLUMN_G_C_COMPANYID_2 = "commercePriceList.companyId = ?";
	...
	public static final FinderPath FINDER_PATH_WITH_PAGINATION_FIND_BY_G_C_S = new FinderPath(CommercePriceListModelImpl.ENTITY_CACHE_ENABLED,
			CommercePriceListModelImpl.FINDER_CACHE_ENABLED,
			CommercePriceListImpl.class,
	...
	public static final FinderPath FINDER_PATH_WITHOUT_PAGINATION_FIND_BY_G_C_S = new FinderPath(CommercePriceListModelImpl.ENTITY_CACHE_ENABLED,
			CommercePriceListModelImpl.FINDER_CACHE_ENABLED,
			CommercePriceListImpl.class,
			...
			CommercePriceListModelImpl.CREATEDATE_COLUMN_BITMASK |
			CommercePriceListModelImpl.PRIORITY_COLUMN_BITMASK);
	public static final FinderPath FINDER_PATH_COUNT_BY_G_C_S = new FinderPath(CommercePriceListModelImpl.ENTITY_CACHE_ENABLED,
			CommercePriceListModelImpl.FINDER_CACHE_ENABLED, Long.class,
	...
	public static final FinderPath FINDER_PATH_WITH_PAGINATION_COUNT_BY_G_C_S = new FinderPath(CommercePriceListModelImpl.ENTITY_CACHE_ENABLED,
			CommercePriceListModelImpl.FINDER_CACHE_ENABLED, Long.class,
	 ...
	 */
	@Override
	public List<CommercePriceList> findByG_C_S(long groupId, long companyId,
		int status) {
		return findByG_C_S(groupId, companyId, status, QueryUtil.ALL_POS,
			QueryUtil.ALL_POS, null);
	}
	...
	public List<CommercePriceList> findByG_C_S(long groupId, long companyId,
		int status, int start, int end,
		OrderByComparator<CommercePriceList> orderByComparator) {
		return findByG_C_S(groupId, companyId, status, start, end,
			orderByComparator, true);
	}
	 ...
	 */
	@Override
	public CommercePriceList findByG_C_S_First(long groupId, long companyId,
		int status, OrderByComparator<CommercePriceList> orderByComparator)
		throws NoSuchPriceListException {
		CommercePriceList commercePriceList = fetchByG_C_S_First(groupId,
	 ...
	 */
	@Override
	public CommercePriceList fetchByG_C_S_First(long groupId, long companyId,
		int status, OrderByComparator<CommercePriceList> orderByComparator) {
		List<CommercePriceList> list = findByG_C_S(groupId, companyId, status,
				0, 1, orderByComparator);
	 ...
	 */
	@Override
	public CommercePriceList findByG_C_S_Last(long groupId, long companyId,
		int status, OrderByComparator<CommercePriceList> orderByComparator)
		throws NoSuchPriceListException {
		CommercePriceList commercePriceList = fetchByG_C_S_Last(groupId,
				companyId, status, orderByComparator);
	 ...
	 */
	@Override
	public CommercePriceList fetchByG_C_S_Last(long groupId, long companyId,
		int status, OrderByComparator<CommercePriceList> orderByComparator) {
	...
	public CommercePriceList[] findByG_C_S_PrevAndNext(
		...
		try {
			...
			array[0] = getByG_C_S_PrevAndNext(session, commercePriceList,
					groupId, companyId, status, orderByComparator, true);

			array[1] = commercePriceList;

			array[2] = getByG_C_S_PrevAndNext(session, commercePriceList,
					groupId, companyId, status, orderByComparator, false);
	...
	protected CommercePriceList getByG_C_S_PrevAndNext(Session session,
		CommercePriceList commercePriceList, long groupId, long companyId,
		int status, OrderByComparator<CommercePriceList> orderByComparator,
		boolean previous) {
		StringBundler query = null;
	 ...
	 */
	@Override
	public List<CommercePriceList> findByG_C_S(long[] groupIds, long companyId,
		int status) {
		return findByG_C_S(groupIds, companyId, status, QueryUtil.ALL_POS,
			QueryUtil.ALL_POS, null);
	}
	...
	public List<CommercePriceList> findByG_C_S(long[] groupIds, long companyId,
		int status, int start, int end,
		OrderByComparator<CommercePriceList> orderByComparator) {
		return findByG_C_S(groupIds, companyId, status, start, end,
			orderByComparator, true);
	}
	...
	public List<CommercePriceList> findByG_C_S(long[] groupIds, long companyId,
		...
		if (groupIds.length == 1) {
			return findByG_C_S(groupIds[0], companyId, status, start, end,
				orderByComparator);
		}
		...
		if (retrieveFromCache) {
			list = (List<CommercePriceList>)finderCache.getResult(FINDER_PATH_WITH_PAGINATION_FIND_BY_G_C_S,
					finderArgs, this);
	...
	public void removeByG_C_S(long groupId, long companyId, int status) {
		for (CommercePriceList commercePriceList : findByG_C_S(groupId,
	...
	private static final String _FINDER_COLUMN_G_C_S_GROUPID_2 = "commercePriceList.groupId = ? AND ";
	private static final String _FINDER_COLUMN_G_C_S_GROUPID_7 = "commercePriceList.groupId IN (";
	private static final String _FINDER_COLUMN_G_C_S_COMPANYID_2 = "commercePriceList.companyId = ? AND ";
	private static final String _FINDER_COLUMN_G_C_S_STATUS_2 = "commercePriceList.status = ?";
	public static final FinderPath FINDER_PATH_WITH_PAGINATION_FIND_BY_G_C_NOTS = new FinderPath(CommercePriceListModelImpl.ENTITY_CACHE_ENABLED,
			CommercePriceListModelImpl.FINDER_CACHE_ENABLED,
			CommercePriceListImpl.class,
	 ...
	 */
	@Override
	public List<CommercePriceList> findByG_C_NotS(long groupId, long companyId,
		int status) {
		return findByG_C_NotS(groupId, companyId, status, QueryUtil.ALL_POS,
			QueryUtil.ALL_POS, null);
	}
	...
	public List<CommercePriceList> findByG_C_NotS(long groupId, long companyId,
		int status, int start, int end,
		OrderByComparator<CommercePriceList> orderByComparator) {
		return findByG_C_NotS(groupId, companyId, status, start, end,
			orderByComparator, true);
	}
	 ...
	 */
	@Override
	public CommercePriceList findByG_C_NotS_First(long groupId, long companyId,
		int status, OrderByComparator<CommercePriceList> orderByComparator)
		throws NoSuchPriceListException {
		CommercePriceList commercePriceList = fetchByG_C_NotS_First(groupId,
				companyId, status, orderByComparator);
	 ...
	 */
	@Override
	public CommercePriceList fetchByG_C_NotS_First(long groupId,
		long companyId, int status,
		OrderByComparator<CommercePriceList> orderByComparator) {
		List<CommercePriceList> list = findByG_C_NotS(groupId, companyId,
	 ...
	 */
	@Override
	public CommercePriceList findByG_C_NotS_Last(long groupId, long companyId,
		int status, OrderByComparator<CommercePriceList> orderByComparator)
		throws NoSuchPriceListException {
		CommercePriceList commercePriceList = fetchByG_C_NotS_Last(groupId,
				companyId, status, orderByComparator);
	 ...
	 */
	@Override
	public CommercePriceList fetchByG_C_NotS_Last(long groupId, long companyId,
		int status, OrderByComparator<CommercePriceList> orderByComparator) {
	...
	public CommercePriceList[] findByG_C_NotS_PrevAndNext(
		...
		try {
			...
			array[0] = getByG_C_NotS_PrevAndNext(session, commercePriceList,
					groupId, companyId, status, orderByComparator, true);

			array[1] = commercePriceList;

			array[2] = getByG_C_NotS_PrevAndNext(session, commercePriceList,
					groupId, companyId, status, orderByComparator, false);
	...
	protected CommercePriceList getByG_C_NotS_PrevAndNext(Session session,
		CommercePriceList commercePriceList, long groupId, long companyId,
		int status, OrderByComparator<CommercePriceList> orderByComparator,
		boolean previous) {
		StringBundler query = null;
	 ...
	 */
	@Override
	public List<CommercePriceList> findByG_C_NotS(long[] groupIds,
		long companyId, int status) {
		return findByG_C_NotS(groupIds, companyId, status, QueryUtil.ALL_POS,
			QueryUtil.ALL_POS, null);
	}
	...
	public List<CommercePriceList> findByG_C_NotS(long[] groupIds,
		long companyId, int status, int start, int end,
		OrderByComparator<CommercePriceList> orderByComparator) {
		return findByG_C_NotS(groupIds, companyId, status, start, end,
			orderByComparator, true);
	}
	...
	public List<CommercePriceList> findByG_C_NotS(long[] groupIds,
		...
		if (groupIds.length == 1) {
			return findByG_C_NotS(groupIds[0], companyId, status, start, end,
				orderByComparator);
		}
		...
		if (retrieveFromCache) {
			list = (List<CommercePriceList>)finderCache.getResult(FINDER_PATH_WITH_PAGINATION_FIND_BY_G_C_NOTS,
					finderArgs, this);
	...
	public void removeByG_C_NotS(long groupId, long companyId, int status) {
		for (CommercePriceList commercePriceList : findByG_C_NotS(groupId,
				companyId, status, QueryUtil.ALL_POS, QueryUtil.ALL_POS, null)) {
			remove(commercePriceList);
		}
	}
	...
	private static final String _FINDER_COLUMN_G_C_NOTS_GROUPID_2 = "commercePriceList.groupId = ? AND ";
	private static final String _FINDER_COLUMN_G_C_NOTS_GROUPID_7 = "commercePriceList.groupId IN (";
	private static final String _FINDER_COLUMN_G_C_NOTS_COMPANYID_2 = "commercePriceList.companyId = ? AND ";
	private static final String _FINDER_COLUMN_G_C_NOTS_STATUS_2 = "commercePriceList.status != ?";

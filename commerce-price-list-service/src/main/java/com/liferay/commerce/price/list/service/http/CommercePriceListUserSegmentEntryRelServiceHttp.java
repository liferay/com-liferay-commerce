...
public class CommercePriceListUserSegmentEntryRelServiceHttp {
	...
	public static
		...
		try {
			MethodKey methodKey = new MethodKey(
				CommercePriceListUserSegmentEntryRelServiceUtil.class,
				"addCommercePriceListUserSegmentEntryRel",
				_addCommercePriceListUserSegmentEntryRelParameterTypes0);

			MethodHandler methodHandler = new MethodHandler(
				methodKey, commercePriceListId, commerceUserSegmentEntryId,
			...
			return (com.liferay.commerce.price.list.model.
				CommercePriceListUserSegmentEntryRel)returnObj;
		}
	...
	public static void deleteCommercePriceListUserSegmentEntryRel(
		...
		try {
			...
			MethodHandler methodHandler = new MethodHandler(
				methodKey, commercePriceListUserSegmentEntryRelId);
	...
	public static
		...
		try {
			...
			MethodHandler methodHandler = new MethodHandler(
				methodKey, commercePriceListUserSegmentEntryRelId, order,
				serviceContext);
	...
	private static Log _log = LogFactoryUtil.getLog(
		CommercePriceListUserSegmentEntryRelServiceHttp.class);

	private static final Class<?>[]
		_addCommercePriceListUserSegmentEntryRelParameterTypes0 = new Class[] {
	...
	private static final Class<?>[]
		_getCommercePriceListUserSegmentEntryRelsParameterTypes3 = new Class[] {
			long.class
		};
	private static final Class<?>[]
		_getCommercePriceListUserSegmentEntryRelsParameterTypes4 = new Class[] {

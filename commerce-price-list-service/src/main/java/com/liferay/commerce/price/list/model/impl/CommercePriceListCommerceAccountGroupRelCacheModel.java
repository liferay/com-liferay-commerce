...
public class CommercePriceListCommerceAccountGroupRelCacheModel
	...
	public boolean equals(Object obj) {
		...
		if (!(obj instanceof CommercePriceListCommerceAccountGroupRelCacheModel)) {
			return false;
		}
		...
		if (commercePriceListCommerceAccountGroupRelId == commercePriceListCommerceAccountGroupRelCacheModel.commercePriceListCommerceAccountGroupRelId) {
			return true;
		}
	...
	public CommercePriceListCommerceAccountGroupRel toEntityModel() {
		...
		if (createDate == Long.MIN_VALUE) {
			...
			commercePriceListCommerceAccountGroupRelImpl.setCreateDate(new Date(
					createDate));
		}
		...
		if (modifiedDate == Long.MIN_VALUE) {
			...
			commercePriceListCommerceAccountGroupRelImpl.setModifiedDate(new Date(
					modifiedDate));
		}

		commercePriceListCommerceAccountGroupRelImpl.setCommercePriceListId(commercePriceListId);
		commercePriceListCommerceAccountGroupRelImpl.setCommerceAccountGroupId(commerceAccountGroupId);
		commercePriceListCommerceAccountGroupRelImpl.setOrder(order);

		if (lastPublishDate == Long.MIN_VALUE) {
			commercePriceListCommerceAccountGroupRelImpl.setLastPublishDate(null);
		}
		else {
			commercePriceListCommerceAccountGroupRelImpl.setLastPublishDate(new Date(
					lastPublishDate));
		}

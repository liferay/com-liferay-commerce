...
public class CommercePriceEntryPersistenceImpl
	...
	/**
	 * Returns the commerce price entry where uuid = &#63; and groupId = &#63; or throws a <code>NoSuchPriceEntryException</code> if it could not be found.
	 *
	 * @param uuid the uuid
	 ...
	 */
	@Override
	public CommercePriceEntry fetchByUUID_G(
	 ...
	 */
	@Override
	public List<CommercePriceEntry> findByGroupId(
	 ...
	 */
	@Override
	public CommercePriceEntry findByGroupId_First(
			long groupId,
			OrderByComparator<CommercePriceEntry> orderByComparator)
		throws NoSuchPriceEntryException {

		CommercePriceEntry commercePriceEntry = fetchByGroupId_First(
	 ...
	 */
	@Override
	public CommercePriceEntry fetchByGroupId_First(
		long groupId, OrderByComparator<CommercePriceEntry> orderByComparator) {

		List<CommercePriceEntry> list = findByGroupId(
	 ...
	 */
	@Override
	public CommercePriceEntry findByGroupId_Last(
			long groupId,
			OrderByComparator<CommercePriceEntry> orderByComparator)
		throws NoSuchPriceEntryException {

		CommercePriceEntry commercePriceEntry = fetchByGroupId_Last(
			groupId, orderByComparator);
	 ...
	 */
	@Override
	public CommercePriceEntry fetchByGroupId_Last(
		long groupId, OrderByComparator<CommercePriceEntry> orderByComparator) {
	...
	public CommercePriceEntry[] findByGroupId_PrevAndNext(
		...
		try {
			...
			array[0] = getByGroupId_PrevAndNext(
				session, commercePriceEntry, groupId, orderByComparator, true);

			array[1] = commercePriceEntry;

			array[2] = getByGroupId_PrevAndNext(
				session, commercePriceEntry, groupId, orderByComparator, false);
	...
	protected CommercePriceEntry getByGroupId_PrevAndNext(
		Session session, CommercePriceEntry commercePriceEntry, long groupId,
		OrderByComparator<CommercePriceEntry> orderByComparator,
		boolean previous) {
	...
	protected void cacheUniqueFindersCache(
		...
		finderCache.putResult(
			_finderPathFetchByUUID_G, args, commercePriceEntryModelImpl, false);

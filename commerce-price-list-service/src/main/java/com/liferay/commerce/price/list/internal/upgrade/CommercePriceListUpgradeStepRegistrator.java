...
import com.liferay.commerce.price.list.internal.upgrade.v3_0_0.CommercePriceListUpgradeProcess;
...
public class CommercePriceListUpgradeStepRegistrator
	...
	public void register(Registry registry) {
		...
		registry.register(
			_SCHEMA_VERSION_2_0_0, _SCHEMA_VERSION_3_0_0,
			new CommercePriceListUpgradeProcess());

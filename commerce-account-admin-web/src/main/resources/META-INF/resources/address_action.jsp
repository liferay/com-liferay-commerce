...
>
	<liferay-ui:icon
		message="edit"
		url="<%= commerceAccountAddressAdminDisplayContext.getEditCommerceAddressURL(commerceAddress.getCommerceAddressId()) %>"
	/>

	<liferay-ui:icon-delete
		url="<%= commerceAccountAddressAdminDisplayContext.getDeleteCommerceAddressURL(commerceAddress.getCommerceAddressId()) %>"
	/>
</liferay-ui:icon-menu>
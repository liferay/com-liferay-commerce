...
>
	<c:if test="<%= cpInstanceCommerceTierPriceEntryDisplayContext.hasManageCommercePriceListPermission() %>">
		...
		<portlet:actionURL name="editCPInstanceCommerceTierPriceEntry" var="deleteURL">

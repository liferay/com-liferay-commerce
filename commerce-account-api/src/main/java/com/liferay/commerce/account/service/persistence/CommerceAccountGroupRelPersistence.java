...
public interface CommerceAccountGroupRelPersistence extends BasePersistence<CommerceAccountGroupRel> {
	...
	* @return the matching commerce account group rels
	*/
	public java.util.List<CommerceAccountGroupRel> findByC_C(long classNameId,
		long classPK);
	...
	*/
	...
	@Override
	public java.util.Map<java.io.Serializable, CommerceAccountGroupRel> fetchByPrimaryKeys(

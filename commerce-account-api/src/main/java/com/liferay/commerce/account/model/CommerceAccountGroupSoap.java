 ...
 *
 * @author Marco Leo
 * @see com.liferay.commerce.account.service.http.CommerceAccountGroupServiceSoap
 * @generated
 */
@ProviderType
public class CommerceAccountGroupSoap implements Serializable {
	...
	public static CommerceAccountGroupSoap[] toSoapModels(
		...
		CommerceAccountGroupSoap[] soapModels = new CommerceAccountGroupSoap[models.length];
	...
	public static CommerceAccountGroupSoap[][] toSoapModels(
		...
		if (models.length > 0) {
			soapModels = new CommerceAccountGroupSoap[models.length][models[0].length];
		}
		else {
	...
	public static CommerceAccountGroupSoap[] toSoapModels(
		...
		List<CommerceAccountGroupSoap> soapModels = new ArrayList<CommerceAccountGroupSoap>(models.size());

		for (CommerceAccountGroup model : models) {
			soapModels.add(toSoapModel(model));
		}

		return soapModels.toArray(new CommerceAccountGroupSoap[soapModels.size()]);
	}

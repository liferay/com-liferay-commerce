 ...
 */
@ProviderType
public class CommerceAccountGroupWrapper implements CommerceAccountGroup,
	ModelWrapper<CommerceAccountGroup> {
	...
	@Override
	public Object clone() {
		return new CommerceAccountGroupWrapper((CommerceAccountGroup)_commerceAccountGroup.clone());
	}
	...
	*/
	...
	@Override
	public com.liferay.portal.kernel.model.CacheModel<CommerceAccountGroup> toCacheModel() {
		return _commerceAccountGroup.toCacheModel();
	}

	@Override
	public CommerceAccountGroup toEscapedModel() {
		return new CommerceAccountGroupWrapper(_commerceAccountGroup.toEscapedModel());
	}
	...
	public CommerceAccountGroup toUnescapedModel() {
		return new CommerceAccountGroupWrapper(_commerceAccountGroup.toUnescapedModel());
	}
	...
	public boolean equals(Object obj) {
		...
		CommerceAccountGroupWrapper commerceAccountGroupWrapper = (CommerceAccountGroupWrapper)obj;

		if (Objects.equals(_commerceAccountGroup,

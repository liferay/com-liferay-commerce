 ...
 *
 * @author Marco Leo
 * @see com.liferay.commerce.account.service.http.CommerceAccountGroupCommerceAccountRelServiceSoap
 * @generated
 */
@ProviderType
public class CommerceAccountGroupCommerceAccountRelSoap implements Serializable {
	public static CommerceAccountGroupCommerceAccountRelSoap toSoapModel(
		...
		CommerceAccountGroupCommerceAccountRelSoap soapModel = new CommerceAccountGroupCommerceAccountRelSoap();

		soapModel.setExternalReferenceCode(model.getExternalReferenceCode());
		soapModel.setCommerceAccountGroupCommerceAccountRelId(model.getCommerceAccountGroupCommerceAccountRelId());
	...
	public static CommerceAccountGroupCommerceAccountRelSoap[] toSoapModels(
		...
		CommerceAccountGroupCommerceAccountRelSoap[] soapModels = new CommerceAccountGroupCommerceAccountRelSoap[models.length];
	...
	public static CommerceAccountGroupCommerceAccountRelSoap[][] toSoapModels(
		...
		if (models.length > 0) {
			soapModels = new CommerceAccountGroupCommerceAccountRelSoap[models.length][models[0].length];
		}
		else {
	...
	public static CommerceAccountGroupCommerceAccountRelSoap[] toSoapModels(
		...
		List<CommerceAccountGroupCommerceAccountRelSoap> soapModels = new ArrayList<CommerceAccountGroupCommerceAccountRelSoap>(models.size());

		for (CommerceAccountGroupCommerceAccountRel model : models) {
			soapModels.add(toSoapModel(model));
		}

		return soapModels.toArray(new CommerceAccountGroupCommerceAccountRelSoap[soapModels.size()]);
	}

 ...
 * {@link com.liferay.commerce.account.service.impl.CommerceAccountOrganizationRelLocalServiceImpl} and is the
...
public class CommerceAccountOrganizationRelLocalServiceUtil {
	 ...
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this class directly. Add custom service methods to {@link com.liferay.commerce.account.service.impl.CommerceAccountOrganizationRelLocalServiceImpl} and rerun ServiceBuilder to regenerate this class.
	 */
	...
	*/
	public static com.liferay.commerce.account.model.CommerceAccountOrganizationRel createCommerceAccountOrganizationRel(
		com.liferay.commerce.account.service.persistence.CommerceAccountOrganizationRelPK commerceAccountOrganizationRelPK) {
		return getService()
				   .createCommerceAccountOrganizationRel(commerceAccountOrganizationRelPK);
	}
	...
	*/
	public static com.liferay.commerce.account.model.CommerceAccountOrganizationRel deleteCommerceAccountOrganizationRel(
		com.liferay.commerce.account.model.CommerceAccountOrganizationRel commerceAccountOrganizationRel) {
		return getService()
				   .deleteCommerceAccountOrganizationRel(commerceAccountOrganizationRel);
	}
	...
	*/
	...
	public static com.liferay.commerce.account.model.CommerceAccountOrganizationRel fetchCommerceAccountOrganizationRel(
		com.liferay.commerce.account.service.persistence.CommerceAccountOrganizationRelPK commerceAccountOrganizationRelPK) {
		return getService()
				   .fetchCommerceAccountOrganizationRel(commerceAccountOrganizationRelPK);
	}
	...
	*/
	public static com.liferay.commerce.account.model.CommerceAccountOrganizationRel updateCommerceAccountOrganizationRel(
		com.liferay.commerce.account.model.CommerceAccountOrganizationRel commerceAccountOrganizationRel) {
		return getService()
				   .updateCommerceAccountOrganizationRel(commerceAccountOrganizationRel);
	}
	...
	private static ServiceTracker<CommerceAccountOrganizationRelLocalService, CommerceAccountOrganizationRelLocalService> _serviceTracker;

	static {
		Bundle bundle = FrameworkUtil.getBundle(CommerceAccountOrganizationRelLocalService.class);

		ServiceTracker<CommerceAccountOrganizationRelLocalService, CommerceAccountOrganizationRelLocalService> serviceTracker =
			new ServiceTracker<CommerceAccountOrganizationRelLocalService, CommerceAccountOrganizationRelLocalService>(bundle.getBundleContext(),
				CommerceAccountOrganizationRelLocalService.class, null);

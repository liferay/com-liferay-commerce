 ...
 *
 * @author Marco Leo
 * @see com.liferay.commerce.account.service.http.CommerceAccountGroupRelServiceSoap
 * @generated
 */
@ProviderType
public class CommerceAccountGroupRelSoap implements Serializable {
	public static CommerceAccountGroupRelSoap toSoapModel(
		...
		CommerceAccountGroupRelSoap soapModel = new CommerceAccountGroupRelSoap();

		soapModel.setCommerceAccountGroupRelId(model.getCommerceAccountGroupRelId());
	...
	public static CommerceAccountGroupRelSoap[] toSoapModels(
		...
		CommerceAccountGroupRelSoap[] soapModels = new CommerceAccountGroupRelSoap[models.length];
	...
	public static CommerceAccountGroupRelSoap[][] toSoapModels(
		...
		if (models.length > 0) {
			soapModels = new CommerceAccountGroupRelSoap[models.length][models[0].length];
		}
		else {
	...
	public static CommerceAccountGroupRelSoap[] toSoapModels(
		...
		List<CommerceAccountGroupRelSoap> soapModels = new ArrayList<CommerceAccountGroupRelSoap>(models.size());

		for (CommerceAccountGroupRel model : models) {
			soapModels.add(toSoapModel(model));
		}

		return soapModels.toArray(new CommerceAccountGroupRelSoap[soapModels.size()]);
	}

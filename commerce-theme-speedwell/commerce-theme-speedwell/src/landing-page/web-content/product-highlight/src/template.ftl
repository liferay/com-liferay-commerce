<div class="product-highlight">
    <div class="bg-slider">
        <div data-state="current" class="bg-slider__slide">
        ...
        <div data-state="next" class="bg-slider__slide">
    ...
    <div class="product-hint">
        ...
        <div class="hint-text">
            ...
            <span class="hint-text__name-slider">
                <span data-state="current" class="hint-text__name">
                    Black 17'' Amazing Rim
                </span>
                <span data-state="next" class="hint-text__name">
                    Silver 18'' Amazing Rim
                </span>
                <span data-state="will-be-next" class="hint-text__name">

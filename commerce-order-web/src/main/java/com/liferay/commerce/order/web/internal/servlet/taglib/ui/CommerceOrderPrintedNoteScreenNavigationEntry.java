...
public class CommerceOrderPrintedNoteScreenNavigationEntry
	implements ScreenNavigationEntry<CommerceOrder> {

	public static final String KEY = "printed-note";
	...
	public void render(
		...
		_jspRenderer.renderJSP(
			httpServletRequest, httpServletResponse, "/order/printed_note.jsp");
	}

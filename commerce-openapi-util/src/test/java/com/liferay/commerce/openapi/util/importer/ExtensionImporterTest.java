 ...
 * @author Igor Beslic
 */
public class ExtensionImporterTest {

	@Test
	public void testImportExtensions() throws Exception {
		ExtensionImporter extensionImporter = new ExtensionImporter();

		List<OpenApiContextExtension> openApiContextExtensions =
			extensionImporter.getExtensions(
				OpenApiTestUtil.getOpenApiContextExtensionPattern());

		for (OpenApiContextExtension openApiContextExtension :
				OpenApiContextExtension.values()) {

			Assert.assertTrue(
				"contains " + openApiContextExtension,
				openApiContextExtensions.contains(openApiContextExtension));
		}
	}

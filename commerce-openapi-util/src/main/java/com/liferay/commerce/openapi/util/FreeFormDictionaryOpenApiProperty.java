 ...
 * @author Igor Beslic
 */
public class FreeFormDictionaryOpenApiProperty extends OpenApiProperty {

	public Provider getJavaTypeProvider() {
		return _provider;
	}

	protected FreeFormDictionaryOpenApiProperty(
		...
		_provider = new MapStringWildcardProvider(

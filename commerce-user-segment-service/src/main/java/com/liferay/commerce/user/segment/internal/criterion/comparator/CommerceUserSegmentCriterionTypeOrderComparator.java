 ...
 */
public class CommerceUserSegmentCriterionTypeOrderComparator
	implements Comparator<ServiceWrapper<CommerceUserSegmentCriterionType>>,
			   Serializable {
	...
	public CommerceUserSegmentCriterionTypeOrderComparator(boolean ascending) {
		_ascending = ascending;
	}

	@Override
	public int compare(
		ServiceWrapper<CommerceUserSegmentCriterionType> serviceWrapper1,
		ServiceWrapper<CommerceUserSegmentCriterionType> serviceWrapper2) {

		int displayOrder1 = MapUtil.getInteger(
			serviceWrapper1.getProperties(),
			"commerce.user.segment.criterion.type.order", Integer.MAX_VALUE);

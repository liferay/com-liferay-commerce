...
public class CommerceUserSegmentCriterionServiceHttp {
	...
	public static
		...
		try {
			MethodKey methodKey = new MethodKey(
				CommerceUserSegmentCriterionServiceUtil.class,
				"addCommerceUserSegmentCriterion",
				_addCommerceUserSegmentCriterionParameterTypes0);

			MethodHandler methodHandler = new MethodHandler(
				methodKey, commerceUserSegmentEntryId, type, typeSettings,
			...
			return (com.liferay.commerce.user.segment.model.
				CommerceUserSegmentCriterion)returnObj;
		}
	...
	public static void deleteCommerceUserSegmentCriterion(
		...
		try {
			...
			MethodHandler methodHandler = new MethodHandler(
				methodKey, commerceUserSegmentCriterionId);
	...
	public static java.util.List
		...
		try {
			...
			MethodHandler methodHandler = new MethodHandler(
				methodKey, commerceUserSegmentEntryId, start, end,
				orderByComparator);
	...
	public static
		...
		try {
			...
			MethodHandler methodHandler = new MethodHandler(
				methodKey, commerceUserSegmentCriterionId, type, typeSettings,
				priority, serviceContext);
	...
	private static Log _log = LogFactoryUtil.getLog(
		CommerceUserSegmentCriterionServiceHttp.class);

	private static final Class<?>[]
		_addCommerceUserSegmentCriterionParameterTypes0 = new Class[] {
			long.class, String.class, String.class, double.class,
			com.liferay.portal.kernel.service.ServiceContext.class
		};
	private static final Class<?>[]
		_deleteCommerceUserSegmentCriterionParameterTypes1 = new Class[] {
			long.class
		};
	private static final Class<?>[]
		_getCommerceUserSegmentCriteriaParameterTypes2 = new Class[] {
			long.class, int.class, int.class,
			com.liferay.portal.kernel.util.OrderByComparator.class
		};
	private static final Class<?>[]
		_getCommerceUserSegmentCriteriaCountParameterTypes3 = new Class[] {
			long.class
		};
	private static final Class<?>[]
		_getCommerceUserSegmentCriterionParameterTypes4 = new Class[] {
			long.class
		};
	private static final Class<?>[]
		_updateCommerceUserSegmentCriterionParameterTypes5 = new Class[] {
			long.class, String.class, String.class, double.class,
			com.liferay.portal.kernel.service.ServiceContext.class
		};

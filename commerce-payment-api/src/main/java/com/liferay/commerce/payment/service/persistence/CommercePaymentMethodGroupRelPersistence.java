...
public interface CommercePaymentMethodGroupRelPersistence
	...
	*/
	public void cacheResult(
		java.util.List<CommercePaymentMethodGroupRel> commercePaymentMethodGroupRels);
	...
	*/
	...
	@Override
	public java.util.Map<java.io.Serializable, CommercePaymentMethodGroupRel> fetchByPrimaryKeys(
	...
	*/
	public java.util.List<CommercePaymentMethodGroupRel> findAll(int start,
		int end);

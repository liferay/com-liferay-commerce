...
public class CommerceInventoryWarehouseItemServiceHttp {
	...
	public static com.liferay.commerce.inventory.model.CommerceInventoryWarehouseItem fetchCommerceInventoryWarehouseItem(
		...
		try {
			MethodKey methodKey = new MethodKey(CommerceInventoryWarehouseItemServiceUtil.class,
					...
					_fetchCommerceInventoryWarehouseItemParameterTypes1);
	...
	public static java.util.List<com.liferay.commerce.inventory.model.CommerceInventoryWarehouseItem> getCommerceInventoryWarehouseItems(
		...
		try {
			MethodKey methodKey = new MethodKey(CommerceInventoryWarehouseItemServiceUtil.class,
					...
					_getCommerceInventoryWarehouseItemsParameterTypes2);
	...
	public static com.liferay.commerce.inventory.model.CommerceInventoryWarehouseItem updateCommerceInventoryWarehouseItem(
		...
		try {
			MethodKey methodKey = new MethodKey(CommerceInventoryWarehouseItemServiceUtil.class,
					...
					_updateCommerceInventoryWarehouseItemParameterTypes3);
	...
	public static com.liferay.commerce.inventory.model.CommerceInventoryWarehouseItem upsertCommerceInventoryWarehouseItem(
		...
		try {
			MethodKey methodKey = new MethodKey(CommerceInventoryWarehouseItemServiceUtil.class,
					...
					_upsertCommerceInventoryWarehouseItemParameterTypes4);
	...
	private static final Class<?>[] _fetchCommerceInventoryWarehouseItemParameterTypes1 =
		new Class[] { long.class, String.class };
	private static final Class<?>[] _getCommerceInventoryWarehouseItemsParameterTypes2 =
		new Class[] { long.class, int.class, int.class };
	private static final Class<?>[] _updateCommerceInventoryWarehouseItemParameterTypes3 =
		new Class[] { long.class, int.class };
	private static final Class<?>[] _upsertCommerceInventoryWarehouseItemParameterTypes4 =
		new Class[] { long.class, long.class, String.class, int.class };
}
...
@Component(
	immediate = true,
	property = "commerce.region.starter.key=" + IndonesiaCommerceRegionsStarter.INDONESIA_NUMERIC_ISO_CODE,
	service = CommerceRegionsStarter.class
)
public class IndonesiaCommerceRegionsStarter implements CommerceRegionsStarter {

	public static final int INDONESIA_NUMERIC_ISO_CODE = 360;

	public CommerceCountry getCommerceCountry(long companyId)
		throws PortalException {

		return _commerceCountryLocalService.fetchCommerceCountry(
			companyId, INDONESIA_NUMERIC_ISO_CODE);
	}

	public JSONArray getCommerceRegionsJSONArray() throws Exception {
		Class<?> clazz = getClass();

		String layoutsPath = "com/liferay/commerce/internal/indonesia.json";

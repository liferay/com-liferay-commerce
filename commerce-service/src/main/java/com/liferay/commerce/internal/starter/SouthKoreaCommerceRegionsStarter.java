...
public class SouthKoreaCommerceRegionsStarter implements CommerceRegionsStarter {
	...
	public CommerceCountry getCommerceCountry(long companyId)
		...
		return _commerceCountryLocalService.fetchCommerceCountry(
			companyId, SOUTH_KOREA_NUMERIC_ISO_CODE);
	}

	public JSONArray getCommerceRegionsJSONArray() throws Exception {
		Class<?> clazz = getClass();

		String layoutsPath = "com/liferay/commerce/internal/south-korea.json";

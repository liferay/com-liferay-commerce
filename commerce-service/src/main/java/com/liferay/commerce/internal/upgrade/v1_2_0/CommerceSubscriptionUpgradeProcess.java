...
public class CommerceSubscriptionUpgradeProcess extends UpgradeProcess {
	...
	protected void doUpgrade() throws Exception {
		if (!hasTable(CPSubscriptionEntryImpl.TABLE_NAME)) {
			String template = StringUtil.read(
				CommerceSubscriptionUpgradeProcess.class.getResourceAsStream(
					"dependencies/CPSubscriptionEntry.sql"));

			runSQLTemplateString(template, false, false);
		}

		if (!hasTable(CPSubscriptionCycleEntryImpl.TABLE_NAME)) {
			String template = StringUtil.read(
				CommerceSubscriptionUpgradeProcess.class.getResourceAsStream(
					"dependencies/CPSubscriptionCycleEntry.sql"));

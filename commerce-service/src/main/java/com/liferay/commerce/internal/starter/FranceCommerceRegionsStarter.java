...
public class FranceCommerceRegionsStarter extends BaseCommerceRegionsStarter {

	public static final int FRANCE_NUMERIC_ISO_CODE = 250;

	@Override
	public String getLabel(Locale locale) {
		return LanguageUtil.get(locale, "country.france");
	}

	@Override
	protected int getCountryIsoCode() {
		return FRANCE_NUMERIC_ISO_CODE;
	}

...
@Component(
	immediate = true,
	property = "commerce.region.starter.key=" + RussiaCommerceRegionsStarter.RUSSIA_NUMERIC_ISO_CODE,
	service = CommerceRegionsStarter.class
)
public class RussiaCommerceRegionsStarter implements CommerceRegionsStarter {
	...
	public CommerceCountry getCommerceCountry(long companyId)
		...
		return _commerceCountryLocalService.fetchCommerceCountry(
			companyId, RUSSIA_NUMERIC_ISO_CODE);
	}

	public JSONArray getCommerceRegionsJSONArray() throws Exception {
		Class<?> clazz = getClass();

		String layoutsPath = "com/liferay/commerce/internal/russia.json";

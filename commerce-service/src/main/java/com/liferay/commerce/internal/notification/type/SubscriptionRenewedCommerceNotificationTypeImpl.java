...
public class SubscriptionRenewedCommerceNotificationTypeImpl
	...
	public Map<String, String> getDefinitionTerms(Locale locale) {
		...
		map.put(
			_PRODUCT_NAME,
			LanguageUtil.get(resourceBundle, "product-name-definition-term"));
	...
	public String getFilledTerm(String term, Object object, Locale locale)
		...
		if (!(object instanceof CPSubscriptionCycleEntry)) {
			return term;
		}

		CPSubscriptionCycleEntry cpSubscriptionCycleEntry =
			(CPSubscriptionCycleEntry)object;

		if (_commerceOrderItem == null) {
			_commerceOrderItem =
				_commerceOrderItemLocalService.getCommerceOrderItem(
					cpSubscriptionCycleEntry.getCommerceOrderItemId());
		}

 ...
 * @see com.liferay.commerce.service.CPDAvailabilityEstimateLocalServiceUtil
 * @generated
 */
@ProviderType
public abstract class CPDAvailabilityEstimateLocalServiceBaseImpl
	extends BaseLocalServiceImpl implements CPDAvailabilityEstimateLocalService,
		IdentifiableOSGiService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link com.liferay.commerce.service.CPDAvailabilityEstimateLocalServiceUtil} to access the cpd availability estimate local service.
	 */
	...
	public CPDAvailabilityEstimate deleteCPDAvailabilityEstimate(
		CPDAvailabilityEstimate cpdAvailabilityEstimate) {
		return cpdAvailabilityEstimatePersistence.remove(cpdAvailabilityEstimate);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(CPDAvailabilityEstimate.class,
	...
	public <T> List<T> dynamicQuery(DynamicQuery dynamicQuery) {
		return cpdAvailabilityEstimatePersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery) {
		return cpdAvailabilityEstimatePersistence.countWithDynamicQuery(dynamicQuery);
	}
	...
	public CPDAvailabilityEstimate fetchCPDAvailabilityEstimate(
		long CPDAvailabilityEstimateId) {
		return cpdAvailabilityEstimatePersistence.fetchByPrimaryKey(CPDAvailabilityEstimateId);
	}
	...
	public CPDAvailabilityEstimate getCPDAvailabilityEstimate(
		long CPDAvailabilityEstimateId) throws PortalException {
		return cpdAvailabilityEstimatePersistence.findByPrimaryKey(CPDAvailabilityEstimateId);
	}
	...
	public ActionableDynamicQuery getActionableDynamicQuery() {
		...
		actionableDynamicQuery.setBaseLocalService(cpdAvailabilityEstimateLocalService);
	...
	public IndexableActionableDynamicQuery getIndexableActionableDynamicQuery() {
		...
		indexableActionableDynamicQuery.setBaseLocalService(cpdAvailabilityEstimateLocalService);
		indexableActionableDynamicQuery.setClassLoader(getClassLoader());
		indexableActionableDynamicQuery.setModelClass(CPDAvailabilityEstimate.class);
	...
	public PersistedModel deletePersistedModel(PersistedModel persistedModel)
		throws PortalException {
		return cpdAvailabilityEstimateLocalService.deleteCPDAvailabilityEstimate((CPDAvailabilityEstimate)persistedModel);
	}

	@Override
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		throws PortalException {
		return cpdAvailabilityEstimatePersistence.findByPrimaryKey(primaryKeyObj);
	}
	...
	public void afterPropertiesSet() {
		persistedModelLocalServiceRegistry.register("com.liferay.commerce.model.CPDAvailabilityEstimate",
	...
	protected void runSQL(String sql) {
		try {
			DataSource dataSource = cpdAvailabilityEstimatePersistence.getDataSource();

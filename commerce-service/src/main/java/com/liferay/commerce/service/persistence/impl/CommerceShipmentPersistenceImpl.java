...
public class CommerceShipmentPersistenceImpl extends BasePersistenceImpl<CommerceShipment>
	...
	public static final FinderPath FINDER_PATH_WITH_PAGINATION_FIND_BY_GROUPIDS = new FinderPath(CommerceShipmentModelImpl.ENTITY_CACHE_ENABLED,
			CommerceShipmentModelImpl.FINDER_CACHE_ENABLED,
			CommerceShipmentImpl.class, FINDER_CLASS_NAME_LIST_WITH_PAGINATION,
			"findByGroupIds",
			new String[] {
	...
	public static final FinderPath FINDER_PATH_WITHOUT_PAGINATION_FIND_BY_GROUPIDS =
	...
	public static final FinderPath FINDER_PATH_COUNT_BY_GROUPIDS = new FinderPath(CommerceShipmentModelImpl.ENTITY_CACHE_ENABLED,
			CommerceShipmentModelImpl.FINDER_CACHE_ENABLED, Long.class,
			FINDER_CLASS_NAME_LIST_WITHOUT_PAGINATION, "countByGroupIds",
			new String[] { Long.class.getName() });
	public static final FinderPath FINDER_PATH_WITH_PAGINATION_COUNT_BY_GROUPIDS =
		new FinderPath(CommerceShipmentModelImpl.ENTITY_CACHE_ENABLED,
			CommerceShipmentModelImpl.FINDER_CACHE_ENABLED, Long.class,
	...
	public List<CommerceShipment> findByGroupIds(long groupId) {
		return findByGroupIds(groupId, QueryUtil.ALL_POS, QueryUtil.ALL_POS,
			null);
	}
	 ...
	 */
	@Override
	public List<CommerceShipment> findByGroupIds(long groupId, int start,
		int end) {
	...
	public List<CommerceShipment> findByGroupIds(long groupId, int start,
		...
		if ((start == QueryUtil.ALL_POS) && (end == QueryUtil.ALL_POS) &&
			...
			pagination = false;
			finderPath = FINDER_PATH_WITHOUT_PAGINATION_FIND_BY_GROUPIDS;
			finderArgs = new Object[] { groupId };
		}
		else {
			finderPath = FINDER_PATH_WITH_PAGINATION_FIND_BY_GROUPIDS;
	 ...
	 */
	@Override
	public CommerceShipment findByGroupIds_First(long groupId,
		OrderByComparator<CommerceShipment> orderByComparator)
		throws NoSuchShipmentException {
		CommerceShipment commerceShipment = fetchByGroupIds_First(groupId,
				orderByComparator);
	 ...
	 */
	@Override
	public CommerceShipment fetchByGroupIds_First(long groupId,
		OrderByComparator<CommerceShipment> orderByComparator) {
		List<CommerceShipment> list = findByGroupIds(groupId, 0, 1,
				orderByComparator);
	 ...
	 */
	@Override
	public CommerceShipment findByGroupIds_Last(long groupId,
		OrderByComparator<CommerceShipment> orderByComparator)
		throws NoSuchShipmentException {
		CommerceShipment commerceShipment = fetchByGroupIds_Last(groupId,
				orderByComparator);
	 ...
	 */
	@Override
	public CommerceShipment fetchByGroupIds_Last(long groupId,
		OrderByComparator<CommerceShipment> orderByComparator) {
		...
		List<CommerceShipment> list = findByGroupIds(groupId, count - 1, count,
				orderByComparator);
	...
	public CommerceShipment[] findByGroupIds_PrevAndNext(
		...
		try {
			...
			array[0] = getByGroupIds_PrevAndNext(session, commerceShipment,
					groupId, orderByComparator, true);

			array[1] = commerceShipment;

			array[2] = getByGroupIds_PrevAndNext(session, commerceShipment,
	...
	protected CommerceShipment getByGroupIds_PrevAndNext(Session session,
	...
	public List<CommerceShipment> findByGroupIds(long[] groupIds) {
		return findByGroupIds(groupIds, QueryUtil.ALL_POS, QueryUtil.ALL_POS,
			null);
	}
	 ...
	 */
	@Override
	public List<CommerceShipment> findByGroupIds(long[] groupIds, int start,
		int end) {
	...
	public List<CommerceShipment> findByGroupIds(long[] groupIds, int start,
		...
		if (retrieveFromCache) {
			list = (List<CommerceShipment>)finderCache.getResult(FINDER_PATH_WITH_PAGINATION_FIND_BY_GROUPIDS,
					finderArgs, this);
		...
		if (list == null) {
			...
			try {
				...
				finderCache.putResult(FINDER_PATH_WITH_PAGINATION_FIND_BY_GROUPIDS,
					finderArgs, list);
			}
			catch (Exception e) {
				finderCache.removeResult(FINDER_PATH_WITH_PAGINATION_FIND_BY_GROUPIDS,
					finderArgs);
	...
	public void removeByGroupIds(long groupId) {
		for (CommerceShipment commerceShipment : findByGroupIds(groupId,
	...
	public int countByGroupIds(long groupId) {
		FinderPath finderPath = FINDER_PATH_COUNT_BY_GROUPIDS;
	...
	public int countByGroupIds(long[] groupIds) {
		...
		Long count = (Long)finderCache.getResult(FINDER_PATH_WITH_PAGINATION_COUNT_BY_GROUPIDS,
				finderArgs, this);
		...
		if (count == null) {
			...
			try {
				...
				finderCache.putResult(FINDER_PATH_WITH_PAGINATION_COUNT_BY_GROUPIDS,
					finderArgs, count);
			}
			catch (Exception e) {
				finderCache.removeResult(FINDER_PATH_WITH_PAGINATION_COUNT_BY_GROUPIDS,
					finderArgs);
	...
	public static final FinderPath FINDER_PATH_COUNT_BY_G_S = new FinderPath(CommerceShipmentModelImpl.ENTITY_CACHE_ENABLED,
			...
			new String[] { Long.class.getName(), Integer.class.getName() });
	public static final FinderPath FINDER_PATH_WITH_PAGINATION_COUNT_BY_G_S = new FinderPath(CommerceShipmentModelImpl.ENTITY_CACHE_ENABLED,
			CommerceShipmentModelImpl.FINDER_CACHE_ENABLED, Long.class,
	...
	public List<CommerceShipment> findByG_S(long[] groupIds, int status) {
		return findByG_S(groupIds, status, QueryUtil.ALL_POS,
	...
	public List<CommerceShipment> findByG_S(long[] groupIds, int status,
		...
		if (groupIds.length == 1) {
			return findByG_S(groupIds[0], status, start, end, orderByComparator);
		}
		...
		if ((start == QueryUtil.ALL_POS) && (end == QueryUtil.ALL_POS) &&
			...
			finderArgs = new Object[] {
					StringUtil.merge(groupIds), status,
		...
		if (retrieveFromCache) {
			list = (List<CommerceShipment>)finderCache.getResult(FINDER_PATH_WITH_PAGINATION_FIND_BY_G_S,
					finderArgs, this);
		...
		if (list == null) {
			...
			try {
				...
				finderCache.putResult(FINDER_PATH_WITH_PAGINATION_FIND_BY_G_S,
					finderArgs, list);
			}
			catch (Exception e) {
				finderCache.removeResult(FINDER_PATH_WITH_PAGINATION_FIND_BY_G_S,
					finderArgs);
	...
	public int countByG_S(long[] groupIds, int status) {
		...
		Long count = (Long)finderCache.getResult(FINDER_PATH_WITH_PAGINATION_COUNT_BY_G_S,
				finderArgs, this);
		...
		if (count == null) {
			...
			try {
				...
				finderCache.putResult(FINDER_PATH_WITH_PAGINATION_COUNT_BY_G_S,
					finderArgs, count);
			}
			catch (Exception e) {
				finderCache.removeResult(FINDER_PATH_WITH_PAGINATION_COUNT_BY_G_S,
					finderArgs);
	...
	public CommerceShipment updateImpl(CommerceShipment commerceShipment) {
		...
		if (!CommerceShipmentModelImpl.COLUMN_BITMASK_ENABLED) {
		 ...
		 if (isNew) {
			...
			finderCache.removeResult(FINDER_PATH_COUNT_BY_GROUPIDS, args);
			finderCache.removeResult(FINDER_PATH_WITHOUT_PAGINATION_FIND_BY_GROUPIDS,
				args);
			...
			if ((commerceShipmentModelImpl.getColumnBitmask() &
					FINDER_PATH_WITHOUT_PAGINATION_FIND_BY_GROUPIDS.getColumnBitmask()) != 0) {

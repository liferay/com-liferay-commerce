...
public abstract class CommerceWarehouseLocalServiceBaseImpl
	...
	implements CommerceWarehouseLocalService, IdentifiableOSGiService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>CommerceWarehouseLocalService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>com.liferay.commerce.service.CommerceWarehouseLocalServiceUtil</code>.
	 */
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(
			CommerceWarehouse.class, clazz.getClassLoader());
	}
	...
	public <T> List<T> dynamicQuery(
		...
		return commerceWarehousePersistence.findWithDynamicQuery(
	...
	public long dynamicQueryCount(
		...
		return commerceWarehousePersistence.countWithDynamicQuery(
	...
	public PersistedModel deletePersistedModel(PersistedModel persistedModel)
		...
		return commerceWarehouseLocalService.deleteCommerceWarehouse(
			(CommerceWarehouse)persistedModel);
	}
	...
	protected void runSQL(String sql) {
		try {
			DataSource dataSource =
				commerceWarehousePersistence.getDataSource();

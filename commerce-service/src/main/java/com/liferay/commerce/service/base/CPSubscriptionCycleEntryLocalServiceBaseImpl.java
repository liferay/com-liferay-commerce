...
/**
 * Provides the base implementation for the cp subscription cycle entry local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.liferay.commerce.service.impl.CPSubscriptionCycleEntryLocalServiceImpl}.
 * </p>
 *
 * @author Alessio Antonio Rendina
 * @see com.liferay.commerce.service.impl.CPSubscriptionCycleEntryLocalServiceImpl
 * @see com.liferay.commerce.service.CPSubscriptionCycleEntryLocalServiceUtil
 * @generated
 */
@ProviderType
public abstract class CPSubscriptionCycleEntryLocalServiceBaseImpl
	extends BaseLocalServiceImpl implements CPSubscriptionCycleEntryLocalService,
		IdentifiableOSGiService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link com.liferay.commerce.service.CPSubscriptionCycleEntryLocalServiceUtil} to access the cp subscription cycle entry local service.
	 */
	...
	public CPSubscriptionCycleEntry addCPSubscriptionCycleEntry(
		...
		return cpSubscriptionCycleEntryPersistence.update(cpSubscriptionCycleEntry);
	}
	...
	public CPSubscriptionCycleEntry createCPSubscriptionCycleEntry(
		...
		return cpSubscriptionCycleEntryPersistence.create(CPSubscriptionCycleEntryId);
	}
	...
	public CPSubscriptionCycleEntry deleteCPSubscriptionCycleEntry(
		...
		return cpSubscriptionCycleEntryPersistence.remove(CPSubscriptionCycleEntryId);
	}
	...
	public CPSubscriptionCycleEntry deleteCPSubscriptionCycleEntry(
		CPSubscriptionCycleEntry cpSubscriptionCycleEntry) {
		return cpSubscriptionCycleEntryPersistence.remove(cpSubscriptionCycleEntry);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(CPSubscriptionCycleEntry.class,
	...
	public <T> List<T> dynamicQuery(DynamicQuery dynamicQuery) {
		return cpSubscriptionCycleEntryPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery) {
		return cpSubscriptionCycleEntryPersistence.countWithDynamicQuery(dynamicQuery);
	}
	...
	public CPSubscriptionCycleEntry fetchCPSubscriptionCycleEntry(
		long CPSubscriptionCycleEntryId) {
		return cpSubscriptionCycleEntryPersistence.fetchByPrimaryKey(CPSubscriptionCycleEntryId);
	}
	...
	public CPSubscriptionCycleEntry fetchCPSubscriptionCycleEntryByUuidAndGroupId(
		...
		return cpSubscriptionCycleEntryPersistence.fetchByUUID_G(uuid, groupId);
	}
	...
	public CPSubscriptionCycleEntry getCPSubscriptionCycleEntry(
		long CPSubscriptionCycleEntryId) throws PortalException {
		return cpSubscriptionCycleEntryPersistence.findByPrimaryKey(CPSubscriptionCycleEntryId);
	}
	...
	public ActionableDynamicQuery getActionableDynamicQuery() {
		...
		actionableDynamicQuery.setBaseLocalService(cpSubscriptionCycleEntryLocalService);
		actionableDynamicQuery.setClassLoader(getClassLoader());
		actionableDynamicQuery.setModelClass(CPSubscriptionCycleEntry.class);
	...
	public IndexableActionableDynamicQuery getIndexableActionableDynamicQuery() {
		...
		indexableActionableDynamicQuery.setBaseLocalService(cpSubscriptionCycleEntryLocalService);
		indexableActionableDynamicQuery.setClassLoader(getClassLoader());
		indexableActionableDynamicQuery.setModelClass(CPSubscriptionCycleEntry.class);
	...
	public ExportActionableDynamicQuery getExportActionableDynamicQuery(
		...
		exportActionableDynamicQuery.setPerformActionMethod(new ActionableDynamicQuery.PerformActionMethod<CPSubscriptionCycleEntry>() {
				@Override
	...
	public PersistedModel deletePersistedModel(PersistedModel persistedModel)
		throws PortalException {
		return cpSubscriptionCycleEntryLocalService.deleteCPSubscriptionCycleEntry((CPSubscriptionCycleEntry)persistedModel);
	}

	@Override
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		throws PortalException {
		return cpSubscriptionCycleEntryPersistence.findByPrimaryKey(primaryKeyObj);
	}
	...
	public List<CPSubscriptionCycleEntry> getCPSubscriptionCycleEntriesByUuidAndCompanyId(
		...
		return cpSubscriptionCycleEntryPersistence.findByUuid_C(uuid, companyId);
	}
	...
	public List<CPSubscriptionCycleEntry> getCPSubscriptionCycleEntriesByUuidAndCompanyId(
		...
		return cpSubscriptionCycleEntryPersistence.findByUuid_C(uuid,
	...
	public CPSubscriptionCycleEntry getCPSubscriptionCycleEntryByUuidAndGroupId(
		...
		return cpSubscriptionCycleEntryPersistence.findByUUID_G(uuid, groupId);
	}
	...
	public List<CPSubscriptionCycleEntry> getCPSubscriptionCycleEntries(
		int start, int end) {
		return cpSubscriptionCycleEntryPersistence.findAll(start, end);
	}
	...
	public int getCPSubscriptionCycleEntriesCount() {
		return cpSubscriptionCycleEntryPersistence.countAll();
	}
	 ...
	 */
	public CPSubscriptionCycleEntryLocalService getCPSubscriptionCycleEntryLocalService() {
	...
	public void afterPropertiesSet() {
		persistedModelLocalServiceRegistry.register("com.liferay.commerce.model.CPSubscriptionCycleEntry",
			cpSubscriptionCycleEntryLocalService);
	}

	public void destroy() {
		persistedModelLocalServiceRegistry.unregister(
			"com.liferay.commerce.model.CPSubscriptionCycleEntry");
	}
	...
	public String getOSGiServiceIdentifier() {
		return CPSubscriptionCycleEntryLocalService.class.getName();
	}
	...
	protected void runSQL(String sql) {
		try {
			DataSource dataSource = cpSubscriptionCycleEntryPersistence.getDataSource();
	...
	@BeanReference(type = CPSubscriptionCycleEntryLocalService.class)
	protected CPSubscriptionCycleEntryLocalService cpSubscriptionCycleEntryLocalService;

...
public class CPSubscriptionEntryTest {
	...
	@Test
	public void testAddCPSubscriptionEntry() throws Exception {
		...
		CPSubscriptionEntryTestUtil.setUpCPSubscriptionEntry(
			_group.getGroupId(), _user.getUserId(), 1);

		int cpSubscriptionEntriesCount =
			_cpSubscriptionEntryLocalService.getCPSubscriptionEntriesCount(

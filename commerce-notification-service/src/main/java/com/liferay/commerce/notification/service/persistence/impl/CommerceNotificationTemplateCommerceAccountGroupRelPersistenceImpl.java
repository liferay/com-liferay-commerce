 ...
 * @see com.liferay.commerce.notification.service.persistence.CommerceNotificationTemplateCommerceAccountGroupRelUtil
 * @generated
 */
@ProviderType
public class CommerceNotificationTemplateCommerceAccountGroupRelPersistenceImpl
	extends BasePersistenceImpl<CommerceNotificationTemplateCommerceAccountGroupRel>
	implements CommerceNotificationTemplateCommerceAccountGroupRelPersistence {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link CommerceNotificationTemplateCommerceAccountGroupRelUtil} to access the commerce notification template commerce account group rel persistence. Modify <code>service.xml</code> and rerun ServiceBuilder to regenerate this class.
	 */
	...
	public static final String FINDER_CLASS_NAME_LIST_WITHOUT_PAGINATION = FINDER_CLASS_NAME_ENTITY +
		".List2";
	public static final FinderPath FINDER_PATH_WITH_PAGINATION_FIND_ALL = new FinderPath(CommerceNotificationTemplateCommerceAccountGroupRelModelImpl.ENTITY_CACHE_ENABLED,
			CommerceNotificationTemplateCommerceAccountGroupRelModelImpl.FINDER_CACHE_ENABLED,
			CommerceNotificationTemplateCommerceAccountGroupRelImpl.class,
			FINDER_CLASS_NAME_LIST_WITH_PAGINATION, "findAll", new String[0]);
	public static final FinderPath FINDER_PATH_WITHOUT_PAGINATION_FIND_ALL = new FinderPath(CommerceNotificationTemplateCommerceAccountGroupRelModelImpl.ENTITY_CACHE_ENABLED,
			CommerceNotificationTemplateCommerceAccountGroupRelModelImpl.FINDER_CACHE_ENABLED,
			CommerceNotificationTemplateCommerceAccountGroupRelImpl.class,
			FINDER_CLASS_NAME_LIST_WITHOUT_PAGINATION, "findAll", new String[0]);
	public static final FinderPath FINDER_PATH_COUNT_ALL = new FinderPath(CommerceNotificationTemplateCommerceAccountGroupRelModelImpl.ENTITY_CACHE_ENABLED,
			CommerceNotificationTemplateCommerceAccountGroupRelModelImpl.FINDER_CACHE_ENABLED,
			Long.class, FINDER_CLASS_NAME_LIST_WITHOUT_PAGINATION, "countAll",
			new String[0]);
	public static final FinderPath FINDER_PATH_WITH_PAGINATION_FIND_BY_COMMERCEACCOUNTGROUPID =
		new FinderPath(CommerceNotificationTemplateCommerceAccountGroupRelModelImpl.ENTITY_CACHE_ENABLED,
			CommerceNotificationTemplateCommerceAccountGroupRelModelImpl.FINDER_CACHE_ENABLED,
			CommerceNotificationTemplateCommerceAccountGroupRelImpl.class,
	...
	public static final FinderPath FINDER_PATH_WITHOUT_PAGINATION_FIND_BY_COMMERCEACCOUNTGROUPID =
		new FinderPath(CommerceNotificationTemplateCommerceAccountGroupRelModelImpl.ENTITY_CACHE_ENABLED,
			...
			CommerceNotificationTemplateCommerceAccountGroupRelModelImpl.COMMERCEACCOUNTGROUPID_COLUMN_BITMASK |
			CommerceNotificationTemplateCommerceAccountGroupRelModelImpl.CREATEDATE_COLUMN_BITMASK);
	public static final FinderPath FINDER_PATH_COUNT_BY_COMMERCEACCOUNTGROUPID = new FinderPath(CommerceNotificationTemplateCommerceAccountGroupRelModelImpl.ENTITY_CACHE_ENABLED,
			CommerceNotificationTemplateCommerceAccountGroupRelModelImpl.FINDER_CACHE_ENABLED,
	 ...
	 */
	@Override
	public List<CommerceNotificationTemplateCommerceAccountGroupRel> findByCommerceAccountGroupId(
	...
	public List<CommerceNotificationTemplateCommerceAccountGroupRel> findByCommerceAccountGroupId(
		long commerceAccountGroupId, int start, int end,
		OrderByComparator<CommerceNotificationTemplateCommerceAccountGroupRel> orderByComparator) {
		return findByCommerceAccountGroupId(commerceAccountGroupId, start, end,
	...
	public List<CommerceNotificationTemplateCommerceAccountGroupRel> findByCommerceAccountGroupId(
		...
		if (retrieveFromCache) {
			list = (List<CommerceNotificationTemplateCommerceAccountGroupRel>)finderCache.getResult(finderPath,
					finderArgs, this);

			if ((list != null) && !list.isEmpty()) {
				for (CommerceNotificationTemplateCommerceAccountGroupRel commerceNotificationTemplateCommerceAccountGroupRel : list) {
					if ((commerceAccountGroupId != commerceNotificationTemplateCommerceAccountGroupRel.getCommerceAccountGroupId())) {
						list = null;
		...
		if (list == null) {
			...
			query.append(_SQL_SELECT_COMMERCENOTIFICATIONTEMPLATECOMMERCEACCOUNTGROUPREL_WHERE);
			...
			if (orderByComparator != null) {
			 ...
			 if (pagination) {
				query.append(CommerceNotificationTemplateCommerceAccountGroupRelModelImpl.ORDER_BY_JPQL);
			}
			...
			try {
				...
				if (!pagination) {
					list = (List<CommerceNotificationTemplateCommerceAccountGroupRel>)QueryUtil.list(q,
	 ...
	 */
	@Override
	public CommerceNotificationTemplateCommerceAccountGroupRel findByCommerceAccountGroupId_First(
		long commerceAccountGroupId,
		OrderByComparator<CommerceNotificationTemplateCommerceAccountGroupRel> orderByComparator)
		...
		throw new NoSuchNotificationTemplateCommerceAccountGroupRelException(msg.toString());
	}
	 ...
	 */
	@Override
	public CommerceNotificationTemplateCommerceAccountGroupRel fetchByCommerceAccountGroupId_First(
		long commerceAccountGroupId,
		OrderByComparator<CommerceNotificationTemplateCommerceAccountGroupRel> orderByComparator) {
		List<CommerceNotificationTemplateCommerceAccountGroupRel> list = findByCommerceAccountGroupId(commerceAccountGroupId,
	 ...
	 */
	@Override
	public CommerceNotificationTemplateCommerceAccountGroupRel findByCommerceAccountGroupId_Last(
		long commerceAccountGroupId,
		OrderByComparator<CommerceNotificationTemplateCommerceAccountGroupRel> orderByComparator)
		throws NoSuchNotificationTemplateCommerceAccountGroupRelException {
		CommerceNotificationTemplateCommerceAccountGroupRel commerceNotificationTemplateCommerceAccountGroupRel =
	 ...
	 */
	@Override
	public CommerceNotificationTemplateCommerceAccountGroupRel fetchByCommerceAccountGroupId_Last(
		long commerceAccountGroupId,
		OrderByComparator<CommerceNotificationTemplateCommerceAccountGroupRel> orderByComparator) {
	 ...
	 */
	@Override
	public CommerceNotificationTemplateCommerceAccountGroupRel[] findByCommerceAccountGroupId_PrevAndNext(
		long commerceNotificationTemplateCommerceAccountGroupRelId,
		long commerceAccountGroupId,
		OrderByComparator<CommerceNotificationTemplateCommerceAccountGroupRel> orderByComparator)
		throws NoSuchNotificationTemplateCommerceAccountGroupRelException {
		CommerceNotificationTemplateCommerceAccountGroupRel commerceNotificationTemplateCommerceAccountGroupRel =
			findByPrimaryKey(commerceNotificationTemplateCommerceAccountGroupRelId);
		...
		try {
			...
			CommerceNotificationTemplateCommerceAccountGroupRel[] array = new CommerceNotificationTemplateCommerceAccountGroupRelImpl[3];
	...
	protected CommerceNotificationTemplateCommerceAccountGroupRel getByCommerceAccountGroupId_PrevAndNext(
		Session session,
		CommerceNotificationTemplateCommerceAccountGroupRel commerceNotificationTemplateCommerceAccountGroupRel,
		long commerceAccountGroupId,
		OrderByComparator<CommerceNotificationTemplateCommerceAccountGroupRel> orderByComparator,
		...
		if (orderByComparator != null) {
			Object[] values = orderByComparator.getOrderByConditionValues(commerceNotificationTemplateCommerceAccountGroupRel);
		...
		List<CommerceNotificationTemplateCommerceAccountGroupRel> list = q.list();
	...
	public void removeByCommerceAccountGroupId(long commerceAccountGroupId) {
		for (CommerceNotificationTemplateCommerceAccountGroupRel commerceNotificationTemplateCommerceAccountGroupRel : findByCommerceAccountGroupId(
	...
	public int countByCommerceAccountGroupId(long commerceAccountGroupId) {
		...
		if (count == null) {
			...
			query.append(_SQL_COUNT_COMMERCENOTIFICATIONTEMPLATECOMMERCEACCOUNTGROUPREL_WHERE);
	...
	public static final FinderPath FINDER_PATH_WITHOUT_PAGINATION_FIND_BY_COMMERCENOTIFICATIONTEMPLATEID =
		new FinderPath(CommerceNotificationTemplateCommerceAccountGroupRelModelImpl.ENTITY_CACHE_ENABLED,
			...
			"findByCommerceNotificationTemplateId",
			new String[] { Long.class.getName() },
			CommerceNotificationTemplateCommerceAccountGroupRelModelImpl.COMMERCENOTIFICATIONTEMPLATEID_COLUMN_BITMASK |
			CommerceNotificationTemplateCommerceAccountGroupRelModelImpl.CREATEDATE_COLUMN_BITMASK);
	 ...
	 */
	@Override
	public List<CommerceNotificationTemplateCommerceAccountGroupRel> findByCommerceNotificationTemplateId(
	...
	public List<CommerceNotificationTemplateCommerceAccountGroupRel> findByCommerceNotificationTemplateId(
		...
		if (retrieveFromCache) {
			...
			if ((list != null) && !list.isEmpty()) {
				for (CommerceNotificationTemplateCommerceAccountGroupRel commerceNotificationTemplateCommerceAccountGroupRel : list) {
					if ((commerceNotificationTemplateId != commerceNotificationTemplateCommerceAccountGroupRel.getCommerceNotificationTemplateId())) {
						list = null;
	 ...
	 */
	@Override
	public CommerceNotificationTemplateCommerceAccountGroupRel findByCommerceNotificationTemplateId_First(
		long commerceNotificationTemplateId,
		OrderByComparator<CommerceNotificationTemplateCommerceAccountGroupRel> orderByComparator)
		throws NoSuchNotificationTemplateCommerceAccountGroupRelException {
		CommerceNotificationTemplateCommerceAccountGroupRel commerceNotificationTemplateCommerceAccountGroupRel =
	 ...
	 */
	@Override
	public CommerceNotificationTemplateCommerceAccountGroupRel fetchByCommerceNotificationTemplateId_First(
		long commerceNotificationTemplateId,
		OrderByComparator<CommerceNotificationTemplateCommerceAccountGroupRel> orderByComparator) {
		List<CommerceNotificationTemplateCommerceAccountGroupRel> list = findByCommerceNotificationTemplateId(commerceNotificationTemplateId,
				0, 1, orderByComparator);
	 ...
	 */
	@Override
	public CommerceNotificationTemplateCommerceAccountGroupRel findByCommerceNotificationTemplateId_Last(
		long commerceNotificationTemplateId,
		OrderByComparator<CommerceNotificationTemplateCommerceAccountGroupRel> orderByComparator)
		throws NoSuchNotificationTemplateCommerceAccountGroupRelException {
		CommerceNotificationTemplateCommerceAccountGroupRel commerceNotificationTemplateCommerceAccountGroupRel =
	 ...
	 */
	@Override
	public CommerceNotificationTemplateCommerceAccountGroupRel fetchByCommerceNotificationTemplateId_Last(
		long commerceNotificationTemplateId,
		OrderByComparator<CommerceNotificationTemplateCommerceAccountGroupRel> orderByComparator) {
	 ...
	 */
	@Override
	public CommerceNotificationTemplateCommerceAccountGroupRel[] findByCommerceNotificationTemplateId_PrevAndNext(
		long commerceNotificationTemplateCommerceAccountGroupRelId,
		long commerceNotificationTemplateId,
		OrderByComparator<CommerceNotificationTemplateCommerceAccountGroupRel> orderByComparator)
		throws NoSuchNotificationTemplateCommerceAccountGroupRelException {
	...
	public void removeByCommerceNotificationTemplateId(
		long commerceNotificationTemplateId) {
		for (CommerceNotificationTemplateCommerceAccountGroupRel commerceNotificationTemplateCommerceAccountGroupRel : findByCommerceNotificationTemplateId(
	...
	public static final FinderPath FINDER_PATH_FETCH_BY_C_C = new FinderPath(CommerceNotificationTemplateCommerceAccountGroupRelModelImpl.ENTITY_CACHE_ENABLED,
			CommerceNotificationTemplateCommerceAccountGroupRelModelImpl.FINDER_CACHE_ENABLED,
			CommerceNotificationTemplateCommerceAccountGroupRelImpl.class,
			...
			CommerceNotificationTemplateCommerceAccountGroupRelModelImpl.COMMERCENOTIFICATIONTEMPLATEID_COLUMN_BITMASK |
			CommerceNotificationTemplateCommerceAccountGroupRelModelImpl.COMMERCEACCOUNTGROUPID_COLUMN_BITMASK);
	public static final FinderPath FINDER_PATH_COUNT_BY_C_C = new FinderPath(CommerceNotificationTemplateCommerceAccountGroupRelModelImpl.ENTITY_CACHE_ENABLED,
			CommerceNotificationTemplateCommerceAccountGroupRelModelImpl.FINDER_CACHE_ENABLED,
			Long.class, FINDER_CLASS_NAME_LIST_WITHOUT_PAGINATION,
			"countByC_C",
			new String[] { Long.class.getName(), Long.class.getName() });
	...
	/**
	 * Returns the commerce notification template commerce account group rel where commerceNotificationTemplateId = &#63; and commerceAccountGroupId = &#63; or throws a {@link NoSuchNotificationTemplateCommerceAccountGroupRelException} if it could not be found.
	 *
	 * @param commerceNotificationTemplateId the commerce notification template ID
	 * @param commerceAccountGroupId the commerce account group ID
	...
	public CommerceNotificationTemplateCommerceAccountGroupRel fetchByC_C(
		...
		if (result instanceof CommerceNotificationTemplateCommerceAccountGroupRel) {
			CommerceNotificationTemplateCommerceAccountGroupRel commerceNotificationTemplateCommerceAccountGroupRel =
				(CommerceNotificationTemplateCommerceAccountGroupRel)result;

			if ((commerceNotificationTemplateId != commerceNotificationTemplateCommerceAccountGroupRel.getCommerceNotificationTemplateId()) ||
					(commerceAccountGroupId != commerceNotificationTemplateCommerceAccountGroupRel.getCommerceAccountGroupId())) {
				result = null;
			}
		}
		...
		if (result == null) {
			...
			try {
				...
				if (list.isEmpty()) {
					...
					result = commerceNotificationTemplateCommerceAccountGroupRel;
	...
	public CommerceNotificationTemplateCommerceAccountGroupRel removeByC_C(
		...
		throws NoSuchNotificationTemplateCommerceAccountGroupRelException {
		CommerceNotificationTemplateCommerceAccountGroupRel commerceNotificationTemplateCommerceAccountGroupRel =
			findByC_C(commerceNotificationTemplateId, commerceAccountGroupId);
	...
	public CommerceNotificationTemplateCommerceAccountGroupRelPersistenceImpl() {
		...
		try {
			...
			dbColumnNames.put("commerceNotificationTemplateCommerceAccountGroupRelId",
	...
	public void cacheResult(
		CommerceNotificationTemplateCommerceAccountGroupRel commerceNotificationTemplateCommerceAccountGroupRel) {
		entityCache.putResult(CommerceNotificationTemplateCommerceAccountGroupRelModelImpl.ENTITY_CACHE_ENABLED,
			CommerceNotificationTemplateCommerceAccountGroupRelImpl.class,
		...
		finderCache.putResult(FINDER_PATH_FETCH_BY_C_C,
			new Object[] {
				commerceNotificationTemplateCommerceAccountGroupRel.getCommerceNotificationTemplateId(),
				commerceNotificationTemplateCommerceAccountGroupRel.getCommerceAccountGroupId()
			}, commerceNotificationTemplateCommerceAccountGroupRel);
	...
	@Override
	public void cacheResult(
		List<CommerceNotificationTemplateCommerceAccountGroupRel> commerceNotificationTemplateCommerceAccountGroupRels) {
		for (CommerceNotificationTemplateCommerceAccountGroupRel commerceNotificationTemplateCommerceAccountGroupRel : commerceNotificationTemplateCommerceAccountGroupRels) {
			if (entityCache.getResult(
						CommerceNotificationTemplateCommerceAccountGroupRelModelImpl.ENTITY_CACHE_ENABLED,
						CommerceNotificationTemplateCommerceAccountGroupRelImpl.class,
						commerceNotificationTemplateCommerceAccountGroupRel.getPrimaryKey()) == null) {
				cacheResult(commerceNotificationTemplateCommerceAccountGroupRel);
			}
			else {
				commerceNotificationTemplateCommerceAccountGroupRel.resetOriginalValues();
	...
	public void clearCache() {
		entityCache.clearCache(CommerceNotificationTemplateCommerceAccountGroupRelImpl.class);
	...
	public void clearCache(
		CommerceNotificationTemplateCommerceAccountGroupRel commerceNotificationTemplateCommerceAccountGroupRel) {
		entityCache.removeResult(CommerceNotificationTemplateCommerceAccountGroupRelModelImpl.ENTITY_CACHE_ENABLED,
			CommerceNotificationTemplateCommerceAccountGroupRelImpl.class,
			commerceNotificationTemplateCommerceAccountGroupRel.getPrimaryKey());
		...
		clearUniqueFindersCache((CommerceNotificationTemplateCommerceAccountGroupRelModelImpl)commerceNotificationTemplateCommerceAccountGroupRel,
			true);
	}
	...
	protected void cacheUniqueFindersCache(
		...
		Object[] args = new Object[] {
				commerceNotificationTemplateCommerceAccountGroupRelModelImpl.getCommerceNotificationTemplateId(),
				commerceNotificationTemplateCommerceAccountGroupRelModelImpl.getCommerceAccountGroupId()
			};
	...
	protected void clearUniqueFindersCache(
		...
		if ((commerceNotificationTemplateCommerceAccountGroupRelModelImpl.getColumnBitmask() &
				FINDER_PATH_FETCH_BY_C_C.getColumnBitmask()) != 0) {
			Object[] args = new Object[] {
					commerceNotificationTemplateCommerceAccountGroupRelModelImpl.getOriginalCommerceNotificationTemplateId(),
					commerceNotificationTemplateCommerceAccountGroupRelModelImpl.getOriginalCommerceAccountGroupId()
				};
	...
	public CommerceNotificationTemplateCommerceAccountGroupRel create(
		...
		commerceNotificationTemplateCommerceAccountGroupRel.setPrimaryKey(commerceNotificationTemplateCommerceAccountGroupRelId);

		commerceNotificationTemplateCommerceAccountGroupRel.setCompanyId(companyProvider.getCompanyId());
	...
	public CommerceNotificationTemplateCommerceAccountGroupRel remove(
		long commerceNotificationTemplateCommerceAccountGroupRelId)
		throws NoSuchNotificationTemplateCommerceAccountGroupRelException {
		return remove((Serializable)commerceNotificationTemplateCommerceAccountGroupRelId);
	}
	...
	public CommerceNotificationTemplateCommerceAccountGroupRel remove(
		...
		try {
			...
			CommerceNotificationTemplateCommerceAccountGroupRel commerceNotificationTemplateCommerceAccountGroupRel =
				(CommerceNotificationTemplateCommerceAccountGroupRel)session.get(CommerceNotificationTemplateCommerceAccountGroupRelImpl.class,
					primaryKey);
			...
			if (commerceNotificationTemplateCommerceAccountGroupRel == null) {
				...
				throw new NoSuchNotificationTemplateCommerceAccountGroupRelException(_NO_SUCH_ENTITY_WITH_PRIMARY_KEY +
					primaryKey);
			}

			return remove(commerceNotificationTemplateCommerceAccountGroupRel);
		}
		catch (NoSuchNotificationTemplateCommerceAccountGroupRelException nsee) {
			throw nsee;
		}
		catch (Exception e) {
			throw processException(e);
	...
	protected CommerceNotificationTemplateCommerceAccountGroupRel removeImpl(
		...
		try {
			...
			if (!session.contains(
						commerceNotificationTemplateCommerceAccountGroupRel)) {
				commerceNotificationTemplateCommerceAccountGroupRel = (CommerceNotificationTemplateCommerceAccountGroupRel)session.get(CommerceNotificationTemplateCommerceAccountGroupRelImpl.class,
						commerceNotificationTemplateCommerceAccountGroupRel.getPrimaryKeyObj());
			}
	...
	public CommerceNotificationTemplateCommerceAccountGroupRel updateImpl(
		...
		if (!(commerceNotificationTemplateCommerceAccountGroupRel instanceof CommerceNotificationTemplateCommerceAccountGroupRelModelImpl)) {
			...
			if (ProxyUtil.isProxyClass(
						commerceNotificationTemplateCommerceAccountGroupRel.getClass())) {
				invocationHandler = ProxyUtil.getInvocationHandler(commerceNotificationTemplateCommerceAccountGroupRel);
		...
		CommerceNotificationTemplateCommerceAccountGroupRelModelImpl commerceNotificationTemplateCommerceAccountGroupRelModelImpl =
			(CommerceNotificationTemplateCommerceAccountGroupRelModelImpl)commerceNotificationTemplateCommerceAccountGroupRel;
		...
		if (isNew &&
				(commerceNotificationTemplateCommerceAccountGroupRel.getCreateDate() == null)) {
			if (serviceContext == null) {
				commerceNotificationTemplateCommerceAccountGroupRel.setCreateDate(now);
			}
			else {
				commerceNotificationTemplateCommerceAccountGroupRel.setCreateDate(serviceContext.getCreateDate(
						now));
			}
		}
		...
		if (!commerceNotificationTemplateCommerceAccountGroupRelModelImpl.hasSetModifiedDate()) {
			if (serviceContext == null) {
				commerceNotificationTemplateCommerceAccountGroupRel.setModifiedDate(now);
			}
			else {
				commerceNotificationTemplateCommerceAccountGroupRel.setModifiedDate(serviceContext.getModifiedDate(
						now));
			}
		}
		...
		try {
			...
			if (commerceNotificationTemplateCommerceAccountGroupRel.isNew()) {
				session.save(commerceNotificationTemplateCommerceAccountGroupRel);

				commerceNotificationTemplateCommerceAccountGroupRel.setNew(false);
			}
			else {
				commerceNotificationTemplateCommerceAccountGroupRel = (CommerceNotificationTemplateCommerceAccountGroupRel)session.merge(commerceNotificationTemplateCommerceAccountGroupRel);
			}
		}
		catch (Exception e) {
			throw processException(e);
		...
		if (!CommerceNotificationTemplateCommerceAccountGroupRelModelImpl.COLUMN_BITMASK_ENABLED) {
			finderCache.clearCache(FINDER_CLASS_NAME_LIST_WITHOUT_PAGINATION);
		}
		else
		 if (isNew) {
		...
		clearUniqueFindersCache(commerceNotificationTemplateCommerceAccountGroupRelModelImpl,
			false);
	...
	/**
	 * Returns the commerce notification template commerce account group rel with the primary key or throws a {@link com.liferay.portal.kernel.exception.NoSuchModelException} if it could not be found.
	 *
	 * @param primaryKey the primary key of the commerce notification template commerce account group rel
	...
	/**
	 * Returns the commerce notification template commerce account group rel with the primary key or throws a {@link NoSuchNotificationTemplateCommerceAccountGroupRelException} if it could not be found.
	 *
	 * @param commerceNotificationTemplateCommerceAccountGroupRelId the primary key of the commerce notification template commerce account group rel
	 * @return the commerce notification template commerce account group rel
	 * @throws NoSuchNotificationTemplateCommerceAccountGroupRelException if a commerce notification template commerce account group rel with the primary key could not be found
	...
	public CommerceNotificationTemplateCommerceAccountGroupRel findByPrimaryKey(
		long commerceNotificationTemplateCommerceAccountGroupRelId)
		throws NoSuchNotificationTemplateCommerceAccountGroupRelException {
		return findByPrimaryKey((Serializable)commerceNotificationTemplateCommerceAccountGroupRelId);
	}
	 ...
	 */
	@Override
	public CommerceNotificationTemplateCommerceAccountGroupRel fetchByPrimaryKey(
		Serializable primaryKey) {
		Serializable serializable = entityCache.getResult(CommerceNotificationTemplateCommerceAccountGroupRelModelImpl.ENTITY_CACHE_ENABLED,
				CommerceNotificationTemplateCommerceAccountGroupRelImpl.class,
				primaryKey);
		...
		CommerceNotificationTemplateCommerceAccountGroupRel commerceNotificationTemplateCommerceAccountGroupRel =
			(CommerceNotificationTemplateCommerceAccountGroupRel)serializable;
	...
	public CommerceNotificationTemplateCommerceAccountGroupRel fetchByPrimaryKey(
		long commerceNotificationTemplateCommerceAccountGroupRelId) {
		return fetchByPrimaryKey((Serializable)commerceNotificationTemplateCommerceAccountGroupRelId);
	}

	@Override
	public Map<Serializable, CommerceNotificationTemplateCommerceAccountGroupRel> fetchByPrimaryKeys(
		Set<Serializable> primaryKeys) {
		if (primaryKeys.isEmpty()) {
			return Collections.emptyMap();
		}

		Map<Serializable, CommerceNotificationTemplateCommerceAccountGroupRel> map =
			new HashMap<Serializable, CommerceNotificationTemplateCommerceAccountGroupRel>();
		...
		query.append(_SQL_SELECT_COMMERCENOTIFICATIONTEMPLATECOMMERCEACCOUNTGROUPREL_WHERE_PKS_IN);
		...
		try {
			...
			for (CommerceNotificationTemplateCommerceAccountGroupRel commerceNotificationTemplateCommerceAccountGroupRel : (List<CommerceNotificationTemplateCommerceAccountGroupRel>)q.list()) {
				map.put(commerceNotificationTemplateCommerceAccountGroupRel.getPrimaryKeyObj(),
					commerceNotificationTemplateCommerceAccountGroupRel);

				cacheResult(commerceNotificationTemplateCommerceAccountGroupRel);

				uncachedPrimaryKeys.remove(commerceNotificationTemplateCommerceAccountGroupRel.getPrimaryKeyObj());
			}
	...
	public List<CommerceNotificationTemplateCommerceAccountGroupRel> findAll(
		...
		if (list == null) {
			...
			if (orderByComparator != null) {
				...
				query.append(_SQL_SELECT_COMMERCENOTIFICATIONTEMPLATECOMMERCEACCOUNTGROUPREL);
				...
				sql = _SQL_SELECT_COMMERCENOTIFICATIONTEMPLATECOMMERCEACCOUNTGROUPREL;

				if (pagination) {
					sql = sql.concat(CommerceNotificationTemplateCommerceAccountGroupRelModelImpl.ORDER_BY_JPQL);
				}
			}
	...
	public void removeAll() {
		for (CommerceNotificationTemplateCommerceAccountGroupRel commerceNotificationTemplateCommerceAccountGroupRel : findAll()) {
			remove(commerceNotificationTemplateCommerceAccountGroupRel);
		}
	}
	...
	public int countAll() {
		...
		if (count == null) {
			...
			try {
				...
				Query q = session.createQuery(_SQL_COUNT_COMMERCENOTIFICATIONTEMPLATECOMMERCEACCOUNTGROUPREL);
	...
	public void destroy() {
		entityCache.removeCache(CommerceNotificationTemplateCommerceAccountGroupRelImpl.class.getName());
	...
	private static final String _SQL_SELECT_COMMERCENOTIFICATIONTEMPLATECOMMERCEACCOUNTGROUPREL =
	...
	private static final String _SQL_SELECT_COMMERCENOTIFICATIONTEMPLATECOMMERCEACCOUNTGROUPREL_WHERE_PKS_IN =
	...
	private static final String _SQL_SELECT_COMMERCENOTIFICATIONTEMPLATECOMMERCEACCOUNTGROUPREL_WHERE =
	...
	private static final String _SQL_COUNT_COMMERCENOTIFICATIONTEMPLATECOMMERCEACCOUNTGROUPREL =
	...
	private static final String _SQL_COUNT_COMMERCENOTIFICATIONTEMPLATECOMMERCEACCOUNTGROUPREL_WHERE =

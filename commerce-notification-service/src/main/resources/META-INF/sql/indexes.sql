...
create index IX_355FC10 on CNTemplateAccountGroupRel (commerceAccountGroupId);
create unique index IX_7DEAC57F on CNTemplateAccountGroupRel (commerceNotificationTemplateId, commerceAccountGroupId);

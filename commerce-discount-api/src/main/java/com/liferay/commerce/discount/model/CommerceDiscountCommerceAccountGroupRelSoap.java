 ...
 *
 * @author Marco Leo
 * @see com.liferay.commerce.discount.service.http.CommerceDiscountCommerceAccountGroupRelServiceSoap
 * @generated
 */
@ProviderType
public class CommerceDiscountCommerceAccountGroupRelSoap implements Serializable {
	...
	public static CommerceDiscountCommerceAccountGroupRelSoap[] toSoapModels(
		...
		CommerceDiscountCommerceAccountGroupRelSoap[] soapModels = new CommerceDiscountCommerceAccountGroupRelSoap[models.length];
	...
	public static CommerceDiscountCommerceAccountGroupRelSoap[][] toSoapModels(
		...
		if (models.length > 0) {
			soapModels = new CommerceDiscountCommerceAccountGroupRelSoap[models.length][models[0].length];
		}
		else {
	...
	public static CommerceDiscountCommerceAccountGroupRelSoap[] toSoapModels(
		...
		List<CommerceDiscountCommerceAccountGroupRelSoap> soapModels = new ArrayList<CommerceDiscountCommerceAccountGroupRelSoap>(models.size());

		for (CommerceDiscountCommerceAccountGroupRel model : models) {
			soapModels.add(toSoapModel(model));
		}

		return soapModels.toArray(new CommerceDiscountCommerceAccountGroupRelSoap[soapModels.size()]);
	}

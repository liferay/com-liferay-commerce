 ...
 * <code>com.liferay.commerce.discount.service.impl.CommerceDiscountUserSegmentRelServiceImpl</code> and is an
...
public class CommerceDiscountUserSegmentRelServiceUtil {
	 ...
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this class directly. Add custom service methods to <code>com.liferay.commerce.discount.service.impl.CommerceDiscountUserSegmentRelServiceImpl</code> and rerun ServiceBuilder to regenerate this class.
	 */
	public static
		...
		return getService().addCommerceDiscountUserSegmentRel(
	...
	public static void deleteCommerceDiscountUserSegmentRel(
		...
		getService().deleteCommerceDiscountUserSegmentRel(
	...
	public static java.util.List
		...
		return getService().getCommerceDiscountUserSegmentRels(
	...
	private static ServiceTracker
		<CommerceDiscountUserSegmentRelService,
		 CommerceDiscountUserSegmentRelService> _serviceTracker;

	static {
		Bundle bundle = FrameworkUtil.getBundle(
			CommerceDiscountUserSegmentRelService.class);

		ServiceTracker
			<CommerceDiscountUserSegmentRelService,
			 CommerceDiscountUserSegmentRelService> serviceTracker =
				new ServiceTracker
					<CommerceDiscountUserSegmentRelService,
					 CommerceDiscountUserSegmentRelService>(

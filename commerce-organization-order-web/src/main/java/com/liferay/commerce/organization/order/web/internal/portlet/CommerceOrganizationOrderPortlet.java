...
@Component(
	...
	property = {
		...
		"com.liferay.portlet.css-class-wrapper=portlet-commerce-organization-order",
	...
	service = {CommerceOrganizationOrderPortlet.class, Portlet.class}
)
public class CommerceOrganizationOrderPortlet extends MVCPortlet {

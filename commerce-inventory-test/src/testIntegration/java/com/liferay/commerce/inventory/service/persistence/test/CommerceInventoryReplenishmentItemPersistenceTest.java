...
public class CommerceInventoryReplenishmentItemPersistenceTest {
	...
	public void tearDown() throws Exception {
		Iterator<CommerceInventoryReplenishmentItem> iterator = _commerceInventoryReplenishmentItems.iterator();
	...
	public void testCreate() throws Exception {
		...
		CommerceInventoryReplenishmentItem commerceInventoryReplenishmentItem = _persistence.create(pk);

		Assert.assertNotNull(commerceInventoryReplenishmentItem);

		Assert.assertEquals(commerceInventoryReplenishmentItem.getPrimaryKey(),
			pk);
	}

	@Test
	public void testRemove() throws Exception {
		CommerceInventoryReplenishmentItem newCommerceInventoryReplenishmentItem =
			addCommerceInventoryReplenishmentItem();

		_persistence.remove(newCommerceInventoryReplenishmentItem);

		CommerceInventoryReplenishmentItem existingCommerceInventoryReplenishmentItem =
			_persistence.fetchByPrimaryKey(newCommerceInventoryReplenishmentItem.getPrimaryKey());
	...
	public void testUpdateExisting() throws Exception {
		...
		newCommerceInventoryReplenishmentItem.setCompanyId(RandomTestUtil.nextLong());

		newCommerceInventoryReplenishmentItem.setUserId(RandomTestUtil.nextLong());

		newCommerceInventoryReplenishmentItem.setUserName(RandomTestUtil.randomString());

		newCommerceInventoryReplenishmentItem.setCreateDate(RandomTestUtil.nextDate());
		...
		newCommerceInventoryReplenishmentItem.setAvailabilityDate(RandomTestUtil.nextDate());

		newCommerceInventoryReplenishmentItem.setQuantity(RandomTestUtil.nextInt());

		_commerceInventoryReplenishmentItems.add(_persistence.update(
				newCommerceInventoryReplenishmentItem));

		CommerceInventoryReplenishmentItem existingCommerceInventoryReplenishmentItem =
			_persistence.findByPrimaryKey(newCommerceInventoryReplenishmentItem.getPrimaryKey());

		Assert.assertEquals(existingCommerceInventoryReplenishmentItem.getCommerceInventoryReplenishmentItemId(),
			newCommerceInventoryReplenishmentItem.getCommerceInventoryReplenishmentItemId());
		Assert.assertEquals(existingCommerceInventoryReplenishmentItem.getCompanyId(),
			newCommerceInventoryReplenishmentItem.getCompanyId());
		Assert.assertEquals(existingCommerceInventoryReplenishmentItem.getUserId(),
			newCommerceInventoryReplenishmentItem.getUserId());
		Assert.assertEquals(existingCommerceInventoryReplenishmentItem.getUserName(),
		...
		Assert.assertEquals(Time.getShortTimestamp(
				existingCommerceInventoryReplenishmentItem.getAvailabilityDate()),
			Time.getShortTimestamp(
				newCommerceInventoryReplenishmentItem.getAvailabilityDate()));
		Assert.assertEquals(existingCommerceInventoryReplenishmentItem.getQuantity(),
	...
	public void testFindByPrimaryKeyExisting() throws Exception {
		...
		Assert.assertEquals(existingCommerceInventoryReplenishmentItem,
			newCommerceInventoryReplenishmentItem);
	}
	...
	protected OrderByComparator<CommerceInventoryReplenishmentItem> getOrderByComparator() {
	...
	public void testFetchByPrimaryKeyMissing() throws Exception {
		...
		CommerceInventoryReplenishmentItem missingCommerceInventoryReplenishmentItem =
	...
	public void testFetchByPrimaryKeysWithMultiplePrimaryKeysWhereAllPrimaryKeysExist()
		throws Exception {
		CommerceInventoryReplenishmentItem newCommerceInventoryReplenishmentItem1 =
			addCommerceInventoryReplenishmentItem();
		CommerceInventoryReplenishmentItem newCommerceInventoryReplenishmentItem2 =
			addCommerceInventoryReplenishmentItem();
		...
		Map<Serializable, CommerceInventoryReplenishmentItem> commerceInventoryReplenishmentItems =
			_persistence.fetchByPrimaryKeys(primaryKeys);

		Assert.assertEquals(2, commerceInventoryReplenishmentItems.size());
		Assert.assertEquals(newCommerceInventoryReplenishmentItem1,
			commerceInventoryReplenishmentItems.get(
				newCommerceInventoryReplenishmentItem1.getPrimaryKey()));
		Assert.assertEquals(newCommerceInventoryReplenishmentItem2,
			commerceInventoryReplenishmentItems.get(
	...
	public void testFetchByPrimaryKeysWithMultiplePrimaryKeysWhereSomePrimaryKeysExist()
		...
		Assert.assertEquals(newCommerceInventoryReplenishmentItem,
			commerceInventoryReplenishmentItems.get(
	...
	public void testActionableDynamicQuery() throws Exception {
		...
		ActionableDynamicQuery actionableDynamicQuery = CommerceInventoryReplenishmentItemLocalServiceUtil.getActionableDynamicQuery();

		actionableDynamicQuery.setPerformActionMethod(new ActionableDynamicQuery.PerformActionMethod<CommerceInventoryReplenishmentItem>() {
				@Override
	...
	public void testDynamicQueryByPrimaryKeyExisting()
		...
		DynamicQuery dynamicQuery = DynamicQueryFactoryUtil.forClass(CommerceInventoryReplenishmentItem.class,
		...
		List<CommerceInventoryReplenishmentItem> result = _persistence.findWithDynamicQuery(dynamicQuery);
	...
	public void testDynamicQueryByProjectionExisting()
		...
		Object newCommerceInventoryReplenishmentItemId = newCommerceInventoryReplenishmentItem.getCommerceInventoryReplenishmentItemId();
		...
		Assert.assertEquals(existingCommerceInventoryReplenishmentItemId,
	...
	protected CommerceInventoryReplenishmentItem addCommerceInventoryReplenishmentItem()
		throws Exception {
		long pk = RandomTestUtil.nextLong();

		CommerceInventoryReplenishmentItem commerceInventoryReplenishmentItem = _persistence.create(pk);

		commerceInventoryReplenishmentItem.setCompanyId(RandomTestUtil.nextLong());

		commerceInventoryReplenishmentItem.setUserId(RandomTestUtil.nextLong());

		commerceInventoryReplenishmentItem.setUserName(RandomTestUtil.randomString());

		commerceInventoryReplenishmentItem.setCreateDate(RandomTestUtil.nextDate());
		...
		commerceInventoryReplenishmentItem.setAvailabilityDate(RandomTestUtil.nextDate());

		commerceInventoryReplenishmentItem.setQuantity(RandomTestUtil.nextInt());
	...
	private List<CommerceInventoryReplenishmentItem> _commerceInventoryReplenishmentItems =

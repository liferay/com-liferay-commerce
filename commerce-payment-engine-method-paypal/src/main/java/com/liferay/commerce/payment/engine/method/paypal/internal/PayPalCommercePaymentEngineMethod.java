...
package com.liferay.commerce.payment.engine.method.paypal.internal;
...
@Component(
	immediate = true,
	property = "commerce.payment.engine.method.key=" + PayPalCommercePaymentEngineMethod.KEY,
	service = CommercePaymentEngineMethod.class
)
public class PayPalCommercePaymentEngineMethod
	implements CommercePaymentEngineMethod {

	public static final String KEY = "paypal";

	public PayPalCommercePaymentEngineMethod() {
	...
	public CommercePaymentResult capturePayment(
		...
		if (PayPalCommercePaymentEngineMethodConstants.
	...
	public CommercePaymentResult completePayment(
		...
		String payerId = commercePaymentRequest.getPayerId();
		...
		if (PayPalCommercePaymentEngineMethodConstants.
				PAYMENT_STATE_FAILED.equals(payment.getState())) {
		...
		PayPalGroupServiceConfiguration payPalGroupServiceConfiguration =
			_configurationProvider.getConfiguration(
				...
				new GroupServiceSettingsLocator(
					...
					PayPalCommercePaymentEngineMethodConstants.SERVICE_NAME));

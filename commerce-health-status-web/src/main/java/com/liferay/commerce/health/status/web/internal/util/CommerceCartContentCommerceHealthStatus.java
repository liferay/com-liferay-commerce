...
@Component(
	...
	property = {
		...
		"commerce.health.status.key=" + CommerceHealthStatusConstants.COMMERCE_CART_CONTENT_COMMERCE_HEALTH_STATUS_KEY
	},
	service = CommerceHealthStatus.class
)
public class CommerceCartContentCommerceHealthStatus

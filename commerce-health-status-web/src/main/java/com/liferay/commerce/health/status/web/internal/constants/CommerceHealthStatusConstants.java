...
public class CommerceHealthStatusConstants {
	...
	public static final String CATALOGS_COMMERCE_HEALTH_STATUS_DESCRIPTION =
		"catalogs.commerce.health.status.description";

	public static final String CATALOGS_COMMERCE_HEALTH_STATUS_KEY =
		"catalogs.commerce.health.status.key";
	...
	public static final String
		COMMERCE_CART_CONTENT_COMMERCE_HEALTH_STATUS_KEY =
			"commerce.cart.content.commerce.health.status.key";

	public static final String
		COMMERCE_CHECKOUT_COMMERCE_HEALTH_STATUS_DESCRIPTION =
			"commerce.checkout.commerce.health.status.description";

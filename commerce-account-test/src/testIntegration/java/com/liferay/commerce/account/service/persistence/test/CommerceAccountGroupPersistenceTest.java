...
public class CommerceAccountGroupPersistenceTest {
	...
	public void tearDown() throws Exception {
		Iterator<CommerceAccountGroup> iterator = _commerceAccountGroups.iterator();
	...
	public void testRemove() throws Exception {
		CommerceAccountGroup newCommerceAccountGroup = addCommerceAccountGroup();

		_persistence.remove(newCommerceAccountGroup);

		CommerceAccountGroup existingCommerceAccountGroup = _persistence.fetchByPrimaryKey(newCommerceAccountGroup.getPrimaryKey());
	...
	public void testUpdateExisting() throws Exception {
		...
		newCommerceAccountGroup.setExternalReferenceCode(RandomTestUtil.randomString());
		...
		Assert.assertEquals(existingCommerceAccountGroup.getExternalReferenceCode(),
			newCommerceAccountGroup.getExternalReferenceCode());
		Assert.assertEquals(existingCommerceAccountGroup.getCommerceAccountGroupId(),
			newCommerceAccountGroup.getCommerceAccountGroupId());
		Assert.assertEquals(existingCommerceAccountGroup.getCompanyId(),
			newCommerceAccountGroup.getCompanyId());
		Assert.assertEquals(existingCommerceAccountGroup.getUserId(),
			newCommerceAccountGroup.getUserId());
		Assert.assertEquals(existingCommerceAccountGroup.getUserName(),
		...
		Assert.assertEquals(existingCommerceAccountGroup.getName(),
	...
	public void testFindByPrimaryKeyExisting() throws Exception {
		...
		Assert.assertEquals(existingCommerceAccountGroup,
	...
	public void testFetchByPrimaryKeyMissing() throws Exception {
		...
		CommerceAccountGroup missingCommerceAccountGroup = _persistence.fetchByPrimaryKey(pk);
	...
	public void testFetchByPrimaryKeysWithMultiplePrimaryKeysWhereAllPrimaryKeysExist()
		throws Exception {
		CommerceAccountGroup newCommerceAccountGroup1 = addCommerceAccountGroup();
		CommerceAccountGroup newCommerceAccountGroup2 = addCommerceAccountGroup();
		...
		Map<Serializable, CommerceAccountGroup> commerceAccountGroups = _persistence.fetchByPrimaryKeys(primaryKeys);

		Assert.assertEquals(2, commerceAccountGroups.size());
		Assert.assertEquals(newCommerceAccountGroup1,
			commerceAccountGroups.get(newCommerceAccountGroup1.getPrimaryKey()));
		Assert.assertEquals(newCommerceAccountGroup2,
			commerceAccountGroups.get(newCommerceAccountGroup2.getPrimaryKey()));
	}
	...
	public void testFetchByPrimaryKeysWithMultiplePrimaryKeysWhereSomePrimaryKeysExist()
		...
		Assert.assertEquals(newCommerceAccountGroup,
	...
	public void testActionableDynamicQuery() throws Exception {
		...
		ActionableDynamicQuery actionableDynamicQuery = CommerceAccountGroupLocalServiceUtil.getActionableDynamicQuery();

		actionableDynamicQuery.setPerformActionMethod(new ActionableDynamicQuery.PerformActionMethod<CommerceAccountGroup>() {
				@Override
	...
	public void testDynamicQueryByPrimaryKeyExisting()
		...
		DynamicQuery dynamicQuery = DynamicQueryFactoryUtil.forClass(CommerceAccountGroup.class,
				_dynamicQueryClassLoader);

		dynamicQuery.add(RestrictionsFactoryUtil.eq("commerceAccountGroupId",
				newCommerceAccountGroup.getCommerceAccountGroupId()));

		List<CommerceAccountGroup> result = _persistence.findWithDynamicQuery(dynamicQuery);
	...
	public void testDynamicQueryByProjectionExisting()
		...
		Object newCommerceAccountGroupId = newCommerceAccountGroup.getCommerceAccountGroupId();

		dynamicQuery.add(RestrictionsFactoryUtil.in("commerceAccountGroupId",
		...
		Assert.assertEquals(existingCommerceAccountGroupId,
			newCommerceAccountGroupId);
	}
	...
	public void testResetOriginalValues() throws Exception {
		...
		Assert.assertEquals(Long.valueOf(
			...
			ReflectionTestUtil.<Long>invoke(existingCommerceAccountGroup,
				"getOriginalCompanyId", new Class<?>[0]));
		Assert.assertTrue(Objects.equals(
				existingCommerceAccountGroup.getExternalReferenceCode(),
				ReflectionTestUtil.invoke(existingCommerceAccountGroup,
					"getOriginalExternalReferenceCode", new Class<?>[0])));
	}

	protected CommerceAccountGroup addCommerceAccountGroup()
		throws Exception {
		long pk = RandomTestUtil.nextLong();

		CommerceAccountGroup commerceAccountGroup = _persistence.create(pk);

		commerceAccountGroup.setExternalReferenceCode(RandomTestUtil.randomString());
	...
	private List<CommerceAccountGroup> _commerceAccountGroups = new ArrayList<CommerceAccountGroup>();

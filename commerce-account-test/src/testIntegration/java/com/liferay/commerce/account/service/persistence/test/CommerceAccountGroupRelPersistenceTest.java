...
public class CommerceAccountGroupRelPersistenceTest {
	...
	public void tearDown() throws Exception {
		Iterator<CommerceAccountGroupRel> iterator = _commerceAccountGroupRels.iterator();
	...
	public void testCreate() throws Exception {
		...
		CommerceAccountGroupRel commerceAccountGroupRel = _persistence.create(pk);
	...
	public void testRemove() throws Exception {
		CommerceAccountGroupRel newCommerceAccountGroupRel = addCommerceAccountGroupRel();

		_persistence.remove(newCommerceAccountGroupRel);

		CommerceAccountGroupRel existingCommerceAccountGroupRel = _persistence.fetchByPrimaryKey(newCommerceAccountGroupRel.getPrimaryKey());
	...
	public void testUpdateExisting() throws Exception {
		...
		CommerceAccountGroupRel newCommerceAccountGroupRel = _persistence.create(pk);
		...
		newCommerceAccountGroupRel.setCommerceAccountGroupId(RandomTestUtil.nextLong());

		_commerceAccountGroupRels.add(_persistence.update(
				newCommerceAccountGroupRel));

		CommerceAccountGroupRel existingCommerceAccountGroupRel = _persistence.findByPrimaryKey(newCommerceAccountGroupRel.getPrimaryKey());

		Assert.assertEquals(existingCommerceAccountGroupRel.getCommerceAccountGroupRelId(),
			newCommerceAccountGroupRel.getCommerceAccountGroupRelId());
		Assert.assertEquals(existingCommerceAccountGroupRel.getCompanyId(),
			newCommerceAccountGroupRel.getCompanyId());
		Assert.assertEquals(existingCommerceAccountGroupRel.getUserId(),
			newCommerceAccountGroupRel.getUserId());
		Assert.assertEquals(existingCommerceAccountGroupRel.getUserName(),
		...
		Assert.assertEquals(Time.getShortTimestamp(
			...
			Time.getShortTimestamp(newCommerceAccountGroupRel.getModifiedDate()));
		Assert.assertEquals(existingCommerceAccountGroupRel.getClassNameId(),
			newCommerceAccountGroupRel.getClassNameId());
		Assert.assertEquals(existingCommerceAccountGroupRel.getClassPK(),
			newCommerceAccountGroupRel.getClassPK());
		Assert.assertEquals(existingCommerceAccountGroupRel.getCommerceAccountGroupId(),
	...
	public void testFindByPrimaryKeyExisting() throws Exception {
		...
		Assert.assertEquals(existingCommerceAccountGroupRel,
			newCommerceAccountGroupRel);
	}
	...
	protected OrderByComparator<CommerceAccountGroupRel> getOrderByComparator() {
		return OrderByComparatorFactoryUtil.create("CommerceAccountGroupRel",
			"commerceAccountGroupRelId", true, "companyId", true, "userId",
			true, "userName", true, "createDate", true, "modifiedDate", true,
			"classNameId", true, "classPK", true, "commerceAccountGroupId", true);
	}
	...
	public void testFetchByPrimaryKeyMissing() throws Exception {
		...
		CommerceAccountGroupRel missingCommerceAccountGroupRel = _persistence.fetchByPrimaryKey(pk);
	...
	public void testFetchByPrimaryKeysWithMultiplePrimaryKeysWhereAllPrimaryKeysExist()
		throws Exception {
		CommerceAccountGroupRel newCommerceAccountGroupRel1 = addCommerceAccountGroupRel();
		CommerceAccountGroupRel newCommerceAccountGroupRel2 = addCommerceAccountGroupRel();
		...
		Map<Serializable, CommerceAccountGroupRel> commerceAccountGroupRels = _persistence.fetchByPrimaryKeys(primaryKeys);

		Assert.assertEquals(2, commerceAccountGroupRels.size());
		Assert.assertEquals(newCommerceAccountGroupRel1,
			commerceAccountGroupRels.get(
				newCommerceAccountGroupRel1.getPrimaryKey()));
		Assert.assertEquals(newCommerceAccountGroupRel2,
			commerceAccountGroupRels.get(
	...
	public void testFetchByPrimaryKeysWithMultiplePrimaryKeysWhereSomePrimaryKeysExist()
		...
		Assert.assertEquals(newCommerceAccountGroupRel,
			commerceAccountGroupRels.get(
	...
	public void testActionableDynamicQuery() throws Exception {
		...
		ActionableDynamicQuery actionableDynamicQuery = CommerceAccountGroupRelLocalServiceUtil.getActionableDynamicQuery();

		actionableDynamicQuery.setPerformActionMethod(new ActionableDynamicQuery.PerformActionMethod<CommerceAccountGroupRel>() {
				@Override
	...
	public void testDynamicQueryByPrimaryKeyExisting()
		...
		DynamicQuery dynamicQuery = DynamicQueryFactoryUtil.forClass(CommerceAccountGroupRel.class,
		...
		List<CommerceAccountGroupRel> result = _persistence.findWithDynamicQuery(dynamicQuery);
	...
	public void testDynamicQueryByProjectionExisting()
		...
		Object newCommerceAccountGroupRelId = newCommerceAccountGroupRel.getCommerceAccountGroupRelId();
		...
		Assert.assertEquals(existingCommerceAccountGroupRelId,
			newCommerceAccountGroupRelId);
	}
	...
	public void testResetOriginalValues() throws Exception {
		...
		Assert.assertEquals(Long.valueOf(
			...
			ReflectionTestUtil.<Long>invoke(existingCommerceAccountGroupRel,
	...
	protected CommerceAccountGroupRel addCommerceAccountGroupRel()
		...
		commerceAccountGroupRel.setCommerceAccountGroupId(RandomTestUtil.nextLong());
	...
	private List<CommerceAccountGroupRel> _commerceAccountGroupRels = new ArrayList<CommerceAccountGroupRel>();

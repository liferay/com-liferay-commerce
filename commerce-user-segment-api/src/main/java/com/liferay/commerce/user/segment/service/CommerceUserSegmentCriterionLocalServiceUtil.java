 ...
 * <code>com.liferay.commerce.user.segment.service.impl.CommerceUserSegmentCriterionLocalServiceImpl</code> and
...
public class CommerceUserSegmentCriterionLocalServiceUtil {
	 ...
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this class directly. Add custom service methods to <code>com.liferay.commerce.user.segment.service.impl.CommerceUserSegmentCriterionLocalServiceImpl</code> and rerun ServiceBuilder to regenerate this class.
	 */
	...
	public static
		...
		return getService().addCommerceUserSegmentCriterion(
	...
	public static
		com.liferay.commerce.user.segment.model.CommerceUserSegmentCriterion
			createCommerceUserSegmentCriterion(
				long commerceUserSegmentCriterionId) {

		return getService().createCommerceUserSegmentCriterion(
	...
	public static void deleteCommerceUserSegmentCriteria(
		...
		getService().deleteCommerceUserSegmentCriteria(
	...
	public static
		...
		return getService().deleteCommerceUserSegmentCriterion(
			commerceUserSegmentCriterion);
	}
	...
	public static
		com.liferay.commerce.user.segment.model.CommerceUserSegmentCriterion
			fetchCommerceUserSegmentCriterion(
				long commerceUserSegmentCriterionId) {

		return getService().fetchCommerceUserSegmentCriterion(
			commerceUserSegmentCriterionId);
	}
	...
	public static java.util.List
		...
		return getService().getCommerceUserSegmentCriteria(
	...
	public static int getCommerceUserSegmentCriteriaCount(
		...
		return getService().getCommerceUserSegmentCriteriaCount(
			commerceUserSegmentEntryId);
	}
	...
	public static
		...
		return getService().getCommerceUserSegmentCriterion(
			commerceUserSegmentCriterionId);
	}
	...
	public static java.util.List
		<com.liferay.commerce.user.segment.model.CommerceUserSegmentCriterion>
			getCommerceUserSegmentCriterions(int start, int end) {
	...
	public static
		...
		return getService().updateCommerceUserSegmentCriterion(
			commerceUserSegmentCriterion);
	}
	...
	private static ServiceTracker
		<CommerceUserSegmentCriterionLocalService,
		 CommerceUserSegmentCriterionLocalService> _serviceTracker;

	static {
		Bundle bundle = FrameworkUtil.getBundle(
			CommerceUserSegmentCriterionLocalService.class);

		ServiceTracker
			<CommerceUserSegmentCriterionLocalService,
			 CommerceUserSegmentCriterionLocalService> serviceTracker =
				new ServiceTracker
					<CommerceUserSegmentCriterionLocalService,
					 CommerceUserSegmentCriterionLocalService>(

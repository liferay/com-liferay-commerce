 ...
 */
@ProviderType
public interface CommerceUserSegmentEntryPersistence
	extends BasePersistence<CommerceUserSegmentEntry> {
	 ...
	 * @return the matching commerce user segment entries
	 */
	public java.util.List<CommerceUserSegmentEntry> findByG_A(

 ...
 */
@ProviderType
public interface CommerceUserSegmentCriterionPersistence
	extends BasePersistence<CommerceUserSegmentCriterion> {
	 ...
	 */
	public void cacheResult(
		java.util.List<CommerceUserSegmentCriterion>

...
/**
 * Provides the local service interface for CommerceUserSegmentCriterion. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author Marco Leo
 * @see CommerceUserSegmentCriterionLocalServiceUtil
 * @generated
 */
@ProviderType
@Transactional(
...
public interface CommerceUserSegmentCriterionLocalService
	extends BaseLocalService, PersistedModelLocalService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link CommerceUserSegmentCriterionLocalServiceUtil} to access the commerce user segment criterion local service. Add custom service methods to <code>com.liferay.commerce.user.segment.service.impl.CommerceUserSegmentCriterionLocalServiceImpl</code> and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */

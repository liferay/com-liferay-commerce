...
@OSGiBeanProperties(
	property = {
		...
		"json.web.service.context.path=CommerceUserSegmentCriterion"
	},
	service = CommerceUserSegmentCriterionService.class
)
@ProviderType
@Transactional(
...
public interface CommerceUserSegmentCriterionService extends BaseService {
	 ...
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link CommerceUserSegmentCriterionServiceUtil} to access the commerce user segment criterion remote service. Add custom service methods to <code>com.liferay.commerce.user.segment.service.impl.CommerceUserSegmentCriterionServiceImpl</code> and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */

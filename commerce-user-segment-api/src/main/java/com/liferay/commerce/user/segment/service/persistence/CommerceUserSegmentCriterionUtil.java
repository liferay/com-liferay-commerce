...
/**
 * The persistence utility for the commerce user segment criterion service. This utility wraps <code>com.liferay.commerce.user.segment.service.persistence.impl.CommerceUserSegmentCriterionPersistenceImpl</code> and provides direct access to the database for CRUD operations. This utility should only be used by the service layer, as it must operate within a transaction. Never access this utility in a JSP, controller, model, or other front-end class.
 *
 * <p>
...
public class CommerceUserSegmentCriterionUtil {
	 ...
	 */
	public static Map<Serializable, CommerceUserSegmentCriterion>
	...
	public static CommerceUserSegmentCriterion update(
		...
		return getPersistence().update(
			commerceUserSegmentCriterion, serviceContext);
	}
	 ...
	 */
	public static List<CommerceUserSegmentCriterion>
	 ...
	 */
	public static CommerceUserSegmentCriterion
	...
	public static CommerceUserSegmentCriterion[]
		...
		return getPersistence().findByCommerceUserSegmentEntryId_PrevAndNext(
			commerceUserSegmentCriterionId, commerceUserSegmentEntryId,
			orderByComparator);
	}
	...
	private static ServiceTracker
		<CommerceUserSegmentCriterionPersistence,
		 CommerceUserSegmentCriterionPersistence> _serviceTracker;

	static {
		Bundle bundle = FrameworkUtil.getBundle(
			CommerceUserSegmentCriterionPersistence.class);

		ServiceTracker
			<CommerceUserSegmentCriterionPersistence,
			 CommerceUserSegmentCriterionPersistence> serviceTracker =
				new ServiceTracker
					<CommerceUserSegmentCriterionPersistence,
					 CommerceUserSegmentCriterionPersistence>(

			...
			>
				...
				>
					...
					>
						...
						boolean hasDownloadCommerceVirtualOrderItemPermission = commerceVirtualOrderItemContentDisplayContext.hasPermission(commerceVirtualOrderItem, CommerceVirtualOrderActionKeys.DOWNLOAD_COMMERCE_VIRTUAL_ORDER_ITEM);
						%>

...
public class HistoryLocalServiceUtil {
	...
	*/
	public static History fetchHistoryByUuidAndGroupId(
	...
	*/
	public static java.util.List<History> getHistories(
		int start, int end) {
		return getService().getHistories(start, end);
	}

	public static java.util.List<History> getHistoriesByGoupId(
	...
	*/
	public static java.util.List<History> getHistoriesByUuidAndCompanyId(
	...
	*/
	public static History getHistoryByUuidAndGroupId(
		String uuid, long groupId)
		throws com.liferay.portal.kernel.exception.PortalException {
	...
	*/
	public static History updateHistory(
		History history) {

...
public class CPRuleAccountGroupsScreenNavigationEntry
	implements ScreenNavigationCategory, ScreenNavigationEntry<CPRule> {

	@Override
	public String getCategoryKey() {
		return CPRuleScreenNavigationConstants.
			CATEGORY_KEY_COMMERCE_PRODUCT_RULE_ACCOUNT_GROUPS;
	}

	@Override
	public String getEntryKey() {
		return CPRuleScreenNavigationConstants.
			ENTRY_KEY_COMMERCE_PRODUCT_RULE_ACCOUNT_GROUPS;
	}

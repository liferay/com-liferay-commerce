...
<c:if test="<%= cpCatalogRuleDisplayContext.hasPermission(CPActionKeys.VIEW_COMMERCE_PRODUCT_RULES) %>">
	...
	>
		<liferay-frontend:management-bar-buttons>
			...
			<c:if test="<%= cpCatalogRuleDisplayContext.hasPermission(CPActionKeys.ADD_COMMERCE_PRODUCT_RULE) %>">

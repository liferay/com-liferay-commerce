...
public class CPSpecificationOptionPersistenceImpl
	...
	/**
	 * Returns the cp specification option where uuid = &#63; and groupId = &#63; or throws a <code>NoSuchCPSpecificationOptionException</code> if it could not be found.
	 *
	 * @param uuid the uuid
	...
	public CPSpecificationOption findByUUID_G(String uuid, long groupId)
		...
		CPSpecificationOption cpSpecificationOption = fetchByUUID_G(
			uuid, groupId);
	 ...
	 */
	@Override
	public CPSpecificationOption fetchByUUID_G(
	...
	public CPSpecificationOption removeByUUID_G(String uuid, long groupId)
		...
		CPSpecificationOption cpSpecificationOption = findByUUID_G(
			uuid, groupId);
	 ...
	 */
	@Override
	public List<CPSpecificationOption> findByGroupId(
	 ...
	 */
	@Override
	public CPSpecificationOption findByGroupId_First(
			long groupId,
			OrderByComparator<CPSpecificationOption> orderByComparator)
		throws NoSuchCPSpecificationOptionException {

		CPSpecificationOption cpSpecificationOption = fetchByGroupId_First(
	 ...
	 */
	@Override
	public CPSpecificationOption fetchByGroupId_First(
		long groupId,
		OrderByComparator<CPSpecificationOption> orderByComparator) {

		List<CPSpecificationOption> list = findByGroupId(
	 ...
	 */
	@Override
	public CPSpecificationOption findByGroupId_Last(
			long groupId,
			OrderByComparator<CPSpecificationOption> orderByComparator)
		throws NoSuchCPSpecificationOptionException {

		CPSpecificationOption cpSpecificationOption = fetchByGroupId_Last(
			groupId, orderByComparator);
	 ...
	 */
	@Override
	public CPSpecificationOption fetchByGroupId_Last(
		long groupId,
		OrderByComparator<CPSpecificationOption> orderByComparator) {
	...
	public CPSpecificationOption[] findByGroupId_PrevAndNext(
		...
		try {
			...
			array[0] = getByGroupId_PrevAndNext(
				session, cpSpecificationOption, groupId, orderByComparator,
				true);
	...
	protected CPSpecificationOption getByGroupId_PrevAndNext(
		Session session, CPSpecificationOption cpSpecificationOption,
		long groupId,
		OrderByComparator<CPSpecificationOption> orderByComparator,
		boolean previous) {
	...
	public List<CPSpecificationOption> findByCPOptionCategoryId(
		...
		if ((start == QueryUtil.ALL_POS) && (end == QueryUtil.ALL_POS) &&
			...
			pagination = false;
			finderPath = _finderPathWithoutPaginationFindByCPOptionCategoryId;
	...
	/**
	 * Returns the cp specification option where groupId = &#63; and key = &#63; or throws a <code>NoSuchCPSpecificationOptionException</code> if it could not be found.
	 *
	 * @param groupId the group ID
	 * @param key the key
	 * @return the matching cp specification option
	 ...
	 */
	@Override
	public CPSpecificationOption fetchByG_K(
	...
	private static final String _FINDER_COLUMN_G_K_GROUPID_2 =
		"cpSpecificationOption.groupId = ? AND ";
	...
	protected void cacheUniqueFindersCache(
		...
		finderCache.putResult(
			_finderPathFetchByUUID_G, args, cpSpecificationOptionModelImpl,
			false);
		...
		finderCache.putResult(
			_finderPathFetchByG_K, args, cpSpecificationOptionModelImpl, false);
	}

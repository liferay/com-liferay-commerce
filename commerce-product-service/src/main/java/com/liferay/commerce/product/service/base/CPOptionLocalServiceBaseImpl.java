 ...
 * @see com.liferay.commerce.product.service.CPOptionLocalServiceUtil
 * @generated
 */
@ProviderType
public abstract class CPOptionLocalServiceBaseImpl extends BaseLocalServiceImpl
	implements CPOptionLocalService, IdentifiableOSGiService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link com.liferay.commerce.product.service.CPOptionLocalServiceUtil} to access the cp option local service.
	 */
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(CPOption.class,
	...
	public <T> List<T> dynamicQuery(DynamicQuery dynamicQuery, int start,
		int end) {
		return cpOptionPersistence.findWithDynamicQuery(dynamicQuery, start, end);
	}
	...
	public <T> List<T> dynamicQuery(DynamicQuery dynamicQuery, int start,
		...
		return cpOptionPersistence.findWithDynamicQuery(dynamicQuery, start,
	...
	public IndexableActionableDynamicQuery getIndexableActionableDynamicQuery() {
		...
		indexableActionableDynamicQuery.setBaseLocalService(cpOptionLocalService);
	...
	public void afterPropertiesSet() {
		persistedModelLocalServiceRegistry.register("com.liferay.commerce.product.model.CPOption",

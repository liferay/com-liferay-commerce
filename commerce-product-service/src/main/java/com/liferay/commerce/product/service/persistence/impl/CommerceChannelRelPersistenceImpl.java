 ...
 * @see com.liferay.commerce.product.service.persistence.CommerceChannelRelUtil
 * @generated
 */
@ProviderType
public class CommerceChannelRelPersistenceImpl extends BasePersistenceImpl<CommerceChannelRel>
	implements CommerceChannelRelPersistence {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link CommerceChannelRelUtil} to access the commerce channel rel persistence. Modify <code>service.xml</code> and rerun ServiceBuilder to regenerate this class.
	 */
	public static final String FINDER_CLASS_NAME_ENTITY = CommerceChannelRelImpl.class.getName();
	public static final String FINDER_CLASS_NAME_LIST_WITH_PAGINATION = FINDER_CLASS_NAME_ENTITY +
		".List1";
	public static final String FINDER_CLASS_NAME_LIST_WITHOUT_PAGINATION = FINDER_CLASS_NAME_ENTITY +
		".List2";
	public static final FinderPath FINDER_PATH_WITH_PAGINATION_FIND_ALL = new FinderPath(CommerceChannelRelModelImpl.ENTITY_CACHE_ENABLED,
			CommerceChannelRelModelImpl.FINDER_CACHE_ENABLED,
			CommerceChannelRelImpl.class,
			FINDER_CLASS_NAME_LIST_WITH_PAGINATION, "findAll", new String[0]);
	public static final FinderPath FINDER_PATH_WITHOUT_PAGINATION_FIND_ALL = new FinderPath(CommerceChannelRelModelImpl.ENTITY_CACHE_ENABLED,
			CommerceChannelRelModelImpl.FINDER_CACHE_ENABLED,
			CommerceChannelRelImpl.class,
			FINDER_CLASS_NAME_LIST_WITHOUT_PAGINATION, "findAll", new String[0]);
	public static final FinderPath FINDER_PATH_COUNT_ALL = new FinderPath(CommerceChannelRelModelImpl.ENTITY_CACHE_ENABLED,
	...
	public static final FinderPath FINDER_PATH_WITH_PAGINATION_FIND_BY_COMMERCECHANNELID =
		new FinderPath(CommerceChannelRelModelImpl.ENTITY_CACHE_ENABLED,
			CommerceChannelRelModelImpl.FINDER_CACHE_ENABLED,
			CommerceChannelRelImpl.class,
	...
	public static final FinderPath FINDER_PATH_COUNT_BY_COMMERCECHANNELID = new FinderPath(CommerceChannelRelModelImpl.ENTITY_CACHE_ENABLED,
			CommerceChannelRelModelImpl.FINDER_CACHE_ENABLED, Long.class,
			FINDER_CLASS_NAME_LIST_WITHOUT_PAGINATION,
	...
	public List<CommerceChannelRel> findByCommerceChannelId(
		...
		if (retrieveFromCache) {
			list = (List<CommerceChannelRel>)finderCache.getResult(finderPath,
					finderArgs, this);

			if ((list != null) && !list.isEmpty()) {
				for (CommerceChannelRel commerceChannelRel : list) {
					if ((commerceChannelId != commerceChannelRel.getCommerceChannelId())) {
						list = null;
		...
		if (list == null) {
			...
			try {
				...
				if (!pagination) {
					list = (List<CommerceChannelRel>)QueryUtil.list(q,
	...
	public CommerceChannelRel findByCommerceChannelId_First(
		...
		CommerceChannelRel commerceChannelRel = fetchByCommerceChannelId_First(commerceChannelId,
				orderByComparator);
	...
	public CommerceChannelRel fetchByCommerceChannelId_First(
		long commerceChannelId,
		OrderByComparator<CommerceChannelRel> orderByComparator) {
		List<CommerceChannelRel> list = findByCommerceChannelId(commerceChannelId,
	...
	public CommerceChannelRel findByCommerceChannelId_Last(
		...
		OrderByComparator<CommerceChannelRel> orderByComparator)
		throws NoSuchChannelRelException {
		CommerceChannelRel commerceChannelRel = fetchByCommerceChannelId_Last(commerceChannelId,
				orderByComparator);
	...
	public CommerceChannelRel[] findByCommerceChannelId_PrevAndNext(
		...
		OrderByComparator<CommerceChannelRel> orderByComparator)
		throws NoSuchChannelRelException {
		CommerceChannelRel commerceChannelRel = findByPrimaryKey(commerceChannelRelId);
		...
		try {
			...
			array[0] = getByCommerceChannelId_PrevAndNext(session,
					commerceChannelRel, commerceChannelId, orderByComparator,
					true);
	...
	protected CommerceChannelRel getByCommerceChannelId_PrevAndNext(
		...
		if (orderByComparator != null) {
			Object[] values = orderByComparator.getOrderByConditionValues(commerceChannelRel);
	...
	public void removeByCommerceChannelId(long commerceChannelId) {
		for (CommerceChannelRel commerceChannelRel : findByCommerceChannelId(
	...
	public static final FinderPath FINDER_PATH_WITH_PAGINATION_FIND_BY_C_C = new FinderPath(CommerceChannelRelModelImpl.ENTITY_CACHE_ENABLED,
			CommerceChannelRelModelImpl.FINDER_CACHE_ENABLED,
			CommerceChannelRelImpl.class,
	...
	public static final FinderPath FINDER_PATH_WITHOUT_PAGINATION_FIND_BY_C_C = new FinderPath(CommerceChannelRelModelImpl.ENTITY_CACHE_ENABLED,
			CommerceChannelRelModelImpl.FINDER_CACHE_ENABLED,
			CommerceChannelRelImpl.class,
			...
			CommerceChannelRelModelImpl.CREATEDATE_COLUMN_BITMASK);
	public static final FinderPath FINDER_PATH_COUNT_BY_C_C = new FinderPath(CommerceChannelRelModelImpl.ENTITY_CACHE_ENABLED,
			CommerceChannelRelModelImpl.FINDER_CACHE_ENABLED, Long.class,
	 ...
	 */
	@Override
	public CommerceChannelRel findByC_C_First(long classNameId, long classPK,
		OrderByComparator<CommerceChannelRel> orderByComparator)
		throws NoSuchChannelRelException {
		CommerceChannelRel commerceChannelRel = fetchByC_C_First(classNameId,
	 ...
	 */
	@Override
	public CommerceChannelRel fetchByC_C_First(long classNameId, long classPK,
		OrderByComparator<CommerceChannelRel> orderByComparator) {
		List<CommerceChannelRel> list = findByC_C(classNameId, classPK, 0, 1,
				orderByComparator);
	 ...
	 */
	@Override
	public CommerceChannelRel findByC_C_Last(long classNameId, long classPK,
		OrderByComparator<CommerceChannelRel> orderByComparator)
		throws NoSuchChannelRelException {
		CommerceChannelRel commerceChannelRel = fetchByC_C_Last(classNameId,
				classPK, orderByComparator);
	 ...
	 */
	@Override
	public CommerceChannelRel fetchByC_C_Last(long classNameId, long classPK,
		OrderByComparator<CommerceChannelRel> orderByComparator) {
		...
		List<CommerceChannelRel> list = findByC_C(classNameId, classPK,
				count - 1, count, orderByComparator);
	...
	public CommerceChannelRel[] findByC_C_PrevAndNext(
		...
		try {
			...
			array[0] = getByC_C_PrevAndNext(session, commerceChannelRel,
					classNameId, classPK, orderByComparator, true);

			array[1] = commerceChannelRel;

			array[2] = getByC_C_PrevAndNext(session, commerceChannelRel,
	...
	protected CommerceChannelRel getByC_C_PrevAndNext(Session session,
		CommerceChannelRel commerceChannelRel, long classNameId, long classPK,
		OrderByComparator<CommerceChannelRel> orderByComparator,
		boolean previous) {
		StringBundler query = null;
	...
	public void removeByC_C(long classNameId, long classPK) {
		for (CommerceChannelRel commerceChannelRel : findByC_C(classNameId,
	...
	private static final String _FINDER_COLUMN_C_C_CLASSNAMEID_2 = "commerceChannelRel.classNameId = ? AND ";
	private static final String _FINDER_COLUMN_C_C_CLASSPK_2 = "commerceChannelRel.classPK = ?";
	public static final FinderPath FINDER_PATH_FETCH_BY_C_C_C = new FinderPath(CommerceChannelRelModelImpl.ENTITY_CACHE_ENABLED,
			CommerceChannelRelModelImpl.FINDER_CACHE_ENABLED,
			...
			CommerceChannelRelModelImpl.CLASSPK_COLUMN_BITMASK |
			CommerceChannelRelModelImpl.COMMERCECHANNELID_COLUMN_BITMASK);
	public static final FinderPath FINDER_PATH_COUNT_BY_C_C_C = new FinderPath(CommerceChannelRelModelImpl.ENTITY_CACHE_ENABLED,
			CommerceChannelRelModelImpl.FINDER_CACHE_ENABLED, Long.class,
	...
	/**
	 * Returns the commerce channel rel where classNameId = &#63; and classPK = &#63; and commerceChannelId = &#63; or throws a {@link NoSuchChannelRelException} if it could not be found.
	 *
	 * @param classNameId the class name ID
	 * @param classPK the class pk
	 * @param commerceChannelId the commerce channel ID
	 ...
	 */
	@Override
	public CommerceChannelRel findByC_C_C(long classNameId, long classPK,
		long commerceChannelId) throws NoSuchChannelRelException {
		CommerceChannelRel commerceChannelRel = fetchByC_C_C(classNameId,
	 ...
	 */
	@Override
	public CommerceChannelRel fetchByC_C_C(long classNameId, long classPK,
		long commerceChannelId) {
	...
	@Override
	public CommerceChannelRel fetchByC_C_C(long classNameId, long classPK,
		long commerceChannelId, boolean retrieveFromCache) {
	 ...
	 */
	@Override
	public CommerceChannelRel removeByC_C_C(long classNameId, long classPK,
		long commerceChannelId) throws NoSuchChannelRelException {
		CommerceChannelRel commerceChannelRel = findByC_C_C(classNameId,
				classPK, commerceChannelId);
	...
	private static final String _FINDER_COLUMN_C_C_C_CLASSNAMEID_2 = "commerceChannelRel.classNameId = ? AND ";
	private static final String _FINDER_COLUMN_C_C_C_CLASSPK_2 = "commerceChannelRel.classPK = ? AND ";
	private static final String _FINDER_COLUMN_C_C_C_COMMERCECHANNELID_2 = "commerceChannelRel.commerceChannelId = ?";
	...
	public void cacheResult(CommerceChannelRel commerceChannelRel) {
		entityCache.putResult(CommerceChannelRelModelImpl.ENTITY_CACHE_ENABLED,
	...
	public void clearCache(CommerceChannelRel commerceChannelRel) {
		entityCache.removeResult(CommerceChannelRelModelImpl.ENTITY_CACHE_ENABLED,
			CommerceChannelRelImpl.class, commerceChannelRel.getPrimaryKey());

		finderCache.clearCache(FINDER_CLASS_NAME_LIST_WITH_PAGINATION);
		finderCache.clearCache(FINDER_CLASS_NAME_LIST_WITHOUT_PAGINATION);

		clearUniqueFindersCache((CommerceChannelRelModelImpl)commerceChannelRel,
			true);
	}
	...
	protected void cacheUniqueFindersCache(
		...
		finderCache.putResult(FINDER_PATH_FETCH_BY_C_C_C, args,
			commerceChannelRelModelImpl, false);
	}
	...
	public CommerceChannelRel create(long commerceChannelRelId) {
		...
		commerceChannelRel.setCompanyId(companyProvider.getCompanyId());
	...
	public CommerceChannelRel remove(Serializable primaryKey)
		...
		try {
			...
			CommerceChannelRel commerceChannelRel = (CommerceChannelRel)session.get(CommerceChannelRelImpl.class,
					primaryKey);
			...
			if (commerceChannelRel == null) {
				...
				throw new NoSuchChannelRelException(_NO_SUCH_ENTITY_WITH_PRIMARY_KEY +
					primaryKey);
			}
	...
	protected CommerceChannelRel removeImpl(
		...
		try {
			...
			if (!session.contains(commerceChannelRel)) {
				commerceChannelRel = (CommerceChannelRel)session.get(CommerceChannelRelImpl.class,
	...
	public CommerceChannelRel updateImpl(CommerceChannelRel commerceChannelRel) {
		...
		if (!(commerceChannelRel instanceof CommerceChannelRelModelImpl)) {
			...
			if (ProxyUtil.isProxyClass(commerceChannelRel.getClass())) {
				invocationHandler = ProxyUtil.getInvocationHandler(commerceChannelRel);
		...
		CommerceChannelRelModelImpl commerceChannelRelModelImpl = (CommerceChannelRelModelImpl)commerceChannelRel;
		...
		if (isNew && (commerceChannelRel.getCreateDate() == null)) {
			if (serviceContext == null) {
				...
				commerceChannelRel.setCreateDate(serviceContext.getCreateDate(
						now));
			}
		}
		...
		if (!commerceChannelRelModelImpl.hasSetModifiedDate()) {
			if (serviceContext == null) {
				...
				commerceChannelRel.setModifiedDate(serviceContext.getModifiedDate(
						now));
			}
		}
		...
		try {
			...
			if (commerceChannelRel.isNew()) {
				...
				commerceChannelRel = (CommerceChannelRel)session.merge(commerceChannelRel);
			}
		}
		catch (Exception e) {
			throw processException(e);
	...
	/**
	 * Returns the commerce channel rel with the primary key or throws a {@link com.liferay.portal.kernel.exception.NoSuchModelException} if it could not be found.
	 *
	 * @param primaryKey the primary key of the commerce channel rel
	...
	/**
	 * Returns the commerce channel rel with the primary key or throws a {@link NoSuchChannelRelException} if it could not be found.
	 *
	 * @param commerceChannelRelId the primary key of the commerce channel rel
	 * @return the commerce channel rel
	 * @throws NoSuchChannelRelException if a commerce channel rel with the primary key could not be found
	...
	public CommerceChannelRel fetchByPrimaryKey(Serializable primaryKey) {
		Serializable serializable = entityCache.getResult(CommerceChannelRelModelImpl.ENTITY_CACHE_ENABLED,
		...
		CommerceChannelRel commerceChannelRel = (CommerceChannelRel)serializable;
	...
	public Map<Serializable, CommerceChannelRel> fetchByPrimaryKeys(
		...
		Map<Serializable, CommerceChannelRel> map = new HashMap<Serializable, CommerceChannelRel>();
		...
		try {
			...
			for (CommerceChannelRel commerceChannelRel : (List<CommerceChannelRel>)q.list()) {
				map.put(commerceChannelRel.getPrimaryKeyObj(),
					commerceChannelRel);

				cacheResult(commerceChannelRel);

				uncachedPrimaryKeys.remove(commerceChannelRel.getPrimaryKeyObj());
			}
	...
	private static final String _SQL_SELECT_COMMERCECHANNELREL = "SELECT commerceChannelRel FROM CommerceChannelRel commerceChannelRel";
	private static final String _SQL_SELECT_COMMERCECHANNELREL_WHERE_PKS_IN = "SELECT commerceChannelRel FROM CommerceChannelRel commerceChannelRel WHERE commerceChannelRelId IN (";
	private static final String _SQL_SELECT_COMMERCECHANNELREL_WHERE = "SELECT commerceChannelRel FROM CommerceChannelRel commerceChannelRel WHERE ";
	private static final String _SQL_COUNT_COMMERCECHANNELREL = "SELECT COUNT(commerceChannelRel) FROM CommerceChannelRel commerceChannelRel";
	private static final String _SQL_COUNT_COMMERCECHANNELREL_WHERE = "SELECT COUNT(commerceChannelRel) FROM CommerceChannelRel commerceChannelRel WHERE ";
	private static final String _ORDER_BY_ENTITY_ALIAS = "commerceChannelRel.";
	private static final String _NO_SUCH_ENTITY_WITH_PRIMARY_KEY = "No CommerceChannelRel exists with the primary key ";
	private static final String _NO_SUCH_ENTITY_WITH_KEY = "No CommerceChannelRel exists with the key {";
	private static final Log _log = LogFactoryUtil.getLog(CommerceChannelRelPersistenceImpl.class);
}
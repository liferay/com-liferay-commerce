...
public class CPOptionPersistenceImpl extends BasePersistenceImpl<CPOption>
	...
	public List<CPOption> filterFindByUuid(String uuid, int start, int end,
		...
		if (getDB().isSupportsInlineDistinct()) {
			...
			query.append(_FILTER_SQL_SELECT_CPOPTION_NO_INLINE_DISTINCT_WHERE_1);
		}
		...
		if (!getDB().isSupportsInlineDistinct()) {
			query.append(_FILTER_SQL_SELECT_CPOPTION_NO_INLINE_DISTINCT_WHERE_2);
		}
		...
		String sql = InlineSQLHelperUtil.replacePermissionCheck(query.toString(),
				CPOption.class.getName(), _FILTER_ENTITY_TABLE_FILTER_PK_COLUMN);
	 ...
	 */
	@Override
	public CPOption[] filterFindByUuid_PrevAndNext(long CPOptionId,
		...
		try {
			...
			array[0] = filterGetByUuid_PrevAndNext(session, cpOption, uuid,
					orderByComparator, true);

			array[1] = cpOption;

			array[2] = filterGetByUuid_PrevAndNext(session, cpOption, uuid,
					orderByComparator, false);
	...
	protected CPOption filterGetByUuid_PrevAndNext(Session session,
		CPOption cpOption, String uuid,
		OrderByComparator<CPOption> orderByComparator, boolean previous) {
		StringBundler query = null;
	...
	private static final String _FINDER_COLUMN_UUID_UUID_1_SQL = "cpOption.uuid_ IS NULL";
	private static final String _FINDER_COLUMN_UUID_UUID_2_SQL = "cpOption.uuid_ = ?";
	private static final String _FINDER_COLUMN_UUID_UUID_3_SQL = "(cpOption.uuid_ IS NULL OR cpOption.uuid_ = '')";
	 ...
	 */
	@Override
	public CPOption[] filterFindByUuid_C_PrevAndNext(long CPOptionId,
		String uuid, long companyId,
		OrderByComparator<CPOption> orderByComparator)
		throws NoSuchCPOptionException {
		if (!InlineSQLHelperUtil.isEnabled(companyId, 0)) {
			return findByUuid_C_PrevAndNext(CPOptionId, uuid, companyId,
				orderByComparator);
		}
		...
		try {
			...
			array[0] = filterGetByUuid_C_PrevAndNext(session, cpOption, uuid,
					companyId, orderByComparator, true);

			array[1] = cpOption;

			array[2] = filterGetByUuid_C_PrevAndNext(session, cpOption, uuid,
					companyId, orderByComparator, false);
	...
	protected CPOption filterGetByUuid_C_PrevAndNext(Session session,
		CPOption cpOption, String uuid, long companyId,
		OrderByComparator<CPOption> orderByComparator, boolean previous) {
		StringBundler query = null;
	...
	private static final String _FINDER_COLUMN_UUID_C_UUID_1_SQL = "cpOption.uuid_ IS NULL AND ";
	private static final String _FINDER_COLUMN_UUID_C_UUID_2_SQL = "cpOption.uuid_ = ? AND ";
	private static final String _FINDER_COLUMN_UUID_C_UUID_3_SQL = "(cpOption.uuid_ IS NULL OR cpOption.uuid_ = '') AND ";
	 ...
	 */
	@Override
	public List<CPOption> filterFindByCompanyId(long companyId, int start,
		int end) {
	 ...
	 */
	@Override
	public CPOption[] filterFindByCompanyId_PrevAndNext(long CPOptionId,
		long companyId, OrderByComparator<CPOption> orderByComparator)
		throws NoSuchCPOptionException {
		if (!InlineSQLHelperUtil.isEnabled(companyId, 0)) {
			return findByCompanyId_PrevAndNext(CPOptionId, companyId,
				orderByComparator);
		}
		...
		try {
			...
			array[0] = filterGetByCompanyId_PrevAndNext(session, cpOption,
					companyId, orderByComparator, true);

			array[1] = cpOption;

			array[2] = filterGetByCompanyId_PrevAndNext(session, cpOption,
					companyId, orderByComparator, false);
	...
	protected CPOption filterGetByCompanyId_PrevAndNext(Session session,
		CPOption cpOption, long companyId,
		OrderByComparator<CPOption> orderByComparator, boolean previous) {
		StringBundler query = null;
	...
	private static final String _FILTER_ENTITY_TABLE_FILTER_PK_COLUMN = "cpOption.CPOptionId";
	private static final String _FILTER_SQL_SELECT_CPOPTION_WHERE = "SELECT DISTINCT {cpOption.*} FROM CPOption cpOption WHERE ";
	private static final String _FILTER_SQL_SELECT_CPOPTION_NO_INLINE_DISTINCT_WHERE_1 =
		"SELECT {CPOption.*} FROM (SELECT DISTINCT cpOption.CPOptionId FROM CPOption cpOption WHERE ";
	private static final String _FILTER_SQL_SELECT_CPOPTION_NO_INLINE_DISTINCT_WHERE_2 =
		") TEMP_TABLE INNER JOIN CPOption ON TEMP_TABLE.CPOptionId = CPOption.CPOptionId";
	private static final String _FILTER_SQL_COUNT_CPOPTION_WHERE = "SELECT COUNT(DISTINCT cpOption.CPOptionId) AS COUNT_VALUE FROM CPOption cpOption WHERE ";

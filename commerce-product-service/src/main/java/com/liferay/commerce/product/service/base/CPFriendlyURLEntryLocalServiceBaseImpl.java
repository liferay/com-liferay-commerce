...
public abstract class CPFriendlyURLEntryLocalServiceBaseImpl
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(
			CPFriendlyURLEntry.class, clazz.getClassLoader());
	}
	...
	public <T> List<T> dynamicQuery(
		...
		return cpFriendlyURLEntryPersistence.findWithDynamicQuery(
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery) {
		return cpFriendlyURLEntryPersistence.countWithDynamicQuery(
			dynamicQuery);
	}
	...
	public CPFriendlyURLEntry fetchCPFriendlyURLEntry(
		...
		return cpFriendlyURLEntryPersistence.fetchByPrimaryKey(
	...
	public CPFriendlyURLEntry getCPFriendlyURLEntry(long CPFriendlyURLEntryId)
		...
		return cpFriendlyURLEntryPersistence.findByPrimaryKey(
			CPFriendlyURLEntryId);
	}
			...
			new ActionableDynamicQuery.PerformActionMethod
				...
				public void performAction(CPFriendlyURLEntry cpFriendlyURLEntry)
					...
					StagedModelDataHandlerUtil.exportStagedModel(
						portletDataContext, cpFriendlyURLEntry);
				}
	...
	public PersistedModel deletePersistedModel(PersistedModel persistedModel)
		...
		return cpFriendlyURLEntryLocalService.deleteCPFriendlyURLEntry(
			(CPFriendlyURLEntry)persistedModel);
	}
	...
	public List<CPFriendlyURLEntry> getCPFriendlyURLEntriesByUuidAndCompanyId(
		...
		return cpFriendlyURLEntryPersistence.findByUuid_C(
	...
	protected void runSQL(String sql) {
		try {
			DataSource dataSource =
				cpFriendlyURLEntryPersistence.getDataSource();

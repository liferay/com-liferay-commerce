...
public class CPSpecificationOptionServiceHttp {
	...
	private static final Class<?>[] _searchCPSpecificationOptionsParameterTypes3 =
		new Class[] {
			long.class, Boolean.class, String.class, int.class, int.class,
			com.liferay.portal.kernel.search.Sort.class
		};
	private static final Class<?>[] _updateCPSpecificationOptionParameterTypes4 = new Class[] {

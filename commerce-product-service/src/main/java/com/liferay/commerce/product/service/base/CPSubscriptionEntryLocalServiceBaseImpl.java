...
/**
 * Provides the base implementation for the cp subscription entry local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.liferay.commerce.product.service.impl.CPSubscriptionEntryLocalServiceImpl}.
 * </p>
 *
 * @author Marco Leo
 * @see com.liferay.commerce.product.service.impl.CPSubscriptionEntryLocalServiceImpl
 * @see com.liferay.commerce.product.service.CPSubscriptionEntryLocalServiceUtil
 * @generated
 */
@ProviderType
public abstract class CPSubscriptionEntryLocalServiceBaseImpl
	extends BaseLocalServiceImpl implements CPSubscriptionEntryLocalService,
		IdentifiableOSGiService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link com.liferay.commerce.product.service.CPSubscriptionEntryLocalServiceUtil} to access the cp subscription entry local service.
	 */
	...
	public CPSubscriptionEntry addCPSubscriptionEntry(
		...
		return cpSubscriptionEntryPersistence.update(cpSubscriptionEntry);
	}
	...
	public CPSubscriptionEntry createCPSubscriptionEntry(
		...
		return cpSubscriptionEntryPersistence.create(CPSubscriptionEntryId);
	}
	...
	public CPSubscriptionEntry deleteCPSubscriptionEntry(
		...
		return cpSubscriptionEntryPersistence.remove(CPSubscriptionEntryId);
	}
	...
	public CPSubscriptionEntry deleteCPSubscriptionEntry(
		CPSubscriptionEntry cpSubscriptionEntry) {
		return cpSubscriptionEntryPersistence.remove(cpSubscriptionEntry);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(CPSubscriptionEntry.class,
	...
	public <T> List<T> dynamicQuery(DynamicQuery dynamicQuery) {
		return cpSubscriptionEntryPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery) {
		return cpSubscriptionEntryPersistence.countWithDynamicQuery(dynamicQuery);
	}
	...
	public CPSubscriptionEntry fetchCPSubscriptionEntry(
		long CPSubscriptionEntryId) {
		return cpSubscriptionEntryPersistence.fetchByPrimaryKey(CPSubscriptionEntryId);
	}
	...
	public CPSubscriptionEntry fetchCPSubscriptionEntryByUuidAndGroupId(
		...
		return cpSubscriptionEntryPersistence.fetchByUUID_G(uuid, groupId);
	}
	...
	public CPSubscriptionEntry getCPSubscriptionEntry(
		long CPSubscriptionEntryId) throws PortalException {
		return cpSubscriptionEntryPersistence.findByPrimaryKey(CPSubscriptionEntryId);
	}
	...
	public ActionableDynamicQuery getActionableDynamicQuery() {
		...
		actionableDynamicQuery.setBaseLocalService(cpSubscriptionEntryLocalService);
		actionableDynamicQuery.setClassLoader(getClassLoader());
		actionableDynamicQuery.setModelClass(CPSubscriptionEntry.class);
	...
	public IndexableActionableDynamicQuery getIndexableActionableDynamicQuery() {
		...
		indexableActionableDynamicQuery.setBaseLocalService(cpSubscriptionEntryLocalService);
		indexableActionableDynamicQuery.setClassLoader(getClassLoader());
		indexableActionableDynamicQuery.setModelClass(CPSubscriptionEntry.class);
	...
	public ExportActionableDynamicQuery getExportActionableDynamicQuery(
		...
		exportActionableDynamicQuery.setPerformActionMethod(new ActionableDynamicQuery.PerformActionMethod<CPSubscriptionEntry>() {
				@Override
		...
		exportActionableDynamicQuery.setStagedModelType(new StagedModelType(
				PortalUtil.getClassNameId(CPSubscriptionEntry.class.getName())));
	...
	public PersistedModel deletePersistedModel(PersistedModel persistedModel)
		throws PortalException {
		return cpSubscriptionEntryLocalService.deleteCPSubscriptionEntry((CPSubscriptionEntry)persistedModel);
	}

	@Override
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		throws PortalException {
		return cpSubscriptionEntryPersistence.findByPrimaryKey(primaryKeyObj);
	}
	...
	public List<CPSubscriptionEntry> getCPSubscriptionEntriesByUuidAndCompanyId(
		...
		return cpSubscriptionEntryPersistence.findByUuid_C(uuid, companyId);
	}
	...
	public CPSubscriptionEntry getCPSubscriptionEntryByUuidAndGroupId(
		...
		return cpSubscriptionEntryPersistence.findByUUID_G(uuid, groupId);
	}
	...
	public List<CPSubscriptionEntry> getCPSubscriptionEntries(int start, int end) {
		return cpSubscriptionEntryPersistence.findAll(start, end);
	}
	...
	public int getCPSubscriptionEntriesCount() {
		return cpSubscriptionEntryPersistence.countAll();
	}
	 ...
	 */
	public CPSubscriptionEntryLocalService getCPSubscriptionEntryLocalService() {
	...
	public void afterPropertiesSet() {
		persistedModelLocalServiceRegistry.register("com.liferay.commerce.product.model.CPSubscriptionEntry",
			cpSubscriptionEntryLocalService);
	}

	public void destroy() {
		persistedModelLocalServiceRegistry.unregister(
			"com.liferay.commerce.product.model.CPSubscriptionEntry");
	}
	...
	public String getOSGiServiceIdentifier() {
		return CPSubscriptionEntryLocalService.class.getName();
	}
	...
	protected void runSQL(String sql) {
		try {
			DataSource dataSource = cpSubscriptionEntryPersistence.getDataSource();
	...
	@BeanReference(type = CPSubscriptionEntryLocalService.class)
	protected CPSubscriptionEntryLocalService cpSubscriptionEntryLocalService;

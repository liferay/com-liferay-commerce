 ...
 * @see com.liferay.commerce.product.service.CPSpecificationOptionLocalServiceUtil
 * @generated
 */
@ProviderType
public abstract class CPSpecificationOptionLocalServiceBaseImpl
	extends BaseLocalServiceImpl implements CPSpecificationOptionLocalService,
		IdentifiableOSGiService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link com.liferay.commerce.product.service.CPSpecificationOptionLocalServiceUtil} to access the cp specification option local service.
	 */
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(CPSpecificationOption.class,
	...
	public <T> List<T> dynamicQuery(DynamicQuery dynamicQuery) {
		return cpSpecificationOptionPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public CPSpecificationOption fetchCPSpecificationOption(
		long CPSpecificationOptionId) {
		return cpSpecificationOptionPersistence.fetchByPrimaryKey(CPSpecificationOptionId);
	}
	...
	public CPSpecificationOption getCPSpecificationOption(
		long CPSpecificationOptionId) throws PortalException {
		return cpSpecificationOptionPersistence.findByPrimaryKey(CPSpecificationOptionId);
	}
	...
	public ActionableDynamicQuery getActionableDynamicQuery() {
		...
		actionableDynamicQuery.setBaseLocalService(cpSpecificationOptionLocalService);
	...
	public IndexableActionableDynamicQuery getIndexableActionableDynamicQuery() {
		...
		indexableActionableDynamicQuery.setBaseLocalService(cpSpecificationOptionLocalService);
		indexableActionableDynamicQuery.setClassLoader(getClassLoader());
		indexableActionableDynamicQuery.setModelClass(CPSpecificationOption.class);
	...
	public PersistedModel deletePersistedModel(PersistedModel persistedModel)
		throws PortalException {
		return cpSpecificationOptionLocalService.deleteCPSpecificationOption((CPSpecificationOption)persistedModel);
	}
	...
	public void afterPropertiesSet() {
		persistedModelLocalServiceRegistry.register("com.liferay.commerce.product.model.CPSpecificationOption",
	...
	protected void runSQL(String sql) {
		try {
			DataSource dataSource = cpSpecificationOptionPersistence.getDataSource();

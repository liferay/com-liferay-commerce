...
public class CommerceChannelServiceHttp {
	...
	public static com.liferay.commerce.product.model.CommerceChannel
		...
		try {
			...
			MethodHandler methodHandler = new MethodHandler(
				methodKey, name, filterType, type, typeSettingsProperties,
				serviceContext);
	...
	public static com.liferay.commerce.product.model.CommerceChannel
		...
		try {
			...
			MethodHandler methodHandler = new MethodHandler(
				methodKey, commerceChannelId, name, filterType, type,
	...
	private static final Class<?>[] _updateCommerceChannelParameterTypes5 =
		new Class[] {

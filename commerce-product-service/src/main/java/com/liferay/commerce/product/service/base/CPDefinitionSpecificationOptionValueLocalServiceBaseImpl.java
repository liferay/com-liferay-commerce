 ...
 * @see com.liferay.commerce.product.service.CPDefinitionSpecificationOptionValueLocalServiceUtil
 * @generated
 */
@ProviderType
public abstract class CPDefinitionSpecificationOptionValueLocalServiceBaseImpl
	 ...
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link com.liferay.commerce.product.service.CPDefinitionSpecificationOptionValueLocalServiceUtil} to access the cp definition specification option value local service.
	 */
	...
	public CPDefinitionSpecificationOptionValue createCPDefinitionSpecificationOptionValue(
		...
		return cpDefinitionSpecificationOptionValuePersistence.create(CPDefinitionSpecificationOptionValueId);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(CPDefinitionSpecificationOptionValue.class,
	...
	public <T> List<T> dynamicQuery(DynamicQuery dynamicQuery) {
		return cpDefinitionSpecificationOptionValuePersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public CPDefinitionSpecificationOptionValue fetchCPDefinitionSpecificationOptionValue(
		long CPDefinitionSpecificationOptionValueId) {
		return cpDefinitionSpecificationOptionValuePersistence.fetchByPrimaryKey(CPDefinitionSpecificationOptionValueId);
	}
	...
	public CPDefinitionSpecificationOptionValue fetchCPDefinitionSpecificationOptionValueByUuidAndGroupId(
		...
		return cpDefinitionSpecificationOptionValuePersistence.fetchByUUID_G(uuid,
			groupId);
	}
	...
	public CPDefinitionSpecificationOptionValue getCPDefinitionSpecificationOptionValue(
		long CPDefinitionSpecificationOptionValueId) throws PortalException {
		return cpDefinitionSpecificationOptionValuePersistence.findByPrimaryKey(CPDefinitionSpecificationOptionValueId);
	}
	...
	public ActionableDynamicQuery getActionableDynamicQuery() {
		...
		actionableDynamicQuery.setBaseLocalService(cpDefinitionSpecificationOptionValueLocalService);
		actionableDynamicQuery.setClassLoader(getClassLoader());
		actionableDynamicQuery.setModelClass(CPDefinitionSpecificationOptionValue.class);
	...
	public IndexableActionableDynamicQuery getIndexableActionableDynamicQuery() {
		...
		indexableActionableDynamicQuery.setBaseLocalService(cpDefinitionSpecificationOptionValueLocalService);
		indexableActionableDynamicQuery.setClassLoader(getClassLoader());
		indexableActionableDynamicQuery.setModelClass(CPDefinitionSpecificationOptionValue.class);
	...
	public ExportActionableDynamicQuery getExportActionableDynamicQuery(
		...
		exportActionableDynamicQuery.setPerformActionMethod(new ActionableDynamicQuery.PerformActionMethod<CPDefinitionSpecificationOptionValue>() {
				@Override
	...
	public PersistedModel deletePersistedModel(PersistedModel persistedModel)
		throws PortalException {
		return cpDefinitionSpecificationOptionValueLocalService.deleteCPDefinitionSpecificationOptionValue((CPDefinitionSpecificationOptionValue)persistedModel);
	}

	@Override
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		throws PortalException {
		return cpDefinitionSpecificationOptionValuePersistence.findByPrimaryKey(primaryKeyObj);
	}
	...
	public CPDefinitionSpecificationOptionValue getCPDefinitionSpecificationOptionValueByUuidAndGroupId(
		...
		return cpDefinitionSpecificationOptionValuePersistence.findByUUID_G(uuid,
			groupId);
	}
	...
	public List<CPDefinitionSpecificationOptionValue> getCPDefinitionSpecificationOptionValues(
		int start, int end) {
		return cpDefinitionSpecificationOptionValuePersistence.findAll(start,
			end);
	}
	...
	public void afterPropertiesSet() {
		persistedModelLocalServiceRegistry.register("com.liferay.commerce.product.model.CPDefinitionSpecificationOptionValue",
	...
	protected void runSQL(String sql) {
		try {
			DataSource dataSource = cpDefinitionSpecificationOptionValuePersistence.getDataSource();

 ...
 * @see com.liferay.commerce.product.service.persistence.CProductUtil
 * @generated
 */
@ProviderType
public class CProductPersistenceImpl extends BasePersistenceImpl<CProduct>
	implements CProductPersistence {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link CProductUtil} to access the c product persistence. Modify <code>service.xml</code> and rerun ServiceBuilder to regenerate this class.
	 */
	public static final String FINDER_CLASS_NAME_ENTITY = CProductImpl.class.getName();
	public static final String FINDER_CLASS_NAME_LIST_WITH_PAGINATION = FINDER_CLASS_NAME_ENTITY +
		".List1";
	public static final String FINDER_CLASS_NAME_LIST_WITHOUT_PAGINATION = FINDER_CLASS_NAME_ENTITY +
		".List2";
	public static final FinderPath FINDER_PATH_WITH_PAGINATION_FIND_ALL = new FinderPath(CProductModelImpl.ENTITY_CACHE_ENABLED,
			CProductModelImpl.FINDER_CACHE_ENABLED, CProductImpl.class,
			FINDER_CLASS_NAME_LIST_WITH_PAGINATION, "findAll", new String[0]);
	public static final FinderPath FINDER_PATH_WITHOUT_PAGINATION_FIND_ALL = new FinderPath(CProductModelImpl.ENTITY_CACHE_ENABLED,
			CProductModelImpl.FINDER_CACHE_ENABLED, CProductImpl.class,
			FINDER_CLASS_NAME_LIST_WITHOUT_PAGINATION, "findAll", new String[0]);
	public static final FinderPath FINDER_PATH_COUNT_ALL = new FinderPath(CProductModelImpl.ENTITY_CACHE_ENABLED,
			CProductModelImpl.FINDER_CACHE_ENABLED, Long.class,
			FINDER_CLASS_NAME_LIST_WITHOUT_PAGINATION, "countAll", new String[0]);
	public static final FinderPath FINDER_PATH_WITH_PAGINATION_FIND_BY_UUID = new FinderPath(CProductModelImpl.ENTITY_CACHE_ENABLED,
			CProductModelImpl.FINDER_CACHE_ENABLED, CProductImpl.class,
	...
	public static final FinderPath FINDER_PATH_WITHOUT_PAGINATION_FIND_BY_UUID = new FinderPath(CProductModelImpl.ENTITY_CACHE_ENABLED,
			CProductModelImpl.FINDER_CACHE_ENABLED, CProductImpl.class,
			FINDER_CLASS_NAME_LIST_WITHOUT_PAGINATION, "findByUuid",
			new String[] { String.class.getName() },
			CProductModelImpl.UUID_COLUMN_BITMASK |
			CProductModelImpl.CREATEDATE_COLUMN_BITMASK);
	public static final FinderPath FINDER_PATH_COUNT_BY_UUID = new FinderPath(CProductModelImpl.ENTITY_CACHE_ENABLED,
			CProductModelImpl.FINDER_CACHE_ENABLED, Long.class,
	...
	@Override
	public List<CProduct> findByUuid(String uuid, int start, int end,
		OrderByComparator<CProduct> orderByComparator, boolean retrieveFromCache) {
		...
		if (retrieveFromCache) {
			list = (List<CProduct>)finderCache.getResult(finderPath,
					finderArgs, this);
		...
		if (list == null) {
			...
			try {
				...
				if (!pagination) {
					list = (List<CProduct>)QueryUtil.list(q, getDialect(),
							start, end, false);
	 ...
	 */
	@Override
	public CProduct findByUuid_First(String uuid,
		OrderByComparator<CProduct> orderByComparator)
	 ...
	 */
	@Override
	public CProduct fetchByUuid_First(String uuid,
		OrderByComparator<CProduct> orderByComparator) {
	 ...
	 */
	@Override
	public CProduct fetchByUuid_Last(String uuid,
		OrderByComparator<CProduct> orderByComparator) {
		...
		List<CProduct> list = findByUuid(uuid, count - 1, count,
				orderByComparator);
	 ...
	 */
	@Override
	public CProduct[] findByUuid_PrevAndNext(long CProductId, String uuid,
		OrderByComparator<CProduct> orderByComparator)
		throws NoSuchCProductException {
		...
		try {
			...
			array[0] = getByUuid_PrevAndNext(session, cProduct, uuid,
					orderByComparator, true);

			array[1] = cProduct;

			array[2] = getByUuid_PrevAndNext(session, cProduct, uuid,
	...
	protected CProduct getByUuid_PrevAndNext(Session session,
		CProduct cProduct, String uuid,
		...
		if (orderByComparator != null) {
			Object[] values = orderByComparator.getOrderByConditionValues(cProduct);
	...
	public void removeByUuid(String uuid) {
		for (CProduct cProduct : findByUuid(uuid, QueryUtil.ALL_POS,
	...
	private static final String _FINDER_COLUMN_UUID_UUID_1 = "cProduct.uuid IS NULL";
	private static final String _FINDER_COLUMN_UUID_UUID_2 = "cProduct.uuid = ?";
	private static final String _FINDER_COLUMN_UUID_UUID_3 = "(cProduct.uuid IS NULL OR cProduct.uuid = '')";
	public static final FinderPath FINDER_PATH_FETCH_BY_UUID_G = new FinderPath(CProductModelImpl.ENTITY_CACHE_ENABLED,
			CProductModelImpl.FINDER_CACHE_ENABLED, CProductImpl.class,
			FINDER_CLASS_NAME_ENTITY, "fetchByUUID_G",
			new String[] { String.class.getName(), Long.class.getName() },
			CProductModelImpl.UUID_COLUMN_BITMASK |
			CProductModelImpl.GROUPID_COLUMN_BITMASK);
	public static final FinderPath FINDER_PATH_COUNT_BY_UUID_G = new FinderPath(CProductModelImpl.ENTITY_CACHE_ENABLED,
			CProductModelImpl.FINDER_CACHE_ENABLED, Long.class,
	...
	private static final String _FINDER_COLUMN_UUID_G_UUID_1 = "cProduct.uuid IS NULL AND ";
	private static final String _FINDER_COLUMN_UUID_G_UUID_2 = "cProduct.uuid = ? AND ";
	private static final String _FINDER_COLUMN_UUID_G_UUID_3 = "(cProduct.uuid IS NULL OR cProduct.uuid = '') AND ";
	private static final String _FINDER_COLUMN_UUID_G_GROUPID_2 = "cProduct.groupId = ?";
	public static final FinderPath FINDER_PATH_WITH_PAGINATION_FIND_BY_UUID_C = new FinderPath(CProductModelImpl.ENTITY_CACHE_ENABLED,
			CProductModelImpl.FINDER_CACHE_ENABLED, CProductImpl.class,
	...
	public static final FinderPath FINDER_PATH_WITHOUT_PAGINATION_FIND_BY_UUID_C =
		new FinderPath(CProductModelImpl.ENTITY_CACHE_ENABLED,
			CProductModelImpl.FINDER_CACHE_ENABLED, CProductImpl.class,
			...
			CProductModelImpl.CREATEDATE_COLUMN_BITMASK);
	public static final FinderPath FINDER_PATH_COUNT_BY_UUID_C = new FinderPath(CProductModelImpl.ENTITY_CACHE_ENABLED,
			CProductModelImpl.FINDER_CACHE_ENABLED, Long.class,
	 ...
	 */
	@Override
	public List<CProduct> findByUuid_C(String uuid, long companyId, int start,
		int end) {
	...
	@Override
	public List<CProduct> findByUuid_C(String uuid, long companyId, int start,
		int end, OrderByComparator<CProduct> orderByComparator) {
	 ...
	 */
	@Override
	public CProduct findByUuid_C_First(String uuid, long companyId,
		OrderByComparator<CProduct> orderByComparator)
		throws NoSuchCProductException {
		CProduct cProduct = fetchByUuid_C_First(uuid, companyId,
				orderByComparator);
	 ...
	 */
	@Override
	public CProduct fetchByUuid_C_First(String uuid, long companyId,
		OrderByComparator<CProduct> orderByComparator) {
		List<CProduct> list = findByUuid_C(uuid, companyId, 0, 1,
				orderByComparator);
	 ...
	 */
	@Override
	public CProduct findByUuid_C_Last(String uuid, long companyId,
		OrderByComparator<CProduct> orderByComparator)
		throws NoSuchCProductException {
		CProduct cProduct = fetchByUuid_C_Last(uuid, companyId,
				orderByComparator);
	 ...
	 */
	@Override
	public CProduct fetchByUuid_C_Last(String uuid, long companyId,
		OrderByComparator<CProduct> orderByComparator) {
		...
		List<CProduct> list = findByUuid_C(uuid, companyId, count - 1, count,
				orderByComparator);
	 ...
	 */
	@Override
	public CProduct[] findByUuid_C_PrevAndNext(long CProductId, String uuid,
		long companyId, OrderByComparator<CProduct> orderByComparator)
		throws NoSuchCProductException {
		CProduct cProduct = findByPrimaryKey(CProductId);
		...
		try {
			...
			array[0] = getByUuid_C_PrevAndNext(session, cProduct, uuid,
					companyId, orderByComparator, true);

			array[1] = cProduct;

			array[2] = getByUuid_C_PrevAndNext(session, cProduct, uuid,
	...
	protected CProduct getByUuid_C_PrevAndNext(Session session,
		CProduct cProduct, String uuid, long companyId,
		OrderByComparator<CProduct> orderByComparator, boolean previous) {
		StringBundler query = null;
	...
	private static final String _FINDER_COLUMN_UUID_C_UUID_1 = "cProduct.uuid IS NULL AND ";
	private static final String _FINDER_COLUMN_UUID_C_UUID_2 = "cProduct.uuid = ? AND ";
	private static final String _FINDER_COLUMN_UUID_C_UUID_3 = "(cProduct.uuid IS NULL OR cProduct.uuid = '') AND ";
	private static final String _FINDER_COLUMN_UUID_C_COMPANYID_2 = "cProduct.companyId = ?";
	public static final FinderPath FINDER_PATH_WITH_PAGINATION_FIND_BY_GROUPID = new FinderPath(CProductModelImpl.ENTITY_CACHE_ENABLED,
			CProductModelImpl.FINDER_CACHE_ENABLED, CProductImpl.class,
	...
	public static final FinderPath FINDER_PATH_WITHOUT_PAGINATION_FIND_BY_GROUPID =
		new FinderPath(CProductModelImpl.ENTITY_CACHE_ENABLED,
			...
			CProductModelImpl.GROUPID_COLUMN_BITMASK |
			CProductModelImpl.CREATEDATE_COLUMN_BITMASK);
	public static final FinderPath FINDER_PATH_COUNT_BY_GROUPID = new FinderPath(CProductModelImpl.ENTITY_CACHE_ENABLED,
			CProductModelImpl.FINDER_CACHE_ENABLED, Long.class,
	 ...
	 */
	@Override
	public CProduct findByGroupId_First(long groupId,
		OrderByComparator<CProduct> orderByComparator)
		throws NoSuchCProductException {
	 ...
	 */
	@Override
	public CProduct fetchByGroupId_First(long groupId,
		OrderByComparator<CProduct> orderByComparator) {
	 ...
	 */
	@Override
	public CProduct fetchByGroupId_Last(long groupId,
		OrderByComparator<CProduct> orderByComparator) {
		...
		List<CProduct> list = findByGroupId(groupId, count - 1, count,
				orderByComparator);
	 ...
	 */
	@Override
	public CProduct[] findByGroupId_PrevAndNext(long CProductId, long groupId,
		OrderByComparator<CProduct> orderByComparator)
		throws NoSuchCProductException {
		CProduct cProduct = findByPrimaryKey(CProductId);
		...
		try {
			...
			array[0] = getByGroupId_PrevAndNext(session, cProduct, groupId,
					orderByComparator, true);

			array[1] = cProduct;

			array[2] = getByGroupId_PrevAndNext(session, cProduct, groupId,
					orderByComparator, false);
	...
	protected CProduct getByGroupId_PrevAndNext(Session session,
	...
	public void removeByGroupId(long groupId) {
		for (CProduct cProduct : findByGroupId(groupId, QueryUtil.ALL_POS,
				QueryUtil.ALL_POS, null)) {
			remove(cProduct);
		}
	}
	...
	private static final String _FINDER_COLUMN_GROUPID_GROUPID_2 = "cProduct.groupId = ?";
	public static final FinderPath FINDER_PATH_FETCH_BY_C_ERC = new FinderPath(CProductModelImpl.ENTITY_CACHE_ENABLED,
			CProductModelImpl.FINDER_CACHE_ENABLED, CProductImpl.class,
			FINDER_CLASS_NAME_ENTITY, "fetchByC_ERC",
			new String[] { Long.class.getName(), String.class.getName() },
			CProductModelImpl.COMPANYID_COLUMN_BITMASK |
			CProductModelImpl.EXTERNALREFERENCECODE_COLUMN_BITMASK);
	public static final FinderPath FINDER_PATH_COUNT_BY_C_ERC = new FinderPath(CProductModelImpl.ENTITY_CACHE_ENABLED,
			CProductModelImpl.FINDER_CACHE_ENABLED, Long.class,
	...
	private static final String _FINDER_COLUMN_C_ERC_COMPANYID_2 = "cProduct.companyId = ? AND ";
	private static final String _FINDER_COLUMN_C_ERC_EXTERNALREFERENCECODE_1 = "cProduct.externalReferenceCode IS NULL";
	private static final String _FINDER_COLUMN_C_ERC_EXTERNALREFERENCECODE_2 = "cProduct.externalReferenceCode = ?";
	private static final String _FINDER_COLUMN_C_ERC_EXTERNALREFERENCECODE_3 = "(cProduct.externalReferenceCode IS NULL OR cProduct.externalReferenceCode = '')";
	...
	protected void cacheUniqueFindersCache(CProductModelImpl cProductModelImpl) {
	...
	protected CProduct removeImpl(CProduct cProduct) {
		...
		try {
			...
			if (!session.contains(cProduct)) {
				cProduct = (CProduct)session.get(CProductImpl.class,
						cProduct.getPrimaryKeyObj());
			}
	...
	public CProduct updateImpl(CProduct cProduct) {
		...
		if (!CProductModelImpl.COLUMN_BITMASK_ENABLED) {
		 ...
		 if (isNew) {
			...
			if ((cProductModelImpl.getColumnBitmask() &
				...
				Object[] args = new Object[] { cProductModelImpl.getOriginalUuid() };
		...
		entityCache.putResult(CProductModelImpl.ENTITY_CACHE_ENABLED,
			CProductImpl.class, cProduct.getPrimaryKey(), cProduct, false);
	...
	/**
	 * Returns the c product with the primary key or throws a {@link com.liferay.portal.kernel.exception.NoSuchModelException} if it could not be found.
	 *
	 * @param primaryKey the primary key of the c product
	...
	/**
	 * Returns the c product with the primary key or throws a {@link NoSuchCProductException} if it could not be found.
	 *
	 * @param CProductId the primary key of the c product
	 * @return the c product
	 * @throws NoSuchCProductException if a c product with the primary key could not be found
	...
	public CProduct fetchByPrimaryKey(Serializable primaryKey) {
		Serializable serializable = entityCache.getResult(CProductModelImpl.ENTITY_CACHE_ENABLED,
	...
	private static final String _SQL_SELECT_CPRODUCT = "SELECT cProduct FROM CProduct cProduct";
	private static final String _SQL_SELECT_CPRODUCT_WHERE_PKS_IN = "SELECT cProduct FROM CProduct cProduct WHERE CProductId IN (";
	private static final String _SQL_SELECT_CPRODUCT_WHERE = "SELECT cProduct FROM CProduct cProduct WHERE ";
	private static final String _SQL_COUNT_CPRODUCT = "SELECT COUNT(cProduct) FROM CProduct cProduct";
	private static final String _SQL_COUNT_CPRODUCT_WHERE = "SELECT COUNT(cProduct) FROM CProduct cProduct WHERE ";
	private static final String _ORDER_BY_ENTITY_ALIAS = "cProduct.";
	private static final String _NO_SUCH_ENTITY_WITH_PRIMARY_KEY = "No CProduct exists with the primary key ";
	private static final String _NO_SUCH_ENTITY_WITH_KEY = "No CProduct exists with the key {";
	private static final Log _log = LogFactoryUtil.getLog(CProductPersistenceImpl.class);

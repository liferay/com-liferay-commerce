...
public class CommerceChannelRelServiceHttp {
	public static com.liferay.commerce.product.model.CommerceChannelRel addCommerceChannelRel(
		...
		try {
			MethodKey methodKey = new MethodKey(CommerceChannelRelServiceUtil.class,
			...
			return (com.liferay.commerce.product.model.CommerceChannelRel)returnObj;
		}
	...
	public static void deleteCommerceChannelRels(HttpPrincipal httpPrincipal,
	...
	public static java.util.List<com.liferay.commerce.product.model.CommerceChannelRel> getCommerceChannelRels(
		...
		try {
			...
			return (java.util.List<com.liferay.commerce.product.model.CommerceChannelRel>)returnObj;
		}
		catch (com.liferay.portal.kernel.exception.SystemException se) {
			_log.error(se, se);
	...
	public static int getCommerceChannelRelsCount(HttpPrincipal httpPrincipal,
		long commerceChannelId) {
		try {
			MethodKey methodKey = new MethodKey(CommerceChannelRelServiceUtil.class,
	...
	private static Log _log = LogFactoryUtil.getLog(CommerceChannelRelServiceHttp.class);
	private static final Class<?>[] _addCommerceChannelRelParameterTypes0 = new Class[] {
			String.class, long.class, long.class,
			com.liferay.portal.kernel.service.ServiceContext.class
		};
	private static final Class<?>[] _deleteCommerceChannelRelsParameterTypes1 = new Class[] {
			String.class, long.class
		};
	private static final Class<?>[] _getCommerceChannelRelsParameterTypes2 = new Class[] {
			long.class, int.class, int.class,
			com.liferay.portal.kernel.util.OrderByComparator.class
		};
	private static final Class<?>[] _getCommerceChannelRelsParameterTypes3 = new Class[] {
			String.class, long.class, int.class, int.class,
			com.liferay.portal.kernel.util.OrderByComparator.class
		};
	private static final Class<?>[] _getCommerceChannelRelsCountParameterTypes4 = new Class[] {
			long.class
		};
	private static final Class<?>[] _getCommerceChannelRelsCountParameterTypes5 = new Class[] {
			String.class, long.class
		};
}
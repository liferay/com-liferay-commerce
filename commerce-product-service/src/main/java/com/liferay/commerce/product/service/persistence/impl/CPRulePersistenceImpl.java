...
public class CPRulePersistenceImpl extends BasePersistenceImpl<CPRule>
	...
	public static final FinderPath FINDER_PATH_WITH_PAGINATION_FIND_BY_C_C = new FinderPath(CPRuleModelImpl.ENTITY_CACHE_ENABLED,
			CPRuleModelImpl.FINDER_CACHE_ENABLED, CPRuleImpl.class,
	...
	public static final FinderPath FINDER_PATH_WITHOUT_PAGINATION_FIND_BY_C_C = new FinderPath(CPRuleModelImpl.ENTITY_CACHE_ENABLED,
			CPRuleModelImpl.FINDER_CACHE_ENABLED, CPRuleImpl.class,
			FINDER_CLASS_NAME_LIST_WITHOUT_PAGINATION, "findByC_C",
			new String[] { Long.class.getName(), Long.class.getName() },
			CPRuleModelImpl.CLASSNAMEID_COLUMN_BITMASK |
			CPRuleModelImpl.CLASSPK_COLUMN_BITMASK |
			CPRuleModelImpl.CREATEDATE_COLUMN_BITMASK);
	public static final FinderPath FINDER_PATH_COUNT_BY_C_C = new FinderPath(CPRuleModelImpl.ENTITY_CACHE_ENABLED,
			CPRuleModelImpl.FINDER_CACHE_ENABLED, Long.class,
	 ...
	 */
	@Override
	public List<CPRule> findByC_C(long classNameId, long classPK) {
	 ...
	 */
	@Override
	public List<CPRule> findByC_C(long classNameId, long classPK, int start,
		int end) {
	...
	public List<CPRule> findByC_C(long classNameId, long classPK, int start,
		...
		if (retrieveFromCache) {
			...
			if ((list != null) && !list.isEmpty()) {
				for (CPRule cpRule : list) {
					if ((classNameId != cpRule.getClassNameId()) ||
							(classPK != cpRule.getClassPK())) {
						list = null;
	...
	public CPRule findByC_C_First(long classNameId, long classPK,
		OrderByComparator<CPRule> orderByComparator)
		throws NoSuchCPRuleException {
		CPRule cpRule = fetchByC_C_First(classNameId, classPK, orderByComparator);
	...
	public CPRule fetchByC_C_First(long classNameId, long classPK,
		OrderByComparator<CPRule> orderByComparator) {
		List<CPRule> list = findByC_C(classNameId, classPK, 0, 1,
				orderByComparator);
	...
	public CPRule findByC_C_Last(long classNameId, long classPK,
		OrderByComparator<CPRule> orderByComparator)
		throws NoSuchCPRuleException {
		CPRule cpRule = fetchByC_C_Last(classNameId, classPK, orderByComparator);
	...
	public CPRule fetchByC_C_Last(long classNameId, long classPK,
		...
		List<CPRule> list = findByC_C(classNameId, classPK, count - 1, count,
				orderByComparator);
	...
	public CPRule[] findByC_C_PrevAndNext(long CPRuleId, long classNameId,
		long classPK, OrderByComparator<CPRule> orderByComparator)
		throws NoSuchCPRuleException {
		CPRule cpRule = findByPrimaryKey(CPRuleId);
		...
		try {
			...
			array[0] = getByC_C_PrevAndNext(session, cpRule, classNameId,
					classPK, orderByComparator, true);

			array[1] = cpRule;

			array[2] = getByC_C_PrevAndNext(session, cpRule, classNameId,
	...
	protected CPRule getByC_C_PrevAndNext(Session session, CPRule cpRule,
	...
	public void removeByC_C(long classNameId, long classPK) {
		for (CPRule cpRule : findByC_C(classNameId, classPK, QueryUtil.ALL_POS,
				QueryUtil.ALL_POS, null)) {
			remove(cpRule);
		}
	}
	...
	private static final String _FINDER_COLUMN_C_C_CLASSNAMEID_2 = "cpRule.classNameId = ? AND ";
	private static final String _FINDER_COLUMN_C_C_CLASSPK_2 = "cpRule.classPK = ?";
	...
	public CPRule updateImpl(CPRule cpRule) {
		...
		if (!CPRuleModelImpl.COLUMN_BITMASK_ENABLED) {
		 ...
		 if (isNew) {
			...
			args = new Object[] {
					cpRuleModelImpl.getClassNameId(),
					cpRuleModelImpl.getClassPK()
				};
			...
			if ((cpRuleModelImpl.getColumnBitmask() &
				...
				Object[] args = new Object[] {
						cpRuleModelImpl.getOriginalClassNameId(),
						cpRuleModelImpl.getOriginalClassPK()
					};

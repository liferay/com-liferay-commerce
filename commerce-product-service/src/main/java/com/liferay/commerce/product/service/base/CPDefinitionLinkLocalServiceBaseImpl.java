...
public abstract class CPDefinitionLinkLocalServiceBaseImpl
	extends BaseLocalServiceImpl implements CPDefinitionLinkLocalService,
		IdentifiableOSGiService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link com.liferay.commerce.product.service.CPDefinitionLinkLocalServiceUtil} to access the cp definition link local service.
	 */
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(CPDefinitionLink.class,
	...
	public CPDefinitionLink fetchCPDefinitionLink(long CPDefinitionLinkId) {
		return cpDefinitionLinkPersistence.fetchByPrimaryKey(CPDefinitionLinkId);
	}
	...
	public ActionableDynamicQuery getActionableDynamicQuery() {
		...
		actionableDynamicQuery.setBaseLocalService(cpDefinitionLinkLocalService);
	...
	public IndexableActionableDynamicQuery getIndexableActionableDynamicQuery() {
		...
		indexableActionableDynamicQuery.setBaseLocalService(cpDefinitionLinkLocalService);
	...
	public ExportActionableDynamicQuery getExportActionableDynamicQuery(
		...
		exportActionableDynamicQuery.setPerformActionMethod(new ActionableDynamicQuery.PerformActionMethod<CPDefinitionLink>() {
				@Override
	...
	public PersistedModel deletePersistedModel(PersistedModel persistedModel)
		throws PortalException {
		return cpDefinitionLinkLocalService.deleteCPDefinitionLink((CPDefinitionLink)persistedModel);
	}
	...
	public String getOSGiServiceIdentifier() {
		return CPDefinitionLinkLocalService.class.getName();
	}

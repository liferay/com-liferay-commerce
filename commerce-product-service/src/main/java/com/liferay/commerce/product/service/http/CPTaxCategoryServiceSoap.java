...
public class CPTaxCategoryServiceSoap {
	...
	public static com.liferay.commerce.product.model.CPTaxCategorySoap[] getCPTaxCategories(
		...
		try {
			java.util.List<com.liferay.commerce.product.model.CPTaxCategory> returnValue =
				CPTaxCategoryServiceUtil.getCPTaxCategories(companyId);
	...
	public static com.liferay.commerce.product.model.CPTaxCategorySoap[] getCPTaxCategories(
		...
		try {
			java.util.List<com.liferay.commerce.product.model.CPTaxCategory> returnValue =
				CPTaxCategoryServiceUtil.getCPTaxCategories(companyId, start,
	...
	public static int getCPTaxCategoriesCount(long companyId)
		throws RemoteException {
		try {
			int returnValue = CPTaxCategoryServiceUtil.getCPTaxCategoriesCount(companyId);

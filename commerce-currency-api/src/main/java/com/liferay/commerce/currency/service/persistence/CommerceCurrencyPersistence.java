...
public interface CommerceCurrencyPersistence extends BasePersistence<CommerceCurrency> {
	...
	* @return the matching commerce currencies
	*/
	public java.util.List<CommerceCurrency> findByC_P(long companyId,
		boolean primary);
	...
	* @return the matching commerce currencies
	*/
	public java.util.List<CommerceCurrency> findByC_A(long companyId,
		boolean active);
	...
	* @return the matching commerce currencies
	*/
	public java.util.List<CommerceCurrency> findByC_P_A(long companyId,

...
package com.liferay.commerce.initializer.office.supply.internal;

import com.liferay.asset.kernel.model.AssetVocabulary;
import com.liferay.asset.kernel.service.AssetVocabularyLocalService;
import com.liferay.commerce.constants.CommercePortletKeys;
import com.liferay.commerce.currency.service.CommerceCurrencyLocalService;
import com.liferay.commerce.initializer.office.supply.internal.configuration.OfficeSupplyInitializerConfiguration;
import com.liferay.commerce.initializer.office.supply.internal.product.renderer.OfficeSupplyCPContentRenderer;
import com.liferay.commerce.initializer.office.supply.internal.product.renderer.list.entry.OfficeSupplySearchResultCPContentListEntryRenderer;
 ...
 */
@Component(
	configurationPid = "com.liferay.commerce.initializer.office.supply.internal.configuration.OfficeSupplyInitializerConfiguration",
	immediate = true,
	property = "site.initializer.key=" + OfficeSupplyGroupInitializer.KEY,
	service = SiteInitializer.class
)
public class OfficeSupplyGroupInitializer implements SiteInitializer {

	public static final String KEY = "office-supply-initializer";
	...
	protected void activate(Map<String, Object> properties) {
		_configuration = ConfigurableUtil.createConfigurable(
			OfficeSupplyInitializerConfiguration.class, properties);
	}
	...
	protected void setCPSearchResultPortletSettings(
		...
		if (portletName.equals(_CP_SEARCH_RESULT_PORTLET_NAME)) {
			...
			portletSetup.setValue(
				...
				OfficeSupplySearchResultCPContentListEntryRenderer.KEY);
	...
	protected void updateCompany(ServiceContext serviceContext)
		...
		_companyService.updateCompany(
			...
			null, null, null, null, "Office Supply", "Commerce", null);
	}
	...
	private static final Log _log = LogFactoryUtil.getLog(
		OfficeSupplyGroupInitializer.class);
	...
	private volatile OfficeSupplyInitializerConfiguration _configuration;
	...
	@Reference(target = "(demo.name=office-supply)")

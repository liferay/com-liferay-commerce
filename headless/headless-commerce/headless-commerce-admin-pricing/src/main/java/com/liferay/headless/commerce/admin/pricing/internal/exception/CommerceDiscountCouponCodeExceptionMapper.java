...
public class CommerceDiscountCouponCodeExceptionMapper
	...
	public int getErrorCode() {
		return RESTError.DISCOUNT_COUPON_CODE_ERROR.getErrorCode();
	}

	@Override
	public String getErrorDescription() {
		return RESTError.DISCOUNT_COUPON_CODE_ERROR.getErrorDescription();
	}

	@Override
	public Response.Status getStatus() {
		return RESTError.DISCOUNT_COUPON_CODE_ERROR.getStatus();
	}

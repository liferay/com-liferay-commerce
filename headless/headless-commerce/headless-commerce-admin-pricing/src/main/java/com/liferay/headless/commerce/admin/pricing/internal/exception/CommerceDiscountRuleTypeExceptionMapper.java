...
@Provider
public class CommerceDiscountRuleTypeExceptionMapper
	extends BaseExceptionMapper<CommerceDiscountRuleTypeException> {

	@Override
	public int getErrorCode() {
		return RESTError.DISCOUNT_RULE_TYPE_ERROR.getErrorCode();
	}

	@Override
	public String getErrorDescription() {
		return RESTError.DISCOUNT_RULE_TYPE_ERROR.getErrorDescription();
	}

	@Override
	public Response.Status getStatus() {
		return RESTError.DISCOUNT_RULE_TYPE_ERROR.getStatus();
	}

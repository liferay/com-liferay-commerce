...
@Provider
public class CommerceDiscountDisplayDateExceptionMapper
	extends BaseExceptionMapper<CommerceDiscountDisplayDateException> {

	@Override
	public int getErrorCode() {
		return RESTError.INVALID_COMMERCE_DISCOUNT_DISPLAY_DATE.getErrorCode();
	}

	@Override
	public String getErrorDescription() {
		return RESTError.INVALID_COMMERCE_DISCOUNT_DISPLAY_DATE.
			getErrorDescription();
	}

	@Override
	public Response.Status getStatus() {
		return RESTError.INVALID_COMMERCE_DISCOUNT_DISPLAY_DATE.getStatus();
	}

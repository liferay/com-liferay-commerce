...
public class DuplicateTierPriceEntryExceptionMapper
	...
	public int getErrorCode() {
		return RESTError.DUPLICATE_TIER_PRICE.getErrorCode();
	}

	@Override
	public String getErrorDescription() {
		return RESTError.DUPLICATE_TIER_PRICE.getErrorDescription();
	}

	@Override
	public Response.Status getStatus() {
		return RESTError.DUPLICATE_TIER_PRICE.getStatus();
	}

...
public class CommerceDiscountTitleExceptionMapper
	...
	public int getErrorCode() {
		return RESTError.DISCOUNT_TITLE_ERROR.getErrorCode();
	}

	@Override
	public String getErrorDescription() {
		return RESTError.DISCOUNT_TITLE_ERROR.getErrorDescription();
	}

	@Override
	public Response.Status getStatus() {
		return RESTError.DISCOUNT_TITLE_ERROR.getStatus();
	}

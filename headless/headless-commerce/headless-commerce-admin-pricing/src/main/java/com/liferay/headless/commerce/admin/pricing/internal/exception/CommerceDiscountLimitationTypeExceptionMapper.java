...
@Provider
public class CommerceDiscountLimitationTypeExceptionMapper
	extends BaseExceptionMapper<CommerceDiscountLimitationTypeException> {

	@Override
	public int getErrorCode() {
		return RESTError.DISCOUNT_LIMITATION_TYPE_ERROR.getErrorCode();
	}

	@Override
	public String getErrorDescription() {
		return RESTError.DISCOUNT_LIMITATION_TYPE_ERROR.getErrorDescription();
	}

	@Override
	public Response.Status getStatus() {
		return RESTError.DISCOUNT_LIMITATION_TYPE_ERROR.getStatus();
	}

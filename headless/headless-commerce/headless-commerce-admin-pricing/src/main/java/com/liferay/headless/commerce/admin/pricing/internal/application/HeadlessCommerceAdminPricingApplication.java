...
package com.liferay.headless.commerce.admin.pricing.internal.application;
...
@Component(
	property = {
		JaxrsWhiteboardConstants.JAX_RS_APPLICATION_BASE + "=/commerce-admin-pricing",
		JaxrsWhiteboardConstants.JAX_RS_EXTENSION_SELECT + "=(osgi.jaxrs.name=Liferay.OAuth2)",
		JaxrsWhiteboardConstants.JAX_RS_NAME + "=HeadlessCommerceAdminPricing.Rest",

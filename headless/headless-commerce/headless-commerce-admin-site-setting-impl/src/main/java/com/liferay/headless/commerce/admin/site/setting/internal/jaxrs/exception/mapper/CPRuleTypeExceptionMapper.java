...
@Component(
	property = {
		...
		"osgi.jaxrs.name=Liferay.Headless.Commerce.Admin.Site.Setting.CPRuleTypeException"
	},
	service = ExceptionMapper.class
)
@Provider
public class CPRuleTypeExceptionMapper
	extends BaseExceptionMapper<CPRuleTypeException> {

	@Override
	public String getErrorDescription() {
		return "Invalid catalog rule type";
	}

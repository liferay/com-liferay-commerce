...
@Component(
	property = {
		...
		"osgi.jaxrs.name=Liferay.Headless.Commerce.Admin.Catalog.MethodRequiredParameterMissingExceptionMapper"
	},
	service = ExceptionMapper.class
)
@Provider
public class MethodRequiredParameterMissingExceptionMapper
	extends BaseExceptionMapper<MethodRequiredParameterMissingException> {

...
@Path("/v1.0/optionCategory")
public interface OptionCategoryResource {

	@DELETE
	@Path("/{id}")
	public Response deleteOptionCategory(@PathParam("id") Long id)
		throws Exception;

	@GET
	@Path("/{id}")
	@Produces({"application/json", "application/xml"})
	public OptionCategoryDTO getOptionCategory(@PathParam("id") Long id)
		throws Exception;
	...
	public Response updateOptionCategory(
			@PathParam("id") Long id, OptionCategoryDTO optionCategoryDTO)
		throws Exception;

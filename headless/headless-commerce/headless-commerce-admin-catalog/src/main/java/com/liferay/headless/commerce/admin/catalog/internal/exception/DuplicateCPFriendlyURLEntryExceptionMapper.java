...
@Provider
public class DuplicateCPFriendlyURLEntryExceptionMapper
	extends BaseExceptionMapper<DuplicateCPFriendlyURLEntryException> {

	@Override
	public int getErrorCode() {
		return RESTError.DUPLICATE_FRIENDLY_URL.getErrorCode();
	}

	@Override
	public String getErrorDescription() {
		return RESTError.DUPLICATE_FRIENDLY_URL.getErrorDescription();
	}

	@Override
	public Response.Status getStatus() {
		return RESTError.DUPLICATE_FRIENDLY_URL.getStatus();
	}

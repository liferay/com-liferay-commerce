...
public class NoSuchSkuContributorCPDefinitionOptionRelExceptionMapper
	...
	public int getErrorCode() {
		return RESTError.NO_SUCH_SKU_CONTRIBUTOR_OPTION.getErrorCode();
	}

	@Override
	public String getErrorDescription() {
		return RESTError.NO_SUCH_SKU_CONTRIBUTOR_OPTION.getErrorDescription();
	}

	@Override
	public Response.Status getStatus() {
		return RESTError.NO_SUCH_SKU_CONTRIBUTOR_OPTION.getStatus();
	}

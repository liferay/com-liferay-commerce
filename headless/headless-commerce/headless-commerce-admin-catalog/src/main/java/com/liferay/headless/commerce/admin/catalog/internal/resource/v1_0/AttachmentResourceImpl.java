...
public class AttachmentResourceImpl implements AttachmentResource {
	...
	public Response deleteAttachment(String id) throws Exception {
		_attachmentHelper.deleteAttachment(id, _company);
	...
	public AttachmentDTO getAttachment(String id) throws Exception {
		return _attachmentHelper.getAttachment(id, _company);
	}

	@AsyncSupported
	@Override
	@RequiresScope("HeadlessCommerceAdminCatalog.write")
	public Response updateAttachment(String id, AttachmentDTO attachmentDTO)
		throws Exception {
		...
		if (_async.isEnabled()) {
			new Thread(
				() -> {
					try {
						_attachmentHelper.updateAttachment(
		...
		_attachmentHelper.updateAttachment(id, attachmentDTO, _company);

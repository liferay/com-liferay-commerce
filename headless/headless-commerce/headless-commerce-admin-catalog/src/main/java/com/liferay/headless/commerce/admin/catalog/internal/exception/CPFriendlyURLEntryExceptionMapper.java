...
@Provider
public class CPFriendlyURLEntryExceptionMapper
	extends BaseExceptionMapper<CPFriendlyURLEntryException> {

	@Override
	public int getErrorCode() {
		return RESTError.FRIENDLY_URL_ERROR.getErrorCode();
	}

	@Override
	public String getErrorDescription() {
		return RESTError.FRIENDLY_URL_ERROR.getErrorDescription();
	}

	@Override
	public Response.Status getStatus() {
		return RESTError.FRIENDLY_URL_ERROR.getStatus();
	}

...
public class SKUHelper {
	...
	public SkuDTO updateSKU(String id, SkuDTO skuDTO, Company company)
		throws PortalException {
		...
		cpInstance = _cpInstanceService.updateCPInstance(
			...
			GetterUtil.get(skuDTO.isPurchasable(), cpInstance.isPurchasable()),
			GetterUtil.get(skuDTO.isPublished(), cpInstance.isPublished()),
	...
	public SkuDTO upsertSKU(String productId, SkuDTO skuDTO, Company company)
		throws PortalException {

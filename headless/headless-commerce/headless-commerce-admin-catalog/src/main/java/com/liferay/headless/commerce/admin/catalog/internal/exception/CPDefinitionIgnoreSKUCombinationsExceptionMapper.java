...
@Provider
public class CPDefinitionIgnoreSKUCombinationsExceptionMapper
	extends BaseExceptionMapper<CPDefinitionIgnoreSKUCombinationsException> {

	@Override
	public int getErrorCode() {
		return RESTError.IGNORE_SKU_COMBINATIONS_ERROR.getErrorCode();
	}

	@Override
	public String getErrorDescription() {
		return RESTError.IGNORE_SKU_COMBINATIONS_ERROR.getErrorDescription();
	}

	@Override
	public Response.Status getStatus() {
		return RESTError.IGNORE_SKU_COMBINATIONS_ERROR.getStatus();
	}

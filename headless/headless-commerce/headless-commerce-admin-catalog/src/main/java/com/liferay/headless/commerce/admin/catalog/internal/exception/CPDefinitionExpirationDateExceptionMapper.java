...
@Provider
public class CPDefinitionExpirationDateExceptionMapper
	extends BaseExceptionMapper<CPDefinitionExpirationDateException> {

	@Override
	public int getErrorCode() {
		return RESTError.INVALID_COMMERCE_PRODUCT_EXPIRATION_DATE.
			getErrorCode();
	}
	...
	public Response.Status getStatus() {
		return RESTError.INVALID_COMMERCE_PRODUCT_EXPIRATION_DATE.getStatus();
	}

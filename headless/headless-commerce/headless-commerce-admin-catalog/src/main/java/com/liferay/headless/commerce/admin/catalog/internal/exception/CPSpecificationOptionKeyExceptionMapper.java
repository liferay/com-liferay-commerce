...
@Provider
public class CPSpecificationOptionKeyExceptionMapper
	extends BaseExceptionMapper<CPSpecificationOptionKeyException> {

	@Override
	public int getErrorCode() {
		return RESTError.SPECIFICATION_KEY_ERROR.getErrorCode();
	}

	@Override
	public String getErrorDescription() {
		return RESTError.SPECIFICATION_KEY_ERROR.getErrorDescription();
	}

	@Override
	public Response.Status getStatus() {
		return RESTError.SPECIFICATION_KEY_ERROR.getStatus();
	}

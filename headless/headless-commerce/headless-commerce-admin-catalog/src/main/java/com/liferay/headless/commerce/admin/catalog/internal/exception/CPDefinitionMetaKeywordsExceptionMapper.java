...
public class CPDefinitionMetaKeywordsExceptionMapper
	...
	public int getErrorCode() {
		return RESTError.PRODUCT_META_KEYWORDS_ERROR.getErrorCode();
	}

	@Override
	public String getErrorDescription() {
		return RESTError.PRODUCT_META_KEYWORDS_ERROR.getErrorDescription();
	}

	@Override
	public Response.Status getStatus() {
		return RESTError.PRODUCT_META_KEYWORDS_ERROR.getStatus();
	}

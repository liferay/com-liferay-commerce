...
public class CPInstanceDisplayDateExceptionMapper
	...
	public int getErrorCode() {
		return RESTError.INVALID_COMMERCE_SKU_DISPLAY_DATE.getErrorCode();
	}

	@Override
	public String getErrorDescription() {
		return RESTError.INVALID_COMMERCE_SKU_DISPLAY_DATE.
			getErrorDescription();
	}

	@Override
	public Response.Status getStatus() {
		return RESTError.INVALID_COMMERCE_SKU_DISPLAY_DATE.getStatus();
	}

...
@Provider
public class CPDefinitionMetaTitleExceptionMapper
	extends BaseExceptionMapper<CPDefinitionMetaTitleException> {

	@Override
	public int getErrorCode() {
		return RESTError.PRODUCT_META_TITLE_ERROR.getErrorCode();
	}

	@Override
	public String getErrorDescription() {
		return RESTError.PRODUCT_META_TITLE_ERROR.getErrorDescription();
	}

	@Override
	public Response.Status getStatus() {
		return RESTError.PRODUCT_META_TITLE_ERROR.getStatus();
	}

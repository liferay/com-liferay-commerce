...
public class CPInstanceExpirationDateExceptionMapper
	...
	public int getErrorCode() {
		return RESTError.INVALID_COMMERCE_SKU_EXPIRATION_DATE.getErrorCode();
	}

	@Override
	public String getErrorDescription() {
		return RESTError.INVALID_COMMERCE_SKU_EXPIRATION_DATE.
			getErrorDescription();
	}

	@Override
	public Response.Status getStatus() {
		return RESTError.INVALID_COMMERCE_SKU_EXPIRATION_DATE.getStatus();
	}

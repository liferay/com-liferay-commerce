...
@Provider
public class CPDefinitionMetaDescriptionExceptionMapper
	extends BaseExceptionMapper<CPDefinitionMetaDescriptionException> {

	@Override
	public int getErrorCode() {
		return RESTError.PRODUCT_META_DESCRIPTION_ERROR.getErrorCode();
	}

	@Override
	public String getErrorDescription() {
		return RESTError.PRODUCT_META_DESCRIPTION_ERROR.getErrorDescription();
	}

	@Override
	public Response.Status getStatus() {
		return RESTError.PRODUCT_META_DESCRIPTION_ERROR.getStatus();
	}

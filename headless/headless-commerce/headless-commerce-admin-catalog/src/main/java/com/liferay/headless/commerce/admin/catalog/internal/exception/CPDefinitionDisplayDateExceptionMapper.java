...
public class CPDefinitionDisplayDateExceptionMapper
	...
	public int getErrorCode() {
		return RESTError.INVALID_COMMERCE_PRODUCT_DISPLAY_DATE.getErrorCode();
	}

	@Override
	public String getErrorDescription() {
		return RESTError.INVALID_COMMERCE_PRODUCT_DISPLAY_DATE.
			getErrorDescription();
	}

	@Override
	public Response.Status getStatus() {
		return RESTError.INVALID_COMMERCE_PRODUCT_DISPLAY_DATE.getStatus();
	}

...
public class CPAttachmentFileEntryNameExceptionMapper
	...
	public int getErrorCode() {
		return RESTError.ATTACHMENT_NAME_ERROR.getErrorCode();
	}

	@Override
	public String getErrorDescription() {
		return RESTError.ATTACHMENT_NAME_ERROR.getErrorDescription();
	}

	@Override
	public Response.Status getStatus() {
		return RESTError.ATTACHMENT_NAME_ERROR.getStatus();
	}

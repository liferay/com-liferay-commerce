...
public class CPSpecificationOptionTitleExceptionMapper
	...
	public int getErrorCode() {
		return RESTError.SPECIFICATION_TITLE_ERROR.getErrorCode();
	}

	@Override
	public String getErrorDescription() {
		return RESTError.SPECIFICATION_TITLE_ERROR.getErrorDescription();
	}

	@Override
	public Response.Status getStatus() {
		return RESTError.SPECIFICATION_TITLE_ERROR.getStatus();
	}

...
@Provider
public class CPAttachmentFileEntrySizeExceptionMapper
	extends BaseExceptionMapper<CPAttachmentFileEntrySizeException> {

	@Override
	public int getErrorCode() {
		return RESTError.ATTACHMENT_SIZE_ERROR.getErrorCode();
	}

	@Override
	public String getErrorDescription() {
		return RESTError.ATTACHMENT_SIZE_ERROR.getErrorDescription();
	}

	@Override
	public Response.Status getStatus() {
		return RESTError.ATTACHMENT_SIZE_ERROR.getStatus();
	}

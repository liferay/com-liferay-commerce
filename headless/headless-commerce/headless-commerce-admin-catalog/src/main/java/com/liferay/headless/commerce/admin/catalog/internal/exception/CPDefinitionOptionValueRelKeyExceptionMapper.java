...
@Provider
public class CPDefinitionOptionValueRelKeyExceptionMapper
	extends BaseExceptionMapper<CPDefinitionOptionValueRelKeyException> {

	@Override
	public int getErrorCode() {
		return RESTError.DUPLICATE_PRODUCT_OPTION_KEY.getErrorCode();
	}

	@Override
	public String getErrorDescription() {
		return RESTError.DUPLICATE_PRODUCT_OPTION_KEY.getErrorDescription();
	}

	@Override
	public Response.Status getStatus() {
		return RESTError.DUPLICATE_PRODUCT_OPTION_KEY.getStatus();
	}

...
@Component(
	property = {
		...
		"osgi.jaxrs.name=Liferay.Headless.Commerce.Admin.Account.CommerceAccountUserRelEmailAddressException"
	},
	service = ExceptionMapper.class
)
@Provider
public class CommerceAccountUserRelEmailAddressExceptionMapper

...
public interface ProductOptionValueResource {
	...
	public Response deleteProductOptionValue(String id) throws Exception;

	public Response getProductOptionValue(String id) throws Exception;
	...
	public Response getProductOptionValues(String id) throws Exception;

...
public interface RegionResource {
	...
	public Response getRegion(String id) throws Exception;

	public Response updateMediaType1Region(String id, Region region)
		throws Exception;

	public Response updateMediaType2Region(String id, Region region)
		throws Exception;

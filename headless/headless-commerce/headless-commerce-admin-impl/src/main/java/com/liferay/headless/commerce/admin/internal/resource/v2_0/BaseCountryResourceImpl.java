...
public abstract class BaseCountryResourceImpl implements CountryResource {
	...
	public Response deleteCountry(@NotNull @PathParam("id") String id)
		throws Exception {
	...
	@Produces({"application/json", "application/xml"})
	@Tags(value = {@Tag(name = "Country")})
	public Response getCountry(@NotNull @PathParam("id") String id)
		throws Exception {
	...
	public Response updateMediaType1Country(
			...
			@NotNull @PathParam("id") String id, Country country)
		throws Exception {
	...
	@Produces({"application/json", "application/xml"})
	@Tags(value = {@Tag(name = "Country")})
	public Response getRegions(@NotNull @PathParam("id") String id)
		throws Exception {
	...
	public Response upsertMediaType1Region(
			@NotNull @PathParam("id") String id, Region region)
		throws Exception {
	...
	@Produces({"application/json", "application/xml"})
	@Tags(value = {@Tag(name = "Country")})
	public Response getCountries(@NotNull @QueryParam("groupId") Long groupId)
		throws Exception {
	...
	public Response upsertMediaType1Country(
			@NotNull @QueryParam("groupId") Long groupId, Country country)
		throws Exception {

...
public abstract class BaseProductResourceImpl implements ProductResource {
	...
	@Produces({"application/json", "application/xml"})
	@Tags(value = {@Tag(name = "Product")})
	public Response getProduct(@NotNull @PathParam("id") String id)
		throws Exception {
	...
	public Response updateMediaType1Product(
			...
			@NotNull @QueryParam("groupId") Long groupId, Product product)
		throws Exception {
	...
	@Produces({"application/json", "application/xml"})
	@Tags(value = {@Tag(name = "Product")})
	public Response getProducts(@NotNull @QueryParam("groupId") Long groupId)
		throws Exception {
	...
	@Produces({"application/json", "application/xml"})
	@Tags(value = {@Tag(name = "Product")})
	public Response getSkus(@NotNull @PathParam("id") String id)
		throws Exception {

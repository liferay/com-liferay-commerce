...
public class MiniumCPContentListEntryRenderer
	...
	public void render(
		...
		dependencies.add(
			"commerce-frontend-taglib@2.1.2/add_to_cart/AddToCartButton.es");
		dependencies.add(
			"commerce-frontend-taglib@2.1.2/compare_checkbox" +
				"/CompareCheckbox.es");
		dependencies.add("commerce-frontend-taglib@2.1.2/price/Price.es");

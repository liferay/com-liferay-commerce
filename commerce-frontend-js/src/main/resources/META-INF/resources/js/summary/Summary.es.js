...
function SummaryItemBase(props) {
	return (
		<>
			<div className="col-6 col-md-9"><p className="m-0">{props.label}</p></div>
			<div className="col-6 col-md-3"><p className="m-0">{props.value}</p></div>
		</>
	)
}
...
function SummaryItemBigVariant(props) {
	return (
		<>
			<div className="col-6 col-md-9"><h3 className="my-2">{props.label}</h3></div>
			<div className="col-6 col-md-3"><h3 className="my-2">{props.value}</h3></div>
		</>
	)
}
...
function SummaryItemDangerVariant(props) {
	return (
		<>
			<div className="col-6 col-md-9 text-danger"><p className="m-0">{props.label}</p></div>
			<div className="col-6 col-md-3 text-danger"><p className="m-0">{props.value}</p></div>
		</>
	)
}
...
function Summary(props) {
	return (
		<div className="row summary-table text-right">
			{props.items.map((item, i) => <SummaryItem key={i} {...item} />)}
		</div>
	)
}

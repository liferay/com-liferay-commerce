...
/**
 * Provides the local service interface for CommerceBatchJob. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author Matija Petanjek
 * @see CommerceBatchJobLocalServiceUtil
...
public interface CommerceBatchJobLocalService extends BaseLocalService,
	PersistedModelLocalService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link CommerceBatchJobLocalServiceUtil} to access the commerce batch job local service. Add custom service methods to {@link com.liferay.commerce.batch.service.impl.CommerceBatchJobLocalServiceImpl} and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
	...
	*/
	...
	public CommerceBatchJob createCommerceBatchJob(long commerceBatchJobId);
	...
	*/
	...
	public CommerceBatchJob deleteCommerceBatchJob(
		CommerceBatchJob commerceBatchJob);
	...
	*/
	@Indexable(type = IndexableType.DELETE)
	public CommerceBatchJob deleteCommerceBatchJob(long commerceBatchJobId)
	...
	*/
	...
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public CommerceBatchJob fetchCommerceBatchJob(long commerceBatchJobId);
	...
	*/
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public CommerceBatchJob getCommerceBatchJob(long commerceBatchJobId)
		throws PortalException;
	...
	*/
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public List<CommerceBatchJob> getCommerceBatchJobs(int start, int end);
	...
	*/
	@Indexable(type = IndexableType.REINDEX)
	public CommerceBatchJob updateCommerceBatchJob(
		CommerceBatchJob commerceBatchJob);
}
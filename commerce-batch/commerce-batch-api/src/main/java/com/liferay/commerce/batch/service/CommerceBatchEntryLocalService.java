...
/**
 * Provides the local service interface for CommerceBatchEntry. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author Matija Petanjek
 * @see CommerceBatchEntryLocalServiceUtil
...
public interface CommerceBatchEntryLocalService extends BaseLocalService,
	PersistedModelLocalService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link CommerceBatchEntryLocalServiceUtil} to access the commerce batch entry local service. Add custom service methods to {@link com.liferay.commerce.batch.service.impl.CommerceBatchEntryLocalServiceImpl} and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */

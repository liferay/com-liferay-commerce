...
package com.liferay.commerce.batch.rest.internal.exception;
...
@Provider
public class IllegalFileNameExceptionMapper
	extends BaseExceptionMapper<IllegalFileNameException> {
	...
	public String getErrorDescription() {
		return "Illegal batch file name";
	}

...
/**
 * The persistence utility for the commerce price list user segment entry rel service. This utility wraps <code>com.liferay.commerce.price.list.service.persistence.impl.CommercePriceListUserSegmentEntryRelPersistenceImpl</code> and provides direct access to the database for CRUD operations. This utility should only be used by the service layer, as it must operate within a transaction. Never access this utility in a JSP, controller, model, or other front-end class.
 *
 * <p>
...
public class CommercePriceListUserSegmentEntryRelUtil {
	 ...
	 */
	public static Map<Serializable, CommercePriceListUserSegmentEntryRel>
	 ...
	 */
	public static List<CommercePriceListUserSegmentEntryRel>
	...
	public static CommercePriceListUserSegmentEntryRel update(
		...
		return getPersistence().update(
			commercePriceListUserSegmentEntryRel, serviceContext);
	}
	...
	public static CommercePriceListUserSegmentEntryRel findByUuid_First(
		...
		throws com.liferay.commerce.price.list.exception.
			NoSuchPriceListUserSegmentEntryRelException {
	...
	public static CommercePriceListUserSegmentEntryRel[] findByUuid_PrevAndNext(
		...
		return getPersistence().findByUuid_PrevAndNext(
			commercePriceListUserSegmentEntryRelId, uuid, orderByComparator);
	}
	 ...
	 * @throws NoSuchPriceListUserSegmentEntryRelException if a commerce price list user segment entry rel with the primary key could not be found
	 */
	public static CommercePriceListUserSegmentEntryRel[]
		...
		return getPersistence().findByUuid_C_PrevAndNext(
			commercePriceListUserSegmentEntryRelId, uuid, companyId,
			orderByComparator);
	}
	...
	public static CommercePriceListUserSegmentEntryRel[]
		...
		return getPersistence().findByCommercePriceListId_PrevAndNext(
			commercePriceListUserSegmentEntryRelId, commercePriceListId,
			orderByComparator);
	}
	...
	public static CommercePriceListUserSegmentEntryRel fetchByC_C(
		...
		return getPersistence().fetchByC_C(
			commercePriceListId, commerceUserSegmentEntryId, retrieveFromCache);
	}
	...
	public static CommercePriceListUserSegmentEntryRelPersistence
		getPersistence() {
	...
	private static ServiceTracker
		<CommercePriceListUserSegmentEntryRelPersistence,
		 CommercePriceListUserSegmentEntryRelPersistence> _serviceTracker;

	static {
		Bundle bundle = FrameworkUtil.getBundle(
			CommercePriceListUserSegmentEntryRelPersistence.class);

		ServiceTracker
			<CommercePriceListUserSegmentEntryRelPersistence,
			 CommercePriceListUserSegmentEntryRelPersistence> serviceTracker =
				new ServiceTracker
					<CommercePriceListUserSegmentEntryRelPersistence,
					 CommercePriceListUserSegmentEntryRelPersistence>(

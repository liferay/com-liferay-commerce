 ...
 * @see com.liferay.commerce.price.list.service.http.CommercePriceListCommerceAccountGroupRelServiceSoap
 * @generated
 */
@ProviderType
public class CommercePriceListCommerceAccountGroupRelSoap
	...
	public static CommercePriceListCommerceAccountGroupRelSoap toSoapModel(
		...
		CommercePriceListCommerceAccountGroupRelSoap soapModel = new CommercePriceListCommerceAccountGroupRelSoap();
	...
	public static CommercePriceListCommerceAccountGroupRelSoap[] toSoapModels(
		...
		CommercePriceListCommerceAccountGroupRelSoap[] soapModels = new CommercePriceListCommerceAccountGroupRelSoap[models.length];
	...
	public static CommercePriceListCommerceAccountGroupRelSoap[][] toSoapModels(
		...
		if (models.length > 0) {
			soapModels = new CommercePriceListCommerceAccountGroupRelSoap[models.length][models[0].length];
		}
		else {
	...
	public static CommercePriceListCommerceAccountGroupRelSoap[] toSoapModels(
		...
		List<CommercePriceListCommerceAccountGroupRelSoap> soapModels = new ArrayList<CommercePriceListCommerceAccountGroupRelSoap>(models.size());

		for (CommercePriceListCommerceAccountGroupRel model : models) {
			soapModels.add(toSoapModel(model));
		}

		return soapModels.toArray(new CommercePriceListCommerceAccountGroupRelSoap[soapModels.size()]);
	}

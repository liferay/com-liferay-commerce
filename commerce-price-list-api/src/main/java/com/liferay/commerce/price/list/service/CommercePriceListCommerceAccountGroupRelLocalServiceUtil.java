 ...
 * {@link com.liferay.commerce.price.list.service.impl.CommercePriceListCommerceAccountGroupRelLocalServiceImpl} and is the
...
public class CommercePriceListCommerceAccountGroupRelLocalServiceUtil {
	 ...
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this class directly. Add custom service methods to {@link com.liferay.commerce.price.list.service.impl.CommercePriceListCommerceAccountGroupRelLocalServiceImpl} and rerun ServiceBuilder to regenerate this class.
	 */
	...
	*/
	public static com.liferay.commerce.price.list.model.CommercePriceListCommerceAccountGroupRel addCommercePriceListCommerceAccountGroupRel(
		com.liferay.commerce.price.list.model.CommercePriceListCommerceAccountGroupRel commercePriceListCommerceAccountGroupRel) {
		return getService()
				   .addCommercePriceListCommerceAccountGroupRel(commercePriceListCommerceAccountGroupRel);
	}
	...
	public static com.liferay.commerce.price.list.model.CommercePriceListCommerceAccountGroupRel addCommercePriceListCommerceAccountGroupRel(
		...
		return getService()
				   .addCommercePriceListCommerceAccountGroupRel(commercePriceListId,
	...
	*/
	public static com.liferay.commerce.price.list.model.CommercePriceListCommerceAccountGroupRel createCommercePriceListCommerceAccountGroupRel(
		long commercePriceListCommerceAccountGroupRelId) {
		return getService()
				   .createCommercePriceListCommerceAccountGroupRel(commercePriceListCommerceAccountGroupRelId);
	}
	...
	*/
	public static com.liferay.commerce.price.list.model.CommercePriceListCommerceAccountGroupRel deleteCommercePriceListCommerceAccountGroupRel(
		com.liferay.commerce.price.list.model.CommercePriceListCommerceAccountGroupRel commercePriceListCommerceAccountGroupRel)
		throws com.liferay.portal.kernel.exception.PortalException {
		return getService()
				   .deleteCommercePriceListCommerceAccountGroupRel(commercePriceListCommerceAccountGroupRel);
	}
	...
	*/
	public static com.liferay.commerce.price.list.model.CommercePriceListCommerceAccountGroupRel deleteCommercePriceListCommerceAccountGroupRel(
		...
		throws com.liferay.portal.kernel.exception.PortalException {
		return getService()
				   .deleteCommercePriceListCommerceAccountGroupRel(commercePriceListCommerceAccountGroupRelId);
	}

	public static void deleteCommercePriceListCommerceAccountGroupRels(
		long commercePriceListId) {
		getService()
			.deleteCommercePriceListCommerceAccountGroupRels(commercePriceListId);
	}
	...
	*/
	...
	public static com.liferay.commerce.price.list.model.CommercePriceListCommerceAccountGroupRel fetchCommercePriceListCommerceAccountGroupRel(
		long commercePriceListCommerceAccountGroupRelId) {
		return getService()
				   .fetchCommercePriceListCommerceAccountGroupRel(commercePriceListCommerceAccountGroupRelId);
	}

	public static com.liferay.commerce.price.list.model.CommercePriceListCommerceAccountGroupRel fetchCommercePriceListCommerceAccountGroupRel(
		long commercePriceListId, long commerceAccountGroupId) {
		return getService()
				   .fetchCommercePriceListCommerceAccountGroupRel(commercePriceListId,
	...
	* @throws PortalException if a commerce price list commerce account group rel with the primary key could not be found
	*/
	public static com.liferay.commerce.price.list.model.CommercePriceListCommerceAccountGroupRel getCommercePriceListCommerceAccountGroupRel(
		long commercePriceListCommerceAccountGroupRelId)
		throws com.liferay.portal.kernel.exception.PortalException {
		return getService()
				   .getCommercePriceListCommerceAccountGroupRel(commercePriceListCommerceAccountGroupRelId);
	}
	...
	*/
	public static java.util.List<com.liferay.commerce.price.list.model.CommercePriceListCommerceAccountGroupRel> getCommercePriceListCommerceAccountGroupRels(
		int start, int end) {
		return getService()
	...
	*/
	...
	public static int getCommercePriceListCommerceAccountGroupRelsCount(
		long commercePriceListId) {
		return getService()
				   .getCommercePriceListCommerceAccountGroupRelsCount(commercePriceListId);
	}
	...
	*/
	public static com.liferay.commerce.price.list.model.CommercePriceListCommerceAccountGroupRel updateCommercePriceListCommerceAccountGroupRel(
		com.liferay.commerce.price.list.model.CommercePriceListCommerceAccountGroupRel commercePriceListCommerceAccountGroupRel) {
		return getService()
				   .updateCommercePriceListCommerceAccountGroupRel(commercePriceListCommerceAccountGroupRel);
	}
	...
	public static com.liferay.commerce.price.list.model.CommercePriceListCommerceAccountGroupRel updateCommercePriceListCommerceAccountGroupRel(
		...
		throws com.liferay.portal.kernel.exception.PortalException {
		return getService()
				   .updateCommercePriceListCommerceAccountGroupRel(commercePriceListCommerceAccountGroupRelId,
			order, serviceContext);
	}

	public static CommercePriceListCommerceAccountGroupRelLocalService getService() {
		return _serviceTracker.getService();
	}

	private static ServiceTracker<CommercePriceListCommerceAccountGroupRelLocalService, CommercePriceListCommerceAccountGroupRelLocalService> _serviceTracker;

	static {
		Bundle bundle = FrameworkUtil.getBundle(CommercePriceListCommerceAccountGroupRelLocalService.class);

		ServiceTracker<CommercePriceListCommerceAccountGroupRelLocalService, CommercePriceListCommerceAccountGroupRelLocalService> serviceTracker =
			new ServiceTracker<CommercePriceListCommerceAccountGroupRelLocalService, CommercePriceListCommerceAccountGroupRelLocalService>(bundle.getBundleContext(),
				CommercePriceListCommerceAccountGroupRelLocalService.class, null);

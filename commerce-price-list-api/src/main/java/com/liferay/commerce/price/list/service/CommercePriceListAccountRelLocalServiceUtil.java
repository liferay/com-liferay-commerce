 ...
 * {@link com.liferay.commerce.price.list.service.impl.CommercePriceListAccountRelLocalServiceImpl} and is the
 ...
 * @see com.liferay.commerce.price.list.service.base.CommercePriceListAccountRelLocalServiceBaseImpl
...
public class CommercePriceListAccountRelLocalServiceUtil {
	 ...
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this class directly. Add custom service methods to {@link com.liferay.commerce.price.list.service.impl.CommercePriceListAccountRelLocalServiceImpl} and rerun ServiceBuilder to regenerate this class.
	 */
	...
	*/
	public static com.liferay.commerce.price.list.model.CommercePriceListAccountRel fetchCommercePriceListAccountRelByUuidAndGroupId(
		String uuid, long groupId) {
		return getService()
				   .fetchCommercePriceListAccountRelByUuidAndGroupId(uuid,
			groupId);
	}
	...
	*/
	public static com.liferay.commerce.price.list.model.CommercePriceListAccountRel getCommercePriceListAccountRelByUuidAndGroupId(
		String uuid, long groupId)
		throws com.liferay.portal.kernel.exception.PortalException {
		return getService()
	...
	*/
	public static java.util.List<com.liferay.commerce.price.list.model.CommercePriceListAccountRel> getCommercePriceListAccountRelsByUuidAndCompanyId(
		String uuid, long companyId) {
		return getService()
				   .getCommercePriceListAccountRelsByUuidAndCompanyId(uuid,
			companyId);
	}
	...
	*/
	public static com.liferay.commerce.price.list.model.CommercePriceListAccountRel updateCommercePriceListAccountRel(
		com.liferay.commerce.price.list.model.CommercePriceListAccountRel commercePriceListAccountRel) {
		return getService()
	...
	static {
		Bundle bundle = FrameworkUtil.getBundle(CommercePriceListAccountRelLocalService.class);

		ServiceTracker<CommercePriceListAccountRelLocalService, CommercePriceListAccountRelLocalService> serviceTracker =
			new ServiceTracker<CommercePriceListAccountRelLocalService, CommercePriceListAccountRelLocalService>(bundle.getBundleContext(),

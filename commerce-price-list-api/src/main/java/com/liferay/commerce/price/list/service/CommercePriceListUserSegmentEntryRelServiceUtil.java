 ...
 * <code>com.liferay.commerce.price.list.service.impl.CommercePriceListUserSegmentEntryRelServiceImpl</code> and is an
...
public class CommercePriceListUserSegmentEntryRelServiceUtil {
	 ...
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this class directly. Add custom service methods to <code>com.liferay.commerce.price.list.service.impl.CommercePriceListUserSegmentEntryRelServiceImpl</code> and rerun ServiceBuilder to regenerate this class.
	 */
	public static
	...
	public static void deleteCommercePriceListUserSegmentEntryRel(
		...
		getService().deleteCommercePriceListUserSegmentEntryRel(
	...
	private static ServiceTracker
		<CommercePriceListUserSegmentEntryRelService,
		 CommercePriceListUserSegmentEntryRelService> _serviceTracker;

	static {
		Bundle bundle = FrameworkUtil.getBundle(
			CommercePriceListUserSegmentEntryRelService.class);

		ServiceTracker
			<CommercePriceListUserSegmentEntryRelService,
			 CommercePriceListUserSegmentEntryRelService> serviceTracker =
				new ServiceTracker
					<CommercePriceListUserSegmentEntryRelService,
					 CommercePriceListUserSegmentEntryRelService>(

...
public interface CommercePriceListUserSegmentEntryRelLocalService
	 ...
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link CommercePriceListUserSegmentEntryRelLocalServiceUtil} to access the commerce price list user segment entry rel local service. Add custom service methods to <code>com.liferay.commerce.price.list.service.impl.CommercePriceListUserSegmentEntryRelLocalServiceImpl</code> and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */

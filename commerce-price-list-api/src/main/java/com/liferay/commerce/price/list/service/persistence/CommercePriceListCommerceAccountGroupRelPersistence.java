...
public interface CommercePriceListCommerceAccountGroupRelPersistence
	...
	* @return the matching commerce price list commerce account group rels
	*/
	public java.util.List<CommercePriceListCommerceAccountGroupRel> findByUuid_C(
	...
	* @return the matching commerce price list commerce account group rels
	*/
	public java.util.List<CommercePriceListCommerceAccountGroupRel> findByCommercePriceListId(
	...
	*/
	public void cacheResult(
		java.util.List<CommercePriceListCommerceAccountGroupRel> commercePriceListCommerceAccountGroupRels);
	...
	*/
	...
	@Override
	public java.util.Map<java.io.Serializable, CommercePriceListCommerceAccountGroupRel> fetchByPrimaryKeys(

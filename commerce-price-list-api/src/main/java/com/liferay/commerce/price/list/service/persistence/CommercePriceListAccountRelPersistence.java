...
public interface CommercePriceListAccountRelPersistence extends BasePersistence<CommercePriceListAccountRel> {
	...
	* @return the matching commerce price list account rels
	*/
	public java.util.List<CommercePriceListAccountRel> findByCommercePriceListId(
	...
	*/
	public void cacheResult(
		java.util.List<CommercePriceListAccountRel> commercePriceListAccountRels);
	...
	*/
	...
	@Override
	public java.util.Map<java.io.Serializable, CommercePriceListAccountRel> fetchByPrimaryKeys(
	...
	*/
	public java.util.List<CommercePriceListAccountRel> findAll(int start,
		int end);

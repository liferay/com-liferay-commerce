 ...
 * <code>com.liferay.commerce.price.list.service.impl.CommercePriceListUserSegmentEntryRelLocalServiceImpl</code> and
...
public class CommercePriceListUserSegmentEntryRelLocalServiceUtil {
	 ...
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this class directly. Add custom service methods to <code>com.liferay.commerce.price.list.service.impl.CommercePriceListUserSegmentEntryRelLocalServiceImpl</code> and rerun ServiceBuilder to regenerate this class.
	 */
	...
	public static
		...
		return getService().addCommercePriceListUserSegmentEntryRel(
			commercePriceListUserSegmentEntryRel);
	}
	...
	public static
		...
		return getService().createCommercePriceListUserSegmentEntryRel(
	...
	public static
		...
		return getService().deleteCommercePriceListUserSegmentEntryRel(
			commercePriceListUserSegmentEntryRel);
	}
	...
	public static void deleteCommercePriceListUserSegmentEntryRels(
		...
		getService().deleteCommercePriceListUserSegmentEntryRels(
			commercePriceListId);
	}
	...
	public static
		...
		return getService().fetchCommercePriceListUserSegmentEntryRel(
			commercePriceListUserSegmentEntryRelId);
	}
	...
	public static
		...
		return getService().getCommercePriceListUserSegmentEntryRel(
			commercePriceListUserSegmentEntryRelId);
	}
	...
	public static java.util.List
		...
		return getService().getCommercePriceListUserSegmentEntryRels(
			start, end);
	}
	...
	public static
		...
		return getService().updateCommercePriceListUserSegmentEntryRel(
			commercePriceListUserSegmentEntryRel);
	}
	...
	public static CommercePriceListUserSegmentEntryRelLocalService
		getService() {
	...
	private static ServiceTracker
		<CommercePriceListUserSegmentEntryRelLocalService,
		 CommercePriceListUserSegmentEntryRelLocalService> _serviceTracker;

	static {
		Bundle bundle = FrameworkUtil.getBundle(
			CommercePriceListUserSegmentEntryRelLocalService.class);

		ServiceTracker
			<CommercePriceListUserSegmentEntryRelLocalService,
			 CommercePriceListUserSegmentEntryRelLocalService> serviceTracker =
				new ServiceTracker
					<CommercePriceListUserSegmentEntryRelLocalService,
					 CommercePriceListUserSegmentEntryRelLocalService>(

...
@OSGiBeanProperties(property =  {
	"json.web.service.context.name=commerce", "json.web.service.context.path=CommercePriceListCommerceAccountGroupRel"}, service = CommercePriceListCommerceAccountGroupRelService.class)
@ProviderType
...
public interface CommercePriceListCommerceAccountGroupRelService
	 ...
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link CommercePriceListCommerceAccountGroupRelServiceUtil} to access the commerce price list commerce account group rel remote service. Add custom service methods to {@link com.liferay.commerce.price.list.service.impl.CommercePriceListCommerceAccountGroupRelServiceImpl} and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */

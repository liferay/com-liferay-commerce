...
package com.liferay.commerce.product.subscription.type.yearly.internal;

import com.liferay.commerce.product.subscription.type.yearly.internal.display.context.YearlyCPSubscriptionTypeDisplayContext;
...
@Component(
	immediate = true,
	property = "commerce.product.subscription.type.jsp.contributor.key=" + YearlyCPSubscriptionTypeImpl.NAME,
...
public class YearlyCPSubscriptionTypeJSPContributor
	...
	@Reference(
		target = "(osgi.web.symbolicname=com.liferay.commerce.product.subscription.type.yearly)"
	)

...
package com.liferay.commerce.product.subscription.type.yearly.internal.display.context;

import com.liferay.commerce.product.subscription.type.yearly.internal.display.context.constants.YearlyCPSubscriptionTypeConstants;
import com.liferay.commerce.product.subscription.type.yearly.internal.display.context.util.YearlyCPSubscriptionTypeRequestHelper;
import com.liferay.commerce.product.subscription.type.yearly.internal.display.context.util.comparator.YearlyCPSubscriptionTypeCalendarMonthsComparator;
...
public class YearlyCPSubscriptionTypeDisplayContext {
	...
	public YearlyCPSubscriptionTypeDisplayContext(
		...
		_yearlyCPSubscriptionTypeRequestHelper =
			new YearlyCPSubscriptionTypeRequestHelper(httpServletRequest);
	}
	...
	public int getSelectedYearlyMode() {
		...
		if (subscriptionTypeSettingsProperties == null) {
			return YearlyCPSubscriptionTypeConstants.MODE_ORDER_DATE;
		}
	...
	protected Map<String, Integer> getCalendarMonthsDisplayNames() {
		Calendar calendar = CalendarFactoryUtil.getCalendar(
			_yearlyCPSubscriptionTypeRequestHelper.getLocale());
	...
	private final YearlyCPSubscriptionTypeRequestHelper
		_yearlyCPSubscriptionTypeRequestHelper;

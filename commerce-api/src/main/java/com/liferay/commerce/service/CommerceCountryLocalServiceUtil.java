...
public class CommerceCountryLocalServiceUtil {
	...
	*/
	public static com.liferay.commerce.model.CommerceCountry fetchCommerceCountryByUuidAndCompanyId(
	...
	*/
	public static com.liferay.commerce.model.CommerceCountry getCommerceCountryByUuidAndCompanyId(
		String uuid, long companyId)
		throws com.liferay.portal.kernel.exception.PortalException {
		return getService().getCommerceCountryByUuidAndCompanyId(uuid, companyId);
	}
	...
	*/
	...
	static {
		Bundle bundle = FrameworkUtil.getBundle(CommerceCountryLocalService.class);

		ServiceTracker<CommerceCountryLocalService, CommerceCountryLocalService> serviceTracker =
			new ServiceTracker<CommerceCountryLocalService, CommerceCountryLocalService>(bundle.getBundleContext(),

...
public class CommerceShipmentUtil {
	...
	*/
	public static List<CommerceShipment> findByGroupIds(long groupId,
		...
		OrderByComparator<CommerceShipment> orderByComparator) {
		return getPersistence()
				   .findByGroupIds(groupId, start, end, orderByComparator);
	}
	...
	*/
	public static CommerceShipment findByGroupIds_First(long groupId,
		OrderByComparator<CommerceShipment> orderByComparator)
		throws com.liferay.commerce.exception.NoSuchShipmentException {
		return getPersistence().findByGroupIds_First(groupId, orderByComparator);
	}
	...
	*/
	public static CommerceShipment fetchByGroupIds_First(long groupId,
		OrderByComparator<CommerceShipment> orderByComparator) {
		return getPersistence().fetchByGroupIds_First(groupId, orderByComparator);
	}
	...
	* @throws NoSuchShipmentException if a matching commerce shipment could not be found
	*/
	public static CommerceShipment findByGroupIds_Last(long groupId,
		OrderByComparator<CommerceShipment> orderByComparator)
		throws com.liferay.commerce.exception.NoSuchShipmentException {
	...
	*/
	public static CommerceShipment fetchByGroupIds_Last(long groupId,
		OrderByComparator<CommerceShipment> orderByComparator) {
		return getPersistence().fetchByGroupIds_Last(groupId, orderByComparator);
	}
	...
	*/
	public static CommerceShipment[] findByGroupIds_PrevAndNext(
		...
		throws com.liferay.commerce.exception.NoSuchShipmentException {
		return getPersistence()
				   .findByGroupIds_PrevAndNext(commerceShipmentId, groupId,
			orderByComparator);
	}
	...
	*/
	public static List<CommerceShipment> findByGroupIds(long[] groupIds,
		...
		OrderByComparator<CommerceShipment> orderByComparator) {
		return getPersistence()
				   .findByGroupIds(groupIds, start, end, orderByComparator);
	}
	...
	*/
	public static List<CommerceShipment> findByG_S(long[] groupIds, int status,
		...
		OrderByComparator<CommerceShipment> orderByComparator) {
		return getPersistence()
				   .findByG_S(groupIds, status, start, end, orderByComparator);
	}

...
public class CommerceSubscriptionEntryUtil {
	...
	*/
	public static CommerceSubscriptionEntry[] findByCompanyId_PrevAndNext(
		...
		throws com.liferay.commerce.exception.NoSuchSubscriptionEntryException {
		return getPersistence()
				   .findByCompanyId_PrevAndNext(commerceSubscriptionEntryId,
			companyId, orderByComparator);
	}
	...
	* @return the matching commerce subscription entries
	*/
	public static List<CommerceSubscriptionEntry> findByC_U(long companyId,
		long userId) {
	...
	* @throws NoSuchSubscriptionEntryException if a matching commerce subscription entry could not be found
	*/
	public static CommerceSubscriptionEntry findByC_U_First(long companyId,
		long userId,
		OrderByComparator<CommerceSubscriptionEntry> orderByComparator)
		throws com.liferay.commerce.exception.NoSuchSubscriptionEntryException {
		return getPersistence()
	...
	* @return the first matching commerce subscription entry, or <code>null</code> if a matching commerce subscription entry could not be found
	*/
	public static CommerceSubscriptionEntry fetchByC_U_First(long companyId,
		long userId,
		OrderByComparator<CommerceSubscriptionEntry> orderByComparator) {
		return getPersistence()
	...
	* @throws NoSuchSubscriptionEntryException if a matching commerce subscription entry could not be found
	*/
	public static CommerceSubscriptionEntry findByC_U_Last(long companyId,
		long userId,
		OrderByComparator<CommerceSubscriptionEntry> orderByComparator)
		throws com.liferay.commerce.exception.NoSuchSubscriptionEntryException {
		return getPersistence()
	...
	* @return the last matching commerce subscription entry, or <code>null</code> if a matching commerce subscription entry could not be found
	*/
	public static CommerceSubscriptionEntry fetchByC_U_Last(long companyId,
		long userId,
		OrderByComparator<CommerceSubscriptionEntry> orderByComparator) {
		return getPersistence()
	...
	*/
	public static CommerceSubscriptionEntry[] findByC_U_PrevAndNext(
		...
		throws com.liferay.commerce.exception.NoSuchSubscriptionEntryException {
		return getPersistence()
				   .findByC_U_PrevAndNext(commerceSubscriptionEntryId,
	...
	* @return the matching commerce subscription entries
	*/
	public static List<CommerceSubscriptionEntry> findByG_C_U(long groupId,
	...
	*/
	public static List<CommerceSubscriptionEntry> findByG_C_U(long groupId,
		...
		return getPersistence()
				   .findByG_C_U(groupId, companyId, userId, start, end);
	}
	...
	* @throws NoSuchSubscriptionEntryException if a matching commerce subscription entry could not be found
	*/
	public static CommerceSubscriptionEntry findByG_C_U_First(long groupId,
		long companyId, long userId,
		OrderByComparator<CommerceSubscriptionEntry> orderByComparator)
		throws com.liferay.commerce.exception.NoSuchSubscriptionEntryException {
		return getPersistence()
				   .findByG_C_U_First(groupId, companyId, userId,
			orderByComparator);
	}
	...
	* @return the first matching commerce subscription entry, or <code>null</code> if a matching commerce subscription entry could not be found
	*/
	public static CommerceSubscriptionEntry fetchByG_C_U_First(long groupId,
		long companyId, long userId,
		OrderByComparator<CommerceSubscriptionEntry> orderByComparator) {
		return getPersistence()
				   .fetchByG_C_U_First(groupId, companyId, userId,
			orderByComparator);
	}
	...
	* @throws NoSuchSubscriptionEntryException if a matching commerce subscription entry could not be found
	*/
	public static CommerceSubscriptionEntry findByG_C_U_Last(long groupId,
		long companyId, long userId,
		OrderByComparator<CommerceSubscriptionEntry> orderByComparator)
		throws com.liferay.commerce.exception.NoSuchSubscriptionEntryException {
		return getPersistence()
				   .findByG_C_U_Last(groupId, companyId, userId,
			orderByComparator);
	}
	...
	* @return the last matching commerce subscription entry, or <code>null</code> if a matching commerce subscription entry could not be found
	*/
	public static CommerceSubscriptionEntry fetchByG_C_U_Last(long groupId,
		long companyId, long userId,
		OrderByComparator<CommerceSubscriptionEntry> orderByComparator) {
		return getPersistence()
				   .fetchByG_C_U_Last(groupId, companyId, userId,
			orderByComparator);
	}
	...
	*/
	public static CommerceSubscriptionEntry[] findByG_C_U_PrevAndNext(
		...
		throws com.liferay.commerce.exception.NoSuchSubscriptionEntryException {
		return getPersistence()
				   .findByG_C_U_PrevAndNext(commerceSubscriptionEntryId,

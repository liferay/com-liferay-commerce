...
/**
 * The persistence utility for the cp definition inventory service. This utility wraps <code>com.liferay.commerce.service.persistence.impl.CPDefinitionInventoryPersistenceImpl</code> and provides direct access to the database for CRUD operations. This utility should only be used by the service layer, as it must operate within a transaction. Never access this utility in a JSP, controller, model, or other front-end class.
 *
 * <p>
...
public class CPDefinitionInventoryUtil {
	 ...
	 */
	public static Map<Serializable, CPDefinitionInventory> fetchByPrimaryKeys(
	 ...
	 * @throws NoSuchCPDefinitionInventoryException if a matching cp definition inventory could not be found
	 */
	public static CPDefinitionInventory findByUuid_Last(
			String uuid,
			OrderByComparator<CPDefinitionInventory> orderByComparator)
		throws com.liferay.commerce.exception.
			NoSuchCPDefinitionInventoryException {
	 ...
	 */
	public static CPDefinitionInventory removeByUUID_G(
			String uuid, long groupId)
		throws com.liferay.commerce.exception.
			NoSuchCPDefinitionInventoryException {
	...
	static {
		Bundle bundle = FrameworkUtil.getBundle(
			CPDefinitionInventoryPersistence.class);

...
public class CommerceAvailabilityEstimateLocalServiceUtil {
	...
	public static com.liferay.commerce.model.CommerceAvailabilityEstimate
		...
		return getService().fetchCommerceAvailabilityEstimateByUuidAndGroupId(
			uuid, groupId);
	}
	...
	public static com.liferay.commerce.model.CommerceAvailabilityEstimate
		...
		return getService().getCommerceAvailabilityEstimateByUuidAndGroupId(
			uuid, groupId);
	}
	...
	public static java.util.List
		...
		return getService().getCommerceAvailabilityEstimatesByUuidAndCompanyId(
			uuid, companyId);
	}

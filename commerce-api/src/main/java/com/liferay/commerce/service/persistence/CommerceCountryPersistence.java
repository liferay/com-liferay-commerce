...
public interface CommerceCountryPersistence extends BasePersistence<CommerceCountry> {
	...
	* @return the matching commerce countries
	*/
	public java.util.List<CommerceCountry> findByC_A(long companyId,
		boolean active);
	...
	* @return the matching commerce countries
	*/
	public java.util.List<CommerceCountry> findByC_B_A(long companyId,
	...
	* @return the matching commerce countries
	*/
	public java.util.List<CommerceCountry> findByC_S_A(long companyId,

...
public interface CommerceCountryPersistence
	 ...
	 * @return the range of matching commerce countries
	 */
	public java.util.List<CommerceCountry> findByGroupId(
	 ...
	 * @return the matching commerce countries
	 */
	public java.util.List<CommerceCountry> findByG_A(
	 ...
	 * @return the matching commerce countries
	 */
	public java.util.List<CommerceCountry> findByG_B_A(
	 ...
	 * @return the matching commerce countries
	 */
	public java.util.List<CommerceCountry> findByG_S_A(

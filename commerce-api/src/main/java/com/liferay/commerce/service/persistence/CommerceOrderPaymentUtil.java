...
/**
 * The persistence utility for the commerce order payment service. This utility wraps <code>com.liferay.commerce.service.persistence.impl.CommerceOrderPaymentPersistenceImpl</code> and provides direct access to the database for CRUD operations. This utility should only be used by the service layer, as it must operate within a transaction. Never access this utility in a JSP, controller, model, or other front-end class.
 *
 * <p>
...
public class CommerceOrderPaymentUtil {
	 ...
	 */
	public static Map<Serializable, CommerceOrderPayment> fetchByPrimaryKeys(
	...
	public static CommerceOrderPayment[] findByCommerceOrderId_PrevAndNext(
		...
		return getPersistence().findByCommerceOrderId_PrevAndNext(
			commerceOrderPaymentId, commerceOrderId, orderByComparator);
	}
	...
	static {
		Bundle bundle = FrameworkUtil.getBundle(
			CommerceOrderPaymentPersistence.class);

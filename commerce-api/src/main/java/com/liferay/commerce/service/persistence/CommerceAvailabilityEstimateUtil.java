...
public class CommerceAvailabilityEstimateUtil {
	 ...
	 * @throws NoSuchAvailabilityEstimateException if a matching commerce availability estimate could not be found
	 */
	public static CommerceAvailabilityEstimate findByUUID_G(
	 ...
	 */
	public static CommerceAvailabilityEstimate fetchByUUID_G(
		String uuid, long groupId) {
	 ...
	 */
	public static CommerceAvailabilityEstimate removeByUUID_G(
			String uuid, long groupId)
		throws com.liferay.commerce.exception.
			NoSuchAvailabilityEstimateException {
	...
	public static CommerceAvailabilityEstimate[] findByGroupId_PrevAndNext(
		...
		return getPersistence().findByGroupId_PrevAndNext(
			commerceAvailabilityEstimateId, groupId, orderByComparator);
	}

...
/**
 * The persistence utility for the commerce region service. This utility wraps <code>com.liferay.commerce.service.persistence.impl.CommerceRegionPersistenceImpl</code> and provides direct access to the database for CRUD operations. This utility should only be used by the service layer, as it must operate within a transaction. Never access this utility in a JSP, controller, model, or other front-end class.
 *
 * <p>
...
public class CommerceRegionUtil {
	 ...
	 */
	public static Map<Serializable, CommerceRegion> fetchByPrimaryKeys(
	 ...
	 */
	public static CommerceRegion update(
		CommerceRegion commerceRegion, ServiceContext serviceContext) {
	 ...
	 */
	public static List<CommerceRegion> findByUuid(
	 ...
	 */
	public static CommerceRegion findByUuid_First(
	 ...
	 */
	public static CommerceRegion fetchByUuid_First(
		String uuid, OrderByComparator<CommerceRegion> orderByComparator) {
	 ...
	 * @throws NoSuchRegionException if a matching commerce region could not be found
	 */
	public static CommerceRegion findByUuid_Last(
			String uuid, OrderByComparator<CommerceRegion> orderByComparator)
		throws com.liferay.commerce.exception.NoSuchRegionException {
	 ...
	 */
	public static CommerceRegion fetchByUuid_Last(
		String uuid, OrderByComparator<CommerceRegion> orderByComparator) {
	...
	public static CommerceRegion[] findByUuid_PrevAndNext(
		...
		return getPersistence().findByUuid_PrevAndNext(
			commerceRegionId, uuid, orderByComparator);
	}
	 ...
	 * @return the matching commerce regions
	 */
	public static List<CommerceRegion> findByUuid_C(
	 ...
	 * @throws NoSuchRegionException if a matching commerce region could not be found
	 */
	public static CommerceRegion findByUuid_C_First(
			String uuid, long companyId,
			OrderByComparator<CommerceRegion> orderByComparator)
		throws com.liferay.commerce.exception.NoSuchRegionException {
	 ...
	 * @return the first matching commerce region, or <code>null</code> if a matching commerce region could not be found
	 */
	public static CommerceRegion fetchByUuid_C_First(
		String uuid, long companyId,
		OrderByComparator<CommerceRegion> orderByComparator) {
	 ...
	 * @throws NoSuchRegionException if a matching commerce region could not be found
	 */
	public static CommerceRegion findByUuid_C_Last(
			String uuid, long companyId,
			OrderByComparator<CommerceRegion> orderByComparator)
		throws com.liferay.commerce.exception.NoSuchRegionException {
	 ...
	 * @return the last matching commerce region, or <code>null</code> if a matching commerce region could not be found
	 */
	public static CommerceRegion fetchByUuid_C_Last(
		String uuid, long companyId,
		OrderByComparator<CommerceRegion> orderByComparator) {
	...
	public static CommerceRegion[] findByUuid_C_PrevAndNext(
		...
		return getPersistence().findByUuid_C_PrevAndNext(
			commerceRegionId, uuid, companyId, orderByComparator);
	}
	...
	public static CommerceRegion[] findByCommerceCountryId_PrevAndNext(
		...
		return getPersistence().findByCommerceCountryId_PrevAndNext(
			commerceRegionId, commerceCountryId, orderByComparator);
	}
	 ...
	 * @return the matching commerce region, or <code>null</code> if a matching commerce region could not be found
	 */
	public static CommerceRegion fetchByC_C(
	...
	public static CommerceRegion fetchByC_C(
		...
		return getPersistence().fetchByC_C(
			commerceCountryId, code, retrieveFromCache);
	}
	 ...
	 * @return the commerce region that was removed
	 */
	public static CommerceRegion removeByC_C(
			long commerceCountryId, String code)
		throws com.liferay.commerce.exception.NoSuchRegionException {
	 ...
	 * @return the matching commerce regions
	 */
	public static List<CommerceRegion> findByC_A(
	...
	public static List<CommerceRegion> findByC_A(
		...
		return getPersistence().findByC_A(
			commerceCountryId, active, start, end);
	}
	 ...
	 * @throws NoSuchRegionException if a matching commerce region could not be found
	 */
	public static CommerceRegion findByC_A_First(
			long commerceCountryId, boolean active,
			OrderByComparator<CommerceRegion> orderByComparator)
		throws com.liferay.commerce.exception.NoSuchRegionException {
	 ...
	 * @return the first matching commerce region, or <code>null</code> if a matching commerce region could not be found
	 */
	public static CommerceRegion fetchByC_A_First(
		long commerceCountryId, boolean active,
		OrderByComparator<CommerceRegion> orderByComparator) {
	 ...
	 * @throws NoSuchRegionException if a matching commerce region could not be found
	 */
	public static CommerceRegion findByC_A_Last(
			long commerceCountryId, boolean active,
			OrderByComparator<CommerceRegion> orderByComparator)
		throws com.liferay.commerce.exception.NoSuchRegionException {
	 ...
	 * @return the last matching commerce region, or <code>null</code> if a matching commerce region could not be found
	 */
	public static CommerceRegion fetchByC_A_Last(
		long commerceCountryId, boolean active,
		OrderByComparator<CommerceRegion> orderByComparator) {
	...
	public static CommerceRegion[] findByC_A_PrevAndNext(
		...
		return getPersistence().findByC_A_PrevAndNext(
			commerceRegionId, commerceCountryId, active, orderByComparator);
	}
	...
	private static ServiceTracker
		<CommerceRegionPersistence, CommerceRegionPersistence> _serviceTracker;

	static {
		Bundle bundle = FrameworkUtil.getBundle(
			CommerceRegionPersistence.class);

		ServiceTracker<CommerceRegionPersistence, CommerceRegionPersistence>
			serviceTracker =
				new ServiceTracker

 ...
 */
@Component(
	immediate = true, service = CommerceUserResourceOperationHelper.class
)
public class CommerceUserResourceOperationHelper {
	...
	public void deleteUser(
		...
		User user = _userHelper.getUser(
			commerceUserCPKERC, company.getCompanyId());
	...
	private static final Log _log = LogFactoryUtil.getLog(
		CommerceUserResourceOperationHelper.class);

...
public class ListViewModeProductListRendererFormNavigatorEntry
	extends BaseJSPFormNavigatorEntry<Void> {

	@Override
	public String getCategoryKey() {
		return CPSearchResultsConstants.
			CATEGORY_KEY_LIST_VIEW_MODE_RENDER_SELECTION;
	}
	...
	public String getKey() {
		return "list-view-mode-product-list-renderer";
	}
	...
	protected String getJspPath() {
		return "/search_results/configuration/list_view_mode" +
	...
	private static final Log _log = LogFactoryUtil.getLog(
		ListViewModeProductListRendererFormNavigatorEntry.class);

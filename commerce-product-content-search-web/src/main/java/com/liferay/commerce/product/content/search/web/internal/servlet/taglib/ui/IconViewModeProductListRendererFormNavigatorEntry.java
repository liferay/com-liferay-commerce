...
public class IconViewModeProductListRendererFormNavigatorEntry
	extends BaseJSPFormNavigatorEntry<Void> {

	@Override
	public String getCategoryKey() {
		return CPSearchResultsConstants.
			CATEGORY_KEY_ICON_VIEW_MODE_RENDER_SELECTION;
	}
	...
	public String getKey() {
		return "icon-view-mode-product-list-renderer";
	}
	...
	public String getLabel(Locale locale) {
		...
		return LanguageUtil.get(resourceBundle, "product-list-renderer");
	}
	...
	protected String getJspPath() {
		return "/search_results/configuration/icon_view_mode" +
			"/product_list_renderer.jsp";
	}
	...
	private boolean _isVisible() {
		...
		try {
			...
			return cpSearchResultsPortletInstanceConfiguration.enableViewMode();
		}
	...
	private static final Log _log = LogFactoryUtil.getLog(
		IconViewModeProductListRendererFormNavigatorEntry.class);

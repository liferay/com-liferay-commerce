 ...
 */
@Component(
	property = "form.navigator.category.order:Integer=200",
	service = FormNavigatorCategory.class
)
public class ViewModeFormNavigatorCategory implements FormNavigatorCategory {
	...
	public String getKey() {
		return CPSearchResultsConstants.CATEGORY_KEY_VIEW_MODE;
	}

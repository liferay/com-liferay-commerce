...
public class CPDefinitionChannelScreenNavigationEntry
	...
	public String getEntryKey() {
		return CPDefinitionScreenNavigationConstants.ENTRY_KEY_CHANNELS;
	}
	...
	public String getLabel(Locale locale) {
		...
		return LanguageUtil.get(
			resourceBundle,
			CPDefinitionScreenNavigationConstants.ENTRY_KEY_CHANNELS);
	}
	...
	public void render(
		...
		CPDefinitionChannelDisplayContext cpDefinitionChannelDisplayContext =
			new CPDefinitionChannelDisplayContext(
				...
				_cpDefinitionService, _itemSelector, _portletResourcePermission,
		...
		_jspRenderer.renderJSP(
			...
			"/edit_definition_channels.jsp");
	}

	private static final Log _log = LogFactoryUtil.getLog(
		CPDefinitionChannelScreenNavigationEntry.class);

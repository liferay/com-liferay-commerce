...
if (row != null) {
	cpAttachmentFileEntry = (CPAttachmentFileEntry)row.getObject();
}
else {
	cpAttachmentFileEntry = (CPAttachmentFileEntry)request.getAttribute("info_panel.jsp-entry");
}
%>
...
>
	...
	<portlet:actionURL name="editCPAttachmentFileEntry" var="deleteURL">

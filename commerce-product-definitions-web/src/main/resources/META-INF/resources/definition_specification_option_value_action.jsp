...
if (row != null) {
	cpDefinitionSpecificationOptionValue = (CPDefinitionSpecificationOptionValue)row.getObject();
}
else {
	cpDefinitionSpecificationOptionValue = (CPDefinitionSpecificationOptionValue)request.getAttribute("info_panel.jsp-entry");
}
%>
...
>
	<c:if test="<%= CommerceCatalogPermission.contains(permissionChecker, cpDefinitionSpecificationOptionValue.getCPDefinition(), ActionKeys.UPDATE) %>">
		...
		<portlet:actionURL name="editProductDefinitionSpecificationOptionValue" var="deleteURL">

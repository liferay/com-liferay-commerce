...
package com.liferay.commerce.initializer.breccia.internal.product.renderer;
...
@Component(
	immediate = true,
	property = {
		"commerce.product.content.renderer.key=" + BrecciaCPContentRenderer.KEY,
...
public class BrecciaCPContentRenderer implements CPContentRenderer {

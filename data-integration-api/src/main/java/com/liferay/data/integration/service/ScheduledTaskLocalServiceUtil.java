 ...
 * {@link com.liferay.data.integration.service.impl.ScheduledTaskLocalServiceImpl} and is the
...
public class ScheduledTaskLocalServiceUtil {
	 ...
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this class directly. Add custom service methods to {@link com.liferay.data.integration.service.impl.ScheduledTaskLocalServiceImpl} and rerun ServiceBuilder to regenerate this class.
	 */
	...
	*/
	public static com.liferay.data.integration.model.ScheduledTask addScheduledTask(
	...
	*/
	public static com.liferay.data.integration.model.ScheduledTask addScheduledTask(
		com.liferay.data.integration.model.ScheduledTask scheduledTask) {
	...
	*/
	public static com.liferay.data.integration.model.ScheduledTask createScheduledTask(
	...
	*/
	public static com.liferay.data.integration.model.ScheduledTask deleteScheduledTask(
		long scheduledTaskId)
		throws com.liferay.portal.kernel.exception.PortalException {
	...
	*/
	...
	public static com.liferay.data.integration.model.ScheduledTask disableScheduledTask(
	...
	*/
	...
	public static com.liferay.data.integration.model.ScheduledTask enableScheduledTask(
		long scheduledTaskId, long userId)
		throws com.liferay.portal.kernel.exception.PortalException {
		return getService().enableScheduledTask(scheduledTaskId, userId);
	}

	public static com.liferay.data.integration.model.ScheduledTask fetchScheduledTask(
		long scheduledTaskId) {
	...
	*/
	public static com.liferay.data.integration.model.ScheduledTask fetchScheduledTaskByUuidAndGroupId(
	...
	* @throws PortalException if a scheduled task with the primary key could not be found
	*/
	public static com.liferay.data.integration.model.ScheduledTask getScheduledTask(
		long scheduledTaskId)
		throws com.liferay.portal.kernel.exception.PortalException {
		return getService().getScheduledTask(scheduledTaskId);
	}

	public static java.util.List<com.liferay.data.integration.model.ScheduledTask> getScheduledTaskByGroupId(
	...
	*/
	public static com.liferay.data.integration.model.ScheduledTask getScheduledTaskByUuidAndGroupId(
		String uuid, long groupId)
		throws com.liferay.portal.kernel.exception.PortalException {
	...
	*/
	public static java.util.List<com.liferay.data.integration.model.ScheduledTask> getScheduledTasks(
		int start, int end) {
		return getService().getScheduledTasks(start, end);
	}

	public static java.util.List<com.liferay.data.integration.model.ScheduledTask> getScheduledTasksByActive(
		boolean active, int start, int end) {
		return getService().getScheduledTasksByActive(active, start, end);
	}

	public static java.util.List<com.liferay.data.integration.model.ScheduledTask> getScheduledTasksByEnabled(
		boolean enabled, int start, int end) {
		return getService().getScheduledTasksByEnabled(enabled, start, end);
	}

	public static java.util.List<com.liferay.data.integration.model.ScheduledTask> getScheduledTasksByGroupId_Active(
	...
	public static java.util.List<com.liferay.data.integration.model.ScheduledTask> getScheduledTasksByGroupId_Enabled(
	...
	*/
	public static java.util.List<com.liferay.data.integration.model.ScheduledTask> getScheduledTasksByUuidAndCompanyId(
	...
	*/
	public static java.util.List<com.liferay.data.integration.model.ScheduledTask> getScheduledTasksByUuidAndCompanyId(
		...
		com.liferay.portal.kernel.util.OrderByComparator<com.liferay.data.integration.model.ScheduledTask> orderByComparator) {
		return getService()
	...
	*/
	...
	public static com.liferay.data.integration.model.ScheduledTask startScheduledTask(
		long userId, long scheduledTaskId)
		throws com.liferay.portal.kernel.exception.PortalException {
		return getService().startScheduledTask(userId, scheduledTaskId);
	}

	public static com.liferay.data.integration.model.ScheduledTask stopScheduledTask(
		long userId, long scheduledTaskId)
		throws com.liferay.portal.kernel.exception.PortalException {
		return getService().stopScheduledTask(userId, scheduledTaskId);
	}

	public static com.liferay.data.integration.model.ScheduledTask updateScheduledTask(

...
public class CommerceAccountGroupRelServiceHttp {
	public static com.liferay.commerce.account.model.CommerceAccountGroupRel addCommerceAccountGroupRel(
		...
		try {
			MethodKey methodKey = new MethodKey(CommerceAccountGroupRelServiceUtil.class,
			...
			return (com.liferay.commerce.account.model.CommerceAccountGroupRel)returnObj;
		}
	...
	public static java.util.List<com.liferay.commerce.account.model.CommerceAccountGroupRel> getCommerceAccountGroupRels(
		HttpPrincipal httpPrincipal, long commerceAccountGroupId, int start,
		int end,
		...
		try {
			...
			return (java.util.List<com.liferay.commerce.account.model.CommerceAccountGroupRel>)returnObj;
		}
		catch (com.liferay.portal.kernel.exception.SystemException se) {
			_log.error(se, se);
	...
	private static Log _log = LogFactoryUtil.getLog(CommerceAccountGroupRelServiceHttp.class);
	private static final Class<?>[] _addCommerceAccountGroupRelParameterTypes0 = new Class[] {
			String.class, long.class, long.class,
			com.liferay.portal.kernel.service.ServiceContext.class
		};
	private static final Class<?>[] _deleteCommerceAccountGroupRelsParameterTypes1 =
		new Class[] { String.class, long.class };
	private static final Class<?>[] _getCommerceAccountGroupRelsParameterTypes2 = new Class[] {
			long.class, int.class, int.class,
			com.liferay.portal.kernel.util.OrderByComparator.class
		};
	private static final Class<?>[] _getCommerceAccountGroupRelsParameterTypes3 = new Class[] {
			String.class, long.class, int.class, int.class,
			com.liferay.portal.kernel.util.OrderByComparator.class
		};
	private static final Class<?>[] _getCommerceAccountGroupRelsCountParameterTypes4 =
		new Class[] { long.class };
	private static final Class<?>[] _getCommerceAccountGroupRelsCountParameterTypes5 =
		new Class[] { String.class, long.class };
}
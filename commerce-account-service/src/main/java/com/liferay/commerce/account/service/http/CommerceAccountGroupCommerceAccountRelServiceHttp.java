...
public class CommerceAccountGroupCommerceAccountRelServiceHttp {
	public static com.liferay.commerce.account.model.CommerceAccountGroupCommerceAccountRel addCommerceAccountGroupCommerceAccountRel(
		...
		try {
			MethodKey methodKey = new MethodKey(CommerceAccountGroupCommerceAccountRelServiceUtil.class,
			...
			return (com.liferay.commerce.account.model.CommerceAccountGroupCommerceAccountRel)returnObj;
		}
	...
	public static java.util.List<com.liferay.commerce.account.model.CommerceAccountGroupCommerceAccountRel> getCommerceAccountGroupCommerceAccountRels(
		...
		try {
			...
			return (java.util.List<com.liferay.commerce.account.model.CommerceAccountGroupCommerceAccountRel>)returnObj;
		}
		catch (com.liferay.portal.kernel.exception.SystemException se) {
			_log.error(se, se);
	...
	private static Log _log = LogFactoryUtil.getLog(CommerceAccountGroupCommerceAccountRelServiceHttp.class);
	private static final Class<?>[] _addCommerceAccountGroupCommerceAccountRelParameterTypes0 =
		new Class[] {
			long.class, long.class,
			com.liferay.portal.kernel.service.ServiceContext.class
		};
	private static final Class<?>[] _deleteCommerceAccountGroupCommerceAccountRelParameterTypes1 =
		new Class[] { long.class };
	private static final Class<?>[] _getCommerceAccountGroupCommerceAccountRelsParameterTypes2 =
		new Class[] { long.class, int.class, int.class };
	private static final Class<?>[] _getCommerceAccountGroupCommerceAccountRelsCountParameterTypes3 =
		new Class[] { long.class };
}
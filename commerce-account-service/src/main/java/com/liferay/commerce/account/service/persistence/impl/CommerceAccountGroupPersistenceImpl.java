 ...
 * @see com.liferay.commerce.account.service.persistence.CommerceAccountGroupUtil
 * @generated
 */
@ProviderType
public class CommerceAccountGroupPersistenceImpl extends BasePersistenceImpl<CommerceAccountGroup>
	implements CommerceAccountGroupPersistence {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link CommerceAccountGroupUtil} to access the commerce account group persistence. Modify <code>service.xml</code> and rerun ServiceBuilder to regenerate this class.
	 */
	public static final String FINDER_CLASS_NAME_ENTITY = CommerceAccountGroupImpl.class.getName();
	public static final String FINDER_CLASS_NAME_LIST_WITH_PAGINATION = FINDER_CLASS_NAME_ENTITY +
		".List1";
	public static final String FINDER_CLASS_NAME_LIST_WITHOUT_PAGINATION = FINDER_CLASS_NAME_ENTITY +
		".List2";
	public static final FinderPath FINDER_PATH_WITH_PAGINATION_FIND_ALL = new FinderPath(CommerceAccountGroupModelImpl.ENTITY_CACHE_ENABLED,
			CommerceAccountGroupModelImpl.FINDER_CACHE_ENABLED,
			CommerceAccountGroupImpl.class,
			FINDER_CLASS_NAME_LIST_WITH_PAGINATION, "findAll", new String[0]);
	public static final FinderPath FINDER_PATH_WITHOUT_PAGINATION_FIND_ALL = new FinderPath(CommerceAccountGroupModelImpl.ENTITY_CACHE_ENABLED,
			CommerceAccountGroupModelImpl.FINDER_CACHE_ENABLED,
			CommerceAccountGroupImpl.class,
			FINDER_CLASS_NAME_LIST_WITHOUT_PAGINATION, "findAll", new String[0]);
	public static final FinderPath FINDER_PATH_COUNT_ALL = new FinderPath(CommerceAccountGroupModelImpl.ENTITY_CACHE_ENABLED,
	...
	public static final FinderPath FINDER_PATH_WITHOUT_PAGINATION_FIND_BY_COMPANYID =
		new FinderPath(CommerceAccountGroupModelImpl.ENTITY_CACHE_ENABLED,
			...
			CommerceAccountGroupModelImpl.NAME_COLUMN_BITMASK);
	public static final FinderPath FINDER_PATH_COUNT_BY_COMPANYID = new FinderPath(CommerceAccountGroupModelImpl.ENTITY_CACHE_ENABLED,
			CommerceAccountGroupModelImpl.FINDER_CACHE_ENABLED, Long.class,
	...
	public CommerceAccountGroup findByCompanyId_First(long companyId,
		OrderByComparator<CommerceAccountGroup> orderByComparator)
		throws NoSuchAccountGroupException {
		CommerceAccountGroup commerceAccountGroup = fetchByCompanyId_First(companyId,
				orderByComparator);
	...
	public CommerceAccountGroup fetchByCompanyId_First(long companyId,
		OrderByComparator<CommerceAccountGroup> orderByComparator) {
		List<CommerceAccountGroup> list = findByCompanyId(companyId, 0, 1,
				orderByComparator);
	...
	public CommerceAccountGroup findByCompanyId_Last(long companyId,
		OrderByComparator<CommerceAccountGroup> orderByComparator)
		throws NoSuchAccountGroupException {
		CommerceAccountGroup commerceAccountGroup = fetchByCompanyId_Last(companyId,
				orderByComparator);
	...
	public CommerceAccountGroup fetchByCompanyId_Last(long companyId,
		...
		List<CommerceAccountGroup> list = findByCompanyId(companyId, count - 1,
	...
	public CommerceAccountGroup[] findByCompanyId_PrevAndNext(
		...
		OrderByComparator<CommerceAccountGroup> orderByComparator)
		throws NoSuchAccountGroupException {
		CommerceAccountGroup commerceAccountGroup = findByPrimaryKey(commerceAccountGroupId);
		...
		try {
			...
			array[0] = getByCompanyId_PrevAndNext(session,
					commerceAccountGroup, companyId, orderByComparator, true);

			array[1] = commerceAccountGroup;

			array[2] = getByCompanyId_PrevAndNext(session,
					commerceAccountGroup, companyId, orderByComparator, false);
	...
	protected CommerceAccountGroup getByCompanyId_PrevAndNext(Session session,
		CommerceAccountGroup commerceAccountGroup, long companyId,
		OrderByComparator<CommerceAccountGroup> orderByComparator,
		boolean previous) {
		StringBundler query = null;
		...
		if (orderByComparator != null) {
			Object[] values = orderByComparator.getOrderByConditionValues(commerceAccountGroup);
	...
	public CommerceAccountGroup[] filterFindByCompanyId_PrevAndNext(
		...
		throws NoSuchAccountGroupException {
		if (!InlineSQLHelperUtil.isEnabled(companyId, 0)) {
			return findByCompanyId_PrevAndNext(commerceAccountGroupId,
	...
	public void removeByCompanyId(long companyId) {
		for (CommerceAccountGroup commerceAccountGroup : findByCompanyId(
	...
	public static final FinderPath FINDER_PATH_WITH_PAGINATION_FIND_BY_C_T = new FinderPath(CommerceAccountGroupModelImpl.ENTITY_CACHE_ENABLED,
			CommerceAccountGroupModelImpl.FINDER_CACHE_ENABLED,
			CommerceAccountGroupImpl.class,
	...
	public static final FinderPath FINDER_PATH_WITHOUT_PAGINATION_FIND_BY_C_T = new FinderPath(CommerceAccountGroupModelImpl.ENTITY_CACHE_ENABLED,
			CommerceAccountGroupModelImpl.FINDER_CACHE_ENABLED,
			CommerceAccountGroupImpl.class,
			...
			CommerceAccountGroupModelImpl.NAME_COLUMN_BITMASK);
	public static final FinderPath FINDER_PATH_COUNT_BY_C_T = new FinderPath(CommerceAccountGroupModelImpl.ENTITY_CACHE_ENABLED,
			CommerceAccountGroupModelImpl.FINDER_CACHE_ENABLED, Long.class,
	 ...
	 */
	@Override
	public CommerceAccountGroup findByC_T_First(long companyId, int type,
		OrderByComparator<CommerceAccountGroup> orderByComparator)
		throws NoSuchAccountGroupException {
		CommerceAccountGroup commerceAccountGroup = fetchByC_T_First(companyId,
	 ...
	 */
	@Override
	public CommerceAccountGroup fetchByC_T_First(long companyId, int type,
		OrderByComparator<CommerceAccountGroup> orderByComparator) {
		List<CommerceAccountGroup> list = findByC_T(companyId, type, 0, 1,
				orderByComparator);
	 ...
	 */
	@Override
	public CommerceAccountGroup findByC_T_Last(long companyId, int type,
		OrderByComparator<CommerceAccountGroup> orderByComparator)
		throws NoSuchAccountGroupException {
		CommerceAccountGroup commerceAccountGroup = fetchByC_T_Last(companyId,
				type, orderByComparator);
	 ...
	 */
	@Override
	public CommerceAccountGroup fetchByC_T_Last(long companyId, int type,
		OrderByComparator<CommerceAccountGroup> orderByComparator) {
		...
		List<CommerceAccountGroup> list = findByC_T(companyId, type, count - 1,
				count, orderByComparator);
	...
	public CommerceAccountGroup[] findByC_T_PrevAndNext(
		...
		try {
			...
			array[0] = getByC_T_PrevAndNext(session, commerceAccountGroup,
					companyId, type, orderByComparator, true);

			array[1] = commerceAccountGroup;

			array[2] = getByC_T_PrevAndNext(session, commerceAccountGroup,
	...
	protected CommerceAccountGroup getByC_T_PrevAndNext(Session session,
		CommerceAccountGroup commerceAccountGroup, long companyId, int type,
		OrderByComparator<CommerceAccountGroup> orderByComparator,
		boolean previous) {
		StringBundler query = null;
	 ...
	 */
	@Override
	public List<CommerceAccountGroup> filterFindByC_T(long companyId, int type) {
	...
	public CommerceAccountGroup[] filterFindByC_T_PrevAndNext(
		...
		throws NoSuchAccountGroupException {
		if (!InlineSQLHelperUtil.isEnabled(companyId, 0)) {
			return findByC_T_PrevAndNext(commerceAccountGroupId, companyId,
				type, orderByComparator);
		}
		...
		try {
			...
			array[0] = filterGetByC_T_PrevAndNext(session,
					commerceAccountGroup, companyId, type, orderByComparator,
					true);

			array[1] = commerceAccountGroup;

			array[2] = filterGetByC_T_PrevAndNext(session,
					commerceAccountGroup, companyId, type, orderByComparator,
					false);
	...
	protected CommerceAccountGroup filterGetByC_T_PrevAndNext(Session session,
		CommerceAccountGroup commerceAccountGroup, long companyId, int type,
		OrderByComparator<CommerceAccountGroup> orderByComparator,
		boolean previous) {
		StringBundler query = null;
	...
	public void removeByC_T(long companyId, int type) {
		for (CommerceAccountGroup commerceAccountGroup : findByC_T(companyId,
	...
	private static final String _FINDER_COLUMN_C_T_COMPANYID_2 = "commerceAccountGroup.companyId = ? AND ";
	private static final String _FINDER_COLUMN_C_T_TYPE_2 = "commerceAccountGroup.type = ?";
	private static final String _FINDER_COLUMN_C_T_TYPE_2_SQL = "commerceAccountGroup.type_ = ?";
	...
	public static final FinderPath FINDER_PATH_COUNT_BY_C_ERC = new FinderPath(CommerceAccountGroupModelImpl.ENTITY_CACHE_ENABLED,
			CommerceAccountGroupModelImpl.FINDER_CACHE_ENABLED, Long.class,
	...
	public CommerceAccountGroup findByC_ERC(long companyId,
		...
		CommerceAccountGroup commerceAccountGroup = fetchByC_ERC(companyId,
	...
	public CommerceAccountGroup fetchByC_ERC(long companyId,
		...
		if (result instanceof CommerceAccountGroup) {
			CommerceAccountGroup commerceAccountGroup = (CommerceAccountGroup)result;
	...
	public CommerceAccountGroup removeByC_ERC(long companyId,
		String externalReferenceCode) throws NoSuchAccountGroupException {
		CommerceAccountGroup commerceAccountGroup = findByC_ERC(companyId,
				externalReferenceCode);
	...
	private static final String _FINDER_COLUMN_C_ERC_COMPANYID_2 = "commerceAccountGroup.companyId = ? AND ";
	private static final String _FINDER_COLUMN_C_ERC_EXTERNALREFERENCECODE_1 = "commerceAccountGroup.externalReferenceCode IS NULL";
	private static final String _FINDER_COLUMN_C_ERC_EXTERNALREFERENCECODE_2 = "commerceAccountGroup.externalReferenceCode = ?";
	private static final String _FINDER_COLUMN_C_ERC_EXTERNALREFERENCECODE_3 = "(commerceAccountGroup.externalReferenceCode IS NULL OR commerceAccountGroup.externalReferenceCode = '')";
	...
	public void cacheResult(CommerceAccountGroup commerceAccountGroup) {
		entityCache.putResult(CommerceAccountGroupModelImpl.ENTITY_CACHE_ENABLED,
			CommerceAccountGroupImpl.class,
	...
	public void clearCache(CommerceAccountGroup commerceAccountGroup) {
		entityCache.removeResult(CommerceAccountGroupModelImpl.ENTITY_CACHE_ENABLED,
			CommerceAccountGroupImpl.class, commerceAccountGroup.getPrimaryKey());

		finderCache.clearCache(FINDER_CLASS_NAME_LIST_WITH_PAGINATION);
		finderCache.clearCache(FINDER_CLASS_NAME_LIST_WITHOUT_PAGINATION);

		clearUniqueFindersCache((CommerceAccountGroupModelImpl)commerceAccountGroup,
			true);
	}
	...
	protected void cacheUniqueFindersCache(
		...
		finderCache.putResult(FINDER_PATH_FETCH_BY_C_ERC, args,
			commerceAccountGroupModelImpl, false);
	}
	...
	public CommerceAccountGroup create(long commerceAccountGroupId) {
		CommerceAccountGroup commerceAccountGroup = new CommerceAccountGroupImpl();

		commerceAccountGroup.setNew(true);
		commerceAccountGroup.setPrimaryKey(commerceAccountGroupId);

		commerceAccountGroup.setCompanyId(companyProvider.getCompanyId());
	...
	public CommerceAccountGroup remove(Serializable primaryKey)
		...
		try {
			...
			CommerceAccountGroup commerceAccountGroup = (CommerceAccountGroup)session.get(CommerceAccountGroupImpl.class,
					primaryKey);
			...
			if (commerceAccountGroup == null) {
				...
				throw new NoSuchAccountGroupException(_NO_SUCH_ENTITY_WITH_PRIMARY_KEY +
					primaryKey);
			}
	...
	protected CommerceAccountGroup removeImpl(
		...
		try {
			...
			if (!session.contains(commerceAccountGroup)) {
				commerceAccountGroup = (CommerceAccountGroup)session.get(CommerceAccountGroupImpl.class,
	...
	public CommerceAccountGroup updateImpl(
		...
		if (!(commerceAccountGroup instanceof CommerceAccountGroupModelImpl)) {
			...
			if (ProxyUtil.isProxyClass(commerceAccountGroup.getClass())) {
				invocationHandler = ProxyUtil.getInvocationHandler(commerceAccountGroup);
		...
		CommerceAccountGroupModelImpl commerceAccountGroupModelImpl = (CommerceAccountGroupModelImpl)commerceAccountGroup;
		...
		if (isNew && (commerceAccountGroup.getCreateDate() == null)) {
			if (serviceContext == null) {
				...
				commerceAccountGroup.setCreateDate(serviceContext.getCreateDate(
						now));
			}
		}
		...
		if (!commerceAccountGroupModelImpl.hasSetModifiedDate()) {
			if (serviceContext == null) {
				...
				commerceAccountGroup.setModifiedDate(serviceContext.getModifiedDate(
						now));
			}
		}
		...
		try {
			...
			if (commerceAccountGroup.isNew()) {
				...
				commerceAccountGroup = (CommerceAccountGroup)session.merge(commerceAccountGroup);
			}
		}
		catch (Exception e) {
			throw processException(e);
	...
	/**
	 * Returns the commerce account group with the primary key or throws a {@link com.liferay.portal.kernel.exception.NoSuchModelException} if it could not be found.
	 *
	 * @param primaryKey the primary key of the commerce account group
	...
	public CommerceAccountGroup findByPrimaryKey(Serializable primaryKey)
		throws NoSuchAccountGroupException {
		CommerceAccountGroup commerceAccountGroup = fetchByPrimaryKey(primaryKey);
	...
	public CommerceAccountGroup fetchByPrimaryKey(Serializable primaryKey) {
		Serializable serializable = entityCache.getResult(CommerceAccountGroupModelImpl.ENTITY_CACHE_ENABLED,
		...
		CommerceAccountGroup commerceAccountGroup = (CommerceAccountGroup)serializable;
	...
	public Map<Serializable, CommerceAccountGroup> fetchByPrimaryKeys(
		...
		Map<Serializable, CommerceAccountGroup> map = new HashMap<Serializable, CommerceAccountGroup>();
		...
		try {
			...
			for (CommerceAccountGroup commerceAccountGroup : (List<CommerceAccountGroup>)q.list()) {
				map.put(commerceAccountGroup.getPrimaryKeyObj(),
					commerceAccountGroup);

				cacheResult(commerceAccountGroup);

				uncachedPrimaryKeys.remove(commerceAccountGroup.getPrimaryKeyObj());
			}
	...
	private static final String _SQL_SELECT_COMMERCEACCOUNTGROUP = "SELECT commerceAccountGroup FROM CommerceAccountGroup commerceAccountGroup";
	private static final String _SQL_SELECT_COMMERCEACCOUNTGROUP_WHERE_PKS_IN = "SELECT commerceAccountGroup FROM CommerceAccountGroup commerceAccountGroup WHERE commerceAccountGroupId IN (";
	private static final String _SQL_SELECT_COMMERCEACCOUNTGROUP_WHERE = "SELECT commerceAccountGroup FROM CommerceAccountGroup commerceAccountGroup WHERE ";
	private static final String _SQL_COUNT_COMMERCEACCOUNTGROUP = "SELECT COUNT(commerceAccountGroup) FROM CommerceAccountGroup commerceAccountGroup";
	private static final String _SQL_COUNT_COMMERCEACCOUNTGROUP_WHERE = "SELECT COUNT(commerceAccountGroup) FROM CommerceAccountGroup commerceAccountGroup WHERE ";
	private static final String _FILTER_ENTITY_TABLE_FILTER_PK_COLUMN = "commerceAccountGroup.commerceAccountGroupId";
	private static final String _FILTER_SQL_SELECT_COMMERCEACCOUNTGROUP_WHERE = "SELECT DISTINCT {commerceAccountGroup.*} FROM CommerceAccountGroup commerceAccountGroup WHERE ";
	private static final String _FILTER_SQL_SELECT_COMMERCEACCOUNTGROUP_NO_INLINE_DISTINCT_WHERE_1 =
	...
	private static final String _FILTER_SQL_SELECT_COMMERCEACCOUNTGROUP_NO_INLINE_DISTINCT_WHERE_2 =
	...
	private static final String _FILTER_SQL_COUNT_COMMERCEACCOUNTGROUP_WHERE = "SELECT COUNT(DISTINCT commerceAccountGroup.commerceAccountGroupId) AS COUNT_VALUE FROM CommerceAccountGroup commerceAccountGroup WHERE ";
	...
	private static final String _ORDER_BY_ENTITY_ALIAS = "commerceAccountGroup.";
	private static final String _ORDER_BY_ENTITY_TABLE = "CommerceAccountGroup.";
	private static final String _NO_SUCH_ENTITY_WITH_PRIMARY_KEY = "No CommerceAccountGroup exists with the primary key ";
	private static final String _NO_SUCH_ENTITY_WITH_KEY = "No CommerceAccountGroup exists with the key {";
	private static final Log _log = LogFactoryUtil.getLog(CommerceAccountGroupPersistenceImpl.class);

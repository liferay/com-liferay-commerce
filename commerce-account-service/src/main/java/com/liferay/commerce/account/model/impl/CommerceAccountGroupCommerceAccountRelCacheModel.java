...
public class CommerceAccountGroupCommerceAccountRelCacheModel
	...
	public boolean equals(Object obj) {
		...
		if (!(obj instanceof CommerceAccountGroupCommerceAccountRelCacheModel)) {
			return false;
		}
		...
		if (commerceAccountGroupCommerceAccountRelId == commerceAccountGroupCommerceAccountRelCacheModel.commerceAccountGroupCommerceAccountRelId) {
			return true;
		}
	...
	public CommerceAccountGroupCommerceAccountRel toEntityModel() {
		...
		if (externalReferenceCode == null) {
			...
			commerceAccountGroupCommerceAccountRelImpl.setExternalReferenceCode(externalReferenceCode);
		}

		commerceAccountGroupCommerceAccountRelImpl.setCommerceAccountGroupCommerceAccountRelId(commerceAccountGroupCommerceAccountRelId);
		...
		if (createDate == Long.MIN_VALUE) {
			...
			commerceAccountGroupCommerceAccountRelImpl.setCreateDate(new Date(
					createDate));
		}
		...
		if (modifiedDate == Long.MIN_VALUE) {
			...
			commerceAccountGroupCommerceAccountRelImpl.setModifiedDate(new Date(
					modifiedDate));
		}

		commerceAccountGroupCommerceAccountRelImpl.setCommerceAccountGroupId(commerceAccountGroupId);
		commerceAccountGroupCommerceAccountRelImpl.setCommerceAccountId(commerceAccountId);

 ...
 */
@ProviderType
public class CommerceAccountGroupCacheModel implements CacheModel<CommerceAccountGroup>,
	Externalizable {
	@Override
	public boolean equals(Object obj) {
		...
		CommerceAccountGroupCacheModel commerceAccountGroupCacheModel = (CommerceAccountGroupCacheModel)obj;

		if (commerceAccountGroupId == commerceAccountGroupCacheModel.commerceAccountGroupId) {
			return true;
		}
	...
	public CommerceAccountGroup toEntityModel() {
		...
		if (externalReferenceCode == null) {
			...
			commerceAccountGroupImpl.setExternalReferenceCode(externalReferenceCode);
		}

		commerceAccountGroupImpl.setCommerceAccountGroupId(commerceAccountGroupId);

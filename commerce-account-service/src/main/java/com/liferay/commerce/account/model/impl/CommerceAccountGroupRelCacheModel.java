 ...
 */
@ProviderType
public class CommerceAccountGroupRelCacheModel implements CacheModel<CommerceAccountGroupRel>,
	Externalizable {
	@Override
	public boolean equals(Object obj) {
		...
		CommerceAccountGroupRelCacheModel commerceAccountGroupRelCacheModel = (CommerceAccountGroupRelCacheModel)obj;

		if (commerceAccountGroupRelId == commerceAccountGroupRelCacheModel.commerceAccountGroupRelId) {
			return true;
		}
	...
	public CommerceAccountGroupRel toEntityModel() {
		...
		commerceAccountGroupRelImpl.setCommerceAccountGroupRelId(commerceAccountGroupRelId);
		...
		commerceAccountGroupRelImpl.setCommerceAccountGroupId(commerceAccountGroupId);

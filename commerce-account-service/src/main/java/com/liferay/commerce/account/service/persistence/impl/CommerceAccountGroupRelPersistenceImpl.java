 ...
 * @see com.liferay.commerce.account.service.persistence.CommerceAccountGroupRelUtil
 * @generated
 */
@ProviderType
public class CommerceAccountGroupRelPersistenceImpl extends BasePersistenceImpl<CommerceAccountGroupRel>
	implements CommerceAccountGroupRelPersistence {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link CommerceAccountGroupRelUtil} to access the commerce account group rel persistence. Modify <code>service.xml</code> and rerun ServiceBuilder to regenerate this class.
	 */
	public static final String FINDER_CLASS_NAME_ENTITY = CommerceAccountGroupRelImpl.class.getName();
	public static final String FINDER_CLASS_NAME_LIST_WITH_PAGINATION = FINDER_CLASS_NAME_ENTITY +
		".List1";
	public static final String FINDER_CLASS_NAME_LIST_WITHOUT_PAGINATION = FINDER_CLASS_NAME_ENTITY +
		".List2";
	public static final FinderPath FINDER_PATH_WITH_PAGINATION_FIND_ALL = new FinderPath(CommerceAccountGroupRelModelImpl.ENTITY_CACHE_ENABLED,
			CommerceAccountGroupRelModelImpl.FINDER_CACHE_ENABLED,
			CommerceAccountGroupRelImpl.class,
			FINDER_CLASS_NAME_LIST_WITH_PAGINATION, "findAll", new String[0]);
	public static final FinderPath FINDER_PATH_WITHOUT_PAGINATION_FIND_ALL = new FinderPath(CommerceAccountGroupRelModelImpl.ENTITY_CACHE_ENABLED,
			CommerceAccountGroupRelModelImpl.FINDER_CACHE_ENABLED,
			CommerceAccountGroupRelImpl.class,
			FINDER_CLASS_NAME_LIST_WITHOUT_PAGINATION, "findAll", new String[0]);
	public static final FinderPath FINDER_PATH_COUNT_ALL = new FinderPath(CommerceAccountGroupRelModelImpl.ENTITY_CACHE_ENABLED,
	...
	public static final FinderPath FINDER_PATH_WITH_PAGINATION_FIND_BY_COMMERCEACCOUNTGROUPID =
		new FinderPath(CommerceAccountGroupRelModelImpl.ENTITY_CACHE_ENABLED,
			CommerceAccountGroupRelModelImpl.FINDER_CACHE_ENABLED,
			CommerceAccountGroupRelImpl.class,
	...
	public static final FinderPath FINDER_PATH_WITHOUT_PAGINATION_FIND_BY_COMMERCEACCOUNTGROUPID =
		new FinderPath(CommerceAccountGroupRelModelImpl.ENTITY_CACHE_ENABLED,
			...
			CommerceAccountGroupRelModelImpl.COMMERCEACCOUNTGROUPID_COLUMN_BITMASK |
			CommerceAccountGroupRelModelImpl.CREATEDATE_COLUMN_BITMASK);
	public static final FinderPath FINDER_PATH_COUNT_BY_COMMERCEACCOUNTGROUPID = new FinderPath(CommerceAccountGroupRelModelImpl.ENTITY_CACHE_ENABLED,
			CommerceAccountGroupRelModelImpl.FINDER_CACHE_ENABLED, Long.class,
			FINDER_CLASS_NAME_LIST_WITHOUT_PAGINATION,
	...
	public List<CommerceAccountGroupRel> findByCommerceAccountGroupId(
		...
		if (retrieveFromCache) {
			list = (List<CommerceAccountGroupRel>)finderCache.getResult(finderPath,
					finderArgs, this);

			if ((list != null) && !list.isEmpty()) {
				for (CommerceAccountGroupRel commerceAccountGroupRel : list) {
					if ((commerceAccountGroupId != commerceAccountGroupRel.getCommerceAccountGroupId())) {
						list = null;
		...
		if (list == null) {
			...
			try {
				...
				if (!pagination) {
					list = (List<CommerceAccountGroupRel>)QueryUtil.list(q,
	...
	public CommerceAccountGroupRel findByCommerceAccountGroupId_First(
		...
		CommerceAccountGroupRel commerceAccountGroupRel = fetchByCommerceAccountGroupId_First(commerceAccountGroupId,
				orderByComparator);
	...
	public CommerceAccountGroupRel fetchByCommerceAccountGroupId_First(
		long commerceAccountGroupId,
		OrderByComparator<CommerceAccountGroupRel> orderByComparator) {
		List<CommerceAccountGroupRel> list = findByCommerceAccountGroupId(commerceAccountGroupId,
	...
	public CommerceAccountGroupRel findByCommerceAccountGroupId_Last(
		...
		OrderByComparator<CommerceAccountGroupRel> orderByComparator)
		throws NoSuchAccountGroupRelException {
		CommerceAccountGroupRel commerceAccountGroupRel = fetchByCommerceAccountGroupId_Last(commerceAccountGroupId,
				orderByComparator);
	...
	public CommerceAccountGroupRel[] findByCommerceAccountGroupId_PrevAndNext(
		...
		OrderByComparator<CommerceAccountGroupRel> orderByComparator)
		throws NoSuchAccountGroupRelException {
		CommerceAccountGroupRel commerceAccountGroupRel = findByPrimaryKey(commerceAccountGroupRelId);
		...
		try {
			...
			CommerceAccountGroupRel[] array = new CommerceAccountGroupRelImpl[3];
	...
	protected CommerceAccountGroupRel getByCommerceAccountGroupId_PrevAndNext(
		...
		if (orderByComparator != null) {
			Object[] values = orderByComparator.getOrderByConditionValues(commerceAccountGroupRel);
	...
	public void removeByCommerceAccountGroupId(long commerceAccountGroupId) {
		for (CommerceAccountGroupRel commerceAccountGroupRel : findByCommerceAccountGroupId(
	...
	private static final String _FINDER_COLUMN_COMMERCEACCOUNTGROUPID_COMMERCEACCOUNTGROUPID_2 =
		"commerceAccountGroupRel.commerceAccountGroupId = ?";
	public static final FinderPath FINDER_PATH_WITH_PAGINATION_FIND_BY_C_C = new FinderPath(CommerceAccountGroupRelModelImpl.ENTITY_CACHE_ENABLED,
			CommerceAccountGroupRelModelImpl.FINDER_CACHE_ENABLED,
			CommerceAccountGroupRelImpl.class,
	...
	public static final FinderPath FINDER_PATH_WITHOUT_PAGINATION_FIND_BY_C_C = new FinderPath(CommerceAccountGroupRelModelImpl.ENTITY_CACHE_ENABLED,
			CommerceAccountGroupRelModelImpl.FINDER_CACHE_ENABLED,
			CommerceAccountGroupRelImpl.class,
			...
			CommerceAccountGroupRelModelImpl.CREATEDATE_COLUMN_BITMASK);
	public static final FinderPath FINDER_PATH_COUNT_BY_C_C = new FinderPath(CommerceAccountGroupRelModelImpl.ENTITY_CACHE_ENABLED,
			CommerceAccountGroupRelModelImpl.FINDER_CACHE_ENABLED, Long.class,
	 ...
	 */
	@Override
	public List<CommerceAccountGroupRel> findByC_C(long classNameId,
		long classPK) {
	 ...
	 */
	@Override
	public CommerceAccountGroupRel findByC_C_First(long classNameId,
		long classPK,
		OrderByComparator<CommerceAccountGroupRel> orderByComparator)
		throws NoSuchAccountGroupRelException {
		CommerceAccountGroupRel commerceAccountGroupRel = fetchByC_C_First(classNameId,
	 ...
	 */
	@Override
	public CommerceAccountGroupRel fetchByC_C_First(long classNameId,
		long classPK,
		OrderByComparator<CommerceAccountGroupRel> orderByComparator) {
		List<CommerceAccountGroupRel> list = findByC_C(classNameId, classPK, 0,
				1, orderByComparator);
	 ...
	 */
	@Override
	public CommerceAccountGroupRel findByC_C_Last(long classNameId,
		long classPK,
		OrderByComparator<CommerceAccountGroupRel> orderByComparator)
		throws NoSuchAccountGroupRelException {
		CommerceAccountGroupRel commerceAccountGroupRel = fetchByC_C_Last(classNameId,
				classPK, orderByComparator);
	 ...
	 */
	@Override
	public CommerceAccountGroupRel fetchByC_C_Last(long classNameId,
		long classPK,
		OrderByComparator<CommerceAccountGroupRel> orderByComparator) {
		...
		List<CommerceAccountGroupRel> list = findByC_C(classNameId, classPK,
				count - 1, count, orderByComparator);
	...
	public CommerceAccountGroupRel[] findByC_C_PrevAndNext(
		...
		try {
			...
			array[0] = getByC_C_PrevAndNext(session, commerceAccountGroupRel,
					classNameId, classPK, orderByComparator, true);

			array[1] = commerceAccountGroupRel;

			array[2] = getByC_C_PrevAndNext(session, commerceAccountGroupRel,
	...
	protected CommerceAccountGroupRel getByC_C_PrevAndNext(Session session,
		CommerceAccountGroupRel commerceAccountGroupRel, long classNameId,
		long classPK,
		OrderByComparator<CommerceAccountGroupRel> orderByComparator,
		boolean previous) {
		StringBundler query = null;
	...
	public void removeByC_C(long classNameId, long classPK) {
		for (CommerceAccountGroupRel commerceAccountGroupRel : findByC_C(
	...
	private static final String _FINDER_COLUMN_C_C_CLASSNAMEID_2 = "commerceAccountGroupRel.classNameId = ? AND ";
	private static final String _FINDER_COLUMN_C_C_CLASSPK_2 = "commerceAccountGroupRel.classPK = ?";
	public static final FinderPath FINDER_PATH_FETCH_BY_C_C_C = new FinderPath(CommerceAccountGroupRelModelImpl.ENTITY_CACHE_ENABLED,
			CommerceAccountGroupRelModelImpl.FINDER_CACHE_ENABLED,
			...
			CommerceAccountGroupRelModelImpl.CLASSPK_COLUMN_BITMASK |
			CommerceAccountGroupRelModelImpl.COMMERCEACCOUNTGROUPID_COLUMN_BITMASK);
	public static final FinderPath FINDER_PATH_COUNT_BY_C_C_C = new FinderPath(CommerceAccountGroupRelModelImpl.ENTITY_CACHE_ENABLED,
			CommerceAccountGroupRelModelImpl.FINDER_CACHE_ENABLED, Long.class,
	...
	/**
	 * Returns the commerce account group rel where classNameId = &#63; and classPK = &#63; and commerceAccountGroupId = &#63; or throws a {@link NoSuchAccountGroupRelException} if it could not be found.
	 *
	 * @param classNameId the class name ID
	 * @param classPK the class pk
	 * @param commerceAccountGroupId the commerce account group ID
	 ...
	 */
	@Override
	public CommerceAccountGroupRel findByC_C_C(long classNameId, long classPK,
		long commerceAccountGroupId) throws NoSuchAccountGroupRelException {
		CommerceAccountGroupRel commerceAccountGroupRel = fetchByC_C_C(classNameId,
	 ...
	 */
	@Override
	public CommerceAccountGroupRel fetchByC_C_C(long classNameId, long classPK,
		long commerceAccountGroupId) {
	...
	@Override
	public CommerceAccountGroupRel fetchByC_C_C(long classNameId, long classPK,
		long commerceAccountGroupId, boolean retrieveFromCache) {
		...
		if (result instanceof CommerceAccountGroupRel) {
			CommerceAccountGroupRel commerceAccountGroupRel = (CommerceAccountGroupRel)result;

			if ((classNameId != commerceAccountGroupRel.getClassNameId()) ||
					(classPK != commerceAccountGroupRel.getClassPK()) ||
					(commerceAccountGroupId != commerceAccountGroupRel.getCommerceAccountGroupId())) {
				result = null;
			}
		}
		...
		if (result == null) {
			...
			try {
				...
				if (list.isEmpty()) {
					...
					CommerceAccountGroupRel commerceAccountGroupRel = list.get(0);
	 ...
	 */
	@Override
	public CommerceAccountGroupRel removeByC_C_C(long classNameId,
		long classPK, long commerceAccountGroupId)
		throws NoSuchAccountGroupRelException {
		CommerceAccountGroupRel commerceAccountGroupRel = findByC_C_C(classNameId,
				classPK, commerceAccountGroupId);
	...
	private static final String _FINDER_COLUMN_C_C_C_CLASSNAMEID_2 = "commerceAccountGroupRel.classNameId = ? AND ";
	private static final String _FINDER_COLUMN_C_C_C_CLASSPK_2 = "commerceAccountGroupRel.classPK = ? AND ";
	private static final String _FINDER_COLUMN_C_C_C_COMMERCEACCOUNTGROUPID_2 = "commerceAccountGroupRel.commerceAccountGroupId = ?";
	...
	public void cacheResult(CommerceAccountGroupRel commerceAccountGroupRel) {
		entityCache.putResult(CommerceAccountGroupRelModelImpl.ENTITY_CACHE_ENABLED,
			CommerceAccountGroupRelImpl.class,
	...
	public void clearCache(CommerceAccountGroupRel commerceAccountGroupRel) {
		entityCache.removeResult(CommerceAccountGroupRelModelImpl.ENTITY_CACHE_ENABLED,
			CommerceAccountGroupRelImpl.class,
		...
		clearUniqueFindersCache((CommerceAccountGroupRelModelImpl)commerceAccountGroupRel,
			true);
	}
	...
	protected void cacheUniqueFindersCache(
		...
		finderCache.putResult(FINDER_PATH_FETCH_BY_C_C_C, args,
			commerceAccountGroupRelModelImpl, false);
	}
	...
	protected void clearUniqueFindersCache(
		...
		if ((commerceAccountGroupRelModelImpl.getColumnBitmask() &
			...
			Object[] args = new Object[] {
					...
					commerceAccountGroupRelModelImpl.getOriginalCommerceAccountGroupId()
				};
	...
	public CommerceAccountGroupRel create(long commerceAccountGroupRelId) {
		CommerceAccountGroupRel commerceAccountGroupRel = new CommerceAccountGroupRelImpl();

		commerceAccountGroupRel.setNew(true);
		commerceAccountGroupRel.setPrimaryKey(commerceAccountGroupRelId);

		commerceAccountGroupRel.setCompanyId(companyProvider.getCompanyId());
	...
	public CommerceAccountGroupRel remove(Serializable primaryKey)
		...
		try {
			...
			CommerceAccountGroupRel commerceAccountGroupRel = (CommerceAccountGroupRel)session.get(CommerceAccountGroupRelImpl.class,
					primaryKey);
			...
			if (commerceAccountGroupRel == null) {
				...
				throw new NoSuchAccountGroupRelException(_NO_SUCH_ENTITY_WITH_PRIMARY_KEY +
					primaryKey);
			}
	...
	protected CommerceAccountGroupRel removeImpl(
		...
		try {
			...
			if (!session.contains(commerceAccountGroupRel)) {
				commerceAccountGroupRel = (CommerceAccountGroupRel)session.get(CommerceAccountGroupRelImpl.class,
	...
	public CommerceAccountGroupRel updateImpl(
		...
		if (!(commerceAccountGroupRel instanceof CommerceAccountGroupRelModelImpl)) {
			InvocationHandler invocationHandler = null;

			if (ProxyUtil.isProxyClass(commerceAccountGroupRel.getClass())) {
				invocationHandler = ProxyUtil.getInvocationHandler(commerceAccountGroupRel);
		...
		CommerceAccountGroupRelModelImpl commerceAccountGroupRelModelImpl = (CommerceAccountGroupRelModelImpl)commerceAccountGroupRel;
		...
		if (isNew && (commerceAccountGroupRel.getCreateDate() == null)) {
			if (serviceContext == null) {
				...
				commerceAccountGroupRel.setCreateDate(serviceContext.getCreateDate(
						now));
			}
		}
		...
		if (!commerceAccountGroupRelModelImpl.hasSetModifiedDate()) {
			if (serviceContext == null) {
				...
				commerceAccountGroupRel.setModifiedDate(serviceContext.getModifiedDate(
						now));
			}
		}
		...
		try {
			...
			if (commerceAccountGroupRel.isNew()) {
				...
				commerceAccountGroupRel = (CommerceAccountGroupRel)session.merge(commerceAccountGroupRel);
			}
		}
		catch (Exception e) {
			throw processException(e);
	...
	/**
	 * Returns the commerce account group rel with the primary key or throws a {@link com.liferay.portal.kernel.exception.NoSuchModelException} if it could not be found.
	 *
	 * @param primaryKey the primary key of the commerce account group rel
	...
	public CommerceAccountGroupRel findByPrimaryKey(Serializable primaryKey)
		throws NoSuchAccountGroupRelException {
		CommerceAccountGroupRel commerceAccountGroupRel = fetchByPrimaryKey(primaryKey);
	...
	/**
	 * Returns the commerce account group rel with the primary key or throws a {@link NoSuchAccountGroupRelException} if it could not be found.
	 *
	 * @param commerceAccountGroupRelId the primary key of the commerce account group rel
	 * @return the commerce account group rel
	 * @throws NoSuchAccountGroupRelException if a commerce account group rel with the primary key could not be found
	...
	public CommerceAccountGroupRel findByPrimaryKey(
		long commerceAccountGroupRelId) throws NoSuchAccountGroupRelException {
	...
	public CommerceAccountGroupRel fetchByPrimaryKey(Serializable primaryKey) {
		Serializable serializable = entityCache.getResult(CommerceAccountGroupRelModelImpl.ENTITY_CACHE_ENABLED,
		...
		CommerceAccountGroupRel commerceAccountGroupRel = (CommerceAccountGroupRel)serializable;
	...
	public Map<Serializable, CommerceAccountGroupRel> fetchByPrimaryKeys(
		...
		Map<Serializable, CommerceAccountGroupRel> map = new HashMap<Serializable, CommerceAccountGroupRel>();
		...
		try {
			...
			for (CommerceAccountGroupRel commerceAccountGroupRel : (List<CommerceAccountGroupRel>)q.list()) {
				map.put(commerceAccountGroupRel.getPrimaryKeyObj(),
					commerceAccountGroupRel);

				cacheResult(commerceAccountGroupRel);

				uncachedPrimaryKeys.remove(commerceAccountGroupRel.getPrimaryKeyObj());
			}
	...
	public List<CommerceAccountGroupRel> findAll(int start, int end,
		...
		if (list == null) {
			...
			if (orderByComparator != null) {
				...
				if (pagination) {
					sql = sql.concat(CommerceAccountGroupRelModelImpl.ORDER_BY_JPQL);
				}
			}
	...
	public int countAll() {
		...
		if (count == null) {
			...
			try {
				...
				Query q = session.createQuery(_SQL_COUNT_COMMERCEACCOUNTGROUPREL);
	...
	private static final String _SQL_SELECT_COMMERCEACCOUNTGROUPREL = "SELECT commerceAccountGroupRel FROM CommerceAccountGroupRel commerceAccountGroupRel";
	private static final String _SQL_SELECT_COMMERCEACCOUNTGROUPREL_WHERE_PKS_IN =
		"SELECT commerceAccountGroupRel FROM CommerceAccountGroupRel commerceAccountGroupRel WHERE commerceAccountGroupRelId IN (";
	private static final String _SQL_SELECT_COMMERCEACCOUNTGROUPREL_WHERE = "SELECT commerceAccountGroupRel FROM CommerceAccountGroupRel commerceAccountGroupRel WHERE ";
	private static final String _SQL_COUNT_COMMERCEACCOUNTGROUPREL = "SELECT COUNT(commerceAccountGroupRel) FROM CommerceAccountGroupRel commerceAccountGroupRel";
	private static final String _SQL_COUNT_COMMERCEACCOUNTGROUPREL_WHERE = "SELECT COUNT(commerceAccountGroupRel) FROM CommerceAccountGroupRel commerceAccountGroupRel WHERE ";
	private static final String _ORDER_BY_ENTITY_ALIAS = "commerceAccountGroupRel.";
	private static final String _NO_SUCH_ENTITY_WITH_PRIMARY_KEY = "No CommerceAccountGroupRel exists with the primary key ";
	private static final String _NO_SUCH_ENTITY_WITH_KEY = "No CommerceAccountGroupRel exists with the key {";
	private static final Log _log = LogFactoryUtil.getLog(CommerceAccountGroupRelPersistenceImpl.class);
}